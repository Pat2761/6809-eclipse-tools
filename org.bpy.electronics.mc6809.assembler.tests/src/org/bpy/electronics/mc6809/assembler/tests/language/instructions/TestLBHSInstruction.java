...
import org.bpy.electronics.mc6809.assembler.engine.data.instructions.AssembledLBHSInstruction;
...
public class TestLBHSInstruction {
	 ...
	 */
	@Test 
	public void testSimpleLBHSWithExtraSpace() {
		StringBuilder strBuilder = new StringBuilder();
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("	        ORG     $8000\n");
		strBuilder.append("Jump	    ASLA\n");
		strBuilder.append("			ASLB\n");
		strBuilder.append("			LBHS		Jump \n");
		...
		try {
			...
			Assert.assertTrue("Must be an LBHS directive line", instructionLine.getInstruction() instanceof BhsInstruction);
		} catch (Exception e) {
	 ...
	 */
	@Test 
	public void testSimpleLBHSWithoutExtraSpace() {
		StringBuilder strBuilder = new StringBuilder();
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("	        ORG     $8000\n");
		strBuilder.append("Jump	    ASLA\n");
	...
	/**
	 * Check LBHS with duplicate label
	 */
	@Test 
	public void testSimpleLBHSWithDuplicateLabel() {
		StringBuilder strBuilder = new StringBuilder();
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("	        ORG     $8000\n");
		strBuilder.append("Jump	    LDA		#25\n");
		strBuilder.append("			NOP\n");
		strBuilder.append("Jump		LBHS		Jump		; Jump=3FFF\n");
	...
	/**
	 * Check LBHS with bad label
	 */
	@Test 
	public void testSimpleLBHSWithBadLabel() {
		StringBuilder strBuilder = new StringBuilder();
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("	        ORG    	 	$8000\n");
		strBuilder.append("Jump1	LDA			#25\n");
		strBuilder.append("			NOP\n");
		strBuilder.append("Jump		LBHS		Jump2		; Jump=3FFF\n");
		...
		try {
			...
			Assert.assertNotNull(result);
			Assert.assertTrue("No errors found", result.eResource().getErrors().isEmpty());
			validationHelper.assertError(result,AssemblerPackage.eINSTANCE.getBhsInstruction(),
	 ...
	 */
	@Test 
	public void testSimpleLBHSWithWithLabel() {
		StringBuilder strBuilder = new StringBuilder();
		strBuilder.append("	        	ORG     	$8000\n");
		strBuilder.append("Jump	    	ASLA\n");
		strBuilder.append("				ASLB\n");
		strBuilder.append("MyBanch		LBHS		Jump\n");
	...
	/**
	 * Check LBHS negative jump
	 */
	@Test 
	public void testSimpleLBHSWithNegativeJump1() {
		StringBuilder strBuilder = new StringBuilder();
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("	        	ORG     $8004\n");
		strBuilder.append("Jump	    	LDA		#25\n");
		strBuilder.append("	        	ORG     $8080\n");
		strBuilder.append("MyBanch		LBHS	Jump		; Jump=1024FF80\n");
		...
		try {
			...
			validationHelper.assertWarning(result,
				AssemblerPackage.eINSTANCE.getBhsInstruction(),
			...
			AssembledLBHSInstruction line = (AssembledLBHSInstruction)engine.getAssembledLine(4);
	 ...
	 */
	@Test 
	public void testSimpleLBHSWithNegativeJump2() {
		StringBuilder strBuilder = new StringBuilder();
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("	        	ORG     $8003\n");
		strBuilder.append("Jump	    	LDA		#25\n");
		strBuilder.append("	       	 	ORG     $8080\n");
		strBuilder.append("MyBanch		LBHS	Jump		; Jump=1024FF7F\n");
	...
	/**
	 * Check LBHS positive jump
	 */
	@Test 
	public void testSimpleLBHSWithPositiveJump1() {
		StringBuilder strBuilder = new StringBuilder();
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("	        	ORG     	$8000\n");
		strBuilder.append("MyBanch		LBHS		Jump		; Jump=1024007F\n");
		...
		try {
			...
			AssembledLBHSInstruction line = (AssembledLBHSInstruction)engine.getAssembledLine(2);
			Assert.assertEquals("Check opcode length", 2, line.getOpcode().length);
			Assert.assertEquals("Check opcode value", 0x10, line.getOpcode()[0]);
			Assert.assertEquals("Check opcode value", 0x24, line.getOpcode()[1]);
			Assert.assertEquals("Check operand length", 2, line.getOperand().length);
	 ...
	 */
	@Test 
	public void testSimpleLBHSWithPositiveJump2() {
		StringBuilder strBuilder = new StringBuilder();
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("	        	ORG     	$8000\n");
		strBuilder.append("MyBanch		LBHS		Jump		; Jump=10240080\n");
	...
	/**
	 * Check LBHS positive limit jump
	 */
	@Test 
	public void testSimpleLBHSWithPositiveLimitJump1() {
		StringBuilder strBuilder = new StringBuilder();
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("	        	ORG     	$0000\n");
		strBuilder.append("MyBranch		LBHS		Jump		; Jump=10247FFF\n");
		strBuilder.append("				ORG     	$8003\n");
		strBuilder.append("Jump			RTS			\n");
	 ...
	 */
	@Test 
	public void testSimpleLBHSWithPositiveLimitJump2() {
		StringBuilder strBuilder = new StringBuilder();
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("	        	ORG     	$0000\n");
		strBuilder.append("MyBanch		LBHS		Jump		; Jump=10248000\n");
		strBuilder.append("				ORG     	$8004\n");
		strBuilder.append("Jump			RTS			\n");
	...
	/**
	 * Check LBHS negative limit jump
	 */
	@Test 
	public void testSimpleLBHSWithNegativeLimitJump1() {
		StringBuilder strBuilder = new StringBuilder();
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("				ORG			$0004\n");
		strBuilder.append("JUMP			RTS					\n");
		strBuilder.append("				ORG			$8000		;\n");
		strBuilder.append("VVV			LBHS		JUMP		;		\n");
	 ...
	 */
	@Test 
	public void testSimpleLBHSWithNegativeLimitJump2() {
		StringBuilder strBuilder = new StringBuilder();
		strBuilder.append("; -----------------------------------------\n");
