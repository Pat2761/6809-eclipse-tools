...
public class TestLBRAInstruction {
	...
	public void testSimpleLBRAWithExtraSpace() {
		...
		try {
			...
			Assert.assertTrue("Must be an LBRA directive line", instructionLine.getInstruction() instanceof BraInstruction);
		} catch (Exception e) {
	...
	public void testSimpleLBRAWithDuplicateLabel() {
		...
		strBuilder.append("Jump		LBRA		Jump		; Jump=3FFF\n");
	...
	public void testSimpleLBRAWithBadLabel() {
		...
		strBuilder.append("			NOP\n");
		strBuilder.append("Jump		LBRA		Jump2		; Jump=3FFF\n");
	...
	public void testSimpleLBRAWithWithLabel() {
		...
		strBuilder.append("Jump	    	ASLA\n");
		strBuilder.append("				ASLB\n");
		strBuilder.append("MyBanch		LBRA		Jump\n");
	...
	public void testSimpleLBRAWithNegativeJump1() {
		...
		strBuilder.append("MyBanch		LBRA	Jump		; Jump=16FF80\n");
	...
	public void testSimpleLBRAWithNegativeJump2() {
		...
		strBuilder.append("Jump	    	LDA		#25\n");
		strBuilder.append("	       	 	ORG     $8080\n");
		strBuilder.append("MyBanch		LBRA	Jump		; Jump=16FF7F\n");
	...
	public void testSimpleLBRAWithPositiveJump1() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("	        	ORG     	$8000\n");
		strBuilder.append("MyBanch		LBRA		Jump		; Jump=16007F\n");
	...
	public void testSimpleLBRAWithPositiveJump2() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("	        	ORG     	$8000\n");
		strBuilder.append("MyBanch		LBRA		Jump		; Jump=160080\n");
	...
	public void testSimpleLBRAWithPositiveLimitJump1() {
		...
		strBuilder.append("MyBranch		LBRA		Jump		; Jump=167FFF\n");
		strBuilder.append("				ORG     	$8003\n");
		strBuilder.append("Jump			RTS			\n");
		...
		try {
			...
			Assert.assertEquals("Check comment", "; Jump=167FFF", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception detected", true);
		}
	}
	...
	public void testSimpleLBRAWithPositiveLimitJump2() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("	        	ORG     	$0000\n");
		strBuilder.append("MyBanch		LBRA		Jump		; Jump=168000\n");
		strBuilder.append("				ORG     	$8004\n");
		strBuilder.append("Jump			RTS			\n");
	...
	public void testSimpleLBRAWithNegativeLimitJump1() {
		...
		strBuilder.append("JUMP			RTS					\n");
		strBuilder.append("				ORG			$8000		;\n");
		strBuilder.append("VVV			LBRA		JUMP		;		\n");
