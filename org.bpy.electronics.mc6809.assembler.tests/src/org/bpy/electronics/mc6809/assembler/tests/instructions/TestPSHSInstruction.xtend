...
class TestPSHSInstruction {
	 ...
	 */
	@Test 
	def void testPSHSImemdiatAddressingMode1() {
		...
		Assert.assertTrue("Must be an PSHS directive line", instructionLine.instruction instanceof PshsInstruction)

		val phshInstruction = instructionLine.instruction as PshsInstruction
		assertTrue("Must be an immediate addressing mode", phshInstruction.operand instanceof ImmediatOperand)
	}
