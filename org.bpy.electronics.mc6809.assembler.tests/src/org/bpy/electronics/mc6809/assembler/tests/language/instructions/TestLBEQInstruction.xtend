...
class TestLBEQInstruction {
	...
	def void testSimpleLBEQWithExtraSpace() {
		...
		Assert.assertTrue("Must be an LBEQ directive line", instructionLine.instruction instanceof BeqInstruction)
	}
	 ...
	 */
	@Test 
	def void testSimpleLBEQWithDuplicateLabel() {
		val result = parseHelper.parse('''
		; -----------------------------------------
			        ORG     $8000
		Jump	    LDA		#25
					NOP
		Jump		LBEQ		Jump		; Jump=3FFF
		''')
		Assert.assertNotNull(result)
	 ...
	 */
	@Test 
	def void testSimpleLBEQWithBadLabel() {
		val result = parseHelper.parse('''
		; -----------------------------------------
			        ORG     $8000
		Jump1	    LDA		#25
					NOP
		Jump		LBEQ		Jump2		; Jump=3FFF
		''')
		Assert.assertNotNull(result)
	 ...
	 */
	@Test 
	def void testSimpleLBEQWithWithLabel() {
		val result = parseHelper.parse('''
		; -----------------------------------------
			        ORG     $8000
		Jump	    ASLA
	 ...
	 */
	@Test 
	def void testSimpleLBEQWithNegativeJump1() {
		val result = parseHelper.parse('''
		; -----------------------------------------
			        ORG     $8004
		Jump	    LDA		#25
			        ORG     $8080
		MyBanch		LBEQ	Jump		; Jump=1024FF80
		''')
		Assert.assertNotNull(result)
		...
		val line = engine.getAssembledLine(4) as AssembledLBEQInstruction
		...
		Assert.assertEquals("Check opcode value", 0x27, line.opcode.get(1))
	 ...
	 */
	@Test 
	def void testSimpleLBEQWithNegativeJump2() {
		val result = parseHelper.parse('''
		; -----------------------------------------
			        ORG     $8003
		Jump	    LDA		#25
			        ORG     $8080
		MyBanch		LBEQ	Jump		; Jump=1024FF7F
		''')
		Assert.assertNotNull(result)
	 ...
	 */
	@Test 
	def void testSimpleLBEQWithPositiveJump1() {
		val result = parseHelper.parse('''
		; -----------------------------------------
			        ORG     $8000
		MyBanch		LBEQ		Jump		; Jump=1024007F
					ORG		$8083
		Jump		RTS			
		''')
		Assert.assertNotNull(result)
		...
		val line = engine.getAssembledLine(2) as AssembledLBEQInstruction
		Assert.assertEquals("Check opcode length", 2, line.opcode.length)
		Assert.assertEquals("Check opcode value", 0x10, line.opcode.get(0))
		Assert.assertEquals("Check opcode value", 0x27, line.opcode.get(1))
		Assert.assertEquals("Check operand length", 2, line.operand.length)
	 ...
	 */
	@Test 
	def void testSimpleLBEQWithPositiveJump2() {
		val result = parseHelper.parse('''
		; -----------------------------------------
			        ORG     $8000
		MyBanch		LBEQ		Jump		; Jump=10240080
					ORG		$8084
		Jump		RTS			
		''')
		Assert.assertNotNull(result)
	 ...
	 */
	@Test 
	def void testSimpleLBEQWithPositiveLimitJump1() {
		val result = parseHelper.parse('''
		; -----------------------------------------
			        ORG     $0000
		MyBranch	LBEQ		Jump		; Jump=10257FFF
					ORG     $8003
		Jump		RTS			
		''')
		Assert.assertNotNull(result)
	 ...
	 */
	@Test 
	def void testSimpleLBEQWithPositiveLimitJump2() {
		val result = parseHelper.parse('''
		; -----------------------------------------
			        ORG     $0000
		MyBanch		LBEQ	Jump		; Jump=10248000
					ORG     $8004
		Jump		RTS			
		''')
		Assert.assertNotNull(result)
	 ...
	 */
	@Test 
	def void testSimpleLBEQWithNegativeLimitJump1() {
		val result = parseHelper.parse('''
		; -----------------------------------------
					ORG		$0004
		JUMP		RTS					
	 ...
	 */
	@Test 
	def void testSimpleLBEQWithNegativeLimitJump2() {
		val result = parseHelper.parse('''
		; -----------------------------------------
					ORG		$0003
		JUMP		RTS					
