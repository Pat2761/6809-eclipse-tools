...
public class TestBLEInstruction {
	 ...
	 */
	@Test 
	public void testSimpleBLEWithExtraSpace() {
		StringBuilder strBuilder = new StringBuilder();
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("	        ORG     $8000\n");
		strBuilder.append("Jump	    ASLA\n");
		strBuilder.append("			ASLB\n");
		strBuilder.append("			BLE		Jump \n");
		...
		try {
			...
			Assert.assertTrue("Must be an BLE directive line", instructionLine.getInstruction() instanceof BleInstruction);
		} catch (Exception e) {
	 ...
	 */
	@Test 
	public void testSimpleBLEWithoutExtraSpace() {
		StringBuilder strBuilder = new StringBuilder();
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("	        ORG     $8000\n");
		strBuilder.append("Jump	    ASLA\n");
	 ...
	 */
	@Test 
	public void testSimpleBLEWithWithLabel() {
		StringBuilder strBuilder = new StringBuilder();
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("	        	ORG     $8000\n");
		strBuilder.append("Jump	    	ASLA\n");
		strBuilder.append("				ASLB\n");
		strBuilder.append("MyBanch		BLE		Jump\n");
	...
	public void testSimpleBLEWithDuplicateLabel() {
		...
		strBuilder.append("Jump		BLE		Jump		; Jump=3FFF\n");
	...
	public void testSimpleBLEWithBadLabel() {
		...
		strBuilder.append("				NOP\n");
		strBuilder.append("Jump			BLE		Jump2		; Jump=3FFF\n");
	...
	public void testSimpleBLEWithNegativeJump() {
		...
		strBuilder.append("Jump	    	LDA		#25\n");
		strBuilder.append("				NOP\n");
		strBuilder.append("MyBanch		BLE		Jump		; Jump=24FB\n");
		...
		try {
			...
			AssembledBLEInstruction line = (AssembledBLEInstruction)engine.getAssembledLine(4); 
	...
	public void testSimpleBLEWithPositiveJump() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("	        	ORG     $8000\n");
		strBuilder.append("MyBanch		BLE		Jump		; Jump=2401\n");
		strBuilder.append("				NOP\n");
		...
		try {
			...
			AssembledBLEInstruction line = (AssembledBLEInstruction)engine.getAssembledLine(2); 
			Assert.assertEquals("Check opcode length", 1, line.getOpcode().length);
			Assert.assertEquals("Check opcode value", 0x2F, line.getOpcode()[0]);
			Assert.assertEquals("Check operand length", 1, line.getOperand().length);
	...
	public void testSimpleBLEWithPositiveLimitJump1() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("	    	    ORG     $8000\n");
		strBuilder.append("MyBanch		BLE		Jump		; Jump=247F\n");
	...
	public void testSimpleBLEWithNegativeLimitJump1() {
		...
		strBuilder.append("VVV			BLE		JUMP		;		\n");
