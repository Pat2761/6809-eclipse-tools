...
public class TestADDDInstruction {
	...
	public void testADDDImemdiatAddressingMode() {
		...
		try {
			...
			Assert.assertTrue("Must be an ADD directive line", instructionLine.getInstruction() instanceof AdddInstruction);

			AdddInstruction adcInstruction = (AdddInstruction) instructionLine.getInstruction();
			assertEquals("Must be an ADDD instruction", adcInstruction.getInstruction(), "ADDD");
	...
	public void testADDDConstantOffsetIndexed() {
		...
		strBuilder.append("	      ADDD		  	Const,X\n");
		strBuilder.append("			ADDD		  	,X\n");
		strBuilder.append("			ADDD		  	$9,U\n");
		strBuilder.append("			ADDD		  	$9,S\n");
		strBuilder.append("			ADDD		  	$9,X\n");
		strBuilder.append("			ADDD		  	$9,Y\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testADDDAccumulatorIndexed() {
		...
		strBuilder.append("	      ORG  			$8000\n");
		strBuilder.append("Const	EQU        	5    \n");
		strBuilder.append("	      ADDD		  	A,X\n");
		strBuilder.append("			ADDD		  	B,X\n");
		strBuilder.append("			ADDD		  	D,U\n");
		strBuilder.append("			ADDD		  	A,S\n");
		strBuilder.append("			ADDD		  	B,X\n");
		strBuilder.append("			ADDD		  	D,Y\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testADDDAutoIncrementIndexed() {
		...
		strBuilder.append("	       	ADDD		  	,X+\n");
		strBuilder.append("	       	ADDD		  	,X++\n");
		strBuilder.append("	       	ADDD		  	,--S\n");
		strBuilder.append("	       	ADDD		  	,-S\n");
		strBuilder.append("	       	ADDD		  	,U+\n");
		strBuilder.append("	       	ADDD		  	,U++\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testADDDRelativePCIndexed() {
		...
		strBuilder.append("	       	ADDD		  	Const,PC\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testADDDWithDuplicateLabel() {
		...
		strBuilder.append("Start      	ADDD		  	#Const+2\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testADDDImmediatInstruction1() {
		...
		strBuilder.append("		    		ORG   		$8000\n");
		strBuilder.append("Const	   	EQU       	5\n");
		strBuilder.append("Start      	ADDD		  	#Const+2  ; 8000   C3 00 07        START:    ADDD\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			AssembledADDDInstruction line = (AssembledADDDInstruction) engine.getAssembledLine(3);
			Assert.assertEquals("Check getOpcode() size ", 1, line.getOpcode().length);
			Assert.assertEquals("Check getOpcode()", 0xC3, line.getOpcode()[0]);
			...
			;
			Assert.assertEquals("Check comment", "; 8000   C3 00 07        START:    ADDD", line.getComment());
			;
		} catch (Exception e) {
			Assert.assertTrue("Exception", true);
		}
	...
	public void testADDDImmediatInstruction2() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("		   		ORG    		$8000\n");
		strBuilder.append("Start      	ADDD		  	#-32769\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());

			Assert.assertNotNull(result);
			Assert.assertTrue("No errors found", result.eResource().getErrors().isEmpty());
			validationTestHelper.assertError(result, AssemblerPackage.eINSTANCE.getAdddInstruction(), InstructionValidator.OVERFLOW_ERROR,
	...
	public void testADDDImmediatInstruction3() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("		   		ORG    			$8000\n");
		strBuilder.append("Start      	ADDD		  	#-128\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testADDDImmediatInstruction4() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("		   		ORG    		$8000\n");
		strBuilder.append("Start      	ADDD		  	#127\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testADDDImmediatInstruction5() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("		   		ORG    		$8000\n");
		strBuilder.append("Start      	ADDD		  	#65535\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	 ...
	 */
	@Test
	public void testADDDImmediatInstruction6() {
		StringBuilder strBuilder = new StringBuilder();
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("		   		ORG    		$8000\n");
		strBuilder.append("Start      	ADDD		  	#65536\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testADDDDirectInstruction1() {
		...
		strBuilder.append("		   		ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	ADDD		  	<Const*2  ; 8000   D3 0A        START:    ADDD   <Const*2 \n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			AssembledADDDInstruction line = (AssembledADDDInstruction) engine.getAssembledLine(3);
			Assert.assertEquals("Check getOpcode() size ", 1, line.getOpcode().length);
			Assert.assertEquals("Check getOpcode()", 0xD3, line.getOpcode()[0]);
	...
	public void testADDDDirectInstruction2() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("		   		ORG    			$8000\n");
		strBuilder.append("Start      	ADDD		  	<-129\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testADDDExtendedInstruction1() {
		...
		strBuilder.append("		   		ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	ADDD		  	>Const*1000  ; 8000   F3 13 88     START:    ADDD   >Const*1000 \n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			AssembledADDDInstruction line = (AssembledADDDInstruction) engine.getAssembledLine(3);
			Assert.assertEquals("Check getOpcode() size ", 1, line.getOpcode().length);
			Assert.assertEquals("Check getOpcode()", 0xF3, line.getOpcode()[0]);
			Assert.assertEquals("Check operand size ", 2, line.getOperand().length);
	...
	public void testADDDExtendedInstruction3() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("		   		ORG    			$8000\n");
		strBuilder.append("Start      	ADDD		  	>-32768\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testADDDExtendedIndirectInstruction1() {
		...
		strBuilder.append("		   		ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	ADDD		  	[Const*1000]  ; 8000   AB 9F 13 88  START:    ADDD   [Const*1000]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check getOpcode()", 0xE3, line.getOpcode()[0]);
	...
	public void testADDDIndexedAccumulatorMovingMode1() {
		...
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	ADDD		  	A,X  ; 8000   AB 86        START:    ADDD   A,X\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testADDDIndexedAccumulatorMovingMode2() {
		...
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	ADDD		  	A,Y  ; 8000   	E3 A6        START:    ADDD   A,Y\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testADDDIndexedAccumulatorMovingMode3() {
		...
		strBuilder.append("		   	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	ADDD		  	A,U  ; 8000   	E3 C6        START:    ADDD   A,U\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testADDDIndexedAccumulatorMovingMode4() {
		...
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	ADDD		  	A,S  ; 8000   	E3 E6        START:    ADDD   A,S\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testADDDIndexedAccumulatorMovingMode5() {
		...
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	ADDD		  	B,X  ; 8000   AB 85        START:    ADDD   B,X\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testADDDIndexedAccumulatorMovingMode6() {
		...
		strBuilder.append("		   		ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	ADDD		  	B,Y  ; 8000   	E3 A5        START:    ADDD   B,Y\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testADDDIndexedAccumulatorMovingMode7() {
		...
		strBuilder.append("		   		ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	ADDD		  	B,U  ; 8000   	E3 C5        START:    ADDD   B,U\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testADDDIndexedAccumulatorMovingMode8() {
		...
		strBuilder.append("		   		ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	ADDD		  	B,S  ; 8000   	E3 E5        START:    ADDD   B,S\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testADDDIndexedAccumulatorMovingMode9() {
		...
		strBuilder.append("		   		ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	ADDD		  	D,X  ; 8000   AB 8B        START:    ADDD   D,X\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testADDDIndexedAccumulatorMovingMode10() {
		...
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	ADDD		  	D,Y  ; 8000   	E3 AB        START:    ADDD   D,Y\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testADDDIndexedAccumulatorMovingMode11() {
		...
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	ADDD		  	D,U  ; 8000   	E3 CB        START:    ADDD   D,U\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testADDDIndexedAccumulatorMovingMode12() {
		...
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	ADDD		  	D,S  ; 8000   	E3 EB        START:    ADDD   D,S\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testADDDIndexedIndorectAccumulatorMovingMode1() {
		...
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	ADDD		  	[A,X]  ; 8000   AB 96        START:    ADDD   [A,X]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testADDDIndexedIndirectAccumulatorMovingMode2() {
		...
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	ADDD		  	[A,Y]  ; 8000   	E3 B6        START:    ADDD   [A,Y]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testADDDIndexedIndirectAccumulatorMovingMode3() {
		...
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	ADDD		  	[A,U]  ; 8000   	E3 D6        START:    ADDD   [A,U]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testADDDIndexedIndirectAccumulatorMovingMode4() {
		...
		strBuilder.append("		   		ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	ADDD		  	[A,S]  ; 8000   	E3 F6        START:    ADDD   [A,S]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testADDDIndexedIndirectAccumulatorMovingMode5() {
		...
		strBuilder.append("		   		ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	ADDD		  	[B,X]  ; 8000   AB 95        START:    ADDD   [B,X]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testADDDIndexedIndirectAccumulatorMovingMode6() {
		...
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	ADDD		  	[B,Y]  ; 8000   	E3 B5        START:    ADDD   [B,Y]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testADDDIndexedIndirectAccumulatorMovingMode7() {
		...
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	ADDD		  	[B,U]  ; 8000   	E3 D5        START:    ADDD   [B,U]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testADDDIndexedIndirectAccumulatorMovingMode8() {
		...
		strBuilder.append("		   		ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	ADDD		  	[B,S]  ; 8000   	E3 F5        START:    ADDD   [B,S]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testADDDIndexedIndirectAccumulatorMovingMode9() {
		...
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	ADDD		  	[D,X]  ; 8000   AB 9B        START:    ADDD   [D,X]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testADDDIndexedIndirectAccumulatorMovingMode10() {
		...
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	ADDD		  	[D,Y]  ; 8000   	E3 BB        START:    ADDD   [D,Y]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testADDDIndexedIndirectAccumulatorMovingMode11() {
		...
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	ADDD		  	[D,U]  ; 8000   	E3 DB        START:    ADDD   [D,U]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testADDDIndexedIndirectAccumulatorMovingMode12() {
		...
		strBuilder.append("		  	 	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	ADDD		  	[D,S]  ; 8000   	E3 FB        START:    ADDD   [D,S]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testADDDIndexedAutoIncrementDecrementMode1() {
		...
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	ADDD		  	,X+  ; 8000   	E3 80        START:    ADDD   ,X+\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testADDDIndexedAutoIncrementDecrementMode2() {
		...
		strBuilder.append("		   		ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	ADDD		  	,X++  ; 8000   	E3 81        START:    ADDD   ,X++\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testADDDIndexedAutoIncrementDecrementMode3() {
		...
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	ADDD		  	,Y+  ; 8000   	E3 A0        START:    ADDD   ,Y+\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testADDDIndexedAutoIncrementDecrementMode4() {
		...
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	ADDD		  	,Y++  ; 8000   	E3 A1        START:    ADDD   ,Y++\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testADDDIndexedAutoIncrementDecrementMode5() {
		...
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	ADDD		  	,S+  ; 8000   	E3 E0        START:    ADDD   ,S+\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testADDDIndexedAutoIncrementDecrementMode6() {
		...
		strBuilder.append("		  	 	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	ADDD		  	,S++  ; 8000   	E3 E1        START:    ADDD   ,S++\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testADDDIndexedAutoIncrementDecrementMode7() {
		...
		strBuilder.append("		  	 	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	ADDD		  	,U+  ; 8000   	E3 C0        START:    ADDD   ,U+\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testADDDIndexedAutoIncrementDecrementMode8() {
		...
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	ADDD		  	,U++  ; 8000   	E3 C1        START:    ADDD   ,U++\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testADDDIndexedAutoIncrementDecrementMode9() {
		...
		strBuilder.append("		 	  	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	ADDD		  	,-X  ; 8000   	E3 82        START:    ADDD   ,-X\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testADDDIndexedAutoIncrementDecrementMode10() {
		...
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	ADDD		  	,--X  ; 8000   	E3 83        START:    ADDD   ,--X\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testADDDIndexedAutoIncrementDecrementMode11() {
		...
		strBuilder.append("		 	  	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	ADDD		  	,-Y  ; 8000   	E3 A2        START:    ADDD   ,-Y\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testADDDIndexedAutoIncrementDecrementMode12() {
		...
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	ADDD		  	,--Y  ; 8000   	E3 A3        START:    ADDD   ,--Y\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testADDDIndexedAutoIncrementDecrementMode13() {
		...
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	ADDD		  	,-S  ; 8000   	E3 E2        START:    ADDD   ,-S\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testADDDIndexedAutoIncrementDecrementMode14() {
		...
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	ADDD		  	,--S  ; 8000   	E3 E3        START:    ADDD   ,--S\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testADDDIndexedAutoIncrementDecrementMode15() {
		...
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	ADDD		  	,-U  ; 8000   	E3 C2        START:    ADDD   ,-U\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testADDDIndexedAutoIncrementDecrementMode16() {
		...
		strBuilder.append("		   		ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	ADDD		  	,--U  ; 8000   	E3 C3        START:    ADDD   ,--U\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	/**
	 * Check Assembled ADDD Indexed Auto Increment Decrement Indirect Mode
	 * instruction
	 */
	@Test
	public void testADDDIndexedAutoIncrementDecrementIndirectMode1() {
		...
		try {
			...
			Assert.assertNotNull(result);
			Assert.assertTrue("No errors found", result.eResource().getErrors().isEmpty());
			validationTestHelper.assertError(result, AssemblerPackage.eINSTANCE.getAdddInstruction(),
	...
	/**
	 * Check Assembled ADDD Indexed Auto Increment Decrement Mode indorect
	 * instruction
	 */
	@Test
	public void testADDDIndexedAutoIncrementDecrementIndirectMode2() {
		...
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	ADDD		  	[,X++]  ; 8000   	E3 91        START:    ADDD   [,X++]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	/**
	 * Check Assembled ADDD Indexed Auto Increment Decrement Mode indirect
	 * instruction
	 */
	@Test
	...
	public void testADDDIndexedAutoIncrementDecrementIndirectMode4() {
		...
		strBuilder.append("		   		ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	ADDD		  	[,Y++]  ; 8000   	E3 B1        START:    ADDD   [,Y++]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testADDDIndexedAutoIncrementDecrementIndirectMode6() {
		...
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	ADDD		  	[,S++]  ; 8000   	E3 F1        START:    ADDD   [,S++]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testADDDIndexedAutoIncrementDecrementindirectMode8() {
		...
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	ADDD		  	[,U++]  ; 8000   	E3 D1        START:    ADDD   [,U++]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testADDDIndexedAutoIncrementDecrementIndirectMode10() {
		...
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	ADDD		  	[,--X]  ; 8000   	E3 93        START:    ADDD   [,--X]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testADDDIndexedAutoIncrementDecrementIndirectMode12() {
		...
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	ADDD		  	[,--Y]  ; 8000   	E3 B3        START:    ADDD   [,--Y]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testADDDIndexedAutoIncrementDecrementIndirectMode14() {
		...
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	ADDD		  	[,--S]  ; 8000   	E3 F3        START:    ADDD   [,--S]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testADDDIndexedAutoIncrementDecrementIndirectMode16() {
		...
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	ADDD		  	[,--U]  ; 8000   	E3 D3        START:    ADDD   [,--U]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testADDDIndexedConstantMove1() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("		 	  	ORG    			$8000\n");
		strBuilder.append("Start      	ADDD		  	1234,X  ; 8000   	E3 89 04 D2            ADDD   1234,X\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testADDDIndexedConstantMove2() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	ADDD		  	1234,Y  ; 8000   	AB A9 04 D2            ADDD   1234,Y\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check operand", 0xD2, line.getOperand()[2]);
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	AB A9 04 D2            ADDD   1234,Y", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", true);
		}
	}
	...
	public void testADDDIndexedConstantMove3() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	ADDD		  	1234,U  ; 8000   	E3 C9 04 D2            ADDD   1234,U\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testADDDIndexedConstantMove4() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	ADDD		  	1234,S  ; 8000   	E3 E9 04 D2            ADDD   1234,S\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testADDDIndexedConstantMove5() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	ADDD		  	34,X  ; 8000   	E3 88 22            ADDD   34,X\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testADDDIndexedConstantMove6() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	ADDD		  	34,Y  ; 8000   	E3 A8 22            ADDD   34,Y\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testADDDIndexedConstantMove7() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("		  	 	ORG    			$8000\n");
		strBuilder.append("Start      	ADDD		  	34,U  ; 8000   	E3 C8 22            ADDD   34,U\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testADDDIndexedConstantMove8() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	ADDD		  	34,S  ; 8000   	E3 E8 22            ADDD   34,S\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testADDDIndexedConstantMove9() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	ADDD		  	,X  ; 8000   	E3 84            ADDD   ,X\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testADDDIndexedConstantMove10() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	ADDD		  	,Y  ; 8000   	E3 A4            ADDD   ,Y\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testADDDIndexedConstantMove11() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	ADDD		  	,U  ; 8000   	E3 C4            ADDD   ,U\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testADDDIndexedConstantMove12() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("		 	  	ORG    			$8000\n");
		strBuilder.append("Start      	ADDD		  	,S  ; 8000   	E3 E4            ADDD   ,S\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testADDDIndexedConstantMove13() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	ADDD		  	0,X  ; 8000   	E3 84            ADDD   0,X\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testADDDIndexedConstantMove14() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	ADDD		  	0,Y  ; 8000   	E3 A4            ADDD   0,Y\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testADDDIndexedConstantMove15() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	ADDD		  	0,U  ; 8000   	E3 C4            ADDD   0,U\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testADDDIndexedConstantMove16() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	ADDD		  	0,S  ; 8000   	E3 E4            ADDD   0,S\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testADDDIndexedConstantMove17() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	ADDD		  	-16,X  ; 8000   	E3 10            ADDD   -16,X\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testADDDIndexedConstantMove19() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	ADDD		  	1,X  ; 8000   	E3 01            ADDD   1,X\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testADDDIndexedConstantMove20() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("		 	  	ORG    			$8000\n");
		strBuilder.append("Start      	ADDD		  	15,X  ; 8000   	E3 0F            ADDD   15,X\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testADDDIndexedConstantMove21() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	ADDD		  	-16,Y  ; 8000   	E3 30            ADDD   -16,Y\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testADDDIndexedConstantMove23() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	ADDD		  	1,Y  ; 8000   	E3 21            ADDD   1,Y\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testADDDIndexedConstantMove24() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	ADDD		  	15,Y  ; 8000   	E3 2F            ADDD   15,Y\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testADDDIndexedConstantMove25() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	ADDD		  	-16,U  ; 8000   	E3 50            ADDD   -16,U\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testADDDIndexedConstantMove26() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	ADDD		  	1,U  ; 8000   	E3 41            ADDD   1,U\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testADDDIndexedConstantMove27() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	ADDD		  	15,U  ; 8000   	E3 4F            ADDD   15,U\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testADDDIndexedConstantMove28() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	ADDD		  	-16,S  ; 8000   	E3 70            ADDD   -16,S\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testADDDIndexedConstantMove29() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	ADDD		  	1,S  ; 8000   	E3 61            ADDD   1,S\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testADDDIndexedConstantMove30() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	ADDD		  	15,S  ; 8000   	E3 6F            ADDD   15,S\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testADDDIndexedConstantMove31() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	ADDD		  	-128,X  ; 8000   	E3 88 80            ADDD   -128,X\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testADDDIndexedConstantMove32() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("		 	  	ORG    			$8000\n");
		strBuilder.append("Start      	ADDD		  	127,X  ; 8000   	E3 88 7F            ADDD   127,X\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testADDDIndexedConstantMove33() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	ADDD		  	-128,Y  ; 8000   	E3 A8 80            ADDD   -128,Y\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testADDDIndexedConstantMove34() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("		 	  	ORG    			$8000\n");
		strBuilder.append("Start      	ADDD		  	127,Y  ; 8000   	E3 A8 7F            ADDD   127,Y\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testADDDIndexedConstantMove35() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	ADDD		  	-128,U  ; 8000   	E3 C8 80            ADDD   -128,U\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testADDDIndexedConstantMove36() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("		  	 	ORG    			$8000\n");
		strBuilder.append("Start      	ADDD		  	127,U  ; 8000   	E3 C8 7F            ADDD   127,U\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testADDDIndexedConstantMove37() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	ADDD		  	-128,S  ; 8000   	E3 E8 80            ADDD   -128,S\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testADDDIndexedConstantMove38() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	ADDD		  	127,S  ; 8000   	E3 E8 7F            ADDD   127,S\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testADDDIndexedConstantMove39() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	ADDD		  	-32768,X  ; 8000   	E3 89 80 00             ADDD   -32768,X\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testADDDIndexedConstantMove40() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	ADDD		  32767,X  ; 8000   	E3 89 7F FF             ADDD   32767,X\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testADDDIndexedConstantMove41() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	ADDD		  	-32768,Y  ; 8000   	AB A9 80 00             ADDD   -32768,Y\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check operand", 0x00, line.getOperand()[2]);
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	AB A9 80 00             ADDD   -32768,Y", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", true);
		}
	}
	...
	public void testADDDIndexedConstantMove42() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	ADDD		  32767,Y  ; 8000   	AB A9 7F FF             ADDD   32767,Y\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check operand", 0xFF, line.getOperand()[2]);
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	AB A9 7F FF             ADDD   32767,Y", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", true);
		}
	}
	...
	public void testADDDIndexedConstantMove43() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	ADDD		  	-32768,U  ; 8000   	E3 C9 80 00             ADDD   -32768,U\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testADDDIndexedConstantMove44() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	ADDD		  32767,U  ; 8000   	E3 C9 7F FF             ADDD   32767,U\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testADDDIndexedConstantMove45() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("		 	  	ORG    			$8000\n");
		strBuilder.append("Start      	ADDD		  	-32768,S  ; 8000   	E3 E9 80 00             ADDD   -32768,S\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testADDDIndexedConstantMove46() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	ADDD		  32767,S  ; 8000   	E3 E9 7F FF             ADDD   32767,S\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testADDDIndexedConstantMove47() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	ADDD		  	-32769,X  ; 8000   	E3 89 80 00             ADDD   -32769,X\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testADDDIndexedConstantMove48() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	ADDD		  32768,X  ; 8000   	E3 89 7F FF             ADDD   32768,X\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testADDDIndexedConstantMove49() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("		   		ORG    			$8000\n");
		strBuilder.append("Start      	ADDD		  	-32769,Y  ; 8000   	AB A9 80 00             ADDD   -32769,Y\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check operand", 0x00, line.getOperand()[2]);
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	AB A9 80 00             ADDD   -32769,Y", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", true);
		}
	}
	...
	public void testADDDIndexedConstantMove50() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("		  	 	ORG    			$8000\n");
		strBuilder.append("Start      	ADDD		  32768,Y  ; 8000   	AB A9 7F FF             ADDD   32768,Y\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check operand", 0xFF, line.getOperand()[2]);
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	AB A9 7F FF             ADDD   32768,Y", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", true);
		}
	}
	...
	public void testADDDIndexedConstantMove51() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("		 	  	ORG    			$8000\n");
		strBuilder.append("Start      	ADDD		  	-32769,U  ; 8000   	E3 C9 80 00             ADDD   -32769,U\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testADDDIndexedConstantMove52() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	ADDD		  32768,U  ; 8000   	E3 C9 7F FF             ADDD   32768,U\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testADDDIndexedConstantMove53() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	ADDD		  	-32769,S  ; 8000   	E3 E9 80 00             ADDD   -32769,S\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testADDDIndexedConstantMove54() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	ADDD		  32768,S  ; 8000   	E3 E9 7F FF             ADDD   32768,S\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testADDDIndexedConstantIndirectMove1() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	ADDD		  	[1234,X]  ; 8000   	E3 99 04 D2            ADDD   [1234,X]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testADDDIndexedConstantIndirectMove2() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	ADDD		  	[1234,Y]  ; 8000   	E3 B9 04 D2            ADDD   [1234,Y]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testADDDIndexedConstantIndirectMove3() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("		 	  	ORG    			$8000\n");
		strBuilder.append("Start      	ADDD		  	[1234,U]  ; 8000   	E3 D9 04 D2            ADDD   [1234,U]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testADDDIndexedConstantIndirectMove4() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	ADDD		  	[1234,S]  ; 8000   	E3 F9 04 D2            ADDD   [1234,S]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testADDDIndexedConstantIndirectMove5() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	ADDD		  	[34,X]  ; 8000   	E3 98 22            ADDD   [34,X]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testADDDIndexedConstantIndirectMove6() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	ADDD		  	[34,Y]  ; 8000   	E3 B8 22            ADDD   [34,Y]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testADDDIndexedConstantIndirectMove7() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	ADDD		  	[34,U]  ; 8000   	E3 D8 22            ADDD   [34,U]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testADDDIndexedConstantIndirectMove8() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	ADDD		  	[34,S]  ; 8000   	E3 F8 22            ADDD   [34,S]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testADDDIndexedConstantIndirectMove9() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	ADDD		  	[,X]  ; 8000   	E3 94            ADDD   [,X]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testADDDIndexedConstantIndirectMove10() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("		 	  	ORG    			$8000\n");
		strBuilder.append("Start      	ADDD		  	[,Y]  ; 8000   	E3 B4            ADDD   [,Y]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testADDDIndexedConstantIndirectMove11() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	ADDD		  	[,U]  ; 8000   	E3 D4            ADDD   [,U]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testADDDIndexedConstantIndirectMove12() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	ADDD		  	[,S]  ; 8000   	E3 F4            ADDD   [,S]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testADDDIndexedConstantIndirectMove13() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	ADDD		  	[0,X]  ; 8000   	E3 94            ADDD   [0,X]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testADDDIndexedConstantIndirectMove14() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	ADDD		  	[0,Y]  ; 8000   	E3 B4            ADDD   [0,Y]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testADDDIndexedConstantIndirectMove15() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	ADDD		  	[0,U]  ; 8000   	E3 D4            ADDD   [0,U]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testADDDIndexedConstantIndirectMove16() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	ADDD		  	[0,S]  ; 8000   	E3 F4            ADDD   [0,S]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testADDDIndexedConstantIndirectMove17() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	ADDD		  	[-16,X]  ; 8000   	E3 98 F0            ADDD   [-16,X]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testADDDIndexedConstantIndirectMove18() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	ADDD		  	[15,X]  ; 8000   	E3 98 0F            ADDD   [15,X]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testADDDIndexedConstantIndirectMove19() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	ADDD		  	[-16,Y]  ; 8000   	E3 B8 F0            ADDD   [-16,Y]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testADDDIndexedConstantIndirectMove20() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	ADDD		  	[15,Y]  ; 8000   	E3 B8 0F            ADDD   [15,Y]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testADDDIndexedConstantIndirectMove21() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	ADDD		  	[-16,U]  ; 8000   	E3 D8 F0            ADDD   [-16,U]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testADDDIndexedConstantIndirectMove22() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	ADDD		  	[15,U]  ; 8000   	E3 D8 0F            ADDD   [15,U]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testADDDIndexedConstantIndirectMove23() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	ADDD		  	[-16,S]  ; 8000   	E3 F8 F0            ADDD   [-16,S]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testADDDIndexedConstantIndirectMove24() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	ADDD		  	[15,S]  ; 8000   	E3 F8 0F            ADDD   [15,S]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testADDDIndexedConstantIndirectMove31() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("		 	  	ORG    			$8000\n");
		strBuilder.append("Start      	ADDD		  	[-128,X]  ; 8000   	E3 98 80            ADDD   [-128,X}\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testADDDIndexedConstantIndirectMove32() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	ADDD		  	[127,X]  ; 8000   	E3 98 7F            ADDD   [127,X]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testADDDIndexedConstantIndirectMove33() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	ADDD		  	[-128,Y]  ; 8000   	E3 B8 80            ADDD   [-128,Y]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testADDDIndexedConstantIndirectMove34() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("		 	  	ORG    			$8000\n");
		strBuilder.append("Start      	ADDD		  	[127,Y]  ; 8000   	E3 B8 7F            ADDD   [127,Y]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testADDDIndexedConstantIndirectMove35() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	ADDD		  	[-128,U]  ; 8000   	E3 D8 80            ADDD   [-128,U]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testADDDIndexedConstantIndirectMove36() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	ADDD		  	[127,U]  ; 8000   	E3 D8 7F            ADDD   [127,U]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testADDDIndexedConstantIndirectMove37() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	ADDD		  	[-128,S]  ; 8000   	E3 F8 80            ADDD   [-128,S]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testADDDIndexedConstantIndirectMove38() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	ADDD		  	[127,S]  ; 8000   	E3 F8 7F            ADDD   [127,S]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testADDDIndexedConstantIndirectMove39() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	ADDD		  	[-32768,X]  ; 8000   	E3 99 80 00             ADDD   [-32768,X]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testADDDIndexedConstantIndirectMove40() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	ADDD		  [32767,X]  ; 8000   	E3 99 7F FF             ADDD   [32767,X]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testADDDIndexedConstantIndirectMove41() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	ADDD		  	[-32768,Y]  ; 8000   	E3 B9 80 00             ADDD   [-32768,Y]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testADDDIndexedConstantIndirectMove42() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	ADDD		  [32767,Y]  ; 8000   	E3 B9 7F FF             ADDD   [32767,Y]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testADDDIndexedConstantIndirectMove43() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	ADDD		  	[-32768,U]  ; 8000   	E3 D9 80 00             ADDD   [-32768,U]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testADDDIndexedConstantIndirectMove44() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	ADDD		  [32767,U]  ; 8000   	E3 D9 7F FF             ADDD   [32767,U]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testADDDIndexedConstantIndirectMove45() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("		   		ORG    			$8000\n");
		strBuilder.append("Start      	ADDD		  	[-32768,S]  ; 8000   	E3 F9 80 00             ADDD   [-32768,S]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testADDDIndexedConstantIndirectMove46() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	ADDD		  [32767,S]  ; 8000   	E3 F9 7F FF             ADDD   [32767,S]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testADDDIndexedConstantIndirectMove47() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("		 	  	ORG    			$8000\n");
		strBuilder.append("Start      	ADDD		  	[-32769,X]  ; 8000   	E3 99 80 00             ADDD   [-32769,X]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testADDDIndexedConstantIndirectMove48() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	ADDD		  [32768,X]  ; 8000   	E3 99 7F FF             ADDD   [32768,X]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testADDDIndexedConstantIndirectMove49() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("		 	  	ORG    			$8000\n");
		strBuilder.append("Start      	ADDD		  	[-32769,Y]  ; 8000   	E3 B9 80 00             ADDD   [-32769,Y]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testADDDIndexedConstantIndirectMove50() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("		 	  	ORG    			$8000\n");
		strBuilder.append("Start      	ADDD		  [32768,Y]  ; 8000   	E3 B9 7F FF             ADDD   [32768,Y]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testADDDIndexedConstantIndirectMove51() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	ADDD		  	[-32769,U]  ; 8000   	E3 D9 80 00             ADDD   [-32769,U]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testADDDIndexedConstantIndirectMove52() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	ADDD		  [32768,U]  ; 8000   	E3 D9 7F FF             ADDD   [32768,U]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testADDDIndexedConstantIndirectMove53() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	ADDD		  	[-32769,S]  ; 8000   	E3 F9 80 00             ADDD   [-32769,S]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testADDDIndexedConstantIndirectMove54() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("		   		ORG    			$8000\n");
		strBuilder.append("Start      	ADDD		  [32768,S]  ; 8000   	E3 F9 7F FF             ADDD   [32768,S]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
