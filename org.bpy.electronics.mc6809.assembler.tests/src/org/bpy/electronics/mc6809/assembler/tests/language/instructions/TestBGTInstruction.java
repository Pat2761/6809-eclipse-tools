...
import org.bpy.electronics.mc6809.assembler.engine.data.instructions.AssembledBGTInstruction;
...
public class TestBGTInstruction {
	...
	public void testSimpleBGTWithExtraSpace() {
		...
		try {
			...
			Assert.assertTrue("Must be an BGT directive line", instructionLine.getInstruction() instanceof BgtInstruction);
		} catch (Exception e) {
	...
	public void testSimpleBGTWithWithLabel() {
		...
		strBuilder.append("Jump	    	ASLA\n");
		strBuilder.append("				ASLB\n");
		strBuilder.append("MyBanch		BGT		Jump\n");
	...
	/**
	 * Check BGT with duplicate label
	 */
	@Test 
	public void testSimpleBGTWithDuplicateLabel() {
		StringBuilder strBuilder = new StringBuilder();
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("	        ORG     $8000\n");
		strBuilder.append("Jump	    LDA		#25\n");
		strBuilder.append("			NOP\n");
		strBuilder.append("Jump		BGT		Jump		; Jump=3FFF\n");
	...
	/**
	 * Check BGT with bad label
	 */
	@Test 
	public void testSimpleBGTWithBadLabel() {
		StringBuilder strBuilder = new StringBuilder();
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("	        	ORG     $8000\n");
		strBuilder.append("Jump1	    LDA		#25\n");
		strBuilder.append("				NOP\n");
		strBuilder.append("Jump			BGT		Jump2		; Jump=3FFF\n");
	...
	/**
	 * Check BGT negative jump
	 */
	@Test 
	public void testSimpleBGTWithNegativeJump() {
		StringBuilder strBuilder = new StringBuilder();
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("	        	ORG     $8000\n");
		strBuilder.append("Jump	    	LDA		#25\n");
		strBuilder.append("				NOP\n");
		strBuilder.append("MyBanch		BGT		Jump		; Jump=24FB\n");
		...
		try {
			...
			AssembledBGTInstruction line = (AssembledBGTInstruction)engine.getAssembledLine(4); 
			Assert.assertEquals("Check opcode length", 1, line.getOpcode().length);
			Assert.assertEquals("Check opcode value", 0x2E, line.getOpcode()[0]);
	...
	/**
	 * Check BGT positive jump
	 */
	@Test 
	public void testSimpleBGTWithPositiveJump() {
		StringBuilder strBuilder = new StringBuilder();
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("	        	ORG     $8000\n");
		strBuilder.append("MyBanch		BGT		Jump		; Jump=2401\n");
		strBuilder.append("				NOP\n");
		...
		try {
			...
			AssembledBGTInstruction line = (AssembledBGTInstruction)engine.getAssembledLine(2); 
			Assert.assertEquals("Check opcode length", 1, line.getOpcode().length);
			Assert.assertEquals("Check opcode value", 0x2E, line.getOpcode()[0]);
			Assert.assertEquals("Check operand length", 1, line.getOperand().length);
	...
	/**
	 * Check BGT positive limit jump
	 */
	@Test 
	public void testSimpleBGTWithPositiveLimitJump1() {
		StringBuilder strBuilder = new StringBuilder();
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("	    	    ORG     $8000\n");
		strBuilder.append("MyBanch		BGT		Jump		; Jump=247F\n");
	 ...
	 */
	@Test 
	public void testSimpleBGTWithPositiveLimitJump2() {
		StringBuilder strBuilder = new StringBuilder();
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("	        	ORG     $8000\n");
		strBuilder.append("MyBanch		BGT		Jump		; Jump=247F\n");
	...
	/**
	 * Check BGT negative limit jump
	 */
	@Test 
	public void testSimpleBGTWithNegativeLimitJump1() {
		StringBuilder strBuilder = new StringBuilder();
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("				ORG		$8002\n");
		strBuilder.append("JUMP			RTS					\n");
		strBuilder.append("				ORG		$8080		;\n");
		strBuilder.append("VVV			BGT		JUMP		;		\n");
	 ...
	 */
	@Test 
	public void testSimpleBGTWithNegativeLimitJump2() {
		StringBuilder strBuilder = new StringBuilder();
		strBuilder.append("; -----------------------------------------\n");
