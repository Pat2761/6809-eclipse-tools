...
class TestBVSInstruction {
	 ...
	 */
	@Test 
	def void testSimpleBVSWithExtraSpace() {
		...
		Assert.assertTrue("Must be an BVS directive line", instructionLine.instruction instanceof BvsInstruction)
	}
	 ...
	 */
	@Test 
	def void testSimpleBVSWithoutExtraSpace() {
		val result = parseHelper.parse('''
		; -----------------------------------------
			        ORG     $8000
		Jump	    ASLA
	 ...
	 */
	@Test 
	def void testSimpleBVSWithWithLabel() {
		val result = parseHelper.parse('''
		; -----------------------------------------
			        ORG     $8000
		Jump	    ASLA
	 ...
	 */
	@Test 
	def void testSimpleBVSWithDuplicateLabel() {
		val result = parseHelper.parse('''
		; -----------------------------------------
			        ORG     $8000
		Jump	    LDA		#25
					NOP
		Jump		BVS		Jump		; Jump=3FFF
		''')
		Assert.assertNotNull(result)
	 ...
	 */
	@Test 
	def void testSimpleBVSWithBadLabel() {
		val result = parseHelper.parse('''
		; -----------------------------------------
			        ORG     $8000
		Jump1	    LDA		#25
					NOP
		Jump		BVS		Jump2		; Jump=3FFF
		''')
		Assert.assertNotNull(result)
	 ...
	 */
	@Test 
	def void testSimpleBVSWithNegativeJump() {
		val result = parseHelper.parse('''
		; -----------------------------------------
			        ORG     $8000
		Jump	    LDA		#25
		...
		val line = engine.getAssembledLine(4) as AssembledBVSInstruction
		Assert.assertEquals("Check opcode length", 1, line.opcode.length)
		Assert.assertEquals("Check opcode value", 0x29, line.opcode.get(0))
	 ...
	 */
	@Test 
	def void testSimpleBVSWithPositiveJump() {
		val result = parseHelper.parse('''
		; -----------------------------------------
			        ORG     $8000
		MyBanch		BVS		Jump		; 
		...
		val line = engine.getAssembledLine(2) as AssembledBVSInstruction
		Assert.assertEquals("Check opcode length", 1, line.opcode.length)
		Assert.assertEquals("Check opcode value", 0x29, line.opcode.get(0))
		Assert.assertEquals("Check operand length", 1, line.operand.length)
	 ...
	 */
	@Test 
	def void testSimpleBVSWithPositiveLimitJump1() {
		val result = parseHelper.parse('''
		; -----------------------------------------
			        ORG     $8000
		MyBanch		BVS		Jump		; 
	 ...
	 */
	@Test 
	def void testSimpleBVSWithPositiveLimitJump2() {
		val result = parseHelper.parse('''
		; -----------------------------------------
			        ORG     $8000
		MyBanch		BVS		Jump		; 
	 ...
	 */
	@Test 
	def void testSimpleBVSWithNegativeLimitJump1() {
		val result = parseHelper.parse('''
		; -----------------------------------------
					ORG		$8002
		JUMP		RTS					
	 ...
	 */
	@Test 
	def void testSimpleBVSWithNegativeLimitJump2() {
		val result = parseHelper.parse('''
		; -----------------------------------------
					ORG		$8001
		JUMP		RTS					
