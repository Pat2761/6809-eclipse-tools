...
class TestBMIInstruction {
	 ...
	 */
	@Test 
	def void testSimpleBMIWithExtraSpace() {
		...
		Assert.assertTrue("Must be an BMI directive line", instructionLine.instruction instanceof BmiInstruction)
	}
	 ...
	 */
	@Test 
	def void testSimpleBMIWithoutExtraSpace() {
		val result = parseHelper.parse('''
		; -----------------------------------------
			        ORG     $8000
		Jump	    ASLA
	 ...
	 */
	@Test 
	def void testSimpleBMIWithWithLabel() {
		val result = parseHelper.parse('''
		; -----------------------------------------
			        ORG     $8000
		Jump	    ASLA
	 ...
	 */
	@Test 
	def void testSimpleBMIWithDuplicateLabel() {
		val result = parseHelper.parse('''
		; -----------------------------------------
			        ORG     $8000
		Jump	    LDA		#25
					NOP
		Jump		BMI		Jump		; Jump=3FFF
		''')
		Assert.assertNotNull(result)
	 ...
	 */
	@Test 
	def void testSimpleBMIWithBadLabel() {
		val result = parseHelper.parse('''
		; -----------------------------------------
			        ORG     $8000
		Jump1	    LDA		#25
					NOP
		Jump		BMI		Jump2		; Jump=3FFF
		''')
		Assert.assertNotNull(result)
	 ...
	 */
	@Test 
	def void testSimpleBMIWithNegativeJump() {
		val result = parseHelper.parse('''
		; -----------------------------------------
			        ORG     $8000
		Jump	    LDA		#25
		...
		val line = engine.getAssembledLine(4) as AssembledBMIInstruction
		Assert.assertEquals("Check opcode length", 1, line.opcode.length)
		Assert.assertEquals("Check opcode value", 0x2B, line.opcode.get(0))
	 ...
	 */
	@Test 
	def void testSimpleBMIWithPositiveJump() {
		val result = parseHelper.parse('''
		; -----------------------------------------
			        ORG     $8000
		MyBanch		BMI		Jump		; 
		...
		val line = engine.getAssembledLine(2) as AssembledBMIInstruction
		Assert.assertEquals("Check opcode length", 1, line.opcode.length)
		Assert.assertEquals("Check opcode value", 0x2B, line.opcode.get(0))
		Assert.assertEquals("Check operand length", 1, line.operand.length)
	 ...
	 */
	@Test 
	def void testSimpleBMIWithPositiveLimitJump1() {
		val result = parseHelper.parse('''
		; -----------------------------------------
			        ORG     $8000
		MyBanch		BMI		Jump		; 
	 ...
	 */
	@Test 
	def void testSimpleBMIWithPositiveLimitJump2() {
		val result = parseHelper.parse('''
		; -----------------------------------------
			        ORG     $8000
		MyBanch		BMI		Jump		; 
	 ...
	 */
	@Test 
	def void testSimpleBMIWithNegativeLimitJump1() {
		val result = parseHelper.parse('''
		; -----------------------------------------
					ORG		$8002
		JUMP		RTS					
	 ...
	 */
	@Test 
	def void testSimpleBMIWithNegativeLimitJump2() {
		val result = parseHelper.parse('''
		; -----------------------------------------
					ORG		$8001
		JUMP		RTS					
