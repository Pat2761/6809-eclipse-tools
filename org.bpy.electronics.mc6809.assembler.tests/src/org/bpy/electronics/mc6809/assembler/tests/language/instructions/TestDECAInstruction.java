...
public class TestDECAInstruction {
	...
	public void testSimpleDECAWithExtraSpace() {
		...
		try {
			...
			DecInstruction decInstruction = (DecInstruction)instructionLine.getInstruction();
	...
	public void testSimpleDECAWithExtraSpaceWithComment() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("	       ORG    	$8000\n");
		strBuilder.append("	       DECA  			; It is a comment \n");
	...
	public void testDECAAssembly() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("		   		ORG    			$8000\n");
		strBuilder.append("Start      	DECA				  		    ; 4A   DECA\n");
		...
		try {
			...
			AssembledDECAInstruction line = (AssembledDECAInstruction)engine.getAssembledLine(2);
