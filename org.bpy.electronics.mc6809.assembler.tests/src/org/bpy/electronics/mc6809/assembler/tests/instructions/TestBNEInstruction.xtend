...
class TestBNEInstruction {
	 ...
	 */
	@Test 
	def void testSimpleBNEWithExtraSpace() {
		...
		Assert.assertTrue("Must be an BNE directive line", instructionLine.instruction instanceof BneInstruction)
	}
	 ...
	 */
	@Test 
	def void testSimpleBNEWithoutExtraSpace() {
		val result = parseHelper.parse('''
		; -----------------------------------------
			        ORG     $8000
		Jump	    ASLA
	 ...
	 */
	@Test 
	def void testSimpleBNEWithWithLabel() {
		val result = parseHelper.parse('''
		; -----------------------------------------
			        ORG     $8000
		Jump	    ASLA
	 ...
	 */
	@Test 
	def void testSimpleBNEWithDuplicateLabel() {
		val result = parseHelper.parse('''
		; -----------------------------------------
			        ORG     $8000
		Jump	    LDA		#25
					NOP
		Jump		BNE		Jump		; Jump=3FFF
		''')
		Assert.assertNotNull(result)
	 ...
	 */
	@Test 
	def void testSimpleBNEWithBadLabel() {
		val result = parseHelper.parse('''
		; -----------------------------------------
			        ORG     $8000
		Jump1	    LDA		#25
					NOP
		Jump		BNE		Jump2		; Jump=3FFF
		''')
		Assert.assertNotNull(result)
	 ...
	 */
	@Test 
	def void testSimpleBNEWithNegativeJump() {
		val result = parseHelper.parse('''
		; -----------------------------------------
			        ORG     $8000
		Jump	    LDA		#25
		...
		val line = engine.getAssembledLine(4) as AssembledBNEInstruction
		Assert.assertEquals("Check opcode length", 1, line.opcode.length)
		Assert.assertEquals("Check opcode value", 0x26, line.opcode.get(0))
	 ...
	 */
	@Test 
	def void testSimpleBNEWithPositiveJump() {
		val result = parseHelper.parse('''
		; -----------------------------------------
			        ORG     $8000
		MyBanch		BNE		Jump		; 
		...
		val line = engine.getAssembledLine(2) as AssembledBNEInstruction
		Assert.assertEquals("Check opcode length", 1, line.opcode.length)
		Assert.assertEquals("Check opcode value", 0x26, line.opcode.get(0))
		Assert.assertEquals("Check operand length", 1, line.operand.length)
	 ...
	 */
	@Test 
	def void testSimpleBNEWithPositiveLimitJump1() {
		val result = parseHelper.parse('''
		; -----------------------------------------
			        ORG     $8000
		MyBanch		BNE		Jump		; 
	 ...
	 */
	@Test 
	def void testSimpleBNEWithPositiveLimitJump2() {
		val result = parseHelper.parse('''
		; -----------------------------------------
			        ORG     $8000
		MyBanch		BNE		Jump		; 
	 ...
	 */
	@Test 
	def void testSimpleBNEWithNegativeLimitJump1() {
		val result = parseHelper.parse('''
		; -----------------------------------------
					ORG		$8002
		JUMP		RTS					
	 ...
	 */
	@Test 
	def void testSimpleBNEWithNegativeLimitJump2() {
		val result = parseHelper.parse('''
		; -----------------------------------------
					ORG		$8001
		JUMP		RTS					
