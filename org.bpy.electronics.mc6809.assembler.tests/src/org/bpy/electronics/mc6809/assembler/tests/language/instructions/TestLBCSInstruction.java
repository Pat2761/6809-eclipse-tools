...
import org.bpy.electronics.mc6809.assembler.engine.data.instructions.AssembledLBCSInstruction;
...
public class TestLBCSInstruction {
	...
	public void testSimpleLBCSWithExtraSpace() {
		...
		try {
			...
			Assert.assertTrue("Must be an LBCS directive line", instructionLine.getInstruction() instanceof BcsInstruction);
		} catch (Exception e) {
	...
	/**
	 * Check LBCS with duplicate label
	 */
	@Test 
	public void testSimpleLBCSWithDuplicateLabel() {
		StringBuilder strBuilder = new StringBuilder();
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("	        ORG     $8000\n");
		strBuilder.append("Jump	    LDA		#25\n");
		strBuilder.append("			NOP\n");
		strBuilder.append("Jump		LBCS		Jump		; Jump=3FFF\n");
	...
	/**
	 * Check LBCS with bad label
	 */
	@Test 
	public void testSimpleLBCSWithBadLabel() {
		StringBuilder strBuilder = new StringBuilder();
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("	        ORG    	 	$8000\n");
		strBuilder.append("Jump1	LDA			#25\n");
		strBuilder.append("			NOP\n");
		strBuilder.append("Jump		LBCS		Jump2		; Jump=3FFF\n");
	 ...
	 */
	@Test 
	public void testSimpleLBCSWithWithLabel() {
		StringBuilder strBuilder = new StringBuilder();
		strBuilder.append("	        	ORG     	$8000\n");
		strBuilder.append("Jump	    	ASLA\n");
		strBuilder.append("				ASLB\n");
		strBuilder.append("MyBanch		LBCS		Jump\n");
	...
	/**
	 * Check LBCS negative jump
	 */
	@Test 
	public void testSimpleLBCSWithNegativeJump1() {
		StringBuilder strBuilder = new StringBuilder();
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("	        	ORG     $8004\n");
		strBuilder.append("Jump	    	LDA		#25\n");
		strBuilder.append("	        	ORG     $8080\n");
		strBuilder.append("MyBanch		LBCS	Jump		; Jump=1025FF80\n");
		...
		try {
			...
			AssembledLBCSInstruction line = (AssembledLBCSInstruction)engine.getAssembledLine(4);
	 ...
	 */
	@Test 
	public void testSimpleLBCSWithNegativeJump2() {
		StringBuilder strBuilder = new StringBuilder();
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("	        	ORG     $8003\n");
		strBuilder.append("Jump	    	LDA		#25\n");
		strBuilder.append("	       	 	ORG     $8080\n");
		strBuilder.append("MyBanch		LBCS	Jump		; Jump=1025FF7F\n");
	...
	/**
	 * Check LBCS positive jump
	 */
	@Test 
	public void testSimpleLBCSWithPositiveJump1() {
		StringBuilder strBuilder = new StringBuilder();
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("	        	ORG     	$8000\n");
		strBuilder.append("MyBanch		LBCS		Jump		; Jump=1025007F\n");
		...
		try {
			...
			AssembledLBCSInstruction line = (AssembledLBCSInstruction)engine.getAssembledLine(2);
			Assert.assertEquals("Check opcode length", 2, line.getOpcode().length);
			Assert.assertEquals("Check opcode value", 0x10, line.getOpcode()[0]);
			Assert.assertEquals("Check opcode value", 0x25, line.getOpcode()[1]);
			Assert.assertEquals("Check operand length", 2, line.getOperand().length);
	 ...
	 */
	@Test 
	public void testSimpleLBCSWithPositiveJump2() {
		StringBuilder strBuilder = new StringBuilder();
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("	        	ORG     	$8000\n");
		strBuilder.append("MyBanch		LBCS		Jump		; Jump=10250080\n");
	...
	/**
	 * Check LBCS positive limit jump
	 */
	@Test 
	public void testSimpleLBCSWithPositiveLimitJump1() {
		StringBuilder strBuilder = new StringBuilder();
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("	        	ORG     	$0000\n");
		strBuilder.append("MyBranch		LBCS		Jump		; Jump=10257FFF\n");
		strBuilder.append("				ORG     	$8003\n");
		strBuilder.append("Jump			RTS			\n");
	 ...
	 */
	@Test 
	public void testSimpleLBCSWithPositiveLimitJump2() {
		StringBuilder strBuilder = new StringBuilder();
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("	        	ORG     	$0000\n");
		strBuilder.append("MyBanch		LBCS		Jump		; Jump=10258000\n");
		strBuilder.append("				ORG     	$8004\n");
		strBuilder.append("Jump			RTS			\n");
	...
	/**
	 * Check LBCS negative limit jump
	 */
	@Test 
	public void testSimpleLBCSWithNegativeLimitJump1() {
		StringBuilder strBuilder = new StringBuilder();
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("				ORG			$0004\n");
		strBuilder.append("JUMP			RTS					\n");
		strBuilder.append("				ORG			$8000		;\n");
		strBuilder.append("VVV			LBCS		JUMP		;		\n");
	 ...
	 */
	@Test 
	public void testSimpleLBCSWithNegativeLimitJump2() {
		StringBuilder strBuilder = new StringBuilder();
		strBuilder.append("; -----------------------------------------\n");
