...
public class TestSWI2Instruction {
	 ...
	 */
	@Test 
	public void testSimpleSWI2WithExtraSpace() {
		StringBuilder strBuilder = new StringBuilder();
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("	       ORG    		$8000\n");
		strBuilder.append("	       SWI2  \n");
		...
		try {
			...
			Assert.assertTrue("Must be an SWI2 Accumulator line", instructionLine.getInstruction() instanceof Swi2Instruction);
			Swi2Instruction swi2Instruction = (Swi2Instruction)instructionLine.getInstruction();
	 ...
	 */
	@Test 
	public void testSimpleSWI2WithoutExtraSpace() {
		StringBuilder strBuilder = new StringBuilder();
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("	       ORG    $8000\n");
		strBuilder.append("	       SWI2\n");
	 ...
	 */
	@Test 
	public void testSimpleSWI2WithExtraSpaceWithComment() {
		StringBuilder strBuilder = new StringBuilder();
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("	       ORG    	$8000\n");
		strBuilder.append("	       SWI2  			; It is a comment \n");
	 ...
	 */
	@Test 
	public void testSimpleSWI2WithoutExtraSpaceWithComment() {
		StringBuilder strBuilder = new StringBuilder();
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("	       ORG    $8000\n");
		strBuilder.append("	       SWI2					; It is a comment\n");
	...
	public void testSWI2Assembly() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("		   		ORG    			$8000\n");
		strBuilder.append("Start      	SWI2		  		    ; 103F   SWI2\n");
		...
		try {
			...
			AssembledSWI2Instruction line = (AssembledSWI2Instruction)engine.getAssembledLine(2);
			...
			Assert.assertEquals("Check comment", "; 103F   SWI2" , line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception",true);
		} 
	}
