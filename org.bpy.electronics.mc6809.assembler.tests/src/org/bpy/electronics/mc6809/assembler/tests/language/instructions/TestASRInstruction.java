...
public class TestASRInstruction {
	 ...
	 */
	@Test
	public void testASRImemdiatAddressingMode() {
		StringBuilder strBuilder = new StringBuilder();
		strBuilder.append("			ORG    		$8000\n");
		strBuilder.append("			ASR		#124\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());

			Assert.assertNotNull(result);
			Assert.assertTrue("No errors found", result.eResource().getErrors().isEmpty());
			validationHelper.assertError(result, AssemblerPackage.eINSTANCE.getAsrInstruction(),
	...
	public void testASRDirectAddressingMode() {
		...
		try {
			...
			Assert.assertTrue("Must be an ADD directive line", instructionLine.getInstruction() instanceof AsrInstruction);

			AsrInstruction adcInstruction = (AsrInstruction) instructionLine.getInstruction();
			assertEquals("Must be an ASR instruction", adcInstruction.getInstruction(), "ASR");
	...
	public void testASRConstantOffsetIndexed() {
		...
		strBuilder.append("	      ASR		  	Const,X\n");
		strBuilder.append("			ASR		  	,X\n");
		strBuilder.append("			ASR		  	$9,U\n");
		strBuilder.append("			ASR		  	$9,S\n");
		strBuilder.append("			ASR		  	$9,X\n");
		strBuilder.append("			ASR		  	$9,Y\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testASRAccumulatorIndexed() {
		...
		strBuilder.append("	      ORG  			$8000\n");
		strBuilder.append("Const	EQU        	5    \n");
		strBuilder.append("	      ASR		  	A,X\n");
		strBuilder.append("			ASR		  	B,X\n");
		strBuilder.append("			ASR		  	D,U\n");
		strBuilder.append("			ASR		  	A,S\n");
		strBuilder.append("			ASR		  	B,X\n");
		strBuilder.append("			ASR		  	D,Y\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testASRAutoIncrementIndexed() {
		...
		strBuilder.append("	       	ASR		  	,X+\n");
		strBuilder.append("	       	ASR		  	,X++\n");
		strBuilder.append("	       	ASR		  	,--S\n");
		strBuilder.append("	       	ASR		  	,-S\n");
		strBuilder.append("	       	ASR		  	,U+\n");
		strBuilder.append("	       	ASR		  	,U++\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testASRRelativePCIndexed() {
		...
		strBuilder.append("	       	ASR		  	Const,PC\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testASRWithDuplicateLabel() {
		...
		strBuilder.append("Start      	ASR		  	#Const+2\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testASRDirectInstruction1() {
		...
		strBuilder.append("		   		ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	ASR		  		<Const*2  ; 8000   07 0A        START:    ASR   <Const*2 \n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			AssembledASRInstruction line = (AssembledASRInstruction) engine.getAssembledLine(3);
			Assert.assertEquals("Check getOpcode() size ", 1, line.getOpcode().length);
			Assert.assertEquals("Check getOpcode()", 0x07, line.getOpcode()[0]);
	...
	public void testASRDirectInstruction2() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("		   		ORG    			$8000\n");
		strBuilder.append("Start      	ASR		  	<-129\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());

			Assert.assertNotNull(result);

			validationHelper.assertError(result, AssemblerPackage.eINSTANCE.getAsrInstruction(), InstructionValidator.OVERFLOW_ERROR,
	...
	public void testASRDirectInstruction3() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("		   		ORG    			$8000\n");
		strBuilder.append("Start      	ASR		  	<-128\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testASRDirectInstruction4() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("		   		ORG    			$8000\n");
		strBuilder.append("Start      	ASR		  	<127\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testASRExtendedInstruction1() {
		...
		strBuilder.append("		   		ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	ASR		  	>Const*1000  ; 8000   77 13 88     START:    ASR   >Const*1000 \n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			AssembledASRInstruction line = (AssembledASRInstruction) engine.getAssembledLine(3);
			Assert.assertEquals("Check getOpcode() size ", 1, line.getOpcode().length);
			Assert.assertEquals("Check getOpcode()", 0x77, line.getOpcode()[0]);
	...
	public void testASRExtendedInstruction2() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("		   		ORG    			$8000\n");
		strBuilder.append("Start      	ASR		  	>-32769\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testASRExtendedInstruction3() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("		   		ORG    			$8000\n");
		strBuilder.append("Start      	ASR		  	>-32768\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testASRExtendedInstruction4() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("		   		ORG    			$8000\n");
		strBuilder.append("Start      	ASR		  	>65535\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testASRExtendedInstruction5() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("		   		ORG    			$8000\n");
		strBuilder.append("Start      	ASR		  	>65536\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testASRExtendedIndirectInstruction1() {
		...
		strBuilder.append("		   		ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	ASR		  	[Const*1000]  ; 8000   67 9F 13 88  START:    ASR   [Const*1000]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check getOpcode()", 0x67, line.getOpcode()[0]);
			Assert.assertEquals("Check getOpcode()", 0x9F, line.getOpcode()[1]);
			Assert.assertEquals("Check operand size ", 2, line.getOperand().length);
			Assert.assertEquals("Check operand", 0x13, line.getOperand()[0]);
			Assert.assertEquals("Check operand", 0x88, line.getOperand()[1]);
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   67 9F 13 88  START:    ASR   [Const*1000]", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", true);
		}
	}
	...
	public void testASRIndexedAccumulatorMovingMode1() {
		...
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	ASR		  	A,X  ; 8000   67 86        START:    ASR   A,X\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   67 86        START:    ASR   A,X", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", true);
		}
	}
	...
	public void testASRIndexedAccumulatorMovingMode2() {
		...
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	ASR		  	A,Y  ; 8000   	68 A6        START:    ASR   A,Y\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 A6        START:    ASR   A,Y", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", true);
		}
	}
	...
	public void testASRIndexedAccumulatorMovingMode3() {
		...
		strBuilder.append("		   	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	ASR		  	A,U  ; 8000   	68 C6        START:    ASR   A,U\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 C6        START:    ASR   A,U", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", true);
		}
	}
	...
	public void testASRIndexedAccumulatorMovingMode4() {
		...
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	ASR		  	A,S  ; 8000   	68 E6        START:    ASR   A,S\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 E6        START:    ASR   A,S", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", true);
		}
	}
	...
	public void testASRIndexedAccumulatorMovingMode5() {
		...
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	ASR		  	B,X  ; 8000   67 85        START:    ASR   B,X\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   67 85        START:    ASR   B,X", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", true);
		}
	}
	...
	public void testASRIndexedAccumulatorMovingMode6() {
		...
		strBuilder.append("		   		ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	ASR		  	B,Y  ; 8000   	68 A5        START:    ASR   B,Y\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 A5        START:    ASR   B,Y", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", true);
		}
	}
	...
	public void testASRIndexedAccumulatorMovingMode7() {
		...
		strBuilder.append("		   		ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	ASR		  	B,U  ; 8000   	68 C5        START:    ASR   B,U\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 C5        START:    ASR   B,U", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", true);
		}
	}
	...
	public void testASRIndexedAccumulatorMovingMode8() {
		...
		strBuilder.append("		   		ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	ASR		  	B,S  ; 8000   	68 E5        START:    ASR   B,S\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 E5        START:    ASR   B,S", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", true);
		}
	}
	...
	public void testASRIndexedAccumulatorMovingMode9() {
		...
		strBuilder.append("		   		ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	ASR		  	D,X  ; 8000   67 8B        START:    ASR   D,X\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   67 8B        START:    ASR   D,X", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", true);
		}
	}
	...
	public void testASRIndexedAccumulatorMovingMode10() {
		...
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	ASR		  	D,Y  ; 8000   	68 AB        START:    ASR   D,Y\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 AB        START:    ASR   D,Y", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", true);
		}
	}
	...
	public void testASRIndexedAccumulatorMovingMode11() {
		...
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	ASR		  	D,U  ; 8000   	68 CB        START:    ASR   D,U\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 CB        START:    ASR   D,U", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", true);
		}
	}
	...
	public void testASRIndexedAccumulatorMovingMode12() {
		...
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	ASR		  	D,S  ; 8000   	68 EB        START:    ASR   D,S\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 EB        START:    ASR   D,S", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", true);
		}
	}
	...
	public void testASRIndexedIndorectAccumulatorMovingMode1() {
		...
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	ASR		  	[A,X]  ; 8000   67 96        START:    ASR   [A,X]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   67 96        START:    ASR   [A,X]", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", true);
		}
	}
	...
	public void testASRIndexedIndirectAccumulatorMovingMode2() {
		...
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	ASR		  	[A,Y]  ; 8000   	68 B6        START:    ASR   [A,Y]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 B6        START:    ASR   [A,Y]", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", true);
		}
	}
	...
	public void testASRIndexedIndirectAccumulatorMovingMode3() {
		...
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	ASR		  	[A,U]  ; 8000   	68 D6        START:    ASR   [A,U]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 D6        START:    ASR   [A,U]", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", true);
		}
	}
	...
	public void testASRIndexedIndirectAccumulatorMovingMode4() {
		...
		strBuilder.append("		   		ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	ASR		  	[A,S]  ; 8000   	68 F6        START:    ASR   [A,S]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 F6        START:    ASR   [A,S]", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", true);
		}
	}
	...
	public void testASRIndexedIndirectAccumulatorMovingMode5() {
		...
		strBuilder.append("		   		ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	ASR		  	[B,X]  ; 8000   67 95        START:    ASR   [B,X]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   67 95        START:    ASR   [B,X]", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", true);
		}
	}
	...
	public void testASRIndexedIndirectAccumulatorMovingMode6() {
		...
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	ASR		  	[B,Y]  ; 8000   	68 B5        START:    ASR   [B,Y]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 B5        START:    ASR   [B,Y]", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", true);
		}
	}
	...
	public void testASRIndexedIndirectAccumulatorMovingMode7() {
		...
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	ASR		  	[B,U]  ; 8000   	68 D5        START:    ASR   [B,U]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 D5        START:    ASR   [B,U]", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", true);
		}
	}
	...
	public void testASRIndexedIndirectAccumulatorMovingMode8() {
		...
		strBuilder.append("		   		ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	ASR		  	[B,S]  ; 8000   	68 F5        START:    ASR   [B,S]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 F5        START:    ASR   [B,S]", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", true);
		}
	}
	...
	public void testASRIndexedIndirectAccumulatorMovingMode9() {
		...
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	ASR		  	[D,X]  ; 8000   67 9B        START:    ASR   [D,X]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   67 9B        START:    ASR   [D,X]", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", true);
		}
	}
	...
	public void testASRIndexedIndirectAccumulatorMovingMode10() {
		...
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	ASR		  	[D,Y]  ; 8000   	68 BB        START:    ASR   [D,Y]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 BB        START:    ASR   [D,Y]", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", true);
		}
	}
	...
	public void testASRIndexedIndirectAccumulatorMovingMode11() {
		...
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	ASR		  	[D,U]  ; 8000   	68 DB        START:    ASR   [D,U]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 DB        START:    ASR   [D,U]", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", true);
		}
	}
	...
	public void testASRIndexedIndirectAccumulatorMovingMode12() {
		...
		strBuilder.append("		  	 	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	ASR		  	[D,S]  ; 8000   	68 FB        START:    ASR   [D,S]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 FB        START:    ASR   [D,S]", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", true);
		}
	}
	...
	public void testASRIndexedAutoIncrementDecrementMode1() {
		...
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	ASR		  	,X+  ; 8000   	68 80        START:    ASR   ,X+\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check operand", 0x80, line.getOperand()[0]);
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 80        START:    ASR   ,X+", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", true);
		}
	}
	...
	public void testASRIndexedAutoIncrementDecrementMode2() {
		...
		strBuilder.append("		   		ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	ASR		  	,X++  ; 8000   	68 81        START:    ASR   ,X++\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 81        START:    ASR   ,X++", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", true);
		}
	}
	...
	public void testASRIndexedAutoIncrementDecrementMode3() {
		...
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	ASR		  	,Y+  ; 8000   	68 A0        START:    ASR   ,Y+\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 A0        START:    ASR   ,Y+", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", true);
		}
	}
	...
	public void testASRIndexedAutoIncrementDecrementMode4() {
		...
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	ASR		  	,Y++  ; 8000   	68 A1        START:    ASR   ,Y++\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 A1        START:    ASR   ,Y++", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", true);
		}
	}
	...
	public void testASRIndexedAutoIncrementDecrementMode5() {
		...
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	ASR		  	,S+  ; 8000   	68 E0        START:    ASR   ,S+\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 E0        START:    ASR   ,S+", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", true);
		}
	}
	...
	public void testASRIndexedAutoIncrementDecrementMode6() {
		...
		strBuilder.append("		  	 	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	ASR		  	,S++  ; 8000   	68 E1        START:    ASR   ,S++\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 E1        START:    ASR   ,S++", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", true);
		}
	}
	...
	public void testASRIndexedAutoIncrementDecrementMode7() {
		...
		strBuilder.append("		  	 	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	ASR		  	,U+  ; 8000   	68 C0        START:    ASR   ,U+\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 C0        START:    ASR   ,U+", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", true);
		}
	}
	...
	public void testASRIndexedAutoIncrementDecrementMode8() {
		...
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	ASR		  	,U++  ; 8000   	68 C1        START:    ASR   ,U++\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 C1        START:    ASR   ,U++", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", true);
		}
	}
	...
	public void testASRIndexedAutoIncrementDecrementMode9() {
		...
		strBuilder.append("		 	  	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	ASR		  	,-X  ; 8000   	68 82        START:    ASR   ,-X\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 82        START:    ASR   ,-X", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", true);
		}
	}
	...
	public void testASRIndexedAutoIncrementDecrementMode10() {
		...
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	ASR		  	,--X  ; 8000   	68 83        START:    ASR   ,--X\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 83        START:    ASR   ,--X", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", true);
		}
	}
	...
	public void testASRIndexedAutoIncrementDecrementMode11() {
		...
		strBuilder.append("		 	  	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	ASR		  	,-Y  ; 8000   	68 A2        START:    ASR   ,-Y\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 A2        START:    ASR   ,-Y", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", true);
		}
	}
	...
	public void testASRIndexedAutoIncrementDecrementMode12() {
		...
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	ASR		  	,--Y  ; 8000   	68 A3        START:    ASR   ,--Y\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 A3        START:    ASR   ,--Y", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", true);
		}
	}
	...
	public void testASRIndexedAutoIncrementDecrementMode13() {
		...
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	ASR		  	,-S  ; 8000   	68 E2        START:    ASR   ,-S\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 E2        START:    ASR   ,-S", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", true);
		}
	}
	...
	public void testASRIndexedAutoIncrementDecrementMode14() {
		...
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	ASR		  	,--S  ; 8000   	68 E3        START:    ASR   ,--S\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 E3        START:    ASR   ,--S", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", true);
		}
	}
	...
	public void testASRIndexedAutoIncrementDecrementMode15() {
		...
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	ASR		  	,-U  ; 8000   	68 C2        START:    ASR   ,-U\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 C2        START:    ASR   ,-U", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", true);
		}
	}
	...
	public void testASRIndexedAutoIncrementDecrementMode16() {
		...
		strBuilder.append("		   		ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	ASR		  	,--U  ; 8000   	68 C3        START:    ASR   ,--U\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 C3        START:    ASR   ,--U", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", true);
		}
	}
	...
	/**
	 * Check Assembled ASR Indexed Auto Increment Decrement Indirect Mode
	 * instruction
	 */
	@Test
	...
	/**
	 * Check Assembled ASR Indexed Auto Increment Decrement Mode indorect
	 * instruction
	 */
	@Test
	public void testASRIndexedAutoIncrementDecrementIndirectMode2() {
		...
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	ASR		  	[,X++]  ; 8000   	68 91        START:    ASR   [,X++]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 91        START:    ASR   [,X++]", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", true);
		}
	}
	...
	/**
	 * Check Assembled ASR Indexed Auto Increment Decrement Mode indirect
	 * instruction
	 */
	@Test
	...
	public void testASRIndexedAutoIncrementDecrementIndirectMode4() {
		...
		strBuilder.append("		   		ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	ASR		  	[,Y++]  ; 8000   	68 B1        START:    ASR   [,Y++]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 B1        START:    ASR   [,Y++]", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", true);
		}
	}
	...
	public void testASRIndexedAutoIncrementDecrementIndirectMode6() {
		...
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	ASR		  	[,S++]  ; 8000   	68 F1        START:    ASR   [,S++]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 F1        START:    ASR   [,S++]", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", true);
		}
	}
	...
	public void testASRIndexedAutoIncrementDecrementindirectMode8() {
		...
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	ASR		  	[,U++]  ; 8000   	68 D1        START:    ASR   [,U++]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 D1        START:    ASR   [,U++]", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", true);
		}
	}
	...
	public void testASRIndexedAutoIncrementDecrementIndirectMode10() {
		...
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	ASR		  	[,--X]  ; 8000   	68 93        START:    ASR   [,--X]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 93        START:    ASR   [,--X]", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", true);
		}
	}
	...
	public void testASRIndexedAutoIncrementDecrementIndirectMode12() {
		...
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	ASR		  	[,--Y]  ; 8000   	68 B3        START:    ASR   [,--Y]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 B3        START:    ASR   [,--Y]", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", true);
		}
	}
	...
	public void testASRIndexedAutoIncrementDecrementIndirectMode14() {
		...
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	ASR		  	[,--S]  ; 8000   	68 F3        START:    ASR   [,--S]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 F3        START:    ASR   [,--S]", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", true);
		}
	}
	...
	public void testASRIndexedAutoIncrementDecrementIndirectMode16() {
		...
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	ASR		  	[,--U]  ; 8000   	68 D3        START:    ASR   [,--U]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 D3        START:    ASR   [,--U]", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", true);
		}
	}
	...
	public void testASRIndexedConstantMove1() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("		 	  	ORG    			$8000\n");
		strBuilder.append("Start      	ASR		  	1234,X  ; 8000   	68 89 04 D2            ASR   1234,X\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 89 04 D2            ASR   1234,X", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", true);
		}
	}
	...
	public void testASRIndexedConstantMove2() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	ASR		  	1234,Y  ; 8000   	67 A9 04 D2            ASR   1234,Y\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testASRIndexedConstantMove3() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	ASR		  	1234,U  ; 8000   	68 C9 04 D2            ASR   1234,U\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check operand", 0xD2, line.getOperand()[2]);
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 C9 04 D2            ASR   1234,U", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", true);
		}
	}
	...
	public void testASRIndexedConstantMove4() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	ASR		  	1234,S  ; 8000   	68 E9 04 D2            ASR   1234,S\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check operand", 0xD2, line.getOperand()[2]);
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 E9 04 D2            ASR   1234,S", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", true);
		}
	}
	...
	public void testASRIndexedConstantMove5() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	ASR		  	34,X  ; 8000   	68 88 22            ASR   34,X\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 88 22            ASR   34,X", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", true);
		}
	}
	...
	public void testASRIndexedConstantMove6() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	ASR		  	34,Y  ; 8000   	68 A8 22            ASR   34,Y\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check operand", 0x22, line.getOperand()[1]);
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 A8 22            ASR   34,Y", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", true);
		}
	}
	...
	public void testASRIndexedConstantMove7() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("		  	 	ORG    			$8000\n");
		strBuilder.append("Start      	ASR		  	34,U  ; 8000   	68 C8 22            ASR   34,U\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check operand", 0x22, line.getOperand()[1]);
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 C8 22            ASR   34,U", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", true);
		}
	}
	...
	public void testASRIndexedConstantMove8() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	ASR		  	34,S  ; 8000   	68 E8 22            ASR   34,S\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check operand", 0x22, line.getOperand()[1]);
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 E8 22            ASR   34,S", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", true);
		}
	}
	...
	public void testASRIndexedConstantMove9() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	ASR		  	,X  ; 8000   	68 84            ASR   ,X\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 84            ASR   ,X", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", true);
		}
	}
	...
	public void testASRIndexedConstantMove10() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	ASR		  	,Y  ; 8000   	68 A4            ASR   ,Y\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 A4            ASR   ,Y", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", true);
		}
	}
	...
	public void testASRIndexedConstantMove11() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	ASR		  	,U  ; 8000   	68 C4            ASR   ,U\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 C4            ASR   ,U", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", true);
		}
	}
	...
	public void testASRIndexedConstantMove12() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("		 	  	ORG    			$8000\n");
		strBuilder.append("Start      	ASR		  	,S  ; 8000   	68 E4            ASR   ,S\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 E4            ASR   ,S", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", true);
		}
	}
	...
	public void testASRIndexedConstantMove13() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	ASR		  	0,X  ; 8000   	68 84            ASR   0,X\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check operand", 0x84, line.getOperand()[0]);
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 84            ASR   0,X", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", true);
		}
	}
	...
	public void testASRIndexedConstantMove14() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	ASR		  	0,Y  ; 8000   	68 A4            ASR   0,Y\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check operand", 0xA4, line.getOperand()[0]);
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 A4            ASR   0,Y", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", true);
		}
	}
	...
	public void testASRIndexedConstantMove15() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	ASR		  	0,U  ; 8000   	68 C4            ASR   0,U\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check operand", 0xC4, line.getOperand()[0]);
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 C4            ASR   0,U", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", true);
		}
	}
	...
	public void testASRIndexedConstantMove16() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	ASR		  	0,S  ; 8000   	68 E4            ASR   0,S\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check operand", 0xE4, line.getOperand()[0]);
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 E4            ASR   0,S", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", true);
		}
	}
	...
	public void testASRIndexedConstantMove17() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	ASR		  	-16,X  ; 8000   	68 10            ASR   -16,X\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 10            ASR   -16,X", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", true);
		}
	}
	...
	public void testASRIndexedConstantMove19() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	ASR		  	1,X  ; 8000   	68 01            ASR   1,X\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 01            ASR   1,X", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", true);
		}
	}
	...
	public void testASRIndexedConstantMove20() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("		 	  	ORG    			$8000\n");
		strBuilder.append("Start      	ASR		  	15,X  ; 8000   	68 0F            ASR   15,X\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 0F            ASR   15,X", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", true);
		}
	}
	...
	public void testASRIndexedConstantMove21() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	ASR		  	-16,Y  ; 8000   	68 30            ASR   -16,Y\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 30            ASR   -16,Y", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", true);
		}
	}
	...
	public void testASRIndexedConstantMove23() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	ASR		  	1,Y  ; 8000   	68 21            ASR   1,Y\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 21            ASR   1,Y", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", true);
		}
	}
	...
	public void testASRIndexedConstantMove24() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	ASR		  	15,Y  ; 8000   	68 2F            ASR   15,Y\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 2F            ASR   15,Y", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", true);
		}
	}
	...
	public void testASRIndexedConstantMove25() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	ASR		  	-16,U  ; 8000   	68 50            ASR   -16,U\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 50            ASR   -16,U", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", true);
		}
	}
	...
	public void testASRIndexedConstantMove26() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	ASR		  	1,U  ; 8000   	68 41            ASR   1,U\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 41            ASR   1,U", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", true);
		}
	}
	...
	public void testASRIndexedConstantMove27() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	ASR		  	15,U  ; 8000   	68 4F            ASR   15,U\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 4F            ASR   15,U", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", true);
		}
	}
	...
	public void testASRIndexedConstantMove28() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	ASR		  	-16,S  ; 8000   	68 70            ASR   -16,S\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 70            ASR   -16,S", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", true);
		}
	}
	...
	public void testASRIndexedConstantMove29() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	ASR		  	1,S  ; 8000   	68 61            ASR   1,S\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 61            ASR   1,S", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", true);
		}
	}
	...
	public void testASRIndexedConstantMove30() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	ASR		  	15,S  ; 8000   	68 6F            ASR   15,S\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 6F            ASR   15,S", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", true);
		}
	}
	...
	public void testASRIndexedConstantMove31() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	ASR		  	-128,X  ; 8000   	68 88 80            ASR   -128,X\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 88 80            ASR   -128,X", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", true);
		}
	}
	...
	public void testASRIndexedConstantMove32() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("		 	  	ORG    			$8000\n");
		strBuilder.append("Start      	ASR		  	127,X  ; 8000   	68 88 7F            ASR   127,X\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 88 7F            ASR   127,X", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", true);
		}
	}
	...
	public void testASRIndexedConstantMove33() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	ASR		  	-128,Y  ; 8000   	68 A8 80            ASR   -128,Y\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check operand", 0x80, line.getOperand()[1]);
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 A8 80            ASR   -128,Y", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", true);
		}
	}
	...
	public void testASRIndexedConstantMove34() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("		 	  	ORG    			$8000\n");
		strBuilder.append("Start      	ASR		  	127,Y  ; 8000   	68 A8 7F            ASR   127,Y\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check operand", 0x7F, line.getOperand()[1]);
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 A8 7F            ASR   127,Y", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", true);
		}
	}
	...
	public void testASRIndexedConstantMove35() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	ASR		  	-128,U  ; 8000   	68 C8 80            ASR   -128,U\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check operand", 0x80, line.getOperand()[1]);
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 C8 80            ASR   -128,U", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", true);
		}
	}
	...
	public void testASRIndexedConstantMove36() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("		  	 	ORG    			$8000\n");
		strBuilder.append("Start      	ASR		  	127,U  ; 8000   	68 C8 7F            ASR   127,U\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check operand", 0x7F, line.getOperand()[1]);
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 C8 7F            ASR   127,U", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", true);
		}
	}
	...
	public void testASRIndexedConstantMove37() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	ASR		  	-128,S  ; 8000   	68 E8 80            ASR   -128,S\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check operand", 0x80, line.getOperand()[1]);
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 E8 80            ASR   -128,S", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", true);
		}
	}
	...
	public void testASRIndexedConstantMove38() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	ASR		  	127,S  ; 8000   	68 E8 7F            ASR   127,S\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check operand", 0x7F, line.getOperand()[1]);
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 E8 7F            ASR   127,S", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", true);
		}
	}
	...
	public void testASRIndexedConstantMove39() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	ASR		  	-32768,X  ; 8000   	68 89 80 00             ASR   -32768,X\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 89 80 00             ASR   -32768,X", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", true);
		}
	}
	...
	public void testASRIndexedConstantMove40() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	ASR		  32767,X  ; 8000   	68 89 7F FF             ASR   32767,X\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 89 7F FF             ASR   32767,X", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", true);
		}
	}
	...
	public void testASRIndexedConstantMove41() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	ASR		  	-32768,Y  ; 8000   	67 A9 80 00             ASR   -32768,Y\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testASRIndexedConstantMove42() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	ASR		  32767,Y  ; 8000   	67 A9 7F FF             ASR   32767,Y\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testASRIndexedConstantMove43() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	ASR		  	-32768,U  ; 8000   	68 C9 80 00             ASR   -32768,U\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check operand", 0x00, line.getOperand()[2]);
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 C9 80 00             ASR   -32768,U", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", true);
		}
	}
	...
	public void testASRIndexedConstantMove44() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	ASR		  32767,U  ; 8000   	68 C9 7F FF             ASR   32767,U\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check operand", 0xFF, line.getOperand()[2]);
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 C9 7F FF             ASR   32767,U", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", true);
		}
	}
	...
	public void testASRIndexedConstantMove45() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("		 	  	ORG    			$8000\n");
		strBuilder.append("Start      	ASR		  	-32768,S  ; 8000   	68 E9 80 00             ASR   -32768,S\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check operand", 0x00, line.getOperand()[2]);
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 E9 80 00             ASR   -32768,S", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", true);
		}
	}
	...
	public void testASRIndexedConstantMove46() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	ASR		  32767,S  ; 8000   	68 E9 7F FF             ASR   32767,S\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check operand", 0xFF, line.getOperand()[2]);
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 E9 7F FF             ASR   32767,S", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", true);
		}
	}
	...
	public void testASRIndexedConstantMove47() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	ASR		  	-32769,X  ; 8000   	68 89 80 00             ASR   -32769,X\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check operand", 0x00, line.getOperand()[2]);
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 89 80 00             ASR   -32769,X", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", true);
		}
	}
	...
	public void testASRIndexedConstantMove48() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	ASR		  32768,X  ; 8000   	68 89 7F FF             ASR   32768,X\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check operand", 0xFF, line.getOperand()[2]);
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 89 7F FF             ASR   32768,X", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", true);
		}
	}
	...
	public void testASRIndexedConstantMove49() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("		   		ORG    			$8000\n");
		strBuilder.append("Start      	ASR		  	-32769,Y  ; 8000   	67 A9 80 00             ASR   -32769,Y\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testASRIndexedConstantMove50() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("		  	 	ORG    			$8000\n");
		strBuilder.append("Start      	ASR		  32768,Y  ; 8000   	67 A9 7F FF             ASR   32768,Y\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testASRIndexedConstantMove51() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("		 	  	ORG    			$8000\n");
		strBuilder.append("Start      	ASR		  	-32769,U  ; 8000   	68 C9 80 00             ASR   -32769,U\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check operand", 0x00, line.getOperand()[2]);
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 C9 80 00             ASR   -32769,U", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", true);
		}
	}
	...
	public void testASRIndexedConstantMove52() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	ASR		  32768,U  ; 8000   	68 C9 7F FF             ASR   32768,U\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check operand", 0xFF, line.getOperand()[2]);
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 C9 7F FF             ASR   32768,U", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", true);
		}
	}
	...
	public void testASRIndexedConstantMove53() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	ASR		  	-32769,S  ; 8000   	68 E9 80 00             ASR   -32769,S\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check operand", 0x00, line.getOperand()[2]);
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 E9 80 00             ASR   -32769,S", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", true);
		}
	}
	...
	public void testASRIndexedConstantMove54() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	ASR		  32768,S  ; 8000   	68 E9 7F FF             ASR   32768,S\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check operand", 0xFF, line.getOperand()[2]);
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 E9 7F FF             ASR   32768,S", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", true);
		}
	}
	...
	public void testASRIndexedConstantIndirectMove1() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	ASR		  	[1234,X]  ; 8000   	68 99 04 D2            ASR   [1234,X]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check operand", 0xD2, line.getOperand()[2]);
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 99 04 D2            ASR   [1234,X]", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", true);
		}
	}
	...
	public void testASRIndexedConstantIndirectMove2() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	ASR		  	[1234,Y]  ; 8000   	68 B9 04 D2            ASR   [1234,Y]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check operand", 0xD2, line.getOperand()[2]);
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 B9 04 D2            ASR   [1234,Y]", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", true);
		}
	}
	...
	public void testASRIndexedConstantIndirectMove3() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("		 	  	ORG    			$8000\n");
		strBuilder.append("Start      	ASR		  	[1234,U]  ; 8000   	68 D9 04 D2            ASR   [1234,U]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check operand", 0xD2, line.getOperand()[2]);
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 D9 04 D2            ASR   [1234,U]", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", true);
		}
	}
	...
	public void testASRIndexedConstantIndirectMove4() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	ASR		  	[1234,S]  ; 8000   	68 F9 04 D2            ASR   [1234,S]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check operand", 0xD2, line.getOperand()[2]);
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 F9 04 D2            ASR   [1234,S]", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", true);
		}
	}
	...
	public void testASRIndexedConstantIndirectMove5() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	ASR		  	[34,X]  ; 8000   	68 98 22            ASR   [34,X]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check operand", 0x22, line.getOperand()[1]);
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 98 22            ASR   [34,X]", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", true);
		}
	}
	...
	public void testASRIndexedConstantIndirectMove6() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	ASR		  	[34,Y]  ; 8000   	68 B8 22            ASR   [34,Y]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check operand", 0x22, line.getOperand()[1]);
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 B8 22            ASR   [34,Y]", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", true);
		}
	}
	...
	public void testASRIndexedConstantIndirectMove7() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	ASR		  	[34,U]  ; 8000   	68 D8 22            ASR   [34,U]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check operand", 0x22, line.getOperand()[1]);
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 D8 22            ASR   [34,U]", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", true);
		}
	}
	...
	public void testASRIndexedConstantIndirectMove8() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	ASR		  	[34,S]  ; 8000   	68 F8 22            ASR   [34,S]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check operand", 0x22, line.getOperand()[1]);
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 F8 22            ASR   [34,S]", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", true);
		}
	}
	...
	public void testASRIndexedConstantIndirectMove9() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	ASR		  	[,X]  ; 8000   	68 94            ASR   [,X]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 94            ASR   [,X]", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", true);
		}
	}
	...
	public void testASRIndexedConstantIndirectMove10() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("		 	  	ORG    			$8000\n");
		strBuilder.append("Start      	ASR		  	[,Y]  ; 8000   	68 B4            ASR   [,Y]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 B4            ASR   [,Y]", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", true);
		}
	}
	...
	public void testASRIndexedConstantIndirectMove11() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	ASR		  	[,U]  ; 8000   	68 D4            ASR   [,U]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 D4            ASR   [,U]", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", true);
		}
	}
	...
	public void testASRIndexedConstantIndirectMove12() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	ASR		  	[,S]  ; 8000   	68 F4            ASR   [,S]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 F4            ASR   [,S]", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", true);
		}
	}
	...
	public void testASRIndexedConstantIndirectMove13() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	ASR		  	[0,X]  ; 8000   	68 94            ASR   [0,X]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check operand", 0x94, line.getOperand()[0]);
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 94            ASR   [0,X]", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", true);
		}
	}
	...
	public void testASRIndexedConstantIndirectMove14() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	ASR		  	[0,Y]  ; 8000   	68 B4            ASR   [0,Y]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check operand", 0xB4, line.getOperand()[0]);
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 B4            ASR   [0,Y]", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", true);
		}
	}
	...
	public void testASRIndexedConstantIndirectMove15() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	ASR		  	[0,U]  ; 8000   	68 D4            ASR   [0,U]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check operand", 0xD4, line.getOperand()[0]);
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 D4            ASR   [0,U]", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", true);
		}
	}
	...
	public void testASRIndexedConstantIndirectMove16() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	ASR		  	[0,S]  ; 8000   	68 F4            ASR   [0,S]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check operand", 0xF4, line.getOperand()[0]);
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 F4            ASR   [0,S]", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", true);
		}
	}
	...
	public void testASRIndexedConstantIndirectMove17() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	ASR		  	[-16,X]  ; 8000   	68 98 F0            ASR   [-16,X]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 98 F0            ASR   [-16,X]", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", true);
		}
	}
	...
	public void testASRIndexedConstantIndirectMove18() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	ASR		  	[15,X]  ; 8000   	68 98 0F            ASR   [15,X]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 98 0F            ASR   [15,X]", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", true);
		}
	}
	...
	public void testASRIndexedConstantIndirectMove19() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	ASR		  	[-16,Y]  ; 8000   	68 B8 F0            ASR   [-16,Y]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check operand", 0xF0, line.getOperand()[1]);
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 B8 F0            ASR   [-16,Y]", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", true);
		}
	}
	...
	public void testASRIndexedConstantIndirectMove20() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	ASR		  	[15,Y]  ; 8000   	68 B8 0F            ASR   [15,Y]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check operand", 0x0F, line.getOperand()[1]);
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 B8 0F            ASR   [15,Y]", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", true);
		}
	}
	...
	public void testASRIndexedConstantIndirectMove21() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	ASR		  	[-16,U]  ; 8000   	68 D8 F0            ASR   [-16,U]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check operand", 0xF0, line.getOperand()[1]);
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 D8 F0            ASR   [-16,U]", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", true);
		}
	}
	...
	public void testASRIndexedConstantIndirectMove22() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	ASR		  	[15,U]  ; 8000   	68 D8 0F            ASR   [15,U]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check operand", 0x0F, line.getOperand()[1]);
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 D8 0F            ASR   [15,U]", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", true);
		}
	}
	...
	public void testASRIndexedConstantIndirectMove23() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	ASR		  	[-16,S]  ; 8000   	68 F8 F0            ASR   [-16,S]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check operand", 0xF0, line.getOperand()[1]);
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 F8 F0            ASR   [-16,S]", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", true);
		}
	}
	...
	public void testASRIndexedConstantIndirectMove24() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	ASR		  	[15,S]  ; 8000   	68 F8 0F            ASR   [15,S]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check operand", 0x0F, line.getOperand()[1]);
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 F8 0F            ASR   [15,S]", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", true);
		}
	}
	...
	public void testASRIndexedConstantIndirectMove31() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("		 	  	ORG    			$8000\n");
		strBuilder.append("Start      	ASR		  	[-128,X]  ; 8000   	68 98 80            ASR   [-128,X}\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check operand", 0x80, line.getOperand()[1]);
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 98 80            ASR   [-128,X}", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", true);
		}
	}
	...
	public void testASRIndexedConstantIndirectMove32() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	ASR		  	[127,X]  ; 8000   	68 98 7F            ASR   [127,X]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check operand", 0x7F, line.getOperand()[1]);
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 98 7F            ASR   [127,X]", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", true);
		}
	}
	...
	public void testASRIndexedConstantIndirectMove33() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	ASR		  	[-128,Y]  ; 8000   	68 B8 80            ASR   [-128,Y]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check operand", 0x80, line.getOperand()[1]);
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 B8 80            ASR   [-128,Y]", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", true);
		}
	}
	...
	public void testASRIndexedConstantIndirectMove34() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("		 	  	ORG    			$8000\n");
		strBuilder.append("Start      	ASR		  	[127,Y]  ; 8000   	68 B8 7F            ASR   [127,Y]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check operand", 0x7F, line.getOperand()[1]);
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 B8 7F            ASR   [127,Y]", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", true);
		}
	}
	...
	public void testASRIndexedConstantIndirectMove35() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	ASR		  	[-128,U]  ; 8000   	68 D8 80            ASR   [-128,U]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check operand", 0x80, line.getOperand()[1]);
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 D8 80            ASR   [-128,U]", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", true);
		}
	}
	...
	public void testASRIndexedConstantIndirectMove36() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	ASR		  	[127,U]  ; 8000   	68 D8 7F            ASR   [127,U]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check operand", 0x7F, line.getOperand()[1]);
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 D8 7F            ASR   [127,U]", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", true);
		}
	}
	...
	public void testASRIndexedConstantIndirectMove37() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	ASR		  	[-128,S]  ; 8000   	68 F8 80            ASR   [-128,S]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check operand", 0x80, line.getOperand()[1]);
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 F8 80            ASR   [-128,S]", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", true);
		}
	}
	...
	public void testASRIndexedConstantIndirectMove38() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	ASR		  	[127,S]  ; 8000   	68 F8 7F            ASR   [127,S]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check operand", 0x7F, line.getOperand()[1]);
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 F8 7F            ASR   [127,S]", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", true);
		}
	}
	...
	public void testASRIndexedConstantIndirectMove39() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	ASR		  	[-32768,X]  ; 8000   	68 99 80 00             ASR   [-32768,X]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check operand", 0x00, line.getOperand()[2]);
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 99 80 00             ASR   [-32768,X]", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", true);
		}
	}
	...
	public void testASRIndexedConstantIndirectMove40() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	ASR		  [32767,X]  ; 8000   	68 99 7F FF             ASR   [32767,X]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check operand", 0xFF, line.getOperand()[2]);
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 99 7F FF             ASR   [32767,X]", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", true);
		}
	}
	...
	public void testASRIndexedConstantIndirectMove41() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	ASR		  	[-32768,Y]  ; 8000   	68 B9 80 00             ASR   [-32768,Y]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check operand", 0x00, line.getOperand()[2]);
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 B9 80 00             ASR   [-32768,Y]", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", true);
		}
	}
	...
	public void testASRIndexedConstantIndirectMove42() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	ASR		  [32767,Y]  ; 8000   	68 B9 7F FF             ASR   [32767,Y]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check operand", 0xFF, line.getOperand()[2]);
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 B9 7F FF             ASR   [32767,Y]", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", true);
		}
	}
	...
	public void testASRIndexedConstantIndirectMove43() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	ASR		  	[-32768,U]  ; 8000   	68 D9 80 00             ASR   [-32768,U]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check operand", 0x00, line.getOperand()[2]);
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 D9 80 00             ASR   [-32768,U]", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", true);
		}
	}
	...
	public void testASRIndexedConstantIndirectMove44() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	ASR		  [32767,U]  ; 8000   	68 D9 7F FF             ASR   [32767,U]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check operand", 0xFF, line.getOperand()[2]);
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 D9 7F FF             ASR   [32767,U]", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", true);
		}
	}
	...
	public void testASRIndexedConstantIndirectMove45() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("		   		ORG    			$8000\n");
		strBuilder.append("Start      	ASR		  	[-32768,S]  ; 8000   	68 F9 80 00             ASR   [-32768,S]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check operand", 0x00, line.getOperand()[2]);
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 F9 80 00             ASR   [-32768,S]", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", true);
		}
	}
	...
	public void testASRIndexedConstantIndirectMove46() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	ASR		  [32767,S]  ; 8000   	68 F9 7F FF             ASR   [32767,S]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check operand", 0xFF, line.getOperand()[2]);
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 F9 7F FF             ASR   [32767,S]", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", true);
		}
	}
	...
	public void testASRIndexedConstantIndirectMove47() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("		 	  	ORG    			$8000\n");
		strBuilder.append("Start      	ASR		  	[-32769,X]  ; 8000   	68 99 80 00             ASR   [-32769,X]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check operand", 0x00, line.getOperand()[2]);
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 99 80 00             ASR   [-32769,X]", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", true);
		}
	}
	...
	public void testASRIndexedConstantIndirectMove48() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	ASR		  [32768,X]  ; 8000   	68 99 7F FF             ASR   [32768,X]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check operand", 0xFF, line.getOperand()[2]);
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 99 7F FF             ASR   [32768,X]", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", true);
		}
	}
	...
	public void testASRIndexedConstantIndirectMove49() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("		 	  	ORG    			$8000\n");
		strBuilder.append("Start      	ASR		  	[-32769,Y]  ; 8000   	68 B9 80 00             ASR   [-32769,Y]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check operand", 0x00, line.getOperand()[2]);
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 B9 80 00             ASR   [-32769,Y]", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", true);
		}
	}
	...
	public void testASRIndexedConstantIndirectMove50() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("		 	  	ORG    			$8000\n");
		strBuilder.append("Start      	ASR		  [32768,Y]  ; 8000   	68 B9 7F FF             ASR   [32768,Y]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check operand", 0xFF, line.getOperand()[2]);
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 B9 7F FF             ASR   [32768,Y]", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", true);
		}
	}
	...
	public void testASRIndexedConstantIndirectMove51() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	ASR		  	[-32769,U]  ; 8000   	68 D9 80 00             ASR   [-32769,U]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check operand", 0x00, line.getOperand()[2]);
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 D9 80 00             ASR   [-32769,U]", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", true);
		}
	}
	...
	public void testASRIndexedConstantIndirectMove52() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	ASR		  [32768,U]  ; 8000   	68 D9 7F FF             ASR   [32768,U]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check operand", 0xFF, line.getOperand()[2]);
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 D9 7F FF             ASR   [32768,U]", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", true);
		}
	}
	...
	public void testASRIndexedConstantIndirectMove53() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	ASR		  	[-32769,S]  ; 8000   	68 F9 80 00             ASR   [-32769,S]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check operand", 0x00, line.getOperand()[2]);
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 F9 80 00             ASR   [-32769,S]", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", true);
		}
	}
	...
	public void testASRIndexedConstantIndirectMove54() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("		   		ORG    			$8000\n");
		strBuilder.append("Start      	ASR		  [32768,S]  ; 8000   	68 F9 7F FF             ASR   [32768,S]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check operand", 0xFF, line.getOperand()[2]);
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 F9 7F FF             ASR   [32768,S]", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", true);
		}
	}
