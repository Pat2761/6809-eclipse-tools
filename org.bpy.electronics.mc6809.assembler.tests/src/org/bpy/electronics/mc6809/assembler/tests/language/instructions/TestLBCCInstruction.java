...
public class TestLBCCInstruction {
	...
	public void testSimpleLBCCWithExtraSpace() {
		...
		try {
			...
			Assert.assertTrue("Must be an LBCC directive line", instructionLine.getInstruction() instanceof BccInstruction);
		} catch (Exception e) {
	...
	public void testSimpleLBCCWithDuplicateLabel() {
		...
		strBuilder.append("Jump		LBCC		Jump		; Jump=3FFF\n");
	...
	public void testSimpleLBCCWithBadLabel() {
		...
		strBuilder.append("			NOP\n");
		strBuilder.append("Jump		LBCC		Jump2		; Jump=3FFF\n");
	...
	public void testSimpleLBCCWithWithLabel() {
		...
		strBuilder.append("Jump	    	ASLA\n");
		strBuilder.append("				ASLB\n");
		strBuilder.append("MyBanch		LBCC		Jump\n");
	...
	public void testSimpleLBCCWithNegativeJump1() {
		...
		strBuilder.append("MyBanch		LBCC	Jump		; Jump=1024FF80\n");
		...
		try {
			...
			AssembledLBCCInstruction line = (AssembledLBCCInstruction)engine.getAssembledLine(4);
	...
	public void testSimpleLBCCWithNegativeJump2() {
		...
		strBuilder.append("Jump	    	LDA		#25\n");
		strBuilder.append("	       	 	ORG     $8080\n");
		strBuilder.append("MyBanch		LBCC	Jump		; Jump=1024FF7F\n");
	...
	public void testSimpleLBCCWithPositiveJump1() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("	        	ORG     	$8000\n");
		strBuilder.append("MyBanch		LBCC		Jump		; Jump=1024007F\n");
		...
		try {
			...
			AssembledLBCCInstruction line = (AssembledLBCCInstruction)engine.getAssembledLine(2);
			Assert.assertEquals("Check opcode length", 2, line.getOpcode().length);
			Assert.assertEquals("Check opcode value", 0x10, line.getOpcode()[0]);
			Assert.assertEquals("Check opcode value", 0x24, line.getOpcode()[1]);
			Assert.assertEquals("Check operand length", 2, line.getOperand().length);
	...
	public void testSimpleLBCCWithPositiveJump2() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("	        	ORG     	$8000\n");
		strBuilder.append("MyBanch		LBCC		Jump		; Jump=10240080\n");
	...
	public void testSimpleLBCCWithPositiveLimitJump1() {
		...
		strBuilder.append("MyBranch		LBCC		Jump		; Jump=10247FFF\n");
		strBuilder.append("				ORG     	$8003\n");
		strBuilder.append("Jump			RTS			\n");
	...
	public void testSimpleLBCCWithPositiveLimitJump2() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("	        	ORG     	$0000\n");
		strBuilder.append("MyBanch		LBCC		Jump		; Jump=10248000\n");
		strBuilder.append("				ORG     	$8004\n");
		strBuilder.append("Jump			RTS			\n");
	...
	public void testSimpleLBCCWithNegativeLimitJump1() {
		...
		strBuilder.append("JUMP			RTS					\n");
		strBuilder.append("				ORG			$8000		;\n");
		strBuilder.append("VVV			LBCC		JUMP		;		\n");
