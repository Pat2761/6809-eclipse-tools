...
public class TestLDDInstruction {
	...
	public void testLDDImemdiatAddressingMode() {
		...
		try {
			...
			assertEquals("Must be an LDD instruction", adcInstruction.getInstruction(), "LDD");
	...
	public void testLDDConstantOffsetIndexed() {
		...
		strBuilder.append("	      LDD		  	Const,X\n");
		strBuilder.append("			LDD		  	,X\n");
		strBuilder.append("			LDD		  	$9,U\n");
		strBuilder.append("			LDD		  	$9,S\n");
		strBuilder.append("			LDD		  	$9,X\n");
		strBuilder.append("			LDD		  	$9,Y\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testLDDAccumulatorIndexed() {
		...
		strBuilder.append("	      ORG  			$8000\n");
		strBuilder.append("Const	EQU        	5    \n");
		strBuilder.append("	      LDD		  	A,X\n");
		strBuilder.append("			LDD		  	B,X\n");
		strBuilder.append("			LDD		  	D,U\n");
		strBuilder.append("			LDD		  	A,S\n");
		strBuilder.append("			LDD		  	B,X\n");
		strBuilder.append("			LDD		  	D,Y\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testLDDAutoIncrementIndexed() {
		...
		strBuilder.append("	       	LDD		  	,X+\n");
		strBuilder.append("	       	LDD		  	,X++\n");
		strBuilder.append("	       	LDD		  	,--S\n");
		strBuilder.append("	       	LDD		  	,-S\n");
		strBuilder.append("	       	LDD		  	,U+\n");
		strBuilder.append("	       	LDD		  	,U++\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testLDDWithDuplicateLabel() {
		...
		strBuilder.append("Start      	LDD		  	#Const+2\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testLDDImmediatInstruction1() {
		...
		strBuilder.append("		    		ORG   		$8000\n");
		strBuilder.append("Const	   	EQU       	5\n");
		strBuilder.append("Start      	LDD		  	#Const+2  ; 8000   CC 00 07        START:    LDD\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			AssembledLDDInstruction line = (AssembledLDDInstruction) engine.getAssembledLine(3);
			Assert.assertEquals("Check getOpcode() size ", 1, line.getOpcode().length);
			Assert.assertEquals("Check getOpcode()", 0xCC, line.getOpcode()[0]);
			...
			;
			Assert.assertEquals("Check comment", "; 8000   CC 00 07        START:    LDD", line.getComment());
			;
		} catch (Exception e) {
			Assert.assertTrue("Exception", true);
		}
	...
	public void testLDDImmediatInstruction2() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("		   		ORG    		$8000\n");
		strBuilder.append("Start      	LDD		  	#-32769\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testLDDImmediatInstruction3() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("		   		ORG    			$8000\n");
		strBuilder.append("Start      	LDD		  	#-128\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testLDDImmediatInstruction4() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("		   		ORG    		$8000\n");
		strBuilder.append("Start      	LDD		  	#127\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testLDDImmediatInstruction5() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("		   		ORG    		$8000\n");
		strBuilder.append("Start      	LDD		  	#65535\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	 ...
	 */
	@Test
	public void testLDDImmediatInstruction6() {
		StringBuilder strBuilder = new StringBuilder();
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("		   		ORG    		$8000\n");
		strBuilder.append("Start      	LDD		  	#65536\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testLDDDirectInstruction1() {
		...
		strBuilder.append("		   		ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	LDD		  	<Const*2  ; 8000   DC 0A        START:    LDD   <Const*2 \n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			AssembledLDDInstruction line = (AssembledLDDInstruction) engine.getAssembledLine(3);
			Assert.assertEquals("Check getOpcode() size ", 1, line.getOpcode().length);
			Assert.assertEquals("Check getOpcode()", 0xDC, line.getOpcode()[0]);
	...
	public void testLDDDirectInstruction2() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("		   		ORG    			$8000\n");
		strBuilder.append("Start      	LDD		  	<-129\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testLDDExtendedInstruction1() {
		...
		strBuilder.append("		   		ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	LDD		  	>Const*1000  ; 8000   FC 13 88     START:    LDD   >Const*1000 \n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			AssembledLDDInstruction line = (AssembledLDDInstruction) engine.getAssembledLine(3);
			Assert.assertEquals("Check getOpcode() size ", 1, line.getOpcode().length);
			Assert.assertEquals("Check getOpcode()", 0xFC, line.getOpcode()[0]);
			Assert.assertEquals("Check operand size ", 2, line.getOperand().length);
	...
	public void testLDDExtendedInstruction3() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("		   		ORG    			$8000\n");
		strBuilder.append("Start      	LDD		  	>-32768\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testLDDExtendedIndirectInstruction1() {
		...
		strBuilder.append("		   		ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	LDD		  	[Const*1000]  ; 8000   AB 9F 13 88  START:    LDD   [Const*1000]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check getOpcode()", 0xEC, line.getOpcode()[0]);
	...
	public void testLDDIndexedAccumulatorMovingMode1() {
		...
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	LDD		  	A,X  ; 8000   AB 86        START:    LDD   A,X\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testLDDIndexedAccumulatorMovingMode2() {
		...
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	LDD		  	A,Y  ; 8000   	EC A6        START:    LDD   A,Y\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testLDDIndexedAccumulatorMovingMode3() {
		...
		strBuilder.append("		   	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	LDD		  	A,U  ; 8000   	EC C6        START:    LDD   A,U\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testLDDIndexedAccumulatorMovingMode4() {
		...
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	LDD		  	A,S  ; 8000   	EC E6        START:    LDD   A,S\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testLDDIndexedAccumulatorMovingMode5() {
		...
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	LDD		  	B,X  ; 8000   AB 85        START:    LDD   B,X\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testLDDIndexedAccumulatorMovingMode6() {
		...
		strBuilder.append("		   		ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	LDD		  	B,Y  ; 8000   	EC A5        START:    LDD   B,Y\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testLDDIndexedAccumulatorMovingMode7() {
		...
		strBuilder.append("		   		ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	LDD		  	B,U  ; 8000   	EC C5        START:    LDD   B,U\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testLDDIndexedAccumulatorMovingMode8() {
		...
		strBuilder.append("		   		ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	LDD		  	B,S  ; 8000   	EC E5        START:    LDD   B,S\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testLDDIndexedAccumulatorMovingMode9() {
		...
		strBuilder.append("		   		ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	LDD		  	D,X  ; 8000   AB 8B        START:    LDD   D,X\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testLDDIndexedAccumulatorMovingMode10() {
		...
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	LDD		  	D,Y  ; 8000   	EC AB        START:    LDD   D,Y\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testLDDIndexedAccumulatorMovingMode11() {
		...
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	LDD		  	D,U  ; 8000   	EC CB        START:    LDD   D,U\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testLDDIndexedAccumulatorMovingMode12() {
		...
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	LDD		  	D,S  ; 8000   	EC EB        START:    LDD   D,S\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testLDDIndexedIndorectAccumulatorMovingMode1() {
		...
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	LDD		  	[A,X]  ; 8000   AB 96        START:    LDD   [A,X]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testLDDIndexedIndirectAccumulatorMovingMode2() {
		...
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	LDD		  	[A,Y]  ; 8000   	EC B6        START:    LDD   [A,Y]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testLDDIndexedIndirectAccumulatorMovingMode3() {
		...
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	LDD		  	[A,U]  ; 8000   	EC D6        START:    LDD   [A,U]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testLDDIndexedIndirectAccumulatorMovingMode4() {
		...
		strBuilder.append("		   		ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	LDD		  	[A,S]  ; 8000   	EC F6        START:    LDD   [A,S]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testLDDIndexedIndirectAccumulatorMovingMode5() {
		...
		strBuilder.append("		   		ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	LDD		  	[B,X]  ; 8000   AB 95        START:    LDD   [B,X]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testLDDIndexedIndirectAccumulatorMovingMode6() {
		...
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	LDD		  	[B,Y]  ; 8000   	EC B5        START:    LDD   [B,Y]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testLDDIndexedIndirectAccumulatorMovingMode7() {
		...
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	LDD		  	[B,U]  ; 8000   	EC D5        START:    LDD   [B,U]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testLDDIndexedIndirectAccumulatorMovingMode8() {
		...
		strBuilder.append("		   		ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	LDD		  	[B,S]  ; 8000   	EC F5        START:    LDD   [B,S]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testLDDIndexedIndirectAccumulatorMovingMode9() {
		...
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	LDD		  	[D,X]  ; 8000   AB 9B        START:    LDD   [D,X]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testLDDIndexedIndirectAccumulatorMovingMode10() {
		...
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	LDD		  	[D,Y]  ; 8000   	EC BB        START:    LDD   [D,Y]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testLDDIndexedIndirectAccumulatorMovingMode11() {
		...
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	LDD		  	[D,U]  ; 8000   	EC DB        START:    LDD   [D,U]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testLDDIndexedIndirectAccumulatorMovingMode12() {
		...
		strBuilder.append("		  	 	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	LDD		  	[D,S]  ; 8000   	EC FB        START:    LDD   [D,S]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testLDDIndexedAutoIncrementDecrementMode1() {
		...
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	LDD		  	,X+  ; 8000   	EC 80        START:    LDD   ,X+\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testLDDIndexedAutoIncrementDecrementMode2() {
		...
		strBuilder.append("		   		ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	LDD		  	,X++  ; 8000   	EC 81        START:    LDD   ,X++\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testLDDIndexedAutoIncrementDecrementMode3() {
		...
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	LDD		  	,Y+  ; 8000   	EC A0        START:    LDD   ,Y+\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testLDDIndexedAutoIncrementDecrementMode4() {
		...
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	LDD		  	,Y++  ; 8000   	EC A1        START:    LDD   ,Y++\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testLDDIndexedAutoIncrementDecrementMode5() {
		...
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	LDD		  	,S+  ; 8000   	EC E0        START:    LDD   ,S+\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testLDDIndexedAutoIncrementDecrementMode6() {
		...
		strBuilder.append("		  	 	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	LDD		  	,S++  ; 8000   	EC E1        START:    LDD   ,S++\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testLDDIndexedAutoIncrementDecrementMode7() {
		...
		strBuilder.append("		  	 	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	LDD		  	,U+  ; 8000   	EC C0        START:    LDD   ,U+\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testLDDIndexedAutoIncrementDecrementMode8() {
		...
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	LDD		  	,U++  ; 8000   	EC C1        START:    LDD   ,U++\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testLDDIndexedAutoIncrementDecrementMode9() {
		...
		strBuilder.append("		 	  	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	LDD		  	,-X  ; 8000   	EC 82        START:    LDD   ,-X\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testLDDIndexedAutoIncrementDecrementMode10() {
		...
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	LDD		  	,--X  ; 8000   	EC 83        START:    LDD   ,--X\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testLDDIndexedAutoIncrementDecrementMode11() {
		...
		strBuilder.append("		 	  	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	LDD		  	,-Y  ; 8000   	EC A2        START:    LDD   ,-Y\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testLDDIndexedAutoIncrementDecrementMode12() {
		...
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	LDD		  	,--Y  ; 8000   	EC A3        START:    LDD   ,--Y\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testLDDIndexedAutoIncrementDecrementMode13() {
		...
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	LDD		  	,-S  ; 8000   	EC E2        START:    LDD   ,-S\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testLDDIndexedAutoIncrementDecrementMode14() {
		...
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	LDD		  	,--S  ; 8000   	EC E3        START:    LDD   ,--S\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testLDDIndexedAutoIncrementDecrementMode15() {
		...
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	LDD		  	,-U  ; 8000   	EC C2        START:    LDD   ,-U\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testLDDIndexedAutoIncrementDecrementMode16() {
		...
		strBuilder.append("		   		ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	LDD		  	,--U  ; 8000   	EC C3        START:    LDD   ,--U\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	/**
	 * Check Assembled LDD Indexed Auto Increment Decrement Indirect Mode
	 * instruction
	 */
	@Test
	...
	/**
	 * Check Assembled LDD Indexed Auto Increment Decrement Mode indorect
	 * instruction
	 */
	@Test
	public void testLDDIndexedAutoIncrementDecrementIndirectMode2() {
		...
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	LDD		  	[,X++]  ; 8000   	EC 91        START:    LDD   [,X++]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	/**
	 * Check Assembled LDD Indexed Auto Increment Decrement Mode indirect
	 * instruction
	 */
	@Test
	...
	public void testLDDIndexedAutoIncrementDecrementIndirectMode4() {
		...
		strBuilder.append("		   		ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	LDD		  	[,Y++]  ; 8000   	EC B1        START:    LDD   [,Y++]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testLDDIndexedAutoIncrementDecrementIndirectMode6() {
		...
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	LDD		  	[,S++]  ; 8000   	EC F1        START:    LDD   [,S++]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testLDDIndexedAutoIncrementDecrementindirectMode8() {
		...
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	LDD		  	[,U++]  ; 8000   	EC D1        START:    LDD   [,U++]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testLDDIndexedAutoIncrementDecrementIndirectMode10() {
		...
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	LDD		  	[,--X]  ; 8000   	EC 93        START:    LDD   [,--X]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testLDDIndexedAutoIncrementDecrementIndirectMode12() {
		...
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	LDD		  	[,--Y]  ; 8000   	EC B3        START:    LDD   [,--Y]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testLDDIndexedAutoIncrementDecrementIndirectMode14() {
		...
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	LDD		  	[,--S]  ; 8000   	EC F3        START:    LDD   [,--S]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testLDDIndexedAutoIncrementDecrementIndirectMode16() {
		...
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	LDD		  	[,--U]  ; 8000   	EC D3        START:    LDD   [,--U]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testLDDIndexedConstantMove1() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("		 	  	ORG    			$8000\n");
		strBuilder.append("Start      	LDD		  	1234,X  ; 8000   	EC 89 04 D2            LDD   1234,X\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testLDDIndexedConstantMove2() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	LDD		  	1234,Y  ; 8000   	AB A9 04 D2            LDD   1234,Y\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check operand", 0xD2, line.getOperand()[2]);
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	AB A9 04 D2            LDD   1234,Y", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", true);
		}
	}
	...
	public void testLDDIndexedConstantMove3() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	LDD		  	1234,U  ; 8000   	EC C9 04 D2            LDD   1234,U\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testLDDIndexedConstantMove4() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	LDD		  	1234,S  ; 8000   	EC E9 04 D2            LDD   1234,S\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testLDDIndexedConstantMove5() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	LDD		  	34,X  ; 8000   	EC 88 22            LDD   34,X\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testLDDIndexedConstantMove6() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	LDD		  	34,Y  ; 8000   	EC A8 22            LDD   34,Y\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testLDDIndexedConstantMove7() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("		  	 	ORG    			$8000\n");
		strBuilder.append("Start      	LDD		  	34,U  ; 8000   	EC C8 22            LDD   34,U\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testLDDIndexedConstantMove8() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	LDD		  	34,S  ; 8000   	EC E8 22            LDD   34,S\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testLDDIndexedConstantMove9() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	LDD		  	,X  ; 8000   	EC 84            LDD   ,X\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testLDDIndexedConstantMove10() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	LDD		  	,Y  ; 8000   	EC A4            LDD   ,Y\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testLDDIndexedConstantMove11() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	LDD		  	,U  ; 8000   	EC C4            LDD   ,U\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testLDDIndexedConstantMove12() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("		 	  	ORG    			$8000\n");
		strBuilder.append("Start      	LDD		  	,S  ; 8000   	EC E4            LDD   ,S\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testLDDIndexedConstantMove13() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	LDD		  	0,X  ; 8000   	EC 84            LDD   0,X\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testLDDIndexedConstantMove14() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	LDD		  	0,Y  ; 8000   	EC A4            LDD   0,Y\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testLDDIndexedConstantMove15() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	LDD		  	0,U  ; 8000   	EC C4            LDD   0,U\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testLDDIndexedConstantMove16() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	LDD		  	0,S  ; 8000   	EC E4            LDD   0,S\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testLDDIndexedConstantMove17() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	LDD		  	-16,X  ; 8000   	EC 10            LDD   -16,X\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testLDDIndexedConstantMove19() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	LDD		  	1,X  ; 8000   	EC 01            LDD   1,X\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testLDDIndexedConstantMove20() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("		 	  	ORG    			$8000\n");
		strBuilder.append("Start      	LDD		  	15,X  ; 8000   	EC 0F            LDD   15,X\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testLDDIndexedConstantMove21() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	LDD		  	-16,Y  ; 8000   	EC 30            LDD   -16,Y\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testLDDIndexedConstantMove23() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	LDD		  	1,Y  ; 8000   	EC 21            LDD   1,Y\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testLDDIndexedConstantMove24() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	LDD		  	15,Y  ; 8000   	EC 2F            LDD   15,Y\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testLDDIndexedConstantMove25() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	LDD		  	-16,U  ; 8000   	EC 50            LDD   -16,U\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testLDDIndexedConstantMove26() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	LDD		  	1,U  ; 8000   	EC 41            LDD   1,U\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testLDDIndexedConstantMove27() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	LDD		  	15,U  ; 8000   	EC 4F            LDD   15,U\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testLDDIndexedConstantMove28() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	LDD		  	-16,S  ; 8000   	EC 70            LDD   -16,S\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testLDDIndexedConstantMove29() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	LDD		  	1,S  ; 8000   	EC 61            LDD   1,S\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testLDDIndexedConstantMove30() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	LDD		  	15,S  ; 8000   	EC 6F            LDD   15,S\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testLDDIndexedConstantMove31() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	LDD		  	-128,X  ; 8000   	EC 88 80            LDD   -128,X\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testLDDIndexedConstantMove32() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("		 	  	ORG    			$8000\n");
		strBuilder.append("Start      	LDD		  	127,X  ; 8000   	EC 88 7F            LDD   127,X\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testLDDIndexedConstantMove33() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	LDD		  	-128,Y  ; 8000   	EC A8 80            LDD   -128,Y\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testLDDIndexedConstantMove34() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("		 	  	ORG    			$8000\n");
		strBuilder.append("Start      	LDD		  	127,Y  ; 8000   	EC A8 7F            LDD   127,Y\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testLDDIndexedConstantMove35() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	LDD		  	-128,U  ; 8000   	EC C8 80            LDD   -128,U\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testLDDIndexedConstantMove36() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("		  	 	ORG    			$8000\n");
		strBuilder.append("Start      	LDD		  	127,U  ; 8000   	EC C8 7F            LDD   127,U\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testLDDIndexedConstantMove37() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	LDD		  	-128,S  ; 8000   	EC E8 80            LDD   -128,S\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testLDDIndexedConstantMove38() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	LDD		  	127,S  ; 8000   	EC E8 7F            LDD   127,S\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testLDDIndexedConstantMove39() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	LDD		  	-32768,X  ; 8000   	EC 89 80 00             LDD   -32768,X\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testLDDIndexedConstantMove40() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	LDD		  32767,X  ; 8000   	EC 89 7F FF             LDD   32767,X\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testLDDIndexedConstantMove41() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	LDD		  	-32768,Y  ; 8000   	AB A9 80 00             LDD   -32768,Y\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check operand", 0x00, line.getOperand()[2]);
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	AB A9 80 00             LDD   -32768,Y", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", true);
		}
	}
	...
	public void testLDDIndexedConstantMove42() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	LDD		  32767,Y  ; 8000   	AB A9 7F FF             LDD   32767,Y\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check operand", 0xFF, line.getOperand()[2]);
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	AB A9 7F FF             LDD   32767,Y", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", true);
		}
	}
	...
	public void testLDDIndexedConstantMove43() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	LDD		  	-32768,U  ; 8000   	EC C9 80 00             LDD   -32768,U\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testLDDIndexedConstantMove44() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	LDD		  32767,U  ; 8000   	EC C9 7F FF             LDD   32767,U\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testLDDIndexedConstantMove45() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("		 	  	ORG    			$8000\n");
		strBuilder.append("Start      	LDD		  	-32768,S  ; 8000   	EC E9 80 00             LDD   -32768,S\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testLDDIndexedConstantMove46() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	LDD		  32767,S  ; 8000   	EC E9 7F FF             LDD   32767,S\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testLDDIndexedConstantMove47() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	LDD		  	-32769,X  ; 8000   	EC 89 80 00             LDD   -32769,X\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testLDDIndexedConstantMove48() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	LDD		  32768,X  ; 8000   	EC 89 7F FF             LDD   32768,X\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testLDDIndexedConstantMove49() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("		   		ORG    			$8000\n");
		strBuilder.append("Start      	LDD		  	-32769,Y  ; 8000   	AB A9 80 00             LDD   -32769,Y\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check operand", 0x00, line.getOperand()[2]);
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	AB A9 80 00             LDD   -32769,Y", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", true);
		}
	}
	...
	public void testLDDIndexedConstantMove50() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("		  	 	ORG    			$8000\n");
		strBuilder.append("Start      	LDD		  32768,Y  ; 8000   	AB A9 7F FF             LDD   32768,Y\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check operand", 0xFF, line.getOperand()[2]);
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	AB A9 7F FF             LDD   32768,Y", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", true);
		}
	}
	...
	public void testLDDIndexedConstantMove51() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("		 	  	ORG    			$8000\n");
		strBuilder.append("Start      	LDD		  	-32769,U  ; 8000   	EC C9 80 00             LDD   -32769,U\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testLDDIndexedConstantMove52() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	LDD		  32768,U  ; 8000   	EC C9 7F FF             LDD   32768,U\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testLDDIndexedConstantMove53() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	LDD		  	-32769,S  ; 8000   	EC E9 80 00             LDD   -32769,S\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testLDDIndexedConstantMove54() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	LDD		  32768,S  ; 8000   	EC E9 7F FF             LDD   32768,S\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testLDDIndexedConstantIndirectMove1() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	LDD		  	[1234,X]  ; 8000   	EC 99 04 D2            LDD   [1234,X]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testLDDIndexedConstantIndirectMove2() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	LDD		  	[1234,Y]  ; 8000   	EC B9 04 D2            LDD   [1234,Y]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testLDDIndexedConstantIndirectMove3() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("		 	  	ORG    			$8000\n");
		strBuilder.append("Start      	LDD		  	[1234,U]  ; 8000   	EC D9 04 D2            LDD   [1234,U]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testLDDIndexedConstantIndirectMove4() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	LDD		  	[1234,S]  ; 8000   	EC F9 04 D2            LDD   [1234,S]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testLDDIndexedConstantIndirectMove5() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	LDD		  	[34,X]  ; 8000   	EC 98 22            LDD   [34,X]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testLDDIndexedConstantIndirectMove6() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	LDD		  	[34,Y]  ; 8000   	EC B8 22            LDD   [34,Y]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testLDDIndexedConstantIndirectMove7() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	LDD		  	[34,U]  ; 8000   	EC D8 22            LDD   [34,U]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testLDDIndexedConstantIndirectMove8() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	LDD		  	[34,S]  ; 8000   	EC F8 22            LDD   [34,S]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testLDDIndexedConstantIndirectMove9() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	LDD		  	[,X]  ; 8000   	EC 94            LDD   [,X]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testLDDIndexedConstantIndirectMove10() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("		 	  	ORG    			$8000\n");
		strBuilder.append("Start      	LDD		  	[,Y]  ; 8000   	EC B4            LDD   [,Y]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testLDDIndexedConstantIndirectMove11() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	LDD		  	[,U]  ; 8000   	EC D4            LDD   [,U]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testLDDIndexedConstantIndirectMove12() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	LDD		  	[,S]  ; 8000   	EC F4            LDD   [,S]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testLDDIndexedConstantIndirectMove13() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	LDD		  	[0,X]  ; 8000   	EC 94            LDD   [0,X]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testLDDIndexedConstantIndirectMove14() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	LDD		  	[0,Y]  ; 8000   	EC B4            LDD   [0,Y]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testLDDIndexedConstantIndirectMove15() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	LDD		  	[0,U]  ; 8000   	EC D4            LDD   [0,U]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testLDDIndexedConstantIndirectMove16() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	LDD		  	[0,S]  ; 8000   	EC F4            LDD   [0,S]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testLDDIndexedConstantIndirectMove17() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	LDD		  	[-16,X]  ; 8000   	EC 98 F0            LDD   [-16,X]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testLDDIndexedConstantIndirectMove18() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	LDD		  	[15,X]  ; 8000   	EC 98 0F            LDD   [15,X]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testLDDIndexedConstantIndirectMove19() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	LDD		  	[-16,Y]  ; 8000   	EC B8 F0            LDD   [-16,Y]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testLDDIndexedConstantIndirectMove20() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	LDD		  	[15,Y]  ; 8000   	EC B8 0F            LDD   [15,Y]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testLDDIndexedConstantIndirectMove21() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	LDD		  	[-16,U]  ; 8000   	EC D8 F0            LDD   [-16,U]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testLDDIndexedConstantIndirectMove22() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	LDD		  	[15,U]  ; 8000   	EC D8 0F            LDD   [15,U]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testLDDIndexedConstantIndirectMove23() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	LDD		  	[-16,S]  ; 8000   	EC F8 F0            LDD   [-16,S]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testLDDIndexedConstantIndirectMove24() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	LDD		  	[15,S]  ; 8000   	EC F8 0F            LDD   [15,S]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testLDDIndexedConstantIndirectMove31() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("		 	  	ORG    			$8000\n");
		strBuilder.append("Start      	LDD		  	[-128,X]  ; 8000   	EC 98 80            LDD   [-128,X}\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testLDDIndexedConstantIndirectMove32() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	LDD		  	[127,X]  ; 8000   	EC 98 7F            LDD   [127,X]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testLDDIndexedConstantIndirectMove33() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	LDD		  	[-128,Y]  ; 8000   	EC B8 80            LDD   [-128,Y]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testLDDIndexedConstantIndirectMove34() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("		 	  	ORG    			$8000\n");
		strBuilder.append("Start      	LDD		  	[127,Y]  ; 8000   	EC B8 7F            LDD   [127,Y]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testLDDIndexedConstantIndirectMove35() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	LDD		  	[-128,U]  ; 8000   	EC D8 80            LDD   [-128,U]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testLDDIndexedConstantIndirectMove36() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	LDD		  	[127,U]  ; 8000   	EC D8 7F            LDD   [127,U]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testLDDIndexedConstantIndirectMove37() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	LDD		  	[-128,S]  ; 8000   	EC F8 80            LDD   [-128,S]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testLDDIndexedConstantIndirectMove38() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	LDD		  	[127,S]  ; 8000   	EC F8 7F            LDD   [127,S]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testLDDIndexedConstantIndirectMove39() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	LDD		  	[-32768,X]  ; 8000   	EC 99 80 00             LDD   [-32768,X]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testLDDIndexedConstantIndirectMove40() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	LDD		  [32767,X]  ; 8000   	EC 99 7F FF             LDD   [32767,X]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testLDDIndexedConstantIndirectMove41() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	LDD		  	[-32768,Y]  ; 8000   	EC B9 80 00             LDD   [-32768,Y]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testLDDIndexedConstantIndirectMove42() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	LDD		  [32767,Y]  ; 8000   	EC B9 7F FF             LDD   [32767,Y]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testLDDIndexedConstantIndirectMove43() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	LDD		  	[-32768,U]  ; 8000   	EC D9 80 00             LDD   [-32768,U]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testLDDIndexedConstantIndirectMove44() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	LDD		  [32767,U]  ; 8000   	EC D9 7F FF             LDD   [32767,U]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testLDDIndexedConstantIndirectMove45() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("		   		ORG    			$8000\n");
		strBuilder.append("Start      	LDD		  	[-32768,S]  ; 8000   	EC F9 80 00             LDD   [-32768,S]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testLDDIndexedConstantIndirectMove46() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	LDD		  [32767,S]  ; 8000   	EC F9 7F FF             LDD   [32767,S]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testLDDIndexedConstantIndirectMove47() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("		 	  	ORG    			$8000\n");
		strBuilder.append("Start      	LDD		  	[-32769,X]  ; 8000   	EC 99 80 00             LDD   [-32769,X]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testLDDIndexedConstantIndirectMove48() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	LDD		  [32768,X]  ; 8000   	EC 99 7F FF             LDD   [32768,X]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testLDDIndexedConstantIndirectMove49() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("		 	  	ORG    			$8000\n");
		strBuilder.append("Start      	LDD		  	[-32769,Y]  ; 8000   	EC B9 80 00             LDD   [-32769,Y]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testLDDIndexedConstantIndirectMove50() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("		 	  	ORG    			$8000\n");
		strBuilder.append("Start      	LDD		  [32768,Y]  ; 8000   	EC B9 7F FF             LDD   [32768,Y]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testLDDIndexedConstantIndirectMove51() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	LDD		  	[-32769,U]  ; 8000   	EC D9 80 00             LDD   [-32769,U]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testLDDIndexedConstantIndirectMove52() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	LDD		  [32768,U]  ; 8000   	EC D9 7F FF             LDD   [32768,U]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testLDDIndexedConstantIndirectMove53() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	LDD		  	[-32769,S]  ; 8000   	EC F9 80 00             LDD   [-32769,S]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testLDDIndexedConstantIndirectMove54() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("		   		ORG    			$8000\n");
		strBuilder.append("Start      	LDD		  [32768,S]  ; 8000   	EC F9 7F FF             LDD   [32768,S]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
