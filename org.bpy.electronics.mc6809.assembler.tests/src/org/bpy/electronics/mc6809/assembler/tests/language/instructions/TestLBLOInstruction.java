...
import org.bpy.electronics.mc6809.assembler.engine.data.instructions.AssembledLBLOInstruction;
...
public class TestLBLOInstruction {
	 ...
	 */
	@Test 
	public void testSimpleLBLOWithExtraSpace() {
		StringBuilder strBuilder = new StringBuilder();
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("	        ORG     $8000\n");
		strBuilder.append("Jump	    ASLA\n");
		strBuilder.append("			ASLB\n");
		strBuilder.append("			LBLO		Jump \n");
		...
		try {
			...
			Assert.assertTrue("Must be an LBLO directive line", instructionLine.getInstruction() instanceof BloInstruction);
		} catch (Exception e) {
	 ...
	 */
	@Test 
	public void testSimpleLBLOWithoutExtraSpace() {
		StringBuilder strBuilder = new StringBuilder();
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("	        ORG     $8000\n");
		strBuilder.append("Jump	    ASLA\n");
	...
	/**
	 * Check LBLO with duplicate label
	 */
	@Test 
	public void testSimpleLBLOWithDuplicateLabel() {
		StringBuilder strBuilder = new StringBuilder();
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("	        ORG     $8000\n");
		strBuilder.append("Jump	    LDA		#25\n");
		strBuilder.append("			NOP\n");
		strBuilder.append("Jump		LBLO		Jump		; Jump=3FFF\n");
	...
	/**
	 * Check LBLO with bad label
	 */
	@Test 
	public void testSimpleLBLOWithBadLabel() {
		StringBuilder strBuilder = new StringBuilder();
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("	        ORG    	 	$8000\n");
		strBuilder.append("Jump1	LDA			#25\n");
		strBuilder.append("			NOP\n");
		strBuilder.append("Jump		LBLO		Jump2		; Jump=3FFF\n");
		...
		try {
			...
			Assert.assertNotNull(result);
			Assert.assertTrue("No errors found", result.eResource().getErrors().isEmpty());
			validationHelper.assertError(result,AssemblerPackage.eINSTANCE.getBloInstruction(),
	 ...
	 */
	@Test 
	public void testSimpleLBLOWithWithLabel() {
		StringBuilder strBuilder = new StringBuilder();
		strBuilder.append("	        	ORG     	$8000\n");
		strBuilder.append("Jump	    	ASLA\n");
		strBuilder.append("				ASLB\n");
		strBuilder.append("MyBanch		LBLO		Jump\n");
	...
	/**
	 * Check LBLO negative jump
	 */
	@Test 
	public void testSimpleLBLOWithNegativeJump1() {
		StringBuilder strBuilder = new StringBuilder();
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("	        	ORG     $8004\n");
		strBuilder.append("Jump	    	LDA		#25\n");
		strBuilder.append("	        	ORG     $8080\n");
		strBuilder.append("MyBanch		LBLO	Jump		; Jump=1025FF80\n");
		...
		try {
			...
			AssembledLBLOInstruction line = (AssembledLBLOInstruction)engine.getAssembledLine(4);
			...
			Assert.assertEquals("Check opcode value", 0x25, line.getOpcode()[1]);
	 ...
	 */
	@Test 
	public void testSimpleLBLOWithNegativeJump2() {
		StringBuilder strBuilder = new StringBuilder();
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("	        	ORG     $8003\n");
		strBuilder.append("Jump	    	LDA		#25\n");
		strBuilder.append("	       	 	ORG     $8080\n");
		strBuilder.append("MyBanch		LBLO	Jump		; Jump=1025FF7F\n");
	...
	/**
	 * Check LBLO positive jump
	 */
	@Test 
	public void testSimpleLBLOWithPositiveJump1() {
		StringBuilder strBuilder = new StringBuilder();
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("	        	ORG     	$8000\n");
		strBuilder.append("MyBanch		LBLO		Jump		; Jump=1025007F\n");
		...
		try {
			...
			AssembledLBLOInstruction line = (AssembledLBLOInstruction)engine.getAssembledLine(2);
			Assert.assertEquals("Check opcode length", 2, line.getOpcode().length);
			Assert.assertEquals("Check opcode value", 0x10, line.getOpcode()[0]);
			Assert.assertEquals("Check opcode value", 0x25, line.getOpcode()[1]);
			Assert.assertEquals("Check operand length", 2, line.getOperand().length);
	 ...
	 */
	@Test 
	public void testSimpleLBLOWithPositiveJump2() {
		StringBuilder strBuilder = new StringBuilder();
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("	        	ORG     	$8000\n");
		strBuilder.append("MyBanch		LBLO		Jump		; Jump=10250080\n");
	...
	/**
	 * Check LBLO positive limit jump
	 */
	@Test 
	public void testSimpleLBLOWithPositiveLimitJump1() {
		StringBuilder strBuilder = new StringBuilder();
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("	        	ORG     	$0000\n");
		strBuilder.append("MyBranch		LBLO		Jump		; Jump=10257FFF\n");
		strBuilder.append("				ORG     	$8003\n");
		strBuilder.append("Jump			RTS			\n");
	 ...
	 */
	@Test 
	public void testSimpleLBLOWithPositiveLimitJump2() {
		StringBuilder strBuilder = new StringBuilder();
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("	        	ORG     	$0000\n");
		strBuilder.append("MyBanch		LBLO		Jump		; Jump=10258000\n");
		strBuilder.append("				ORG     	$8004\n");
		strBuilder.append("Jump			RTS			\n");
	...
	/**
	 * Check LBLO negative limit jump
	 */
	@Test 
	public void testSimpleLBLOWithNegativeLimitJump1() {
		StringBuilder strBuilder = new StringBuilder();
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("				ORG			$0004\n");
		strBuilder.append("JUMP			RTS					\n");
		strBuilder.append("				ORG			$8000		;\n");
		strBuilder.append("VVV			LBLO		JUMP		;		\n");
	 ...
	 */
	@Test 
	public void testSimpleLBLOWithNegativeLimitJump2() {
		StringBuilder strBuilder = new StringBuilder();
		strBuilder.append("; -----------------------------------------\n");
