...
public class TestLBGTInstruction {
	...
	public void testSimpleLBGTWithExtraSpace() {
		...
		try {
			...
			Assert.assertTrue("Must be an LBGT directive line", instructionLine.getInstruction() instanceof BgtInstruction);
		} catch (Exception e) {
	 ...
	 */
	@Test 
	public void testSimpleLBGTWithDuplicateLabel() {
		StringBuilder strBuilder = new StringBuilder();
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("	        ORG     $8000\n");
		strBuilder.append("Jump	    LDA		#25\n");
		strBuilder.append("			NOP\n");
		strBuilder.append("Jump		LBGT		Jump		; Jump=3FFF\n");
	 ...
	 */
	@Test 
	public void testSimpleLBGTWithBadLabel() {
		StringBuilder strBuilder = new StringBuilder();
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("	        ORG    	 	$8000\n");
		strBuilder.append("Jump1	LDA			#25\n");
		strBuilder.append("			NOP\n");
		strBuilder.append("Jump		LBGT		Jump2		; Jump=3FFF\n");
		...
		try {
			...
			Assert.assertNotNull(result);
			Assert.assertTrue("No errors found", result.eResource().getErrors().isEmpty());
			validationHelper.assertError(result,AssemblerPackage.eINSTANCE.getBgtInstruction(),
	 ...
	 */
	@Test 
	public void testSimpleLBGTWithWithLabel() {
		StringBuilder strBuilder = new StringBuilder();
		strBuilder.append("	        	ORG     	$8000\n");
		strBuilder.append("Jump	    	ASLA\n");
		strBuilder.append("				ASLB\n");
		strBuilder.append("MyBanch		LBGT		Jump\n");
	 ...
	 */
	@Test 
	public void testSimpleLBGTWithNegativeJump1() {
		StringBuilder strBuilder = new StringBuilder();
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("	        	ORG     $8004\n");
		strBuilder.append("Jump	    	LDA		#25\n");
		strBuilder.append("	        	ORG     $8080\n");
		strBuilder.append("MyBanch		LBGT	Jump		; Jump=102EFF80\n");
		...
		try {
			...
			validationHelper.assertWarning(result,
				AssemblerPackage.eINSTANCE.getBgtInstruction(),
			...
			AssembledLBGTInstruction line = (AssembledLBGTInstruction)engine.getAssembledLine(4);
			...
			Assert.assertEquals("Check opcode value", 0x2E, line.getOpcode()[1]);
	 ...
	 */
	@Test 
	public void testSimpleLBGTWithNegativeJump2() {
		StringBuilder strBuilder = new StringBuilder();
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("	        	ORG     $8003\n");
		strBuilder.append("Jump	    	LDA		#25\n");
		strBuilder.append("	       	 	ORG     $8080\n");
		strBuilder.append("MyBanch		LBGT	Jump		; Jump=102EFF7F\n");
	 ...
	 */
	@Test 
	public void testSimpleLBGTWithPositiveJump1() {
		StringBuilder strBuilder = new StringBuilder();
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("	        	ORG     	$8000\n");
		strBuilder.append("MyBanch		LBGT		Jump		; Jump=102E007F\n");
		...
		try {
			...
			AssembledLBGTInstruction line = (AssembledLBGTInstruction)engine.getAssembledLine(2);
			Assert.assertEquals("Check opcode length", 2, line.getOpcode().length);
			Assert.assertEquals("Check opcode value", 0x10, line.getOpcode()[0]);
			Assert.assertEquals("Check opcode value", 0x2E, line.getOpcode()[1]);
			Assert.assertEquals("Check operand length", 2, line.getOperand().length);
	 ...
	 */
	@Test 
	public void testSimpleLBGTWithPositiveJump2() {
		StringBuilder strBuilder = new StringBuilder();
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("	        	ORG     	$8000\n");
		strBuilder.append("MyBanch		LBGT		Jump		; Jump=102E0080\n");
	 ...
	 */
	@Test 
	public void testSimpleLBGTWithPositiveLimitJump1() {
		StringBuilder strBuilder = new StringBuilder();
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("	        	ORG     	$0000\n");
		strBuilder.append("MyBranch		LBGT		Jump		; Jump=102E7FFF\n");
		strBuilder.append("				ORG     	$8003\n");
		strBuilder.append("Jump			RTS			\n");
		...
		try {
			...
			Assert.assertEquals("Check comment", "; Jump=102E7FFF", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception detected", true);
		}
	}
	 ...
	 */
	@Test 
	public void testSimpleLBGTWithPositiveLimitJump2() {
		StringBuilder strBuilder = new StringBuilder();
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("	        	ORG     	$0000\n");
		strBuilder.append("MyBanch		LBGT		Jump		; Jump=102E8000\n");
		strBuilder.append("				ORG     	$8004\n");
		strBuilder.append("Jump			RTS			\n");
	 ...
	 */
	@Test 
	public void testSimpleLBGTWithNegativeLimitJump1() {
		StringBuilder strBuilder = new StringBuilder();
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("				ORG			$0004\n");
		strBuilder.append("JUMP			RTS					\n");
		strBuilder.append("				ORG			$8000		;\n");
		strBuilder.append("VVV			LBGT		JUMP		;		\n");
	 ...
	 */
	@Test 
	public void testSimpleLBGTWithNegativeLimitJump2() {
		StringBuilder strBuilder = new StringBuilder();
		strBuilder.append("; -----------------------------------------\n");
