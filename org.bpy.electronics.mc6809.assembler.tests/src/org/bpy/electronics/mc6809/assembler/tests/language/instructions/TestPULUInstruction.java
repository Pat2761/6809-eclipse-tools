...
public class TestPULUInstruction {
	...
	public void testPULUImemdiatAddressingMode2() {
		...
		strBuilder.append("	       		PULU		  	#Registers\n");
		...
		try {
			...
			Assert.assertTrue("Must be an PULU instruction line", instructionLine.getInstruction() instanceof PuluInstruction);
	...
	public void testPULUImemdiate1() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("	       ORG    		$8000\n");
		strBuilder.append("	       PULU		  	PC,S,Y,X,DP,B,A,CC\n");
		...
		try {
			...
			PuluInstruction phshInstruction = (PuluInstruction)instructionLine.getInstruction();
			assertEquals("Must be an PULU instruction", phshInstruction.getInstruction(),"PULU");
		} catch (Exception e) {
			Assert.assertTrue("Exception detected", true);
		}
	}
	...
	public void testPULUMissingReg() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("	       		ORG    		$8000\n");
		strBuilder.append("Pshs       	PULU		#RegDir       ; push register\n");
	...
	public void testInstructionWithAAndDRegister() {
		StringBuilder strBuilder = new StringBuilder();
		strBuilder.append("; test PULU without label\n");
		strBuilder.append("	 	    PULU    	A,D 		 ; Oups\n");
		...
		try {
			...
			Assert.assertNotNull(result);
			Assert.assertTrue("No errors found", result.eResource().getErrors().isEmpty());
			validationHelper.assertError(result,AssemblerPackage.eINSTANCE.getPuluInstruction(),
	...
	public void testInstructionWithBAndDRegister() {
		...
		strBuilder.append("	 	    PULU    	B,D 		 ; Oups\n");
	...
	public void testInstructionWithDuplicateLabel() {
		...
		strBuilder.append("Lab1	 	PULU    	B,A 		 ; Oups\n");
	...
	public void testInstructionOperandCC() {
		StringBuilder strBuilder = new StringBuilder();
		strBuilder.append("; test REG without label\n");
		strBuilder.append("	 	    PULU   CC 		 ; Oups\n");
	...
	public void testInstructionOperandDP() {
		StringBuilder strBuilder = new StringBuilder();
		strBuilder.append("; test REG without label\n");
		strBuilder.append("	 	    PULU   DP 		 ; Oups\n");
	...
	public void testInstructionOperandRegS() {
		...
		strBuilder.append("	 	    	PULU   	#REG_S 		 ; Oups\n");
	...
	public void testInstructionOperandPC() {
		StringBuilder strBuilder = new StringBuilder();
		strBuilder.append("; test REG without label\n");
		strBuilder.append("	 	    PULU   PC 		 ; Oups\n");
