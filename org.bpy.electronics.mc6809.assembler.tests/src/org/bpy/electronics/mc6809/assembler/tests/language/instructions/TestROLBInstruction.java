...
public class TestROLBInstruction {
	...
	public void testSimpleROLBWithExtraSpaceWithComment() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("	       ORG    	$8000\n");
		strBuilder.append("	       ROLB  			; It is a comment \n");
	...
	public void testROLBAssembly() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("		   		ORG    			$8000\n");
		strBuilder.append("Start      	ROLB		  		    ; 59   ROLB\n");
		...
		try {
			...
			AssembledROLBInstruction line = (AssembledROLBInstruction)engine.getAssembledLine(2);
