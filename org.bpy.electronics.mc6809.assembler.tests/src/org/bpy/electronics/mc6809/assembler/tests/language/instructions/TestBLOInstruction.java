...
public class TestBLOInstruction {
	...
	public void testSimpleBLOWithExtraSpace() {
		...
		try {
			...
			Assert.assertTrue("Must be an BLO directive line", instructionLine.getInstruction() instanceof BloInstruction);
		} catch (Exception e) {
	...
	public void testSimpleBLOWithWithLabel() {
		...
		strBuilder.append("Jump	    	ASLA\n");
		strBuilder.append("				ASLB\n");
		strBuilder.append("MyBanch		BLO		Jump\n");
	...
	public void testSimpleBLOWithDuplicateLabel() {
		...
		strBuilder.append("Jump		BLO		Jump		; Jump=3FFF\n");
	...
	public void testSimpleBLOWithBadLabel() {
		...
		strBuilder.append("				NOP\n");
		strBuilder.append("Jump			BLO		Jump2		; Jump=3FFF\n");
	...
	public void testSimpleBLOWithNegativeJump() {
		...
		strBuilder.append("Jump	    	LDA		#25\n");
		strBuilder.append("				NOP\n");
		strBuilder.append("MyBanch		BLO		Jump		; Jump=24FB\n");
		...
		try {
			...
			AssembledBLOInstruction line = (AssembledBLOInstruction)engine.getAssembledLine(4); 
	...
	public void testSimpleBLOWithPositiveJump() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("	        	ORG     $8000\n");
		strBuilder.append("MyBanch		BLO		Jump		; Jump=2401\n");
		strBuilder.append("				NOP\n");
		...
		try {
			...
			AssembledBLOInstruction line = (AssembledBLOInstruction)engine.getAssembledLine(2); 
			Assert.assertEquals("Check opcode length", 1, line.getOpcode().length);
			Assert.assertEquals("Check opcode value", 0x25, line.getOpcode()[0]);
			Assert.assertEquals("Check operand length", 1, line.getOperand().length);
	...
	public void testSimpleBLOWithPositiveLimitJump1() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("	    	    ORG     $8000\n");
		strBuilder.append("MyBanch		BLO		Jump		; Jump=247F\n");
	...
	public void testSimpleBLOWithNegativeLimitJump1() {
		...
		strBuilder.append("VVV			BLO		JUMP		;		\n");
