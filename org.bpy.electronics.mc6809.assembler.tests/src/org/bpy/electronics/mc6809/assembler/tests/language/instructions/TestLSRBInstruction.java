...
public class TestLSRBInstruction {
	...
	public void testSimpleLSRBWithExtraSpaceWithComment() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("	       ORG    	$8000\n");
		strBuilder.append("	       LSRB  			; It is a comment \n");
	...
	public void testLSRBAssembly() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("		   		ORG    			$8000\n");
		strBuilder.append("Start      	LSRB		  		    ; 54   LSRB\n");
		...
		try {
			...
			AssembledLSRBInstruction line = (AssembledLSRBInstruction)engine.getAssembledLine(2);
