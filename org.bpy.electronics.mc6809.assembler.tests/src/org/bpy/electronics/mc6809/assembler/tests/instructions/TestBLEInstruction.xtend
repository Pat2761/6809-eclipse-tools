...
class TestBLEInstruction {
	 ...
	 */
	@Test 
	def void testSimpleBLEWithExtraSpace() {
		...
		Assert.assertTrue("Must be an BLE directive line", instructionLine.instruction instanceof BleInstruction)
	}
	 ...
	 */
	@Test 
	def void testSimpleBLEWithoutExtraSpace() {
		val result = parseHelper.parse('''
		; -----------------------------------------
			        ORG     $8000
		Jump	    ASLA
	 ...
	 */
	@Test 
	def void testSimpleBLEWithWithLabel() {
		val result = parseHelper.parse('''
		; -----------------------------------------
			        ORG     $8000
		Jump	    ASLA
	 ...
	 */
	@Test 
	def void testSimpleBLEWithDuplicateLabel() {
		val result = parseHelper.parse('''
		; -----------------------------------------
			        ORG     $8000
		Jump	    LDA		#25
					NOP
		Jump		BLE		Jump		; Jump=3FFF
		''')
		Assert.assertNotNull(result)
	 ...
	 */
	@Test 
	def void testSimpleBLEWithBadLabel() {
		val result = parseHelper.parse('''
		; -----------------------------------------
			        ORG     $8000
		Jump1	    LDA		#25
					NOP
		Jump		BLE		Jump2		; Jump=3FFF
		''')
		Assert.assertNotNull(result)
	 ...
	 */
	@Test 
	def void testSimpleBLEWithNegativeJump() {
		val result = parseHelper.parse('''
		; -----------------------------------------
			        ORG     $8000
		Jump	    LDA		#25
		...
		val line = engine.getAssembledLine(4) as AssembledBLEInstruction
		Assert.assertEquals("Check opcode length", 1, line.opcode.length)
		Assert.assertEquals("Check opcode value", 0x2F, line.opcode.get(0))
	 ...
	 */
	@Test 
	def void testSimpleBLEWithPositiveJump() {
		val result = parseHelper.parse('''
		; -----------------------------------------
			        ORG     $8000
		MyBanch		BLE		Jump		; 
		...
		val line = engine.getAssembledLine(2) as AssembledBLEInstruction
		Assert.assertEquals("Check opcode length", 1, line.opcode.length)
		Assert.assertEquals("Check opcode value", 0x2F, line.opcode.get(0))
		Assert.assertEquals("Check operand length", 1, line.operand.length)
	 ...
	 */
	@Test 
	def void testSimpleBLEWithPositiveLimitJump1() {
		val result = parseHelper.parse('''
		; -----------------------------------------
			        ORG     $8000
		MyBanch		BLE		Jump		; 
	 ...
	 */
	@Test 
	def void testSimpleBLEWithPositiveLimitJump2() {
		val result = parseHelper.parse('''
		; -----------------------------------------
			        ORG     $8000
		MyBanch		BLE		Jump		; 
	 ...
	 */
	@Test 
	def void testSimpleBLEWithNegativeLimitJump1() {
		val result = parseHelper.parse('''
		; -----------------------------------------
					ORG		$8002
		JUMP		RTS					
	 ...
	 */
	@Test 
	def void testSimpleBLEWithNegativeLimitJump2() {
		val result = parseHelper.parse('''
		; -----------------------------------------
					ORG		$8001
		JUMP		RTS					
