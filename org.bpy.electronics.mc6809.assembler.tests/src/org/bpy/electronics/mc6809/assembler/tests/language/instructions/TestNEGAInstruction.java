...
public class TestNEGAInstruction {
	...
	public void testSimpleNEGAWithExtraSpaceWithComment() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("	       ORG    	$8000\n");
		strBuilder.append("	       NEGA  			; It is a comment \n");
	...
	public void testNEGAAssembly() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("		   		ORG    			$8000\n");
		strBuilder.append("Start      	NEGA		  		    ; 40   NEGA\n");
		...
		try {
			...
			AssembledNEGAInstruction line = (AssembledNEGAInstruction)engine.getAssembledLine(2);
