...
public class TestSUBDInstruction {
	...
	public void testSUBDImemdiatAddressingMode() {
		...
		try {
			...
			Assert.assertTrue("Must be an ADD directive line", instructionLine.getInstruction() instanceof SubdInstruction);

			SubdInstruction adcInstruction = (SubdInstruction) instructionLine.getInstruction();
			assertEquals("Must be an SUBD instruction", adcInstruction.getInstruction(), "SUBD");
	...
	public void testSUBDExtendedAddressingMode1() {
		...
		try {
			...
			InstructionLine instructionLine = (InstructionLine) line.getLineContent();
			Assert.assertTrue("Must be an SUBD directive line", instructionLine.getInstruction() instanceof SubdInstruction);
	...
	public void testSUBDConstantOffsetIndexed() {
		...
		strBuilder.append("	      SUBD		  	Const,X\n");
		strBuilder.append("			SUBD		  	,X\n");
		strBuilder.append("			SUBD		  	$9,U\n");
		strBuilder.append("			SUBD		  	$9,S\n");
		strBuilder.append("			SUBD		  	$9,X\n");
		strBuilder.append("			SUBD		  	$9,Y\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testSUBDAccumulatorIndexed() {
		...
		strBuilder.append("	      ORG  			$8000\n");
		strBuilder.append("Const	EQU        	5    \n");
		strBuilder.append("	      SUBD		  	A,X\n");
		strBuilder.append("			SUBD		  	B,X\n");
		strBuilder.append("			SUBD		  	D,U\n");
		strBuilder.append("			SUBD		  	A,S\n");
		strBuilder.append("			SUBD		  	B,X\n");
		strBuilder.append("			SUBD		  	D,Y\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testSUBDAutoIncrementIndexed() {
		...
		strBuilder.append("	       	SUBD		  	,X+\n");
		strBuilder.append("	       	SUBD		  	,X++\n");
		strBuilder.append("	       	SUBD		  	,--S\n");
		strBuilder.append("	       	SUBD		  	,-S\n");
		strBuilder.append("	       	SUBD		  	,U+\n");
		strBuilder.append("	       	SUBD		  	,U++\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testSUBDWithDuplicateLabel() {
		...
		strBuilder.append("Start      	SUBD		  	#Const+2\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testSUBDImmediatInstruction1() {
		...
		strBuilder.append("		    		ORG   		$8000\n");
		strBuilder.append("Const	   	EQU       	5\n");
		strBuilder.append("Start      	SUBD		  	#Const+2  ; 8000   83 00 07        START:    SUBD\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			AssembledSUBDInstruction line = (AssembledSUBDInstruction) engine.getAssembledLine(3);
			Assert.assertEquals("Check getOpcode() size ", 1, line.getOpcode().length);
			Assert.assertEquals("Check getOpcode()", 0x83, line.getOpcode()[0]);
			...
			Assert.assertEquals("Check comment", "; 8000   83 00 07        START:    SUBD", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", true);
		}
	}
	...
	public void testSUBDImmediatInstruction2() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("		   		ORG    		$8000\n");
		strBuilder.append("Start      	SUBD		  	#-32769\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());

			Assert.assertNotNull(result);
			Assert.assertTrue("No errors found", result.eResource().getErrors().isEmpty());
			validationTestHelper.assertError(result, AssemblerPackage.eINSTANCE.getSubdInstruction(), InstructionValidator.OVERFLOW_ERROR,
	...
	public void testSUBDImmediatInstruction3() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("		   		ORG    			$8000\n");
		strBuilder.append("Start      	SUBD		  	#-128\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testSUBDImmediatInstruction4() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("		   		ORG    		$8000\n");
		strBuilder.append("Start      	SUBD		  	#127\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testSUBDImmediatInstruction5() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("		   		ORG    		$8000\n");
		strBuilder.append("Start      	SUBD		  	#65535\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	 ...
	 */
	@Test
	public void testSUBDImmediatInstruction6() {
		StringBuilder strBuilder = new StringBuilder();
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("		   		ORG    		$8000\n");
		strBuilder.append("Start      	SUBD		  	#65536\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testSUBDDirectInstruction1() {
		...
		strBuilder.append("		   		ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	SUBD		  	<Const*2  ; 8000   93 0A        START:    SUBD   <Const*2 \n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			AssembledSUBDInstruction line = (AssembledSUBDInstruction) engine.getAssembledLine(3);
			Assert.assertEquals("Check getOpcode() size ", 1, line.getOpcode().length);
			Assert.assertEquals("Check getOpcode()", 0x93, line.getOpcode()[0]);
	...
	public void testSUBDDirectInstruction2() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("		   		ORG    			$8000\n");
		strBuilder.append("Start      	SUBD		  	<-129\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testSUBDExtendedInstruction1() {
		...
		strBuilder.append("		   		ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	SUBD		  	>Const*1000  ; 8000   B3 13 88     START:    SUBD   >Const*1000 \n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			AssembledSUBDInstruction line = (AssembledSUBDInstruction) engine.getAssembledLine(3);
			Assert.assertEquals("Check getOpcode() size ", 1, line.getOpcode().length);
			Assert.assertEquals("Check getOpcode()", 0xB3, line.getOpcode()[0]);
			Assert.assertEquals("Check operand size ", 2, line.getOperand().length);
	...
	public void testSUBDExtendedInstruction3() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("		   		ORG    			$8000\n");
		strBuilder.append("Start      	SUBD		  	>-32768\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testSUBDExtendedIndirectInstruction1() {
		...
		strBuilder.append("		   		ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	SUBD		  	[Const*1000]  ; 8000   AB 9F 13 88  START:    SUBD   [Const*1000]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check getOpcode()", 0xA3, line.getOpcode()[0]);
	...
	public void testSUBDIndexedAccumulatorMovingMode1() {
		...
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	SUBD		  	A,X  ; 8000   AB 86        START:    SUBD   A,X\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testSUBDIndexedAccumulatorMovingMode2() {
		...
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	SUBD		  	A,Y  ; 8000   	A3 A6        START:    SUBD   A,Y\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testSUBDIndexedAccumulatorMovingMode3() {
		...
		strBuilder.append("		   	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	SUBD		  	A,U  ; 8000   	A3 C6        START:    SUBD   A,U\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testSUBDIndexedAccumulatorMovingMode4() {
		...
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	SUBD		  	A,S  ; 8000   	A3 E6        START:    SUBD   A,S\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testSUBDIndexedAccumulatorMovingMode5() {
		...
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	SUBD		  	B,X  ; 8000   AB 85        START:    SUBD   B,X\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testSUBDIndexedAccumulatorMovingMode6() {
		...
		strBuilder.append("		   		ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	SUBD		  	B,Y  ; 8000   	A3 A5        START:    SUBD   B,Y\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testSUBDIndexedAccumulatorMovingMode7() {
		...
		strBuilder.append("		   		ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	SUBD		  	B,U  ; 8000   	A3 C5        START:    SUBD   B,U\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testSUBDIndexedAccumulatorMovingMode8() {
		...
		strBuilder.append("		   		ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	SUBD		  	B,S  ; 8000   	A3 E5        START:    SUBD   B,S\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testSUBDIndexedAccumulatorMovingMode9() {
		...
		strBuilder.append("		   		ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	SUBD		  	D,X  ; 8000   AB 8B        START:    SUBD   D,X\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testSUBDIndexedAccumulatorMovingMode10() {
		...
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	SUBD		  	D,Y  ; 8000   	A3 AB        START:    SUBD   D,Y\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testSUBDIndexedAccumulatorMovingMode11() {
		...
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	SUBD		  	D,U  ; 8000   	A3 CB        START:    SUBD   D,U\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testSUBDIndexedAccumulatorMovingMode12() {
		...
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	SUBD		  	D,S  ; 8000   	A3 EB        START:    SUBD   D,S\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testSUBDIndexedIndorectAccumulatorMovingMode1() {
		...
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	SUBD		  	[A,X]  ; 8000   AB 96        START:    SUBD   [A,X]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testSUBDIndexedIndirectAccumulatorMovingMode2() {
		...
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	SUBD		  	[A,Y]  ; 8000   	A3 B6        START:    SUBD   [A,Y]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testSUBDIndexedIndirectAccumulatorMovingMode3() {
		...
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	SUBD		  	[A,U]  ; 8000   	A3 D6        START:    SUBD   [A,U]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testSUBDIndexedIndirectAccumulatorMovingMode4() {
		...
		strBuilder.append("		   		ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	SUBD		  	[A,S]  ; 8000   	A3 F6        START:    SUBD   [A,S]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testSUBDIndexedIndirectAccumulatorMovingMode5() {
		...
		strBuilder.append("		   		ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	SUBD		  	[B,X]  ; 8000   AB 95        START:    SUBD   [B,X]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testSUBDIndexedIndirectAccumulatorMovingMode6() {
		...
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	SUBD		  	[B,Y]  ; 8000   	A3 B5        START:    SUBD   [B,Y]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testSUBDIndexedIndirectAccumulatorMovingMode7() {
		...
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	SUBD		  	[B,U]  ; 8000   	A3 D5        START:    SUBD   [B,U]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testSUBDIndexedIndirectAccumulatorMovingMode8() {
		...
		strBuilder.append("		   		ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	SUBD		  	[B,S]  ; 8000   	A3 F5        START:    SUBD   [B,S]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testSUBDIndexedIndirectAccumulatorMovingMode9() {
		...
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	SUBD		  	[D,X]  ; 8000   AB 9B        START:    SUBD   [D,X]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testSUBDIndexedIndirectAccumulatorMovingMode10() {
		...
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	SUBD		  	[D,Y]  ; 8000   	A3 BB        START:    SUBD   [D,Y]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testSUBDIndexedIndirectAccumulatorMovingMode11() {
		...
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	SUBD		  	[D,U]  ; 8000   	A3 DB        START:    SUBD   [D,U]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testSUBDIndexedIndirectAccumulatorMovingMode12() {
		...
		strBuilder.append("		  	 	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	SUBD		  	[D,S]  ; 8000   	A3 FB        START:    SUBD   [D,S]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testSUBDIndexedAutoIncrementDecrementMode1() {
		...
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	SUBD		  	,X+  ; 8000   	A3 80        START:    SUBD   ,X+\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testSUBDIndexedAutoIncrementDecrementMode2() {
		...
		strBuilder.append("		   		ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	SUBD		  	,X++  ; 8000   	A3 81        START:    SUBD   ,X++\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testSUBDIndexedAutoIncrementDecrementMode3() {
		...
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	SUBD		  	,Y+  ; 8000   	A3 A0        START:    SUBD   ,Y+\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testSUBDIndexedAutoIncrementDecrementMode4() {
		...
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	SUBD		  	,Y++  ; 8000   	A3 A1        START:    SUBD   ,Y++\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testSUBDIndexedAutoIncrementDecrementMode5() {
		...
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	SUBD		  	,S+  ; 8000   	A3 E0        START:    SUBD   ,S+\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testSUBDIndexedAutoIncrementDecrementMode6() {
		...
		strBuilder.append("		  	 	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	SUBD		  	,S++  ; 8000   	A3 E1        START:    SUBD   ,S++\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testSUBDIndexedAutoIncrementDecrementMode7() {
		...
		strBuilder.append("		  	 	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	SUBD		  	,U+  ; 8000   	A3 C0        START:    SUBD   ,U+\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testSUBDIndexedAutoIncrementDecrementMode8() {
		...
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	SUBD		  	,U++  ; 8000   	A3 C1        START:    SUBD   ,U++\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testSUBDIndexedAutoIncrementDecrementMode9() {
		...
		strBuilder.append("		 	  	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	SUBD		  	,-X  ; 8000   	A3 82        START:    SUBD   ,-X\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testSUBDIndexedAutoIncrementDecrementMode10() {
		...
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	SUBD		  	,--X  ; 8000   	A3 83        START:    SUBD   ,--X\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testSUBDIndexedAutoIncrementDecrementMode11() {
		...
		strBuilder.append("		 	  	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	SUBD		  	,-Y  ; 8000   	A3 A2        START:    SUBD   ,-Y\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testSUBDIndexedAutoIncrementDecrementMode12() {
		...
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	SUBD		  	,--Y  ; 8000   	A3 A3        START:    SUBD   ,--Y\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testSUBDIndexedAutoIncrementDecrementMode13() {
		...
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	SUBD		  	,-S  ; 8000   	A3 E2        START:    SUBD   ,-S\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testSUBDIndexedAutoIncrementDecrementMode14() {
		...
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	SUBD		  	,--S  ; 8000   	A3 E3        START:    SUBD   ,--S\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testSUBDIndexedAutoIncrementDecrementMode15() {
		...
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	SUBD		  	,-U  ; 8000   	A3 C2        START:    SUBD   ,-U\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testSUBDIndexedAutoIncrementDecrementMode16() {
		...
		strBuilder.append("		   		ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	SUBD		  	,--U  ; 8000   	A3 C3        START:    SUBD   ,--U\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	/**
	 * Check Assembled SUBD Indexed Auto Increment Decrement Indirect Mode
	 * instruction
	 */
	@Test
	public void testSUBDIndexedAutoIncrementDecrementIndirectMode1() {
		...
		try {
			...
			Assert.assertNotNull(result);
			Assert.assertTrue("No errors found", result.eResource().getErrors().isEmpty());
			validationTestHelper.assertError(result, AssemblerPackage.eINSTANCE.getSubdInstruction(),
	...
	/**
	 * Check Assembled SUBD Indexed Auto Increment Decrement Mode indorect
	 * instruction
	 */
	@Test
	public void testSUBDIndexedAutoIncrementDecrementIndirectMode2() {
		...
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	SUBD		  	[,X++]  ; 8000   	A3 91        START:    SUBD   [,X++]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	/**
	 * Check Assembled SUBD Indexed Auto Increment Decrement Mode indirect
	 * instruction
	 */
	@Test
	...
	public void testSUBDIndexedAutoIncrementDecrementIndirectMode4() {
		...
		strBuilder.append("		   		ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	SUBD		  	[,Y++]  ; 8000   	A3 B1        START:    SUBD   [,Y++]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testSUBDIndexedAutoIncrementDecrementIndirectMode6() {
		...
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	SUBD		  	[,S++]  ; 8000   	A3 F1        START:    SUBD   [,S++]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testSUBDIndexedAutoIncrementDecrementindirectMode8() {
		...
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	SUBD		  	[,U++]  ; 8000   	A3 D1        START:    SUBD   [,U++]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testSUBDIndexedAutoIncrementDecrementIndirectMode10() {
		...
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	SUBD		  	[,--X]  ; 8000   	A3 93        START:    SUBD   [,--X]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testSUBDIndexedAutoIncrementDecrementIndirectMode12() {
		...
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	SUBD		  	[,--Y]  ; 8000   	A3 B3        START:    SUBD   [,--Y]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testSUBDIndexedAutoIncrementDecrementIndirectMode14() {
		...
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	SUBD		  	[,--S]  ; 8000   	A3 F3        START:    SUBD   [,--S]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testSUBDIndexedAutoIncrementDecrementIndirectMode16() {
		...
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	SUBD		  	[,--U]  ; 8000   	A3 D3        START:    SUBD   [,--U]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testSUBDIndexedConstantMove1() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("		 	  	ORG    			$8000\n");
		strBuilder.append("Start      	SUBD		  	1234,X  ; 8000   	A3 89 04 D2            SUBD   1234,X\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testSUBDIndexedConstantMove2() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	SUBD		  	1234,Y  ; 8000   	AB A9 04 D2            SUBD   1234,Y\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check operand", 0xD2, line.getOperand()[2]);
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	AB A9 04 D2            SUBD   1234,Y", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", true);
		}
	}
	...
	public void testSUBDIndexedConstantMove3() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	SUBD		  	1234,U  ; 8000   	A3 C9 04 D2            SUBD   1234,U\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testSUBDIndexedConstantMove4() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	SUBD		  	1234,S  ; 8000   	A3 E9 04 D2            SUBD   1234,S\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testSUBDIndexedConstantMove5() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	SUBD		  	34,X  ; 8000   	A3 88 22            SUBD   34,X\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testSUBDIndexedConstantMove6() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	SUBD		  	34,Y  ; 8000   	A3 A8 22            SUBD   34,Y\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testSUBDIndexedConstantMove7() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("		  	 	ORG    			$8000\n");
		strBuilder.append("Start      	SUBD		  	34,U  ; 8000   	A3 C8 22            SUBD   34,U\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testSUBDIndexedConstantMove8() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	SUBD		  	34,S  ; 8000   	A3 E8 22            SUBD   34,S\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testSUBDIndexedConstantMove9() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	SUBD		  	,X  ; 8000   	A3 84            SUBD   ,X\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testSUBDIndexedConstantMove10() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	SUBD		  	,Y  ; 8000   	A3 A4            SUBD   ,Y\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testSUBDIndexedConstantMove11() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	SUBD		  	,U  ; 8000   	A3 C4            SUBD   ,U\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testSUBDIndexedConstantMove12() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("		 	  	ORG    			$8000\n");
		strBuilder.append("Start      	SUBD		  	,S  ; 8000   	A3 E4            SUBD   ,S\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testSUBDIndexedConstantMove13() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	SUBD		  	0,X  ; 8000   	A3 84            SUBD   0,X\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testSUBDIndexedConstantMove14() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	SUBD		  	0,Y  ; 8000   	A3 A4            SUBD   0,Y\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testSUBDIndexedConstantMove15() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	SUBD		  	0,U  ; 8000   	A3 C4            SUBD   0,U\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testSUBDIndexedConstantMove16() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	SUBD		  	0,S  ; 8000   	A3 E4            SUBD   0,S\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testSUBDIndexedConstantMove17() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	SUBD		  	-16,X  ; 8000   	A3 10            SUBD   -16,X\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testSUBDIndexedConstantMove19() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	SUBD		  	1,X  ; 8000   	A3 01            SUBD   1,X\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testSUBDIndexedConstantMove20() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("		 	  	ORG    			$8000\n");
		strBuilder.append("Start      	SUBD		  	15,X  ; 8000   	A3 0F            SUBD   15,X\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testSUBDIndexedConstantMove21() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	SUBD		  	-16,Y  ; 8000   	A3 30            SUBD   -16,Y\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testSUBDIndexedConstantMove23() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	SUBD		  	1,Y  ; 8000   	A3 21            SUBD   1,Y\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testSUBDIndexedConstantMove24() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	SUBD		  	15,Y  ; 8000   	A3 2F            SUBD   15,Y\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testSUBDIndexedConstantMove25() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	SUBD		  	-16,U  ; 8000   	A3 50            SUBD   -16,U\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testSUBDIndexedConstantMove26() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	SUBD		  	1,U  ; 8000   	A3 41            SUBD   1,U\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testSUBDIndexedConstantMove27() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	SUBD		  	15,U  ; 8000   	A3 4F            SUBD   15,U\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testSUBDIndexedConstantMove28() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	SUBD		  	-16,S  ; 8000   	A3 70            SUBD   -16,S\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testSUBDIndexedConstantMove29() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	SUBD		  	1,S  ; 8000   	A3 61            SUBD   1,S\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testSUBDIndexedConstantMove30() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	SUBD		  	15,S  ; 8000   	A3 6F            SUBD   15,S\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testSUBDIndexedConstantMove31() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	SUBD		  	-128,X  ; 8000   	A3 88 80            SUBD   -128,X\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testSUBDIndexedConstantMove32() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("		 	  	ORG    			$8000\n");
		strBuilder.append("Start      	SUBD		  	127,X  ; 8000   	A3 88 7F            SUBD   127,X\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testSUBDIndexedConstantMove33() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	SUBD		  	-128,Y  ; 8000   	A3 A8 80            SUBD   -128,Y\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testSUBDIndexedConstantMove34() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("		 	  	ORG    			$8000\n");
		strBuilder.append("Start      	SUBD		  	127,Y  ; 8000   	A3 A8 7F            SUBD   127,Y\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testSUBDIndexedConstantMove35() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	SUBD		  	-128,U  ; 8000   	A3 C8 80            SUBD   -128,U\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testSUBDIndexedConstantMove36() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("		  	 	ORG    			$8000\n");
		strBuilder.append("Start      	SUBD		  	127,U  ; 8000   	A3 C8 7F            SUBD   127,U\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testSUBDIndexedConstantMove37() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	SUBD		  	-128,S  ; 8000   	A3 E8 80            SUBD   -128,S\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testSUBDIndexedConstantMove38() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	SUBD		  	127,S  ; 8000   	A3 E8 7F            SUBD   127,S\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testSUBDIndexedConstantMove39() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	SUBD		  	-32768,X  ; 8000   	A3 89 80 00             SUBD   -32768,X\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testSUBDIndexedConstantMove40() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	SUBD		  32767,X  ; 8000   	A3 89 7F FF             SUBD   32767,X\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testSUBDIndexedConstantMove41() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	SUBD		  	-32768,Y  ; 8000   	AB A9 80 00             SUBD   -32768,Y\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check operand", 0x00, line.getOperand()[2]);
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	AB A9 80 00             SUBD   -32768,Y", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", true);
		}
	}
	...
	public void testSUBDIndexedConstantMove42() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	SUBD		  32767,Y  ; 8000   	AB A9 7F FF             SUBD   32767,Y\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check operand", 0xFF, line.getOperand()[2]);
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	AB A9 7F FF             SUBD   32767,Y", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", true);
		}
	}
	...
	public void testSUBDIndexedConstantMove43() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	SUBD		  	-32768,U  ; 8000   	A3 C9 80 00             SUBD   -32768,U\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testSUBDIndexedConstantMove44() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	SUBD		  32767,U  ; 8000   	A3 C9 7F FF             SUBD   32767,U\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testSUBDIndexedConstantMove45() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("		 	  	ORG    			$8000\n");
		strBuilder.append("Start      	SUBD		  	-32768,S  ; 8000   	A3 E9 80 00             SUBD   -32768,S\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testSUBDIndexedConstantMove46() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	SUBD		  32767,S  ; 8000   	A3 E9 7F FF             SUBD   32767,S\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testSUBDIndexedConstantMove47() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	SUBD		  	-32769,X  ; 8000   	A3 89 80 00             SUBD   -32769,X\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testSUBDIndexedConstantMove48() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	SUBD		  32768,X  ; 8000   	A3 89 7F FF             SUBD   32768,X\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testSUBDIndexedConstantMove49() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("		   		ORG    			$8000\n");
		strBuilder.append("Start      	SUBD		  	-32769,Y  ; 8000   	AB A9 80 00             SUBD   -32769,Y\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check operand", 0x00, line.getOperand()[2]);
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	AB A9 80 00             SUBD   -32769,Y", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", true);
		}
	}
	...
	public void testSUBDIndexedConstantMove50() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("		  	 	ORG    			$8000\n");
		strBuilder.append("Start      	SUBD		  32768,Y  ; 8000   	AB A9 7F FF             SUBD   32768,Y\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check operand", 0xFF, line.getOperand()[2]);
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	AB A9 7F FF             SUBD   32768,Y", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", true);
		}
	}
	...
	public void testSUBDIndexedConstantMove51() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("		 	  	ORG    			$8000\n");
		strBuilder.append("Start      	SUBD		  	-32769,U  ; 8000   	A3 C9 80 00             SUBD   -32769,U\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testSUBDIndexedConstantMove52() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	SUBD		  32768,U  ; 8000   	A3 C9 7F FF             SUBD   32768,U\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testSUBDIndexedConstantMove53() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	SUBD		  	-32769,S  ; 8000   	A3 E9 80 00             SUBD   -32769,S\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testSUBDIndexedConstantMove54() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	SUBD		  32768,S  ; 8000   	A3 E9 7F FF             SUBD   32768,S\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testSUBDIndexedConstantIndirectMove1() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	SUBD		  	[1234,X]  ; 8000   	A3 99 04 D2            SUBD   [1234,X]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testSUBDIndexedConstantIndirectMove2() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	SUBD		  	[1234,Y]  ; 8000   	A3 B9 04 D2            SUBD   [1234,Y]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testSUBDIndexedConstantIndirectMove3() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("		 	  	ORG    			$8000\n");
		strBuilder.append("Start      	SUBD		  	[1234,U]  ; 8000   	A3 D9 04 D2            SUBD   [1234,U]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testSUBDIndexedConstantIndirectMove4() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	SUBD		  	[1234,S]  ; 8000   	A3 F9 04 D2            SUBD   [1234,S]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testSUBDIndexedConstantIndirectMove5() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	SUBD		  	[34,X]  ; 8000   	A3 98 22            SUBD   [34,X]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testSUBDIndexedConstantIndirectMove6() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	SUBD		  	[34,Y]  ; 8000   	A3 B8 22            SUBD   [34,Y]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testSUBDIndexedConstantIndirectMove7() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	SUBD		  	[34,U]  ; 8000   	A3 D8 22            SUBD   [34,U]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testSUBDIndexedConstantIndirectMove8() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	SUBD		  	[34,S]  ; 8000   	A3 F8 22            SUBD   [34,S]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testSUBDIndexedConstantIndirectMove9() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	SUBD		  	[,X]  ; 8000   	A3 94            SUBD   [,X]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testSUBDIndexedConstantIndirectMove10() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("		 	  	ORG    			$8000\n");
		strBuilder.append("Start      	SUBD		  	[,Y]  ; 8000   	A3 B4            SUBD   [,Y]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testSUBDIndexedConstantIndirectMove11() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	SUBD		  	[,U]  ; 8000   	A3 D4            SUBD   [,U]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testSUBDIndexedConstantIndirectMove12() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	SUBD		  	[,S]  ; 8000   	A3 F4            SUBD   [,S]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testSUBDIndexedConstantIndirectMove13() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	SUBD		  	[0,X]  ; 8000   	A3 94            SUBD   [0,X]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testSUBDIndexedConstantIndirectMove14() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	SUBD		  	[0,Y]  ; 8000   	A3 B4            SUBD   [0,Y]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testSUBDIndexedConstantIndirectMove15() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	SUBD		  	[0,U]  ; 8000   	A3 D4            SUBD   [0,U]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testSUBDIndexedConstantIndirectMove16() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	SUBD		  	[0,S]  ; 8000   	A3 F4            SUBD   [0,S]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testSUBDIndexedConstantIndirectMove17() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	SUBD		  	[-16,X]  ; 8000   	A3 98 F0            SUBD   [-16,X]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testSUBDIndexedConstantIndirectMove18() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	SUBD		  	[15,X]  ; 8000   	A3 98 0F            SUBD   [15,X]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testSUBDIndexedConstantIndirectMove19() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	SUBD		  	[-16,Y]  ; 8000   	A3 B8 F0            SUBD   [-16,Y]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testSUBDIndexedConstantIndirectMove20() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	SUBD		  	[15,Y]  ; 8000   	A3 B8 0F            SUBD   [15,Y]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testSUBDIndexedConstantIndirectMove21() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	SUBD		  	[-16,U]  ; 8000   	A3 D8 F0            SUBD   [-16,U]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testSUBDIndexedConstantIndirectMove22() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	SUBD		  	[15,U]  ; 8000   	A3 D8 0F            SUBD   [15,U]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testSUBDIndexedConstantIndirectMove23() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	SUBD		  	[-16,S]  ; 8000   	A3 F8 F0            SUBD   [-16,S]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testSUBDIndexedConstantIndirectMove24() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	SUBD		  	[15,S]  ; 8000   	A3 F8 0F            SUBD   [15,S]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testSUBDIndexedConstantIndirectMove31() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("		 	  	ORG    			$8000\n");
		strBuilder.append("Start      	SUBD		  	[-128,X]  ; 8000   	A3 98 80            SUBD   [-128,X}\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testSUBDIndexedConstantIndirectMove32() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	SUBD		  	[127,X]  ; 8000   	A3 98 7F            SUBD   [127,X]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testSUBDIndexedConstantIndirectMove33() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	SUBD		  	[-128,Y]  ; 8000   	A3 B8 80            SUBD   [-128,Y]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testSUBDIndexedConstantIndirectMove34() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("		 	  	ORG    			$8000\n");
		strBuilder.append("Start      	SUBD		  	[127,Y]  ; 8000   	A3 B8 7F            SUBD   [127,Y]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testSUBDIndexedConstantIndirectMove35() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	SUBD		  	[-128,U]  ; 8000   	A3 D8 80            SUBD   [-128,U]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testSUBDIndexedConstantIndirectMove36() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	SUBD		  	[127,U]  ; 8000   	A3 D8 7F            SUBD   [127,U]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testSUBDIndexedConstantIndirectMove37() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	SUBD		  	[-128,S]  ; 8000   	A3 F8 80            SUBD   [-128,S]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testSUBDIndexedConstantIndirectMove38() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	SUBD		  	[127,S]  ; 8000   	A3 F8 7F            SUBD   [127,S]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testSUBDIndexedConstantIndirectMove39() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	SUBD		  	[-32768,X]  ; 8000   	A3 99 80 00             SUBD   [-32768,X]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testSUBDIndexedConstantIndirectMove40() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	SUBD		  [32767,X]  ; 8000   	A3 99 7F FF             SUBD   [32767,X]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testSUBDIndexedConstantIndirectMove41() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	SUBD		  	[-32768,Y]  ; 8000   	A3 B9 80 00             SUBD   [-32768,Y]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testSUBDIndexedConstantIndirectMove42() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	SUBD		  [32767,Y]  ; 8000   	A3 B9 7F FF             SUBD   [32767,Y]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testSUBDIndexedConstantIndirectMove43() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	SUBD		  	[-32768,U]  ; 8000   	A3 D9 80 00             SUBD   [-32768,U]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testSUBDIndexedConstantIndirectMove44() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	SUBD		  [32767,U]  ; 8000   	A3 D9 7F FF             SUBD   [32767,U]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testSUBDIndexedConstantIndirectMove45() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("		   		ORG    			$8000\n");
		strBuilder.append("Start      	SUBD		  	[-32768,S]  ; 8000   	A3 F9 80 00             SUBD   [-32768,S]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testSUBDIndexedConstantIndirectMove46() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	SUBD		  [32767,S]  ; 8000   	A3 F9 7F FF             SUBD   [32767,S]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testSUBDIndexedConstantIndirectMove47() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("		 	  	ORG    			$8000\n");
		strBuilder.append("Start      	SUBD		  	[-32769,X]  ; 8000   	A3 99 80 00             SUBD   [-32769,X]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testSUBDIndexedConstantIndirectMove48() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	SUBD		  [32768,X]  ; 8000   	A3 99 7F FF             SUBD   [32768,X]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testSUBDIndexedConstantIndirectMove49() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("		 	  	ORG    			$8000\n");
		strBuilder.append("Start      	SUBD		  	[-32769,Y]  ; 8000   	A3 B9 80 00             SUBD   [-32769,Y]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testSUBDIndexedConstantIndirectMove50() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("		 	  	ORG    			$8000\n");
		strBuilder.append("Start      	SUBD		  [32768,Y]  ; 8000   	A3 B9 7F FF             SUBD   [32768,Y]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testSUBDIndexedConstantIndirectMove51() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	SUBD		  	[-32769,U]  ; 8000   	A3 D9 80 00             SUBD   [-32769,U]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testSUBDIndexedConstantIndirectMove52() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	SUBD		  [32768,U]  ; 8000   	A3 D9 7F FF             SUBD   [32768,U]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testSUBDIndexedConstantIndirectMove53() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	SUBD		  	[-32769,S]  ; 8000   	A3 F9 80 00             SUBD   [-32769,S]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testSUBDIndexedConstantIndirectMove54() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("		   		ORG    			$8000\n");
		strBuilder.append("Start      	SUBD		  [32768,S]  ; 8000   	A3 F9 7F FF             SUBD   [32768,S]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
