...
public class TestBHIInstruction {
	...
	public void testSimpleBHIWithExtraSpace() {
		...
		try {
			...
			Assert.assertTrue("Must be an BHI directive line", instructionLine.getInstruction() instanceof BhiInstruction);
		} catch (Exception e) {
	...
	public void testSimpleBHIWithWithLabel() {
		...
		strBuilder.append("Jump	    	ASLA\n");
		strBuilder.append("				ASLB\n");
		strBuilder.append("MyBanch		BHI		Jump\n");
	...
	public void testSimpleBHIWithDuplicateLabel() {
		...
		strBuilder.append("Jump		BHI		Jump		; Jump=3FFF\n");
	...
	public void testSimpleBHIWithBadLabel() {
		...
		strBuilder.append("				NOP\n");
		strBuilder.append("Jump			BHI		Jump2		; Jump=3FFF\n");
	...
	public void testSimpleBHIWithNegativeJump() {
		...
		strBuilder.append("Jump	    	LDA		#25\n");
		strBuilder.append("				NOP\n");
		strBuilder.append("MyBanch		BHI		Jump		; Jump=24FB\n");
		...
		try {
			...
			AssembledBHIInstruction line = (AssembledBHIInstruction)engine.getAssembledLine(4); 
	...
	public void testSimpleBHIWithPositiveJump() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("	        	ORG     $8000\n");
		strBuilder.append("MyBanch		BHI		Jump		; Jump=2401\n");
		strBuilder.append("				NOP\n");
		...
		try {
			...
			AssembledBHIInstruction line = (AssembledBHIInstruction)engine.getAssembledLine(2); 
			Assert.assertEquals("Check opcode length", 1, line.getOpcode().length);
			Assert.assertEquals("Check opcode value", 0x22, line.getOpcode()[0]);
			Assert.assertEquals("Check operand length", 1, line.getOperand().length);
	...
	public void testSimpleBHIWithPositiveLimitJump1() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("	    	    ORG     $8000\n");
		strBuilder.append("MyBanch		BHI		Jump		; Jump=247F\n");
	...
	public void testSimpleBHIWithNegativeLimitJump1() {
		...
		strBuilder.append("VVV			BHI		JUMP		;		\n");
