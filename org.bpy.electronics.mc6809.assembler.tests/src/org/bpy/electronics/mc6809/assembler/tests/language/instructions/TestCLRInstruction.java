...
public class TestCLRInstruction {
	 ...
	 */
	@Test
	public void testCLRImemdiatAddressingMode() {
		StringBuilder strBuilder = new StringBuilder();
		strBuilder.append("			ORG    		$8000\n");
		strBuilder.append("			CLR		#124\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());

			Assert.assertNotNull(result);
			Assert.assertTrue("No errors found", result.eResource().getErrors().isEmpty());
			validationHelper.assertError(result, AssemblerPackage.eINSTANCE.getClrInstruction(),
	...
	public void testCLRDirectAddressingMode() {
		...
		try {
			...
			Assert.assertTrue("Must be an ADD directive line", instructionLine.getInstruction() instanceof ClrInstruction);

			ClrInstruction adcInstruction = (ClrInstruction) instructionLine.getInstruction();
			assertEquals("Must be an CLR instruction", adcInstruction.getInstruction(), "CLR");
	...
	public void testCLRConstantOffsetIndexed() {
		...
		strBuilder.append("	      CLR		  	Const,X\n");
		strBuilder.append("			CLR		  	,X\n");
		strBuilder.append("			CLR		  	$9,U\n");
		strBuilder.append("			CLR		  	$9,S\n");
		strBuilder.append("			CLR		  	$9,X\n");
		strBuilder.append("			CLR		  	$9,Y\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testCLRAccumulatorIndexed() {
		...
		strBuilder.append("	      ORG  			$8000\n");
		strBuilder.append("Const	EQU        	5    \n");
		strBuilder.append("	      CLR		  	A,X\n");
		strBuilder.append("			CLR		  	B,X\n");
		strBuilder.append("			CLR		  	D,U\n");
		strBuilder.append("			CLR		  	A,S\n");
		strBuilder.append("			CLR		  	B,X\n");
		strBuilder.append("			CLR		  	D,Y\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testCLRAutoIncrementIndexed() {
		...
		strBuilder.append("	       	CLR		  	,X+\n");
		strBuilder.append("	       	CLR		  	,X++\n");
		strBuilder.append("	       	CLR		  	,--S\n");
		strBuilder.append("	       	CLR		  	,-S\n");
		strBuilder.append("	       	CLR		  	,U+\n");
		strBuilder.append("	       	CLR		  	,U++\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testCLRWithDuplicateLabel() {
		...
		strBuilder.append("Start      	CLR		  	#Const+2\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testCLRDirectInstruction1() {
		...
		strBuilder.append("		   		ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	CLR		  		<Const*2  ; 8000   0F 0A        START:    CLR   <Const*2 \n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			AssembledCLRInstruction line = (AssembledCLRInstruction) engine.getAssembledLine(3);
			Assert.assertEquals("Check getOpcode() size ", 1, line.getOpcode().length);
			Assert.assertEquals("Check getOpcode()", 0x0F, line.getOpcode()[0]);
	...
	public void testCLRDirectInstruction2() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("		   		ORG    			$8000\n");
		strBuilder.append("Start      	CLR		  	<-129\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testCLRDirectInstruction3() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("		   		ORG    			$8000\n");
		strBuilder.append("Start      	CLR		  	<-128\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testCLRDirectInstruction4() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("		   		ORG    			$8000\n");
		strBuilder.append("Start      	CLR		  	<127\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testCLRExtendedInstruction1() {
		...
		strBuilder.append("		   		ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	CLR		  	>Const*1000  ; 8000   7F 13 88     START:    CLR   >Const*1000 \n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			AssembledCLRInstruction line = (AssembledCLRInstruction) engine.getAssembledLine(3);
			Assert.assertEquals("Check getOpcode() size ", 1, line.getOpcode().length);
			Assert.assertEquals("Check getOpcode()", 0x7F, line.getOpcode()[0]);
	...
	public void testCLRExtendedInstruction2() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("		   		ORG    			$8000\n");
		strBuilder.append("Start      	CLR		  	>-32769\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testCLRExtendedInstruction3() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("		   		ORG    			$8000\n");
		strBuilder.append("Start      	CLR		  	>-32768\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testCLRExtendedInstruction4() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("		   		ORG    			$8000\n");
		strBuilder.append("Start      	CLR		  	>65535\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testCLRExtendedInstruction5() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("		   		ORG    			$8000\n");
		strBuilder.append("Start      	CLR		  	>65536\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
	...
	public void testCLRExtendedIndirectInstruction1() {
		...
		strBuilder.append("		   		ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	CLR		  	[Const*1000]  ; 8000   67 9F 13 88  START:    CLR   [Const*1000]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check getOpcode()", 0x6F, line.getOpcode()[0]);
			Assert.assertEquals("Check getOpcode()", 0x9F, line.getOpcode()[1]);
			Assert.assertEquals("Check operand size ", 2, line.getOperand().length);
			Assert.assertEquals("Check operand", 0x13, line.getOperand()[0]);
			Assert.assertEquals("Check operand", 0x88, line.getOperand()[1]);
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   67 9F 13 88  START:    CLR   [Const*1000]", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", false);
		}
	}
	...
	public void testCLRIndexedAccumulatorMovingMode1() {
		...
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	CLR		  	A,X  ; 8000   67 86        START:    CLR   A,X\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   67 86        START:    CLR   A,X", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", false);
		}
	}
	...
	public void testCLRIndexedAccumulatorMovingMode2() {
		...
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	CLR		  	A,Y  ; 8000   	68 A6        START:    CLR   A,Y\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 A6        START:    CLR   A,Y", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", false);
		}
	}
	...
	public void testCLRIndexedAccumulatorMovingMode3() {
		...
		strBuilder.append("		   	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	CLR		  	A,U  ; 8000   	68 C6        START:    CLR   A,U\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 C6        START:    CLR   A,U", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", false);
		}
	}
	...
	public void testCLRIndexedAccumulatorMovingMode4() {
		...
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	CLR		  	A,S  ; 8000   	68 E6        START:    CLR   A,S\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 E6        START:    CLR   A,S", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", false);
		}
	}
	...
	public void testCLRIndexedAccumulatorMovingMode5() {
		...
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	CLR		  	B,X  ; 8000   67 85        START:    CLR   B,X\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   67 85        START:    CLR   B,X", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", false);
		}
	}
	...
	public void testCLRIndexedAccumulatorMovingMode6() {
		...
		strBuilder.append("		   		ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	CLR		  	B,Y  ; 8000   	68 A5        START:    CLR   B,Y\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 A5        START:    CLR   B,Y", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", false);
		}
	}
	...
	public void testCLRIndexedAccumulatorMovingMode7() {
		...
		strBuilder.append("		   		ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	CLR		  	B,U  ; 8000   	68 C5        START:    CLR   B,U\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 C5        START:    CLR   B,U", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", false);
		}
	}
	...
	public void testCLRIndexedAccumulatorMovingMode8() {
		...
		strBuilder.append("		   		ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	CLR		  	B,S  ; 8000   	68 E5        START:    CLR   B,S\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 E5        START:    CLR   B,S", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", false);
		}
	}
	...
	public void testCLRIndexedAccumulatorMovingMode9() {
		...
		strBuilder.append("		   		ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	CLR		  	D,X  ; 8000   67 8B        START:    CLR   D,X\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   67 8B        START:    CLR   D,X", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", false);
		}
	}
	...
	public void testCLRIndexedAccumulatorMovingMode10() {
		...
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	CLR		  	D,Y  ; 8000   	68 AB        START:    CLR   D,Y\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 AB        START:    CLR   D,Y", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", false);
		}
	}
	...
	public void testCLRIndexedAccumulatorMovingMode11() {
		...
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	CLR		  	D,U  ; 8000   	68 CB        START:    CLR   D,U\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 CB        START:    CLR   D,U", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", false);
		}
	}
	...
	public void testCLRIndexedAccumulatorMovingMode12() {
		...
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	CLR		  	D,S  ; 8000   	68 EB        START:    CLR   D,S\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 EB        START:    CLR   D,S", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", false);
		}
	}
	...
	public void testCLRIndexedIndorectAccumulatorMovingMode1() {
		...
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	CLR		  	[A,X]  ; 8000   67 96        START:    CLR   [A,X]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   67 96        START:    CLR   [A,X]", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", false);
		}
	}
	...
	public void testCLRIndexedIndirectAccumulatorMovingMode2() {
		...
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	CLR		  	[A,Y]  ; 8000   	68 B6        START:    CLR   [A,Y]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 B6        START:    CLR   [A,Y]", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", false);
		}
	}
	...
	public void testCLRIndexedIndirectAccumulatorMovingMode3() {
		...
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	CLR		  	[A,U]  ; 8000   	68 D6        START:    CLR   [A,U]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 D6        START:    CLR   [A,U]", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", false);
		}
	}
	...
	public void testCLRIndexedIndirectAccumulatorMovingMode4() {
		...
		strBuilder.append("		   		ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	CLR		  	[A,S]  ; 8000   	68 F6        START:    CLR   [A,S]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 F6        START:    CLR   [A,S]", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", false);
		}
	}
	...
	public void testCLRIndexedIndirectAccumulatorMovingMode5() {
		...
		strBuilder.append("		   		ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	CLR		  	[B,X]  ; 8000   67 95        START:    CLR   [B,X]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   67 95        START:    CLR   [B,X]", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", false);
		}
	}
	...
	public void testCLRIndexedIndirectAccumulatorMovingMode6() {
		...
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	CLR		  	[B,Y]  ; 8000   	68 B5        START:    CLR   [B,Y]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 B5        START:    CLR   [B,Y]", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", false);
		}
	}
	...
	public void testCLRIndexedIndirectAccumulatorMovingMode7() {
		...
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	CLR		  	[B,U]  ; 8000   	68 D5        START:    CLR   [B,U]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 D5        START:    CLR   [B,U]", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", false);
		}
	}
	...
	public void testCLRIndexedIndirectAccumulatorMovingMode8() {
		...
		strBuilder.append("		   		ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	CLR		  	[B,S]  ; 8000   	68 F5        START:    CLR   [B,S]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 F5        START:    CLR   [B,S]", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", false);
		}
	}
	...
	public void testCLRIndexedIndirectAccumulatorMovingMode9() {
		...
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	CLR		  	[D,X]  ; 8000   67 9B        START:    CLR   [D,X]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   67 9B        START:    CLR   [D,X]", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", false);
		}
	}
	...
	public void testCLRIndexedIndirectAccumulatorMovingMode10() {
		...
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	CLR		  	[D,Y]  ; 8000   	68 BB        START:    CLR   [D,Y]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 BB        START:    CLR   [D,Y]", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", false);
		}
	}
	...
	public void testCLRIndexedIndirectAccumulatorMovingMode11() {
		...
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	CLR		  	[D,U]  ; 8000   	68 DB        START:    CLR   [D,U]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 DB        START:    CLR   [D,U]", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", false);
		}
	}
	...
	public void testCLRIndexedIndirectAccumulatorMovingMode12() {
		...
		strBuilder.append("		  	 	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	CLR		  	[D,S]  ; 8000   	68 FB        START:    CLR   [D,S]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 FB        START:    CLR   [D,S]", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", false);
		}
	}
	...
	public void testCLRIndexedAutoIncrementDecrementMode1() {
		...
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	CLR		  	,X+  ; 8000   	68 80        START:    CLR   ,X+\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check operand", 0x80, line.getOperand()[0]);
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 80        START:    CLR   ,X+", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", false);
		}
	}
	...
	public void testCLRIndexedAutoIncrementDecrementMode2() {
		...
		strBuilder.append("		   		ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	CLR		  	,X++  ; 8000   	68 81        START:    CLR   ,X++\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 81        START:    CLR   ,X++", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", false);
		}
	}
	...
	public void testCLRIndexedAutoIncrementDecrementMode3() {
		...
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	CLR		  	,Y+  ; 8000   	68 A0        START:    CLR   ,Y+\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 A0        START:    CLR   ,Y+", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", false);
		}
	}
	...
	public void testCLRIndexedAutoIncrementDecrementMode4() {
		...
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	CLR		  	,Y++  ; 8000   	68 A1        START:    CLR   ,Y++\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 A1        START:    CLR   ,Y++", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", false);
		}
	}
	...
	public void testCLRIndexedAutoIncrementDecrementMode5() {
		...
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	CLR		  	,S+  ; 8000   	68 E0        START:    CLR   ,S+\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 E0        START:    CLR   ,S+", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", false);
		}
	}
	...
	public void testCLRIndexedAutoIncrementDecrementMode6() {
		...
		strBuilder.append("		  	 	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	CLR		  	,S++  ; 8000   	68 E1        START:    CLR   ,S++\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 E1        START:    CLR   ,S++", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", false);
		}
	}
	...
	public void testCLRIndexedAutoIncrementDecrementMode7() {
		...
		strBuilder.append("		  	 	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	CLR		  	,U+  ; 8000   	68 C0        START:    CLR   ,U+\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 C0        START:    CLR   ,U+", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", false);
		}
	}
	...
	public void testCLRIndexedAutoIncrementDecrementMode8() {
		...
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	CLR		  	,U++  ; 8000   	68 C1        START:    CLR   ,U++\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 C1        START:    CLR   ,U++", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", false);
		}
	}
	...
	public void testCLRIndexedAutoIncrementDecrementMode9() {
		...
		strBuilder.append("		 	  	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	CLR		  	,-X  ; 8000   	68 82        START:    CLR   ,-X\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 82        START:    CLR   ,-X", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", false);
		}
	}
	...
	public void testCLRIndexedAutoIncrementDecrementMode10() {
		...
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	CLR		  	,--X  ; 8000   	68 83        START:    CLR   ,--X\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 83        START:    CLR   ,--X", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", false);
		}
	}
	...
	public void testCLRIndexedAutoIncrementDecrementMode11() {
		...
		strBuilder.append("		 	  	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	CLR		  	,-Y  ; 8000   	68 A2        START:    CLR   ,-Y\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 A2        START:    CLR   ,-Y", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", false);
		}
	}
	...
	public void testCLRIndexedAutoIncrementDecrementMode12() {
		...
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	CLR		  	,--Y  ; 8000   	68 A3        START:    CLR   ,--Y\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 A3        START:    CLR   ,--Y", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", false);
		}
	}
	...
	public void testCLRIndexedAutoIncrementDecrementMode13() {
		...
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	CLR		  	,-S  ; 8000   	68 E2        START:    CLR   ,-S\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 E2        START:    CLR   ,-S", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", false);
		}
	}
	...
	public void testCLRIndexedAutoIncrementDecrementMode14() {
		...
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	CLR		  	,--S  ; 8000   	68 E3        START:    CLR   ,--S\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 E3        START:    CLR   ,--S", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", false);
		}
	}
	...
	public void testCLRIndexedAutoIncrementDecrementMode15() {
		...
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	CLR		  	,-U  ; 8000   	68 C2        START:    CLR   ,-U\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 C2        START:    CLR   ,-U", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", false);
		}
	}
	...
	public void testCLRIndexedAutoIncrementDecrementMode16() {
		...
		strBuilder.append("		   		ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	CLR		  	,--U  ; 8000   	68 C3        START:    CLR   ,--U\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 C3        START:    CLR   ,--U", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", false);
		}
	}
	...
	/**
	 * Check Assembled CLR Indexed Auto Increment Decrement Indirect Mode
	 * instruction
	 */
	@Test
	...
	/**
	 * Check Assembled CLR Indexed Auto Increment Decrement Mode indorect
	 * instruction
	 */
	@Test
	public void testCLRIndexedAutoIncrementDecrementIndirectMode2() {
		...
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	CLR		  	[,X++]  ; 8000   	68 91        START:    CLR   [,X++]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 91        START:    CLR   [,X++]", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", false);
		}
	}
	...
	/**
	 * Check Assembled CLR Indexed Auto Increment Decrement Mode indirect
	 * instruction
	 */
	@Test
	...
	public void testCLRIndexedAutoIncrementDecrementIndirectMode4() {
		...
		strBuilder.append("		   		ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	CLR		  	[,Y++]  ; 8000   	68 B1        START:    CLR   [,Y++]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 B1        START:    CLR   [,Y++]", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", false);
		}
	}
	...
	public void testCLRIndexedAutoIncrementDecrementIndirectMode6() {
		...
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	CLR		  	[,S++]  ; 8000   	68 F1        START:    CLR   [,S++]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 F1        START:    CLR   [,S++]", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", false);
		}
	}
	...
	public void testCLRIndexedAutoIncrementDecrementindirectMode8() {
		...
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	CLR		  	[,U++]  ; 8000   	68 D1        START:    CLR   [,U++]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 D1        START:    CLR   [,U++]", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", false);
		}
	}
	...
	public void testCLRIndexedAutoIncrementDecrementIndirectMode10() {
		...
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	CLR		  	[,--X]  ; 8000   	68 93        START:    CLR   [,--X]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 93        START:    CLR   [,--X]", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", false);
		}
	}
	...
	public void testCLRIndexedAutoIncrementDecrementIndirectMode12() {
		...
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	CLR		  	[,--Y]  ; 8000   	68 B3        START:    CLR   [,--Y]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 B3        START:    CLR   [,--Y]", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", false);
		}
	}
	...
	public void testCLRIndexedAutoIncrementDecrementIndirectMode14() {
		...
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	CLR		  	[,--S]  ; 8000   	68 F3        START:    CLR   [,--S]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 F3        START:    CLR   [,--S]", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", false);
		}
	}
	...
	public void testCLRIndexedAutoIncrementDecrementIndirectMode16() {
		...
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Const	   	EQU          	5\n");
		strBuilder.append("Start      	CLR		  	[,--U]  ; 8000   	68 D3        START:    CLR   [,--U]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 D3        START:    CLR   [,--U]", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", false);
		}
	}
	...
	public void testCLRIndexedConstantMove1() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("		 	  	ORG    			$8000\n");
		strBuilder.append("Start      	CLR		  	1234,X  ; 8000   	68 89 04 D2            CLR   1234,X\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 89 04 D2            CLR   1234,X", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", false);
		}
	}
	...
	public void testCLRIndexedConstantMove2() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	CLR		  	1234,Y  ; 8000   	67 A9 04 D2            CLR   1234,Y\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check operand", 0xD2, line.getOperand()[2]);
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	67 A9 04 D2            CLR   1234,Y", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", false);
		}
	}
	...
	public void testCLRIndexedConstantMove3() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	CLR		  	1234,U  ; 8000   	68 C9 04 D2            CLR   1234,U\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check operand", 0xD2, line.getOperand()[2]);
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 C9 04 D2            CLR   1234,U", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", false);
		}
	}
	...
	public void testCLRIndexedConstantMove4() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	CLR		  	1234,S  ; 8000   	68 E9 04 D2            CLR   1234,S\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check operand", 0xD2, line.getOperand()[2]);
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 E9 04 D2            CLR   1234,S", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", false);
		}
	}
	...
	public void testCLRIndexedConstantMove5() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	CLR		  	34,X  ; 8000   	68 88 22            CLR   34,X\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 88 22            CLR   34,X", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", false);
		}
	}
	...
	public void testCLRIndexedConstantMove6() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	CLR		  	34,Y  ; 8000   	68 A8 22            CLR   34,Y\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check operand", 0x22, line.getOperand()[1]);
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 A8 22            CLR   34,Y", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", false);
		}
	}
	...
	public void testCLRIndexedConstantMove7() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("		  	 	ORG    			$8000\n");
		strBuilder.append("Start      	CLR		  	34,U  ; 8000   	68 C8 22            CLR   34,U\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check operand", 0x22, line.getOperand()[1]);
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 C8 22            CLR   34,U", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", false);
		}
	}
	...
	public void testCLRIndexedConstantMove8() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	CLR		  	34,S  ; 8000   	68 E8 22            CLR   34,S\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check operand", 0x22, line.getOperand()[1]);
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 E8 22            CLR   34,S", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", false);
		}
	}
	...
	public void testCLRIndexedConstantMove9() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	CLR		  	,X  ; 8000   	68 84            CLR   ,X\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 84            CLR   ,X", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", false);
		}
	}
	...
	public void testCLRIndexedConstantMove10() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	CLR		  	,Y  ; 8000   	68 A4            CLR   ,Y\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 A4            CLR   ,Y", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", false);
		}
	}
	...
	public void testCLRIndexedConstantMove11() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	CLR		  	,U  ; 8000   	68 C4            CLR   ,U\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 C4            CLR   ,U", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", false);
		}
	}
	...
	public void testCLRIndexedConstantMove12() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("		 	  	ORG    			$8000\n");
		strBuilder.append("Start      	CLR		  	,S  ; 8000   	68 E4            CLR   ,S\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 E4            CLR   ,S", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", false);
		}
	}
	...
	public void testCLRIndexedConstantMove13() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	CLR		  	0,X  ; 8000   	68 84            CLR   0,X\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check operand", 0x84, line.getOperand()[0]);
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 84            CLR   0,X", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", false);
		}
	}
	...
	public void testCLRIndexedConstantMove14() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	CLR		  	0,Y  ; 8000   	68 A4            CLR   0,Y\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check operand", 0xA4, line.getOperand()[0]);
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 A4            CLR   0,Y", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", false);
		}
	}
	...
	public void testCLRIndexedConstantMove15() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	CLR		  	0,U  ; 8000   	68 C4            CLR   0,U\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check operand", 0xC4, line.getOperand()[0]);
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 C4            CLR   0,U", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", false);
		}
	}
	...
	public void testCLRIndexedConstantMove16() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	CLR		  	0,S  ; 8000   	68 E4            CLR   0,S\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check operand", 0xE4, line.getOperand()[0]);
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 E4            CLR   0,S", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", false);
		}
	}
	...
	public void testCLRIndexedConstantMove17() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	CLR		  	-16,X  ; 8000   	68 10            CLR   -16,X\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 10            CLR   -16,X", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", false);
		}
	}
	...
	public void testCLRIndexedConstantMove19() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	CLR		  	1,X  ; 8000   	68 01            CLR   1,X\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 01            CLR   1,X", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", false);
		}
	}
	...
	public void testCLRIndexedConstantMove20() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("		 	  	ORG    			$8000\n");
		strBuilder.append("Start      	CLR		  	15,X  ; 8000   	68 0F            CLR   15,X\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 0F            CLR   15,X", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", false);
		}
	}
	...
	public void testCLRIndexedConstantMove21() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	CLR		  	-16,Y  ; 8000   	68 30            CLR   -16,Y\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 30            CLR   -16,Y", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", false);
		}
	}
	...
	public void testCLRIndexedConstantMove23() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	CLR		  	1,Y  ; 8000   	68 21            CLR   1,Y\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 21            CLR   1,Y", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", false);
		}
	}
	...
	public void testCLRIndexedConstantMove24() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	CLR		  	15,Y  ; 8000   	68 2F            CLR   15,Y\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 2F            CLR   15,Y", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", false);
		}
	}
	...
	public void testCLRIndexedConstantMove25() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	CLR		  	-16,U  ; 8000   	68 50            CLR   -16,U\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 50            CLR   -16,U", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", false);
		}
	}
	...
	public void testCLRIndexedConstantMove26() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	CLR		  	1,U  ; 8000   	68 41            CLR   1,U\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 41            CLR   1,U", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", false);
		}
	}
	...
	public void testCLRIndexedConstantMove27() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	CLR		  	15,U  ; 8000   	68 4F            CLR   15,U\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 4F            CLR   15,U", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", false);
		}
	}
	...
	public void testCLRIndexedConstantMove28() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	CLR		  	-16,S  ; 8000   	68 70            CLR   -16,S\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 70            CLR   -16,S", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", false);
		}
	}
	...
	public void testCLRIndexedConstantMove29() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	CLR		  	1,S  ; 8000   	68 61            CLR   1,S\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 61            CLR   1,S", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", false);
		}
	}
	...
	public void testCLRIndexedConstantMove30() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	CLR		  	15,S  ; 8000   	68 6F            CLR   15,S\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 6F            CLR   15,S", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", false);
		}
	}
	...
	public void testCLRIndexedConstantMove31() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	CLR		  	-128,X  ; 8000   	68 88 80            CLR   -128,X\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 88 80            CLR   -128,X", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", false);
		}
	}
	...
	public void testCLRIndexedConstantMove32() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("		 	  	ORG    			$8000\n");
		strBuilder.append("Start      	CLR		  	127,X  ; 8000   	68 88 7F            CLR   127,X\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 88 7F            CLR   127,X", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", false);
		}
	}
	...
	public void testCLRIndexedConstantMove33() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	CLR		  	-128,Y  ; 8000   	68 A8 80            CLR   -128,Y\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check operand", 0x80, line.getOperand()[1]);
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 A8 80            CLR   -128,Y", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", false);
		}
	}
	...
	public void testCLRIndexedConstantMove34() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("		 	  	ORG    			$8000\n");
		strBuilder.append("Start      	CLR		  	127,Y  ; 8000   	68 A8 7F            CLR   127,Y\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check operand", 0x7F, line.getOperand()[1]);
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 A8 7F            CLR   127,Y", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", false);
		}
	}
	...
	public void testCLRIndexedConstantMove35() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	CLR		  	-128,U  ; 8000   	68 C8 80            CLR   -128,U\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check operand", 0x80, line.getOperand()[1]);
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 C8 80            CLR   -128,U", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", false);
		}
	}
	...
	public void testCLRIndexedConstantMove36() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("		  	 	ORG    			$8000\n");
		strBuilder.append("Start      	CLR		  	127,U  ; 8000   	68 C8 7F            CLR   127,U\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check operand", 0x7F, line.getOperand()[1]);
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 C8 7F            CLR   127,U", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", false);
		}
	}
	...
	public void testCLRIndexedConstantMove37() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	CLR		  	-128,S  ; 8000   	68 E8 80            CLR   -128,S\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check operand", 0x80, line.getOperand()[1]);
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 E8 80            CLR   -128,S", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", false);
		}
	}
	...
	public void testCLRIndexedConstantMove38() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	CLR		  	127,S  ; 8000   	68 E8 7F            CLR   127,S\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check operand", 0x7F, line.getOperand()[1]);
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 E8 7F            CLR   127,S", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", false);
		}
	}
	...
	public void testCLRIndexedConstantMove39() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	CLR		  	-32768,X  ; 8000   	68 89 80 00             CLR   -32768,X\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 89 80 00             CLR   -32768,X", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", false);
		}
	}
	...
	public void testCLRIndexedConstantMove40() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	CLR		  32767,X  ; 8000   	68 89 7F FF             CLR   32767,X\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 89 7F FF             CLR   32767,X", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", false);
		}
	}
	...
	public void testCLRIndexedConstantMove41() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	CLR		  	-32768,Y  ; 8000   	67 A9 80 00             CLR   -32768,Y\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check operand", 0x00, line.getOperand()[2]);
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	67 A9 80 00             CLR   -32768,Y", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", false);
		}
	}
	...
	public void testCLRIndexedConstantMove42() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	CLR		  32767,Y  ; 8000   	67 A9 7F FF             CLR   32767,Y\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check operand", 0xFF, line.getOperand()[2]);
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	67 A9 7F FF             CLR   32767,Y", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", false);
		}
	}
	...
	public void testCLRIndexedConstantMove43() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	CLR		  	-32768,U  ; 8000   	68 C9 80 00             CLR   -32768,U\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check operand", 0x00, line.getOperand()[2]);
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 C9 80 00             CLR   -32768,U", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", false);
		}
	}
	...
	public void testCLRIndexedConstantMove44() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	CLR		  32767,U  ; 8000   	68 C9 7F FF             CLR   32767,U\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check operand", 0xFF, line.getOperand()[2]);
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 C9 7F FF             CLR   32767,U", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", false);
		}
	}
	...
	public void testCLRIndexedConstantMove45() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("		 	  	ORG    			$8000\n");
		strBuilder.append("Start      	CLR		  	-32768,S  ; 8000   	68 E9 80 00             CLR   -32768,S\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check operand", 0x00, line.getOperand()[2]);
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 E9 80 00             CLR   -32768,S", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", false);
		}
	}
	...
	public void testCLRIndexedConstantMove46() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	CLR		  32767,S  ; 8000   	68 E9 7F FF             CLR   32767,S\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check operand", 0xFF, line.getOperand()[2]);
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 E9 7F FF             CLR   32767,S", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", false);
		}
	}
	...
	public void testCLRIndexedConstantMove47() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	CLR		  	-32769,X  ; 8000   	68 89 80 00             CLR   -32769,X\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check operand", 0x00, line.getOperand()[2]);
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 89 80 00             CLR   -32769,X", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", false);
		}
	}
	...
	public void testCLRIndexedConstantMove48() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	CLR		  32768,X  ; 8000   	68 89 7F FF             CLR   32768,X\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check operand", 0xFF, line.getOperand()[2]);
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 89 7F FF             CLR   32768,X", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", false);
		}
	}
	...
	public void testCLRIndexedConstantMove49() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("		   		ORG    			$8000\n");
		strBuilder.append("Start      	CLR		  	-32769,Y  ; 8000   	67 A9 80 00             CLR   -32769,Y\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check operand", 0x00, line.getOperand()[2]);
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	67 A9 80 00             CLR   -32769,Y", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", false);
		}
	}
	...
	public void testCLRIndexedConstantMove50() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("		  	 	ORG    			$8000\n");
		strBuilder.append("Start      	CLR		  32768,Y  ; 8000   	67 A9 7F FF             CLR   32768,Y\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check operand", 0xFF, line.getOperand()[2]);
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	67 A9 7F FF             CLR   32768,Y", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", false);
		}
	}
	...
	public void testCLRIndexedConstantMove51() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("		 	  	ORG    			$8000\n");
		strBuilder.append("Start      	CLR		  	-32769,U  ; 8000   	68 C9 80 00             CLR   -32769,U\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check operand", 0x00, line.getOperand()[2]);
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 C9 80 00             CLR   -32769,U", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", false);
		}
	}
	...
	public void testCLRIndexedConstantMove52() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	CLR		  32768,U  ; 8000   	68 C9 7F FF             CLR   32768,U\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check operand", 0xFF, line.getOperand()[2]);
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 C9 7F FF             CLR   32768,U", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", false);
		}
	}
	...
	public void testCLRIndexedConstantMove53() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	CLR		  	-32769,S  ; 8000   	68 E9 80 00             CLR   -32769,S\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check operand", 0x00, line.getOperand()[2]);
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 E9 80 00             CLR   -32769,S", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", false);
		}
	}
	...
	public void testCLRIndexedConstantMove54() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	CLR		  32768,S  ; 8000   	68 E9 7F FF             CLR   32768,S\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check operand", 0xFF, line.getOperand()[2]);
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 E9 7F FF             CLR   32768,S", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", false);
		}
	}
	...
	public void testCLRIndexedConstantIndirectMove1() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	CLR		  	[1234,X]  ; 8000   	68 99 04 D2            CLR   [1234,X]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check operand", 0xD2, line.getOperand()[2]);
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 99 04 D2            CLR   [1234,X]", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", false);
		}
	}
	...
	public void testCLRIndexedConstantIndirectMove2() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	CLR		  	[1234,Y]  ; 8000   	68 B9 04 D2            CLR   [1234,Y]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check operand", 0xD2, line.getOperand()[2]);
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 B9 04 D2            CLR   [1234,Y]", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", false);
		}
	}
	...
	public void testCLRIndexedConstantIndirectMove3() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("		 	  	ORG    			$8000\n");
		strBuilder.append("Start      	CLR		  	[1234,U]  ; 8000   	68 D9 04 D2            CLR   [1234,U]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check operand", 0xD2, line.getOperand()[2]);
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 D9 04 D2            CLR   [1234,U]", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", false);
		}
	}
	...
	public void testCLRIndexedConstantIndirectMove4() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	CLR		  	[1234,S]  ; 8000   	68 F9 04 D2            CLR   [1234,S]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check operand", 0xD2, line.getOperand()[2]);
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 F9 04 D2            CLR   [1234,S]", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", false);
		}
	}
	...
	public void testCLRIndexedConstantIndirectMove5() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	CLR		  	[34,X]  ; 8000   	68 98 22            CLR   [34,X]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check operand", 0x22, line.getOperand()[1]);
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 98 22            CLR   [34,X]", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", false);
		}
	}
	...
	public void testCLRIndexedConstantIndirectMove6() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	CLR		  	[34,Y]  ; 8000   	68 B8 22            CLR   [34,Y]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check operand", 0x22, line.getOperand()[1]);
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 B8 22            CLR   [34,Y]", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", false);
		}
	}
	...
	public void testCLRIndexedConstantIndirectMove7() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	CLR		  	[34,U]  ; 8000   	68 D8 22            CLR   [34,U]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check operand", 0x22, line.getOperand()[1]);
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 D8 22            CLR   [34,U]", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", false);
		}
	}
	...
	public void testCLRIndexedConstantIndirectMove8() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	CLR		  	[34,S]  ; 8000   	68 F8 22            CLR   [34,S]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check operand", 0x22, line.getOperand()[1]);
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 F8 22            CLR   [34,S]", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", false);
		}
	}
	...
	public void testCLRIndexedConstantIndirectMove9() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	CLR		  	[,X]  ; 8000   	68 94            CLR   [,X]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 94            CLR   [,X]", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", false);
		}
	}
	...
	public void testCLRIndexedConstantIndirectMove10() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("		 	  	ORG    			$8000\n");
		strBuilder.append("Start      	CLR		  	[,Y]  ; 8000   	68 B4            CLR   [,Y]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 B4            CLR   [,Y]", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", false);
		}
	}
	...
	public void testCLRIndexedConstantIndirectMove11() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	CLR		  	[,U]  ; 8000   	68 D4            CLR   [,U]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 D4            CLR   [,U]", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", false);
		}
	}
	...
	public void testCLRIndexedConstantIndirectMove12() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	CLR		  	[,S]  ; 8000   	68 F4            CLR   [,S]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 F4            CLR   [,S]", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", false);
		}
	}
	...
	public void testCLRIndexedConstantIndirectMove13() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	CLR		  	[0,X]  ; 8000   	68 94            CLR   [0,X]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check operand", 0x94, line.getOperand()[0]);
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 94            CLR   [0,X]", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", false);
		}
	}
	...
	public void testCLRIndexedConstantIndirectMove14() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	CLR		  	[0,Y]  ; 8000   	68 B4            CLR   [0,Y]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check operand", 0xB4, line.getOperand()[0]);
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 B4            CLR   [0,Y]", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", false);
		}
	}
	...
	public void testCLRIndexedConstantIndirectMove15() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	CLR		  	[0,U]  ; 8000   	68 D4            CLR   [0,U]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check operand", 0xD4, line.getOperand()[0]);
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 D4            CLR   [0,U]", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", false);
		}
	}
	...
	public void testCLRIndexedConstantIndirectMove16() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	CLR		  	[0,S]  ; 8000   	68 F4            CLR   [0,S]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check operand", 0xF4, line.getOperand()[0]);
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 F4            CLR   [0,S]", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", false);
		}
	}
	...
	public void testCLRIndexedConstantIndirectMove17() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	CLR		  	[-16,X]  ; 8000   	68 98 F0            CLR   [-16,X]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 98 F0            CLR   [-16,X]", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", false);
		}
	}
	...
	public void testCLRIndexedConstantIndirectMove18() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	CLR		  	[15,X]  ; 8000   	68 98 0F            CLR   [15,X]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 98 0F            CLR   [15,X]", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", false);
		}
	}
	...
	public void testCLRIndexedConstantIndirectMove19() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	CLR		  	[-16,Y]  ; 8000   	68 B8 F0            CLR   [-16,Y]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check operand", 0xF0, line.getOperand()[1]);
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 B8 F0            CLR   [-16,Y]", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", false);
		}
	}
	...
	public void testCLRIndexedConstantIndirectMove20() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	CLR		  	[15,Y]  ; 8000   	68 B8 0F            CLR   [15,Y]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check operand", 0x0F, line.getOperand()[1]);
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 B8 0F            CLR   [15,Y]", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", false);
		}
	}
	...
	public void testCLRIndexedConstantIndirectMove21() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	CLR		  	[-16,U]  ; 8000   	68 D8 F0            CLR   [-16,U]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check operand", 0xF0, line.getOperand()[1]);
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 D8 F0            CLR   [-16,U]", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", false);
		}
	}
	...
	public void testCLRIndexedConstantIndirectMove22() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	CLR		  	[15,U]  ; 8000   	68 D8 0F            CLR   [15,U]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check operand", 0x0F, line.getOperand()[1]);
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 D8 0F            CLR   [15,U]", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", false);
		}
	}
	...
	public void testCLRIndexedConstantIndirectMove23() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	CLR		  	[-16,S]  ; 8000   	68 F8 F0            CLR   [-16,S]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check operand", 0xF0, line.getOperand()[1]);
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 F8 F0            CLR   [-16,S]", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", false);
		}
	}
	...
	public void testCLRIndexedConstantIndirectMove24() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	CLR		  	[15,S]  ; 8000   	68 F8 0F            CLR   [15,S]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check operand", 0x0F, line.getOperand()[1]);
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 F8 0F            CLR   [15,S]", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", false);
		}
	}
	...
	public void testCLRIndexedConstantIndirectMove31() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("		 	  	ORG    			$8000\n");
		strBuilder.append("Start      	CLR		  	[-128,X]  ; 8000   	68 98 80            CLR   [-128,X}\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check operand", 0x80, line.getOperand()[1]);
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 98 80            CLR   [-128,X}", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", false);
		}
	}
	...
	public void testCLRIndexedConstantIndirectMove32() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	CLR		  	[127,X]  ; 8000   	68 98 7F            CLR   [127,X]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check operand", 0x7F, line.getOperand()[1]);
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 98 7F            CLR   [127,X]", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", false);
		}
	}
	...
	public void testCLRIndexedConstantIndirectMove33() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	CLR		  	[-128,Y]  ; 8000   	68 B8 80            CLR   [-128,Y]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check operand", 0x80, line.getOperand()[1]);
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 B8 80            CLR   [-128,Y]", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", false);
		}
	}
	...
	public void testCLRIndexedConstantIndirectMove34() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("		 	  	ORG    			$8000\n");
		strBuilder.append("Start      	CLR		  	[127,Y]  ; 8000   	68 B8 7F            CLR   [127,Y]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check operand", 0x7F, line.getOperand()[1]);
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 B8 7F            CLR   [127,Y]", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", false);
		}
	}
	...
	public void testCLRIndexedConstantIndirectMove35() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	CLR		  	[-128,U]  ; 8000   	68 D8 80            CLR   [-128,U]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check operand", 0x80, line.getOperand()[1]);
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 D8 80            CLR   [-128,U]", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", false);
		}
	}
	...
	public void testCLRIndexedConstantIndirectMove36() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	CLR		  	[127,U]  ; 8000   	68 D8 7F            CLR   [127,U]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check operand", 0x7F, line.getOperand()[1]);
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 D8 7F            CLR   [127,U]", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", false);
		}
	}
	...
	public void testCLRIndexedConstantIndirectMove37() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	CLR		  	[-128,S]  ; 8000   	68 F8 80            CLR   [-128,S]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check operand", 0x80, line.getOperand()[1]);
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 F8 80            CLR   [-128,S]", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", false);
		}
	}
	...
	public void testCLRIndexedConstantIndirectMove38() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	CLR		  	[127,S]  ; 8000   	68 F8 7F            CLR   [127,S]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check operand", 0x7F, line.getOperand()[1]);
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 F8 7F            CLR   [127,S]", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", false);
		}
	}
	...
	public void testCLRIndexedConstantIndirectMove39() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	CLR		  	[-32768,X]  ; 8000   	68 99 80 00             CLR   [-32768,X]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check operand", 0x00, line.getOperand()[2]);
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 99 80 00             CLR   [-32768,X]", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", false);
		}
	}
	...
	public void testCLRIndexedConstantIndirectMove40() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	CLR		  [32767,X]  ; 8000   	68 99 7F FF             CLR   [32767,X]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check operand", 0xFF, line.getOperand()[2]);
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 99 7F FF             CLR   [32767,X]", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", false);
		}
	}
	...
	public void testCLRIndexedConstantIndirectMove41() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	CLR		  	[-32768,Y]  ; 8000   	68 B9 80 00             CLR   [-32768,Y]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check operand", 0x00, line.getOperand()[2]);
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 B9 80 00             CLR   [-32768,Y]", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", false);
		}
	}
	...
	public void testCLRIndexedConstantIndirectMove42() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	CLR		  [32767,Y]  ; 8000   	68 B9 7F FF             CLR   [32767,Y]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check operand", 0xFF, line.getOperand()[2]);
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 B9 7F FF             CLR   [32767,Y]", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", false);
		}
	}
	...
	public void testCLRIndexedConstantIndirectMove43() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	CLR		  	[-32768,U]  ; 8000   	68 D9 80 00             CLR   [-32768,U]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check operand", 0x00, line.getOperand()[2]);
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 D9 80 00             CLR   [-32768,U]", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", false);
		}
	}
	...
	public void testCLRIndexedConstantIndirectMove44() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	CLR		  [32767,U]  ; 8000   	68 D9 7F FF             CLR   [32767,U]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check operand", 0xFF, line.getOperand()[2]);
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 D9 7F FF             CLR   [32767,U]", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", false);
		}
	}
	...
	public void testCLRIndexedConstantIndirectMove45() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("		   		ORG    			$8000\n");
		strBuilder.append("Start      	CLR		  	[-32768,S]  ; 8000   	68 F9 80 00             CLR   [-32768,S]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check operand", 0x00, line.getOperand()[2]);
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 F9 80 00             CLR   [-32768,S]", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", false);
		}
	}
	...
	public void testCLRIndexedConstantIndirectMove46() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	CLR		  [32767,S]  ; 8000   	68 F9 7F FF             CLR   [32767,S]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check operand", 0xFF, line.getOperand()[2]);
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 F9 7F FF             CLR   [32767,S]", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", false);
		}
	}
	...
	public void testCLRIndexedConstantIndirectMove47() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("		 	  	ORG    			$8000\n");
		strBuilder.append("Start      	CLR		  	[-32769,X]  ; 8000   	68 99 80 00             CLR   [-32769,X]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check operand", 0x00, line.getOperand()[2]);
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 99 80 00             CLR   [-32769,X]", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", false);
		}
	}
	...
	public void testCLRIndexedConstantIndirectMove48() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	CLR		  [32768,X]  ; 8000   	68 99 7F FF             CLR   [32768,X]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check operand", 0xFF, line.getOperand()[2]);
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 99 7F FF             CLR   [32768,X]", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", false);
		}
	}
	...
	public void testCLRIndexedConstantIndirectMove49() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("		 	  	ORG    			$8000\n");
		strBuilder.append("Start      	CLR		  	[-32769,Y]  ; 8000   	68 B9 80 00             CLR   [-32769,Y]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check operand", 0x00, line.getOperand()[2]);
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 B9 80 00             CLR   [-32769,Y]", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", false);
		}
	}
	...
	public void testCLRIndexedConstantIndirectMove50() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("		 	  	ORG    			$8000\n");
		strBuilder.append("Start      	CLR		  [32768,Y]  ; 8000   	68 B9 7F FF             CLR   [32768,Y]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check operand", 0xFF, line.getOperand()[2]);
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 B9 7F FF             CLR   [32768,Y]", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", false);
		}
	}
	...
	public void testCLRIndexedConstantIndirectMove51() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	CLR		  	[-32769,U]  ; 8000   	68 D9 80 00             CLR   [-32769,U]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check operand", 0x00, line.getOperand()[2]);
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 D9 80 00             CLR   [-32769,U]", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", false);
		}
	}
	...
	public void testCLRIndexedConstantIndirectMove52() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	CLR		  [32768,U]  ; 8000   	68 D9 7F FF             CLR   [32768,U]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check operand", 0xFF, line.getOperand()[2]);
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 D9 7F FF             CLR   [32768,U]", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", false);
		}
	}
	...
	public void testCLRIndexedConstantIndirectMove53() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("			   	ORG    			$8000\n");
		strBuilder.append("Start      	CLR		  	[-32769,S]  ; 8000   	68 F9 80 00             CLR   [-32769,S]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check operand", 0x00, line.getOperand()[2]);
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 F9 80 00             CLR   [-32769,S]", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", false);
		}
	}
	...
	public void testCLRIndexedConstantIndirectMove54() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("		   		ORG    			$8000\n");
		strBuilder.append("Start      	CLR		  [32768,S]  ; 8000   	68 F9 7F FF             CLR   [32768,S]\n");
		try {
			Model result = parseHelper.parse(strBuilder.toString());
			...
			Assert.assertEquals("Check operand", 0xFF, line.getOperand()[2]);
			Assert.assertEquals("Check Label", "Start", line.getLabel());
			Assert.assertEquals("Check comment", "; 8000   	68 F9 7F FF             CLR   [32768,S]", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception", false);
		}
	}
