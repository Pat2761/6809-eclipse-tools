...
public class TestRORAInstruction {
	...
	public void testSimpleRORAWithExtraSpaceWithComment() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("	       ORG    	$8000\n");
		strBuilder.append("	       RORA  			; It is a comment \n");
	...
	public void testRORAAssembly() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("		   		ORG    			$8000\n");
		strBuilder.append("Start      	RORA		  		    ; 46   RORA\n");
		...
		try {
			...
			AssembledRORAInstruction line = (AssembledRORAInstruction)engine.getAssembledLine(2);
