...
public class TestBMIInstruction {
	...
	public void testSimpleBMIWithExtraSpace() {
		...
		try {
			...
			Assert.assertTrue("Must be an BMI directive line", instructionLine.getInstruction() instanceof BmiInstruction);
		} catch (Exception e) {
	...
	public void testSimpleBMIWithWithLabel() {
		...
		strBuilder.append("Jump	    	ASLA\n");
		strBuilder.append("				ASLB\n");
		strBuilder.append("MyBanch		BMI		Jump\n");
	...
	public void testSimpleBMIWithDuplicateLabel() {
		...
		strBuilder.append("Jump		BMI		Jump		; Jump=3FFF\n");
	...
	public void testSimpleBMIWithBadLabel() {
		...
		strBuilder.append("				NOP\n");
		strBuilder.append("Jump			BMI		Jump2		; Jump=3FFF\n");
	...
	public void testSimpleBMIWithNegativeJump() {
		...
		strBuilder.append("Jump	    	LDA		#25\n");
		strBuilder.append("				NOP\n");
		strBuilder.append("MyBanch		BMI		Jump		; Jump=24FB\n");
		...
		try {
			...
			AssembledBMIInstruction line = (AssembledBMIInstruction)engine.getAssembledLine(4); 
	...
	public void testSimpleBMIWithPositiveJump() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("	        	ORG     $8000\n");
		strBuilder.append("MyBanch		BMI		Jump		; Jump=2401\n");
		strBuilder.append("				NOP\n");
		...
		try {
			...
			AssembledBMIInstruction line = (AssembledBMIInstruction)engine.getAssembledLine(2); 
			Assert.assertEquals("Check opcode length", 1, line.getOpcode().length);
			Assert.assertEquals("Check opcode value", 0x2B, line.getOpcode()[0]);
			Assert.assertEquals("Check operand length", 1, line.getOperand().length);
	...
	public void testSimpleBMIWithPositiveLimitJump1() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("	    	    ORG     $8000\n");
		strBuilder.append("MyBanch		BMI		Jump		; Jump=247F\n");
	...
	public void testSimpleBMIWithNegativeLimitJump1() {
		...
		strBuilder.append("VVV			BMI		JUMP		;		\n");
