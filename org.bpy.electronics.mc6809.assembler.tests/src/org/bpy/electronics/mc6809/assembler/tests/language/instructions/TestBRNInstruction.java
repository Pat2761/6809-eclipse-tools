...
public class TestBRNInstruction {
	...
	public void testSimpleBRNWithExtraSpace() {
		...
		try {
			...
			Assert.assertTrue("Must be an BRN directive line", instructionLine.getInstruction() instanceof BrnInstruction);
		} catch (Exception e) {
	...
	public void testSimpleBRNWithWithLabel() {
		...
		strBuilder.append("Jump	    	ASLA\n");
		strBuilder.append("				ASLB\n");
		strBuilder.append("MyBanch		BRN		Jump\n");
	...
	public void testSimpleBRNWithDuplicateLabel() {
		...
		strBuilder.append("Jump		BRN		Jump		; Jump=3FFF\n");
	...
	public void testSimpleBRNWithBadLabel() {
		...
		strBuilder.append("				NOP\n");
		strBuilder.append("Jump			BRN		Jump2		; Jump=3FFF\n");
	...
	public void testSimpleBRNWithNegativeJump() {
		...
		strBuilder.append("Jump	    	LDA		#25\n");
		strBuilder.append("				NOP\n");
		strBuilder.append("MyBanch		BRN		Jump		; Jump=24FB\n");
		...
		try {
			...
			AssembledBRNInstruction line = (AssembledBRNInstruction)engine.getAssembledLine(4); 
	...
	public void testSimpleBRNWithPositiveJump() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("	        	ORG     $8000\n");
		strBuilder.append("MyBanch		BRN		Jump		; Jump=2401\n");
		strBuilder.append("				NOP\n");
		...
		try {
			...
			AssembledBRNInstruction line = (AssembledBRNInstruction)engine.getAssembledLine(2); 
			Assert.assertEquals("Check opcode length", 1, line.getOpcode().length);
			Assert.assertEquals("Check opcode value", 0x21, line.getOpcode()[0]);
			Assert.assertEquals("Check operand length", 1, line.getOperand().length);
	...
	public void testSimpleBRNWithPositiveLimitJump1() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("	    	    ORG     $8000\n");
		strBuilder.append("MyBanch		BRN		Jump		; Jump=247F\n");
	...
	public void testSimpleBRNWithNegativeLimitJump1() {
		...
		strBuilder.append("VVV			BRN		JUMP		;		\n");
