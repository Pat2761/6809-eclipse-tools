...
public class TestBEQInstruction {
	...
	public void testSimpleBEQWithExtraSpace() {
		...
		try {
			...
			Assert.assertTrue("Must be an BEQ directive line", instructionLine.getInstruction() instanceof BeqInstruction);
		} catch (Exception e) {
	...
	public void testSimpleBEQWithWithLabel() {
		...
		strBuilder.append("Jump	    	ASLA\n");
		strBuilder.append("				ASLB\n");
		strBuilder.append("MyBanch		BEQ		Jump\n");
	...
	public void testSimpleBEQWithDuplicateLabel() {
		...
		strBuilder.append("Jump		BEQ		Jump		; Jump=3FFF\n");
	...
	public void testSimpleBEQWithBadLabel() {
		...
		strBuilder.append("				NOP\n");
		strBuilder.append("Jump			BEQ		Jump2		; Jump=3FFF\n");
	...
	public void testSimpleBEQWithNegativeJump() {
		...
		strBuilder.append("Jump	    	LDA		#25\n");
		strBuilder.append("				NOP\n");
		strBuilder.append("MyBanch		BEQ		Jump		; Jump=24FB\n");
		...
		try {
			...
			AssembledBEQInstruction line = (AssembledBEQInstruction)engine.getAssembledLine(4); 
	...
	public void testSimpleBEQWithPositiveJump() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("	        	ORG     $8000\n");
		strBuilder.append("MyBanch		BEQ		Jump		; Jump=2401\n");
		strBuilder.append("				NOP\n");
		...
		try {
			...
			AssembledBEQInstruction line = (AssembledBEQInstruction)engine.getAssembledLine(2); 
			Assert.assertEquals("Check opcode length", 1, line.getOpcode().length);
			Assert.assertEquals("Check opcode value", 0x27, line.getOpcode()[0]);
			Assert.assertEquals("Check operand length", 1, line.getOperand().length);
	...
	public void testSimpleBEQWithPositiveLimitJump1() {
		...
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("	    	    ORG     $8000\n");
		strBuilder.append("MyBanch		BEQ		Jump		; Jump=247F\n");
	...
	public void testSimpleBEQWithNegativeLimitJump1() {
		...
		strBuilder.append("VVV			BEQ		JUMP		;		\n");
