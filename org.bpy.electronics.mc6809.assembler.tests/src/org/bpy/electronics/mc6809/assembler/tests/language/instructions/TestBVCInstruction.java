...
import org.bpy.electronics.mc6809.assembler.engine.data.instructions.AssembledBVCInstruction;
...
public class TestBVCInstruction {
	 ...
	 */
	@Test 
	public void testSimpleBVCWithExtraSpace() {
		StringBuilder strBuilder = new StringBuilder();
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("	        ORG     $8000\n");
		strBuilder.append("Jump	    ASLA\n");
		strBuilder.append("			ASLB\n");
		strBuilder.append("			BVC		Jump \n");
		...
		try {
			...
			Assert.assertTrue("Must be an BVC directive line", instructionLine.getInstruction() instanceof BvcInstruction);
		} catch (Exception e) {
	 ...
	 */
	@Test 
	public void testSimpleBVCWithoutExtraSpace() {
		StringBuilder strBuilder = new StringBuilder();
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("	        ORG     $8000\n");
		strBuilder.append("Jump	    ASLA\n");
	 ...
	 */
	@Test 
	public void testSimpleBVCWithWithLabel() {
		StringBuilder strBuilder = new StringBuilder();
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("	        	ORG     $8000\n");
		strBuilder.append("Jump	    	ASLA\n");
		strBuilder.append("				ASLB\n");
		strBuilder.append("MyBanch		BVC		Jump\n");
	...
	/**
	 * Check BVC with duplicate label
	 */
	@Test 
	public void testSimpleBVCWithDuplicateLabel() {
		StringBuilder strBuilder = new StringBuilder();
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("	        ORG     $8000\n");
		strBuilder.append("Jump	    LDA		#25\n");
		strBuilder.append("			NOP\n");
		strBuilder.append("Jump		BVC		Jump		; Jump=3FFF\n");
	...
	/**
	 * Check BVC with bad label
	 */
	@Test 
	public void testSimpleBVCWithBadLabel() {
		StringBuilder strBuilder = new StringBuilder();
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("	        	ORG     $8000\n");
		strBuilder.append("Jump1	    LDA		#25\n");
		strBuilder.append("				NOP\n");
		strBuilder.append("Jump			BVC		Jump2		; Jump=3FFF\n");
	...
	/**
	 * Check BVC negative jump
	 */
	@Test 
	public void testSimpleBVCWithNegativeJump() {
		StringBuilder strBuilder = new StringBuilder();
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("	        	ORG     $8000\n");
		strBuilder.append("Jump	    	LDA		#25\n");
		strBuilder.append("				NOP\n");
		strBuilder.append("MyBanch		BVC		Jump		; Jump=24FB\n");
		...
		try {
			...
			AssembledBVCInstruction line = (AssembledBVCInstruction)engine.getAssembledLine(4); 
			Assert.assertEquals("Check opcode length", 1, line.getOpcode().length);
			Assert.assertEquals("Check opcode value", 0x28, line.getOpcode()[0]);
	...
	/**
	 * Check BVC positive jump
	 */
	@Test 
	public void testSimpleBVCWithPositiveJump() {
		StringBuilder strBuilder = new StringBuilder();
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("	        	ORG     $8000\n");
		strBuilder.append("MyBanch		BVC		Jump		; Jump=2401\n");
		strBuilder.append("				NOP\n");
		...
		try {
			...
			AssembledBVCInstruction line = (AssembledBVCInstruction)engine.getAssembledLine(2); 
			Assert.assertEquals("Check opcode length", 1, line.getOpcode().length);
			Assert.assertEquals("Check opcode value", 0x28, line.getOpcode()[0]);
			Assert.assertEquals("Check operand length", 1, line.getOperand().length);
	...
	/**
	 * Check BVC positive limit jump
	 */
	@Test 
	public void testSimpleBVCWithPositiveLimitJump1() {
		StringBuilder strBuilder = new StringBuilder();
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("	    	    ORG     $8000\n");
		strBuilder.append("MyBanch		BVC		Jump		; Jump=247F\n");
	 ...
	 */
	@Test 
	public void testSimpleBVCWithPositiveLimitJump2() {
		StringBuilder strBuilder = new StringBuilder();
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("	        	ORG     $8000\n");
		strBuilder.append("MyBanch		BVC		Jump		; Jump=247F\n");
	...
	/**
	 * Check BVC negative limit jump
	 */
	@Test 
	public void testSimpleBVCWithNegativeLimitJump1() {
		StringBuilder strBuilder = new StringBuilder();
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("				ORG		$8002\n");
		strBuilder.append("JUMP			RTS					\n");
		strBuilder.append("				ORG		$8080		;\n");
		strBuilder.append("VVV			BVC		JUMP		;		\n");
	 ...
	 */
	@Test 
	public void testSimpleBVCWithNegativeLimitJump2() {
		StringBuilder strBuilder = new StringBuilder();
		strBuilder.append("; -----------------------------------------\n");
