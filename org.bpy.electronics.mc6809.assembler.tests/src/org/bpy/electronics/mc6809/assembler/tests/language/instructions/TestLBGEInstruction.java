...
import org.bpy.electronics.mc6809.assembler.engine.data.instructions.AssembledLBGEInstruction;
...
public class TestLBGEInstruction {
	 ...
	 */
	@Test 
	public void testSimpleLBGEWithExtraSpace() {
		StringBuilder strBuilder = new StringBuilder();
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("	        ORG     $8000\n");
		strBuilder.append("Jump	    ASLA\n");
		strBuilder.append("			ASLB\n");
		strBuilder.append("			LBGE		Jump \n");
		...
		try {
			...
			Assert.assertTrue("Must be an LBGE directive line", instructionLine.getInstruction() instanceof BgeInstruction);
		} catch (Exception e) {
	 ...
	 */
	@Test 
	public void testSimpleLBGEWithoutExtraSpace() {
		StringBuilder strBuilder = new StringBuilder();
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("	        ORG     $8000\n");
		strBuilder.append("Jump	    ASLA\n");
	...
	/**
	 * Check LBGE with duplicate label
	 */
	@Test 
	public void testSimpleLBGEWithDuplicateLabel() {
		StringBuilder strBuilder = new StringBuilder();
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("	        ORG     $8000\n");
		strBuilder.append("Jump	    LDA		#25\n");
		strBuilder.append("			NOP\n");
		strBuilder.append("Jump		LBGE		Jump		; Jump=3FFF\n");
	...
	/**
	 * Check LBGE with bad label
	 */
	@Test 
	public void testSimpleLBGEWithBadLabel() {
		StringBuilder strBuilder = new StringBuilder();
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("	        ORG    	 	$8000\n");
		strBuilder.append("Jump1	LDA			#25\n");
		strBuilder.append("			NOP\n");
		strBuilder.append("Jump		LBGE		Jump2		; Jump=3FFF\n");
	 ...
	 */
	@Test 
	public void testSimpleLBGEWithWithLabel() {
		StringBuilder strBuilder = new StringBuilder();
		strBuilder.append("	        	ORG     	$8000\n");
		strBuilder.append("Jump	    	ASLA\n");
		strBuilder.append("				ASLB\n");
		strBuilder.append("MyBanch		LBGE		Jump\n");
	...
	/**
	 * Check LBGE negative jump
	 */
	@Test 
	public void testSimpleLBGEWithNegativeJump1() {
		StringBuilder strBuilder = new StringBuilder();
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("	        	ORG     $8004\n");
		strBuilder.append("Jump	    	LDA		#25\n");
		strBuilder.append("	        	ORG     $8080\n");
		strBuilder.append("MyBanch		LBGE	Jump		; Jump=102CFF80\n");
		...
		try {
			...
			AssembledLBGEInstruction line = (AssembledLBGEInstruction)engine.getAssembledLine(4);
			...
			Assert.assertEquals("Check opcode value", 0x2C, line.getOpcode()[1]);
	 ...
	 */
	@Test 
	public void testSimpleLBGEWithNegativeJump2() {
		StringBuilder strBuilder = new StringBuilder();
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("	        	ORG     $8003\n");
		strBuilder.append("Jump	    	LDA		#25\n");
		strBuilder.append("	       	 	ORG     $8080\n");
		strBuilder.append("MyBanch		LBGE	Jump		; Jump=102CFF7F\n");
	...
	/**
	 * Check LBGE positive jump
	 */
	@Test 
	public void testSimpleLBGEWithPositiveJump1() {
		StringBuilder strBuilder = new StringBuilder();
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("	        	ORG     	$8000\n");
		strBuilder.append("MyBanch		LBGE		Jump		; Jump=102C007F\n");
		...
		try {
			...
			AssembledLBGEInstruction line = (AssembledLBGEInstruction)engine.getAssembledLine(2);
			Assert.assertEquals("Check opcode length", 2, line.getOpcode().length);
			Assert.assertEquals("Check opcode value", 0x10, line.getOpcode()[0]);
			Assert.assertEquals("Check opcode value", 0x2C, line.getOpcode()[1]);
			Assert.assertEquals("Check operand length", 2, line.getOperand().length);
	 ...
	 */
	@Test 
	public void testSimpleLBGEWithPositiveJump2() {
		StringBuilder strBuilder = new StringBuilder();
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("	        	ORG     	$8000\n");
		strBuilder.append("MyBanch		LBGE		Jump		; Jump=102C0080\n");
	...
	/**
	 * Check LBGE positive limit jump
	 */
	@Test 
	public void testSimpleLBGEWithPositiveLimitJump1() {
		StringBuilder strBuilder = new StringBuilder();
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("	        	ORG     	$0000\n");
		strBuilder.append("MyBranch		LBGE		Jump		; Jump=102C7FFF\n");
		strBuilder.append("				ORG     	$8003\n");
		strBuilder.append("Jump			RTS			\n");
		...
		try {
			...
			Assert.assertEquals("Check comment", "; Jump=102C7FFF", line.getComment());
		} catch (Exception e) {
			Assert.assertTrue("Exception detected", true);
		}
	}
	 ...
	 */
	@Test 
	public void testSimpleLBGEWithPositiveLimitJump2() {
		StringBuilder strBuilder = new StringBuilder();
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("	        	ORG     	$0000\n");
		strBuilder.append("MyBanch		LBGE		Jump		; Jump=102C8000\n");
		strBuilder.append("				ORG     	$8004\n");
		strBuilder.append("Jump			RTS			\n");
	...
	/**
	 * Check LBGE negative limit jump
	 */
	@Test 
	public void testSimpleLBGEWithNegativeLimitJump1() {
		StringBuilder strBuilder = new StringBuilder();
		strBuilder.append("; -----------------------------------------\n");
		strBuilder.append("				ORG			$0004\n");
		strBuilder.append("JUMP			RTS					\n");
		strBuilder.append("				ORG			$8000		;\n");
		strBuilder.append("VVV			LBGE		JUMP		;		\n");
	 ...
	 */
	@Test 
	public void testSimpleLBGEWithNegativeLimitJump2() {
		StringBuilder strBuilder = new StringBuilder();
		strBuilder.append("; -----------------------------------------\n");
