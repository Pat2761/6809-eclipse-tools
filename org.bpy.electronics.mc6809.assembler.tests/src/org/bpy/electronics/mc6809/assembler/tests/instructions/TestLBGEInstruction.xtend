...
class TestLBGEInstruction {
	...
	def void testSimpleLBGEWithExtraSpace() {
		...
		Assert.assertTrue("Must be an LBGE directive line", instructionLine.instruction instanceof BgeInstruction)
	}
	 ...
	 */
	@Test 
	def void testSimpleLBGEWithDuplicateLabel() {
		val result = parseHelper.parse('''
		; -----------------------------------------
			        ORG     $8000
		Jump	    LDA		#25
					NOP
		Jump		LBGE		Jump		; Jump=3FFF
		''')
		Assert.assertNotNull(result)
	 ...
	 */
	@Test 
	def void testSimpleLBGEWithBadLabel() {
		val result = parseHelper.parse('''
		; -----------------------------------------
			        ORG     $8000
		Jump1	    LDA		#25
					NOP
		Jump		LBGE		Jump2		; Jump=3FFF
		''')
		Assert.assertNotNull(result)
		result.assertError(AssemblerPackage.eINSTANCE.bgeInstruction,
	 ...
	 */
	@Test 
	def void testSimpleLBGEWithWithLabel() {
		val result = parseHelper.parse('''
		; -----------------------------------------
			        ORG     $8000
		Jump	    ASLA
	 ...
	 */
	@Test 
	def void testSimpleLBGEWithNegativeJump1() {
		val result = parseHelper.parse('''
		; -----------------------------------------
			        ORG     $8004
		Jump	    LDA		#25
			        ORG     $8080
		MyBanch		LBGE	Jump		; Jump=1024FF80
		''')
		Assert.assertNotNull(result)
		result.assertWarning(
			AssemblerPackage.eINSTANCE.bgeInstruction,
		...
		val line = engine.getAssembledLine(4) as AssembledLBGEInstruction
		...
		Assert.assertEquals("Check opcode value", 0x2C, line.opcode.get(1))
	 ...
	 */
	@Test 
	def void testSimpleLBGEWithNegativeJump2() {
		val result = parseHelper.parse('''
		; -----------------------------------------
			        ORG     $8003
		Jump	    LDA		#25
			        ORG     $8080
		MyBanch		LBGE	Jump		; Jump=1024FF7F
		''')
		Assert.assertNotNull(result)
	 ...
	 */
	@Test 
	def void testSimpleLBGEWithPositiveJump1() {
		val result = parseHelper.parse('''
		; -----------------------------------------
			        ORG     $8000
		MyBanch		LBGE		Jump		; Jump=1024007F
					ORG		$8083
		Jump		RTS			
		''')
		Assert.assertNotNull(result)
		...
		val line = engine.getAssembledLine(2) as AssembledLBGEInstruction
		Assert.assertEquals("Check opcode length", 2, line.opcode.length)
		Assert.assertEquals("Check opcode value", 0x10, line.opcode.get(0))
		Assert.assertEquals("Check opcode value", 0x2C, line.opcode.get(1))
		Assert.assertEquals("Check operand length", 2, line.operand.length)
	 ...
	 */
	@Test 
	def void testSimpleLBGEWithPositiveJump2() {
		val result = parseHelper.parse('''
		; -----------------------------------------
			        ORG     $8000
		MyBanch		LBGE		Jump		; Jump=10240080
					ORG		$8084
		Jump		RTS			
		''')
		Assert.assertNotNull(result)
	 ...
	 */
	@Test 
	def void testSimpleLBGEWithPositiveLimitJump1() {
		val result = parseHelper.parse('''
		; -----------------------------------------
			        ORG     $0000
		MyBranch	LBGE		Jump		; Jump=10257FFF
					ORG     $8003
		Jump		RTS			
		''')
		Assert.assertNotNull(result)
	 ...
	 */
	@Test 
	def void testSimpleLBGEWithPositiveLimitJump2() {
		val result = parseHelper.parse('''
		; -----------------------------------------
			        ORG     $0000
		MyBanch		LBGE	Jump		; Jump=10248000
					ORG     $8004
		Jump		RTS			
		''')
		Assert.assertNotNull(result)
	 ...
	 */
	@Test 
	def void testSimpleLBGEWithNegativeLimitJump1() {
		val result = parseHelper.parse('''
		; -----------------------------------------
					ORG		$0004
		JUMP		RTS					
	 ...
	 */
	@Test 
	def void testSimpleLBGEWithNegativeLimitJump2() {
		val result = parseHelper.parse('''
		; -----------------------------------------
					ORG		$0003
		JUMP		RTS					
