...
class TestBHIInstruction {
	 ...
	 */
	@Test 
	def void testSimpleBHIWithExtraSpace() {
		...
		Assert.assertTrue("Must be an BHI directive line", instructionLine.instruction instanceof BhiInstruction)
	}
	 ...
	 */
	@Test 
	def void testSimpleBHIWithoutExtraSpace() {
		val result = parseHelper.parse('''
		; -----------------------------------------
			        ORG     $8000
		Jump	    ASLA
	 ...
	 */
	@Test 
	def void testSimpleBHIWithWithLabel() {
		val result = parseHelper.parse('''
		; -----------------------------------------
			        ORG     $8000
		Jump	    ASLA
	 ...
	 */
	@Test 
	def void testSimpleBHIWithDuplicateLabel() {
		val result = parseHelper.parse('''
		; -----------------------------------------
			        ORG     $8000
		Jump	    LDA		#25
					NOP
		Jump		BHI		Jump		; Jump=3FFF
		''')
		Assert.assertNotNull(result)
	 ...
	 */
	@Test 
	def void testSimpleBHIWithBadLabel() {
		val result = parseHelper.parse('''
		; -----------------------------------------
			        ORG     $8000
		Jump1	    LDA		#25
					NOP
		Jump		BHI		Jump2		; Jump=3FFF
		''')
		Assert.assertNotNull(result)
	 ...
	 */
	@Test 
	def void testSimpleBHIWithNegativeJump() {
		val result = parseHelper.parse('''
		; -----------------------------------------
			        ORG     $8000
		Jump	    LDA		#25
		...
		val line = engine.getAssembledLine(4) as AssembledBHIInstruction
		Assert.assertEquals("Check opcode length", 1, line.opcode.length)
		Assert.assertEquals("Check opcode value", 0x22, line.opcode.get(0))
	 ...
	 */
	@Test 
	def void testSimpleBHIWithPositiveJump() {
		val result = parseHelper.parse('''
		; -----------------------------------------
			        ORG     $8000
		MyBanch		BHI		Jump		; 
		...
		val line = engine.getAssembledLine(2) as AssembledBHIInstruction
		Assert.assertEquals("Check opcode length", 1, line.opcode.length)
		Assert.assertEquals("Check opcode value", 0x22, line.opcode.get(0))
		Assert.assertEquals("Check operand length", 1, line.operand.length)
	 ...
	 */
	@Test 
	def void testSimpleBHIWithPositiveLimitJump1() {
		val result = parseHelper.parse('''
		; -----------------------------------------
			        ORG     $8000
		MyBanch		BHI		Jump		; 
	 ...
	 */
	@Test 
	def void testSimpleBHIWithPositiveLimitJump2() {
		val result = parseHelper.parse('''
		; -----------------------------------------
			        ORG     $8000
		MyBanch		BHI		Jump		; 
	 ...
	 */
	@Test 
	def void testSimpleBHIWithNegativeLimitJump1() {
		val result = parseHelper.parse('''
		; -----------------------------------------
					ORG		$8002
		JUMP		RTS					
	 ...
	 */
	@Test 
	def void testSimpleBHIWithNegativeLimitJump2() {
		val result = parseHelper.parse('''
		; -----------------------------------------
					ORG		$8001
		JUMP		RTS					
