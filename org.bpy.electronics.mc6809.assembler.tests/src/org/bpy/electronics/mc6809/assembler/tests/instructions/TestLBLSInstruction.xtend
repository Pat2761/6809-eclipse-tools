...
class TestLBLSInstruction {
	 ...
	 */
	@Test 
	def void testSimpleLBLSWithExtraSpace() {
		...
		Assert.assertTrue("Must be an LBLS directive line", instructionLine.instruction instanceof BlsInstruction)
	}
	 ...
	 */
	@Test 
	def void testSimpleLBLSWithoutExtraSpace() {
		val result = parseHelper.parse('''
		; -----------------------------------------
			        ORG     $8000
		Jump	    ASLA
	 ...
	 */
	@Test 
	def void testSimpleLBLSWithDuplicateLabel() {
		val result = parseHelper.parse('''
		; -----------------------------------------
			        ORG     $8000
		Jump	    LDA		#25
					NOP
		Jump		LBLS		Jump		; Jump=3FFF
		''')
		Assert.assertNotNull(result)
	 ...
	 */
	@Test 
	def void testSimpleLBLSWithBadLabel() {
		val result = parseHelper.parse('''
		; -----------------------------------------
			        ORG     $8000
		Jump1	    LDA		#25
					NOP
		Jump		LBLS		Jump2		; Jump=3FFF
		''')
		Assert.assertNotNull(result)
	 ...
	 */
	@Test 
	def void testSimpleLBLSWithWithLabel() {
		val result = parseHelper.parse('''
		; -----------------------------------------
			        ORG     $8000
		Jump	    ASLA
	 ...
	 */
	@Test 
	def void testSimpleLBLSWithNegativeJump1() {
		val result = parseHelper.parse('''
		; -----------------------------------------
			        ORG     $8004
		Jump	    LDA		#25
			        ORG     $8080
		MyBanch		LBLS	Jump		; Jump=1024FF80
		''')
		Assert.assertNotNull(result)
		...
		val line = engine.getAssembledLine(4) as AssembledLBLSInstruction
		...
		Assert.assertEquals("Check opcode value", 0x23, line.opcode.get(1))
	 ...
	 */
	@Test 
	def void testSimpleLBLSWithNegativeJump2() {
		val result = parseHelper.parse('''
		; -----------------------------------------
			        ORG     $8003
		Jump	    LDA		#25
			        ORG     $8080
		MyBanch		LBLS	Jump		; Jump=1024FF7F
		''')
		Assert.assertNotNull(result)
	 ...
	 */
	@Test 
	def void testSimpleLBLSWithPositiveJump1() {
		val result = parseHelper.parse('''
		; -----------------------------------------
			        ORG     $8000
		MyBanch		LBLS		Jump		; Jump=1024007F
					ORG		$8083
		Jump		RTS			
		''')
		Assert.assertNotNull(result)
		...
		val line = engine.getAssembledLine(2) as AssembledLBLSInstruction
		Assert.assertEquals("Check opcode length", 2, line.opcode.length)
		Assert.assertEquals("Check opcode value", 0x10, line.opcode.get(0))
		Assert.assertEquals("Check opcode value", 0x23, line.opcode.get(1))
		Assert.assertEquals("Check operand length", 2, line.operand.length)
	 ...
	 */
	@Test 
	def void testSimpleLBLSWithPositiveJump2() {
		val result = parseHelper.parse('''
		; -----------------------------------------
			        ORG     $8000
		MyBanch		LBLS		Jump		; Jump=10240080
					ORG		$8084
		Jump		RTS			
		''')
		Assert.assertNotNull(result)
	 ...
	 */
	@Test 
	def void testSimpleLBLSWithPositiveLimitJump1() {
		val result = parseHelper.parse('''
		; -----------------------------------------
			        ORG     $0000
		MyBranch	LBLS		Jump		; Jump=10257FFF
					ORG     $8003
		Jump		RTS			
		''')
		Assert.assertNotNull(result)
	 ...
	 */
	@Test 
	def void testSimpleLBLSWithPositiveLimitJump2() {
		val result = parseHelper.parse('''
		; -----------------------------------------
			        ORG     $0000
		MyBanch		LBLS	Jump		; Jump=10248000
					ORG     $8004
		Jump		RTS			
		''')
		Assert.assertNotNull(result)
	 ...
	 */
	@Test 
	def void testSimpleLBLSWithNegativeLimitJump1() {
		val result = parseHelper.parse('''
		; -----------------------------------------
					ORG		$0004
		JUMP		RTS					
	 ...
	 */
	@Test 
	def void testSimpleLBLSWithNegativeLimitJump2() {
		val result = parseHelper.parse('''
		; -----------------------------------------
					ORG		$0003
		JUMP		RTS					
