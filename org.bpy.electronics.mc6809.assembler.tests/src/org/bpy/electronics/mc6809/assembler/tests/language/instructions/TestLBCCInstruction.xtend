...
class TestLBCCInstruction {
	...
	def void testSimpleLBCCWithExtraSpace() {
		...
		Assert.assertTrue("Must be an LBCC directive line", instructionLine.instruction instanceof BccInstruction)
	}
	 ...
	 */
	@Test 
	def void testSimpleLBCCWithDuplicateLabel() {
		val result = parseHelper.parse('''
		; -----------------------------------------
			        ORG     $8000
		Jump	    LDA		#25
					NOP
		Jump		LBCC		Jump		; Jump=3FFF
		''')
		Assert.assertNotNull(result)
	 ...
	 */
	@Test 
	def void testSimpleLBCCWithBadLabel() {
		val result = parseHelper.parse('''
		; -----------------------------------------
			        ORG     $8000
		Jump1	    LDA		#25
					NOP
		Jump		LBCC		Jump2		; Jump=3FFF
		''')
		Assert.assertNotNull(result)
		result.assertError(AssemblerPackage.eINSTANCE.bccInstruction,
	 ...
	 */
	@Test 
	def void testSimpleLBCCWithWithLabel() {
		val result = parseHelper.parse('''
		; -----------------------------------------
			        ORG     $8000
		Jump	    ASLA
	 ...
	 */
	@Test 
	def void testSimpleLBCCWithNegativeJump1() {
		val result = parseHelper.parse('''
		; -----------------------------------------
			        ORG     $8004
		Jump	    LDA		#25
			        ORG     $8080
		MyBanch		LBCC	Jump		; Jump=1024FF80
		''')
		Assert.assertNotNull(result)
		result.assertWarning(
			AssemblerPackage.eINSTANCE.bccInstruction,
		...
		val line = engine.getAssembledLine(4) as AssembledLBCCInstruction
	 ...
	 */
	@Test 
	def void testSimpleLBCCWithNegativeJump2() {
		val result = parseHelper.parse('''
		; -----------------------------------------
			        ORG     $8003
		Jump	    LDA		#25
			        ORG     $8080
		MyBanch		LBCC	Jump		; Jump=1024FF7F
		''')
		Assert.assertNotNull(result)
	 ...
	 */
	@Test 
	def void testSimpleLBCCWithPositiveJump1() {
		val result = parseHelper.parse('''
		; -----------------------------------------
			        ORG     $8000
		MyBanch		LBCC		Jump		; Jump=1024007F
					ORG		$8083
		Jump		RTS			
		''')
		Assert.assertNotNull(result)
		...
		val line = engine.getAssembledLine(2) as AssembledLBCCInstruction
		Assert.assertEquals("Check opcode length", 2, line.opcode.length)
		Assert.assertEquals("Check opcode value", 0x10, line.opcode.get(0))
		Assert.assertEquals("Check opcode value", 0x24, line.opcode.get(1))
		Assert.assertEquals("Check operand length", 2, line.operand.length)
	 ...
	 */
	@Test 
	def void testSimpleLBCCWithPositiveJump2() {
		val result = parseHelper.parse('''
		; -----------------------------------------
			        ORG     $8000
		MyBanch		LBCC		Jump		; Jump=10240080
					ORG		$8084
		Jump		RTS			
		''')
		Assert.assertNotNull(result)
	 ...
	 */
	@Test 
	def void testSimpleLBCCWithPositiveLimitJump1() {
		val result = parseHelper.parse('''
		; -----------------------------------------
			        ORG     $0000
		MyBranch	LBCC		Jump		; Jump=10247FFF
					ORG     $8003
		Jump		RTS			
		''')
		Assert.assertNotNull(result)
		...
		Assert.assertEquals("Check comment", "; Jump=10247FFF", line.comment)
	}
	 ...
	 */
	@Test 
	def void testSimpleLBCCWithPositiveLimitJump2() {
		val result = parseHelper.parse('''
		; -----------------------------------------
			        ORG     $0000
		MyBanch		LBCC	Jump		; Jump=10248000
					ORG     $8004
		Jump		RTS			
		''')
		Assert.assertNotNull(result)
	 ...
	 */
	@Test 
	def void testSimpleLBCCWithNegativeLimitJump1() {
		val result = parseHelper.parse('''
		; -----------------------------------------
					ORG		$0004
		JUMP		RTS					
	 ...
	 */
	@Test 
	def void testSimpleLBCCWithNegativeLimitJump2() {
		val result = parseHelper.parse('''
		; -----------------------------------------
					ORG		$0003
		JUMP		RTS					
