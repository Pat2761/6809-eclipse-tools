...
public class TestADDDInstruction {
  ...
  public void testADDDImemdiatAddressingMode() {
    try {
      ...
      Assert.assertTrue("Must be an ADD directive line", (_instruction instanceof AdddInstruction));
      EObject _instruction_1 = instructionLine.getInstruction();
      final AdddInstruction AdddInstruction = ((org.bpy.electronics.mc6809.assembler.assembler.AdddInstruction) _instruction_1);
      Assert.assertEquals("Must be an ADDD instruction", AdddInstruction.getInstruction(), "ADDD");
      EObject _operand = AdddInstruction.getOperand();
  ...
  public void testADDDConstantOffsetIndexed() {
    try {
      ...
      EObject _operand_1 = AdddInstruction.getOperand();
  ...
  public void testADDDAutoIncrementIndexed() {
    try {
      ...
      _builder.newLine();
      _builder.append("\t       \t");
      _builder.append("ADDD\t\t  \t0,--S");
      _builder.newLine();
      _builder.append("\t       \t");
      _builder.append("ADDD\t\t  \t0,-S");
      _builder.newLine();
      _builder.append("\t       \t");
      _builder.append("ADDD\t\t  \tConst,U+");
      _builder.newLine();
      _builder.append("\t       \t");
      _builder.append("ADDD\t\t  \tConst,U++");
      _builder.newLine();
  ...
  public void testADDDRelativePCIndexed() {
    try {
      ...
      _builder.newLine();
      _builder.append("\t       \t");
      _builder.append("ADDD\t\t  \t0,PCR");
      _builder.newLine();
      _builder.append("\t       \t");
      _builder.append("ADDD\t\t  \t,PCR");
      _builder.newLine();
      _builder.append("\t       \t");
      _builder.append("ADDD\t\t  \tConst,PCR");
      _builder.newLine();
      final Model result = this.parseHelper.parse(_builder);
      Assert.assertNotNull(result);
      this._validationTestHelper.assertNoErrors(result);
