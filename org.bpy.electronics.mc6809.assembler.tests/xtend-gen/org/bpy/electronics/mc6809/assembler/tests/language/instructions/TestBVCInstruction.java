...
public class TestBVCInstruction {
  ...
  public void testSimpleBVCWithExtraSpace() {
    try {
      ...
      Assert.assertTrue("Must be an BVC directive line", (_instruction instanceof BvcInstruction));
    } catch (Throwable _e) {
  ...
  public void testSimpleBVCWithWithLabel() {
    try {
      ...
      _builder.append("ASLB");
      _builder.newLine();
      _builder.append("MyBanch\t\tBVC\t\tJump");
      _builder.newLine();
      final Model result = this.parseHelper.parse(_builder);
      Assert.assertNotNull(result);
      this._validationTestHelper.assertNoErrors(result);
  ...
  public void testSimpleBVCWithDuplicateLabel() {
    try {
      ...
      _builder.append("NOP");
      _builder.newLine();
      _builder.append("Jump\t\tBVC\t\tJump\t\t; Jump=3FFF");
      _builder.newLine();
      final Model result = this.parseHelper.parse(_builder);
      Assert.assertNotNull(result);
  ...
  public void testSimpleBVCWithBadLabel() {
    try {
      ...
      _builder.append("NOP");
      _builder.newLine();
      _builder.append("Jump\t\tBVC\t\tJump2\t\t; Jump=3FFF");
      _builder.newLine();
      final Model result = this.parseHelper.parse(_builder);
      Assert.assertNotNull(result);
      this._validationTestHelper.assertError(result, AssemblerPackage.eINSTANCE.getBvcInstruction(), 
  ...
  public void testSimpleBVCWithNegativeJump() {
    try {
      ...
      final AssembledBVCInstruction line = ((AssembledBVCInstruction) _assembledLine);
