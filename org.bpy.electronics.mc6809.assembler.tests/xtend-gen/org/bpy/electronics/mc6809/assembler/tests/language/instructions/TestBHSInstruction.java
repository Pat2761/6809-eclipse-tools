...
public class TestBHSInstruction {
  ...
  public void testSimpleBHSWithExtraSpace() {
    try {
      ...
      Assert.assertTrue("Must be an BHS directive line", (_instruction instanceof BhsInstruction));
    } catch (Throwable _e) {
  ...
  public void testSimpleBHSWithWithLabel() {
    try {
      ...
      _builder.append("ASLB");
      _builder.newLine();
      _builder.append("MyBanch\t\tBHS\t\tJump");
      _builder.newLine();
      final Model result = this.parseHelper.parse(_builder);
      Assert.assertNotNull(result);
      this._validationTestHelper.assertNoErrors(result);
  ...
  public void testSimpleBHSWithDuplicateLabel() {
    try {
      ...
      _builder.append("NOP");
      _builder.newLine();
      _builder.append("Jump\t\tBHS\t\tJump\t\t; Jump=3FFF");
      _builder.newLine();
      final Model result = this.parseHelper.parse(_builder);
      Assert.assertNotNull(result);
  ...
  public void testSimpleBHSWithBadLabel() {
    try {
      ...
      _builder.append("NOP");
      _builder.newLine();
      _builder.append("Jump\t\tBHS\t\tJump2\t\t; Jump=3FFF");
      _builder.newLine();
      final Model result = this.parseHelper.parse(_builder);
      Assert.assertNotNull(result);
  ...
  public void testSimpleBHSWithNegativeJump() {
    try {
      ...
      final AssembledBHSInstruction line = ((AssembledBHSInstruction) _assembledLine);
