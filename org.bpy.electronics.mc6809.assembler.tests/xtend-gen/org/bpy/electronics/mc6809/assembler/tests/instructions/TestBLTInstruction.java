...
public class TestBLTInstruction {
  ...
  public void testSimpleBLTWithExtraSpace() {
    try {
      ...
      Assert.assertTrue("Must be an BLT directive line", (_instruction instanceof BltInstruction));
    } catch (Throwable _e) {
  ...
  public void testSimpleBLTWithWithLabel() {
    try {
      ...
      _builder.append("ASLB");
      _builder.newLine();
      _builder.append("MyBanch\t\tBLT\t\tJump");
      _builder.newLine();
      final Model result = this.parseHelper.parse(_builder);
      Assert.assertNotNull(result);
      this._validationTestHelper.assertNoErrors(result);
  ...
  public void testSimpleBLTWithDuplicateLabel() {
    try {
      ...
      _builder.append("NOP");
      _builder.newLine();
      _builder.append("Jump\t\tBLT\t\tJump\t\t; Jump=3FFF");
      _builder.newLine();
      final Model result = this.parseHelper.parse(_builder);
      Assert.assertNotNull(result);
  ...
  public void testSimpleBLTWithBadLabel() {
    try {
      ...
      _builder.append("NOP");
      _builder.newLine();
      _builder.append("Jump\t\tBLT\t\tJump2\t\t; Jump=3FFF");
      _builder.newLine();
      final Model result = this.parseHelper.parse(_builder);
      Assert.assertNotNull(result);
  ...
  public void testSimpleBLTWithNegativeJump() {
    try {
      ...
      final AssembledBLTInstruction line = ((AssembledBLTInstruction) _assembledLine);
