...
public class TestLSRInstruction {
  ...
  public void testSimpleLSRAWithExtraSpaceWithComment() {
    try {
      ...
      _builder.newLine();
      _builder.append("\t       ");
      _builder.append("LSRA  \t\t\t; It is a comment ");
      _builder.newLine();
      final Model result = this.parseHelper.parse(_builder);
      Assert.assertNotNull(result);
      this._validationTestHelper.assertNoErrors(result);
  ...
  public void testLSRDirectAddressingMode() {
    try {
      ...
      final InstructionLine instructionLine = ((InstructionLine) _lineContent_1);
      EObject _instruction = instructionLine.getInstruction();
      Assert.assertTrue("Must be an ADD directive line", (_instruction instanceof LsrInstruction));
      EObject _instruction_1 = instructionLine.getInstruction();
  ...
  public void testLSRAutoIncrementIndexed() {
    try {
      ...
      _builder.newLine();
      _builder.append("\t       \t");
      _builder.append("LSR\t\t  \t0,--S");
      _builder.newLine();
      _builder.append("\t       \t");
      _builder.append("LSR\t\t  \t0,-S");
      _builder.newLine();
      _builder.append("\t       \t");
      _builder.append("LSR\t\t  \tConst,U+");
      _builder.newLine();
      _builder.append("\t       \t");
      _builder.append("LSR\t\t  \tConst,U++");
      _builder.newLine();
  ...
  public void testLSRRelativePCIndexed() {
    try {
      ...
      _builder.newLine();
      _builder.append("\t       \t");
      _builder.append("LSR\t\t  \t0,PCR");
      _builder.newLine();
      _builder.append("\t       \t");
      _builder.append("LSR\t\t  \t,PCR");
      _builder.newLine();
      _builder.append("\t       \t");
      _builder.append("LSR\t\t  \tConst,PCR");
      _builder.newLine();
      final Model result = this.parseHelper.parse(_builder);
      Assert.assertNotNull(result);
      this._validationTestHelper.assertNoErrors(result);
