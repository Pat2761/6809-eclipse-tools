...
public class TestOrgDirective {
  ...
  public void testOrgWithIdentifierValue() {
    try {
      ...
      Assert.assertTrue("Must be an ORG directive line", (_directive_1 instanceof OrgDirective));
    } catch (Throwable _e) {
      throw Exceptions.sneakyThrow(_e);
    }
  }
  ...
  public void testORGWithRelativeValueToPC() {
    try {
      ...
      _builder.newLine();
      _builder.append("            ");
      _builder.append("ORG    *+100         ; Start program at $4000");
      _builder.newLine();
      final Model result = this.parseHelper.parse(_builder);
      Assert.assertNotNull(result);
      this._validationTestHelper.assertNoErrors(result);
  ...
  public void testSorekOrg1() {
    try {
      ...
      _builder.newLine();
      _builder.append("       ");
      _builder.append("ORG    $0400 \t\t; opérande du type constante");
      _builder.newLine();
      final Model result = this.parseHelper.parse(_builder);
      Assert.assertNotNull(result);
      this._validationTestHelper.assertNoErrors(result);
  ...
  public void testSorekOrg2() {
    try {
      ...
      _builder.append("; -----------------------------------------");
      _builder.newLine();
      _builder.append("RESET\tEQU\t\t\t$4000\t\t; Reset");
      _builder.newLine();
      _builder.newLine();
      _builder.append("        ");
      _builder.append("ORG         RESET       ; opérande du type symbole");
      _builder.newLine();
      final Model result = this.parseHelper.parse(_builder);
      Assert.assertNotNull(result);
      this._validationTestHelper.assertNoErrors(result);
  ...
  public void testSorekOrg3() {
    try {
      ...
      _builder.newLine();
      _builder.append("        ");
      _builder.append("ORG         *+100       ; opérande du type expression");
      _builder.newLine();
      final Model result = this.parseHelper.parse(_builder);
      Assert.assertNotNull(result);
      this._validationTestHelper.assertNoErrors(result);
  ...
  public void testSorekOrg4() {
    try {
      ...
      _builder.append("; -----------------------------------------");
      _builder.newLine();
      _builder.append("SBR1\t\t\tEQU\t\t\t100\t");
      _builder.newLine();
      _builder.append("LGTAB\t\t\tEQU\t\t\t200");
      _builder.newLine();
      _builder.newLine();
      _builder.append("\t      \t\t");
      _builder.append("ORG         SBR1+LGTAB*8       ; opérande du type expression");
      _builder.newLine();
      final Model result = this.parseHelper.parse(_builder);
      Assert.assertNotNull(result);
      this._validationTestHelper.assertNoErrors(result);
