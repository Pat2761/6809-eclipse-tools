...
public class TestBLSInstruction {
  ...
  public void testSimpleBLSWithExtraSpace() {
    try {
      ...
      Assert.assertTrue("Must be an BLS directive line", (_instruction instanceof BlsInstruction));
    } catch (Throwable _e) {
  ...
  public void testSimpleBLSWithWithLabel() {
    try {
      ...
      _builder.append("ASLB");
      _builder.newLine();
      _builder.append("MyBanch\t\tBLS\t\tJump");
      _builder.newLine();
      final Model result = this.parseHelper.parse(_builder);
      Assert.assertNotNull(result);
      this._validationTestHelper.assertNoErrors(result);
  ...
  public void testSimpleBLSWithDuplicateLabel() {
    try {
      ...
      _builder.append("NOP");
      _builder.newLine();
      _builder.append("Jump\t\tBLS\t\tJump\t\t; Jump=3FFF");
      _builder.newLine();
      final Model result = this.parseHelper.parse(_builder);
      Assert.assertNotNull(result);
  ...
  public void testSimpleBLSWithBadLabel() {
    try {
      ...
      _builder.append("NOP");
      _builder.newLine();
      _builder.append("Jump\t\tBLS\t\tJump2\t\t; Jump=3FFF");
      _builder.newLine();
      final Model result = this.parseHelper.parse(_builder);
      Assert.assertNotNull(result);
      this._validationTestHelper.assertError(result, AssemblerPackage.eINSTANCE.getBlsInstruction(), 
  ...
  public void testSimpleBLSWithNegativeJump() {
    try {
      ...
      final AssembledBLSInstruction line = ((AssembledBLSInstruction) _assembledLine);
