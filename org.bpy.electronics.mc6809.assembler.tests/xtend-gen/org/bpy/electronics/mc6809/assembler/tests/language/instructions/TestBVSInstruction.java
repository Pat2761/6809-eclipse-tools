...
public class TestBVSInstruction {
  ...
  public void testSimpleBVSWithExtraSpace() {
    try {
      ...
      Assert.assertTrue("Must be an BVS directive line", (_instruction instanceof BvsInstruction));
    } catch (Throwable _e) {
  ...
  public void testSimpleBVSWithWithLabel() {
    try {
      ...
      _builder.append("ASLB");
      _builder.newLine();
      _builder.append("MyBanch\t\tBVS\t\tJump");
      _builder.newLine();
      final Model result = this.parseHelper.parse(_builder);
      Assert.assertNotNull(result);
      this._validationTestHelper.assertNoErrors(result);
  ...
  public void testSimpleBVSWithDuplicateLabel() {
    try {
      ...
      _builder.append("NOP");
      _builder.newLine();
      _builder.append("Jump\t\tBVS\t\tJump\t\t; Jump=3FFF");
      _builder.newLine();
      final Model result = this.parseHelper.parse(_builder);
      Assert.assertNotNull(result);
  ...
  public void testSimpleBVSWithBadLabel() {
    try {
      ...
      _builder.append("NOP");
      _builder.newLine();
      _builder.append("Jump\t\tBVS\t\tJump2\t\t; Jump=3FFF");
      _builder.newLine();
      final Model result = this.parseHelper.parse(_builder);
      Assert.assertNotNull(result);
  ...
  public void testSimpleBVSWithNegativeJump() {
    try {
      ...
      final AssembledBVSInstruction line = ((AssembledBVSInstruction) _assembledLine);
