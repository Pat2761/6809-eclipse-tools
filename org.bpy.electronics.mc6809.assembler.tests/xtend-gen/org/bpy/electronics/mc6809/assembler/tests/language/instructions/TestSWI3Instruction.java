...
public class TestSWI3Instruction {
  ...
  public void testSimpleSWI3WithExtraSpace() {
    try {
      ...
      Assert.assertTrue("Must be an Lsr Accumulateur line", (_instruction instanceof Swi3Instruction));
      EObject _instruction_1 = instructionLine.getInstruction();
      final Swi3Instruction Swi3Instruction = ((org.bpy.electronics.mc6809.assembler.assembler.Swi3Instruction) _instruction_1);
  ...
  public void testSimpleSWI3WithExtraSpaceWithComment() {
    try {
      ...
      _builder.newLine();
      _builder.append("\t       ");
      _builder.append("SWI3  \t\t\t; It is a comment ");
      _builder.newLine();
      final Model result = this.parseHelper.parse(_builder);
      Assert.assertNotNull(result);
      this._validationTestHelper.assertNoErrors(result);
  ...
  public void testSWI3Assembly() {
    try {
      ...
      _builder.append("ORG    \t\t\t$8000");
      _builder.newLine();
      _builder.append("Start      \tSWI3\t\t  \t\t    ; 11 3F   SWI3");
      _builder.newLine();
      final Model result = this.parseHelper.parse(_builder);
      Assert.assertNotNull(result);
      this._validationTestHelper.assertNoErrors(result);
      ...
      final AssembledSWI3Instruction line = ((AssembledSWI3Instruction) _assembledLine);
      ...
      Assert.assertEquals("Check comment", "; 11 3F   SWI3", line.getComment());
    } catch (Throwable _e) {
      throw Exceptions.sneakyThrow(_e);
    }
  }
