...
public class TestLBLOInstruction {
  ...
  public void testSimpleLBLOWithExtraSpace() {
    try {
      ...
      Assert.assertTrue("Must be an LBLO directive line", (_instruction instanceof BloInstruction));
    } catch (Throwable _e) {
  ...
  public void testSimpleLBLOWithDuplicateLabel() {
    try {
      ...
      _builder.append("NOP");
      _builder.newLine();
      _builder.append("Jump\t\tLBLO\t\tJump\t\t; Jump=3FFF");
      _builder.newLine();
      final Model result = this.parseHelper.parse(_builder);
      Assert.assertNotNull(result);
  ...
  public void testSimpleLBLOWithBadLabel() {
    try {
      ...
      _builder.append("NOP");
      _builder.newLine();
      _builder.append("Jump\t\tLBLO\t\tJump2\t\t; Jump=3FFF");
      _builder.newLine();
      final Model result = this.parseHelper.parse(_builder);
      Assert.assertNotNull(result);
  ...
  public void testSimpleLBLOWithWithLabel() {
    try {
      ...
      _builder.append("ASLB");
      _builder.newLine();
      _builder.append("MyBanch\t\tLBLO\t\tJump");
      _builder.newLine();
      final Model result = this.parseHelper.parse(_builder);
      Assert.assertNotNull(result);
      this._validationTestHelper.assertNoErrors(result);
  ...
  public void testSimpleLBLOWithNegativeJump1() {
    try {
      ...
      _builder.newLine();
      _builder.append("MyBanch\t\tLBLO\tJump\t\t; Jump=1024FF80");
      _builder.newLine();
      final Model result = this.parseHelper.parse(_builder);
      Assert.assertNotNull(result);
      ...
      final AssembledLBLOInstruction line = ((AssembledLBLOInstruction) _assembledLine);
  ...
  public void testSimpleLBLOWithNegativeJump2() {
    try {
      ...
      _builder.append("ORG     $8080");
      _builder.newLine();
      _builder.append("MyBanch\t\tLBLO\tJump\t\t; Jump=1024FF7F");
      _builder.newLine();
      final Model result = this.parseHelper.parse(_builder);
      Assert.assertNotNull(result);
  ...
  public void testSimpleLBLOWithPositiveJump1() {
    try {
      ...
      _builder.append("ORG     $8000");
      _builder.newLine();
      _builder.append("MyBanch\t\tLBLO\t\tJump\t\t; Jump=1024007F");
      _builder.newLine();
      _builder.append("\t\t\t");
  ...
  public void testSimpleLBLOWithPositiveJump2() {
    try {
      ...
      _builder.append("ORG     $8000");
      _builder.newLine();
      _builder.append("MyBanch\t\tLBLO\t\tJump\t\t; Jump=10240080");
      _builder.newLine();
      _builder.append("\t\t\t");
  ...
  public void testSimpleLBLOWithPositiveLimitJump1() {
    try {
      ...
      _builder.newLine();
      _builder.append("MyBranch\tLBLO\t\tJump\t\t; Jump=10257FFF");
      _builder.newLine();
      _builder.append("\t\t\t");
      _builder.append("ORG     $8003");
      _builder.newLine();
  ...
  public void testSimpleLBLOWithPositiveLimitJump2() {
    try {
      ...
      _builder.append("ORG     $0000");
      _builder.newLine();
      _builder.append("MyBanch\t\tLBLO\tJump\t\t; Jump=10248000");
      _builder.newLine();
      _builder.append("\t\t\t");
      _builder.append("ORG     $8004");
      _builder.newLine();
