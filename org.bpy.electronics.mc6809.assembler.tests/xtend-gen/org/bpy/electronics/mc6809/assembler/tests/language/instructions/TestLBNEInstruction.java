...
public class TestLBNEInstruction {
  ...
  public void testSimpleLBNEWithExtraSpace() {
    try {
      ...
      Assert.assertTrue("Must be an LBNE directive line", (_instruction instanceof BneInstruction));
    } catch (Throwable _e) {
  ...
  public void testSimpleLBNEWithDuplicateLabel() {
    try {
      ...
      _builder.append("NOP");
      _builder.newLine();
      _builder.append("Jump\t\tLBNE\t\tJump\t\t; Jump=3FFF");
      _builder.newLine();
      final Model result = this.parseHelper.parse(_builder);
      Assert.assertNotNull(result);
  ...
  public void testSimpleLBNEWithBadLabel() {
    try {
      ...
      _builder.append("NOP");
      _builder.newLine();
      _builder.append("Jump\t\tLBNE\t\tJump2\t\t; Jump=3FFF");
      _builder.newLine();
      final Model result = this.parseHelper.parse(_builder);
      Assert.assertNotNull(result);
  ...
  public void testSimpleLBNEWithWithLabel() {
    try {
      ...
      _builder.append("ASLB");
      _builder.newLine();
      _builder.append("MyBanch\t\tLBNE\t\tJump");
      _builder.newLine();
      final Model result = this.parseHelper.parse(_builder);
      Assert.assertNotNull(result);
      this._validationTestHelper.assertNoErrors(result);
  ...
  public void testSimpleLBNEWithNegativeJump1() {
    try {
      ...
      _builder.newLine();
      _builder.append("MyBanch\t\tLBNE\tJump\t\t; Jump=1024FF80");
      _builder.newLine();
      final Model result = this.parseHelper.parse(_builder);
      Assert.assertNotNull(result);
      ...
      final AssembledLBNEInstruction line = ((AssembledLBNEInstruction) _assembledLine);
  ...
  public void testSimpleLBNEWithNegativeJump2() {
    try {
      ...
      _builder.append("ORG     $8080");
      _builder.newLine();
      _builder.append("MyBanch\t\tLBNE\tJump\t\t; Jump=1024FF7F");
      _builder.newLine();
      final Model result = this.parseHelper.parse(_builder);
      Assert.assertNotNull(result);
  ...
  public void testSimpleLBNEWithPositiveJump1() {
    try {
      ...
      _builder.append("ORG     $8000");
      _builder.newLine();
      _builder.append("MyBanch\t\tLBNE\t\tJump\t\t; Jump=1024007F");
      _builder.newLine();
      _builder.append("\t\t\t");
  ...
  public void testSimpleLBNEWithPositiveJump2() {
    try {
      ...
      _builder.append("ORG     $8000");
      _builder.newLine();
      _builder.append("MyBanch\t\tLBNE\t\tJump\t\t; Jump=10240080");
      _builder.newLine();
      _builder.append("\t\t\t");
  ...
  public void testSimpleLBNEWithPositiveLimitJump1() {
    try {
      ...
      _builder.newLine();
      _builder.append("MyBranch\tLBNE\t\tJump\t\t; Jump=10257FFF");
      _builder.newLine();
      _builder.append("\t\t\t");
      _builder.append("ORG     $8003");
      _builder.newLine();
  ...
  public void testSimpleLBNEWithPositiveLimitJump2() {
    try {
      ...
      _builder.append("ORG     $0000");
      _builder.newLine();
      _builder.append("MyBanch\t\tLBNE\tJump\t\t; Jump=10248000");
      _builder.newLine();
      _builder.append("\t\t\t");
      _builder.append("ORG     $8004");
      _builder.newLine();
