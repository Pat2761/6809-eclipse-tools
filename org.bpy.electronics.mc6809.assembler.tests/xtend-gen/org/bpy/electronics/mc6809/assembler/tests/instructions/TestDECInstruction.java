...
public class TestDECInstruction {
  ...
  public void testSimpleDECAWithExtraSpace() {
    try {
      ...
      Assert.assertTrue("Must be an DEC Accumulateur line", (_instruction instanceof DecInstruction));
      EObject _instruction_1 = instructionLine.getInstruction();
      final DecInstruction decInstruction = ((DecInstruction) _instruction_1);
      Assert.assertEquals("Must be an DECA instruction", "DECA", decInstruction.getInstruction());
    } catch (Throwable _e) {
  ...
  public void testSimpleDECBWithExtraSpace() {
    try {
      ...
      EObject _instruction_1 = instructionLine.getInstruction();
      final DecInstruction decInstruction = ((DecInstruction) _instruction_1);
      Assert.assertEquals("Must be an DECB instruction", "DECB", decInstruction.getInstruction());
    } catch (Throwable _e) {
      throw Exceptions.sneakyThrow(_e);
    }
  }
  ...
  public void testSimpleDECBWithExtraSpaceWithComment() {
    try {
      ...
      _builder.newLine();
      _builder.append("\t       ");
      _builder.append("DECB  \t\t\t; It is a comment ");
      _builder.newLine();
      final Model result = this.parseHelper.parse(_builder);
      Assert.assertNotNull(result);
      this._validationTestHelper.assertNoErrors(result);
  ...
  public void testDECDirectAddressingMode() {
    try {
      ...
      final InstructionLine instructionLine = ((InstructionLine) _lineContent_1);
      EObject _instruction = instructionLine.getInstruction();
      Assert.assertTrue("Must be an ADD directive line", (_instruction instanceof DecInstruction));
      EObject _instruction_1 = instructionLine.getInstruction();
      final DecInstruction decInstruction = ((DecInstruction) _instruction_1);
  ...
  public void testDECAutoIncrementIndexed() {
    try {
      ...
      _builder.newLine();
      _builder.append("\t       \t");
      _builder.append("DEC\t\t  \t0,--S");
      _builder.newLine();
      _builder.append("\t       \t");
      _builder.append("DEC\t\t  \t0,-S");
      _builder.newLine();
      _builder.append("\t       \t");
      _builder.append("DEC\t\t  \tConst,U+");
      _builder.newLine();
      _builder.append("\t       \t");
      _builder.append("DEC\t\t  \tConst,U++");
      _builder.newLine();
  ...
  public void testDECRelativePCIndexed() {
    try {
      ...
      _builder.newLine();
      _builder.append("\t       \t");
      _builder.append("DEC\t\t  \t0,PCR");
      _builder.newLine();
      _builder.append("\t       \t");
      _builder.append("DEC\t\t  \t,PCR");
      _builder.newLine();
      _builder.append("\t       \t");
      _builder.append("DEC\t\t  \tConst,PCR");
      _builder.newLine();
      final Model result = this.parseHelper.parse(_builder);
      Assert.assertNotNull(result);
      this._validationTestHelper.assertNoErrors(result);
