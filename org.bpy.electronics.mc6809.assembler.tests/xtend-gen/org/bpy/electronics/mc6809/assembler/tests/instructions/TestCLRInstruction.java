...
public class TestCLRInstruction {
  ...
  public void testSimpleCLRAWithExtraSpace() {
    try {
      ...
      Assert.assertTrue("Must be an CLR Accumulateur line", (_instruction instanceof ClrInstruction));
      EObject _instruction_1 = instructionLine.getInstruction();
      final ClrInstruction clrInstruction = ((ClrInstruction) _instruction_1);
      Assert.assertEquals("Must be an CLRA instruction", "CLRA", clrInstruction.getInstruction());
    } catch (Throwable _e) {
  ...
  public void testSimpleCLRAWithExtraSpaceWithComment() {
    try {
      ...
      _builder.newLine();
      _builder.append("\t       ");
      _builder.append("CLRA  \t\t\t; It is a comment ");
      _builder.newLine();
      final Model result = this.parseHelper.parse(_builder);
      Assert.assertNotNull(result);
      this._validationTestHelper.assertNoErrors(result);
  ...
  public void testSimpleCLRBWithExtraSpace() {
    try {
      ...
      EObject _instruction_1 = instructionLine.getInstruction();
      final ClrInstruction clrInstruction = ((ClrInstruction) _instruction_1);
      Assert.assertEquals("Must be an CLRB instruction", "CLRB", clrInstruction.getInstruction());
    } catch (Throwable _e) {
      throw Exceptions.sneakyThrow(_e);
    }
  }
  ...
  public void testCLRDirectAddressingMode() {
    try {
      ...
      final InstructionLine instructionLine = ((InstructionLine) _lineContent_1);
      EObject _instruction = instructionLine.getInstruction();
      Assert.assertTrue("Must be an ADD directive line", (_instruction instanceof ClrInstruction));
      EObject _instruction_1 = instructionLine.getInstruction();
      final ClrInstruction clrInstruction = ((ClrInstruction) _instruction_1);
  ...
  public void testCLRAutoIncrementIndexed() {
    try {
      ...
      _builder.newLine();
      _builder.append("\t       \t");
      _builder.append("CLR\t\t  \t0,--S");
      _builder.newLine();
      _builder.append("\t       \t");
      _builder.append("CLR\t\t  \t0,-S");
      _builder.newLine();
      _builder.append("\t       \t");
      _builder.append("CLR\t\t  \tConst,U+");
      _builder.newLine();
      _builder.append("\t       \t");
      _builder.append("CLR\t\t  \tConst,U++");
      _builder.newLine();
  ...
  public void testCLRRelativePCIndexed() {
    try {
      ...
      _builder.newLine();
      _builder.append("\t       \t");
      _builder.append("CLR\t\t  \t0,PCR");
      _builder.newLine();
      _builder.append("\t       \t");
      _builder.append("CLR\t\t  \t,PCR");
      _builder.newLine();
      _builder.append("\t       \t");
      _builder.append("CLR\t\t  \tConst,PCR");
      _builder.newLine();
      final Model result = this.parseHelper.parse(_builder);
      Assert.assertNotNull(result);
      this._validationTestHelper.assertNoErrors(result);
