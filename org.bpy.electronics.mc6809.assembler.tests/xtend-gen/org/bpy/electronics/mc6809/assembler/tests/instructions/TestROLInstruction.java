...
public class TestROLInstruction {
  ...
  public void testSimpleROLAWithExtraSpace() {
    try {
      ...
      Assert.assertTrue("Must be an Rol Accumulateur line", (_instruction instanceof RolInstruction));
  ...
  public void testSimpleROLAWithExtraSpaceWithComment() {
    try {
      ...
      _builder.newLine();
      _builder.append("\t       ");
      _builder.append("ROLA  \t\t\t; It is a comment ");
      _builder.newLine();
      final Model result = this.parseHelper.parse(_builder);
      Assert.assertNotNull(result);
      this._validationTestHelper.assertNoErrors(result);
   ...
   */
  @Test
  public void testSimpleROLBWithExtraSpace() {
    try {
      StringConcatenation _builder = new StringConcatenation();
      _builder.append("; -----------------------------------------");
      _builder.newLine();
      ...
      EObject _instruction_1 = instructionLine.getInstruction();
      final RolInstruction rolInstruction = ((RolInstruction) _instruction_1);
      Assert.assertEquals("Must be an ROLB instruction", "ROLB", rolInstruction.getInstruction());
    } catch (Throwable _e) {
      throw Exceptions.sneakyThrow(_e);
    }
  }
   ...
   */
  @Test
  public void testSimpleROLBWithoutExtraSpace() {
    try {
      StringConcatenation _builder = new StringConcatenation();
      _builder.append("; -----------------------------------------");
      _builder.newLine();
   ...
   */
  @Test
  public void testSimpleROLBWithExtraSpaceWithComment() {
    try {
      StringConcatenation _builder = new StringConcatenation();
      _builder.append("; -----------------------------------------");
      _builder.newLine();
      ...
      _builder.newLine();
      _builder.append("\t       ");
      _builder.append("ROLB  \t\t\t; It is a comment ");
      _builder.newLine();
      final Model result = this.parseHelper.parse(_builder);
      Assert.assertNotNull(result);
      this._validationTestHelper.assertNoErrors(result);
   ...
   */
  @Test
  public void testSimpleROLBWithoutExtraSpaceWithComment() {
    try {
      StringConcatenation _builder = new StringConcatenation();
      _builder.append("; -----------------------------------------");
      _builder.newLine();
  ...
  public void testROLDirectAddressingMode() {
    try {
      ...
      final InstructionLine instructionLine = ((InstructionLine) _lineContent_1);
      EObject _instruction = instructionLine.getInstruction();
      Assert.assertTrue("Must be an ADD directive line", (_instruction instanceof RolInstruction));
      EObject _instruction_1 = instructionLine.getInstruction();
      final RolInstruction RolInstruction = ((org.bpy.electronics.mc6809.assembler.assembler.RolInstruction) _instruction_1);
  ...
  public void testROLAutoIncrementIndexed() {
    try {
      ...
      _builder.newLine();
      _builder.append("\t       \t");
      _builder.append("ROL\t\t  \t0,--S");
      _builder.newLine();
      _builder.append("\t       \t");
      _builder.append("ROL\t\t  \t0,-S");
      _builder.newLine();
      _builder.append("\t       \t");
      _builder.append("ROL\t\t  \tConst,U+");
      _builder.newLine();
      _builder.append("\t       \t");
      _builder.append("ROL\t\t  \tConst,U++");
      _builder.newLine();
  ...
  public void testROLRelativePCIndexed() {
    try {
      ...
      _builder.newLine();
      _builder.append("\t       \t");
      _builder.append("ROL\t\t  \t0,PCR");
      _builder.newLine();
      _builder.append("\t       \t");
      _builder.append("ROL\t\t  \t,PCR");
      _builder.newLine();
      _builder.append("\t       \t");
      _builder.append("ROL\t\t  \tConst,PCR");
      _builder.newLine();
      final Model result = this.parseHelper.parse(_builder);
      Assert.assertNotNull(result);
      this._validationTestHelper.assertNoErrors(result);
