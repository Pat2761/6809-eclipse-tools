...
public class TestPULSInstruction {
   ...
   */
  @Test
  public void testPULSImemdiatAddressingMode1() {
    try {
      ...
      Assert.assertTrue("Must be an PULS directive line", (_instruction instanceof PulsInstruction));
      EObject _instruction_1 = instructionLine.getInstruction();
      final PulsInstruction pulsInstruction = ((PulsInstruction) _instruction_1);
      ImmediatOperand _operand = pulsInstruction.getOperand();
  ...
  public void testPULSImemdiatAddressingMode3() {
    try {
      ...
      EObject _instruction_1 = instructionLine.getInstruction();
      final PulsInstruction pulsInstruction = ((PulsInstruction) _instruction_1);
      Assert.assertEquals("Must be an PULS instruction", pulsInstruction.getInstruction(), "PULS");
    } catch (Throwable _e) {
      throw Exceptions.sneakyThrow(_e);
    }
  }
