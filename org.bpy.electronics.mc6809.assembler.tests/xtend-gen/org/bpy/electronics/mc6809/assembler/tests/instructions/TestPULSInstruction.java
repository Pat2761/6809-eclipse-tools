...
public class TestPULSInstruction {
  ...
  public void testPULSImemdiatAddressingMode2() {
    try {
      ...
      _builder.newLine();
      _builder.append("\t       ");
      _builder.append("PULS\t\t  \t#Registers");
      _builder.newLine();
      ...
      Assert.assertTrue("Must be an PULS instruction line", (_instruction instanceof PulsInstruction));
    } catch (Throwable _e) {
  ...
  public void testPULSImemdiate1() {
    try {
      ...
      _builder.newLine();
      _builder.append("\t       ");
      _builder.append("PULS\t\t  \tPC,U,Y,X,DP,B,A,CC");
      _builder.newLine();
      final Model result = this.parseHelper.parse(_builder);
      Assert.assertNotNull(result);
      this._validationTestHelper.assertNoErrors(result);
      ...
      final PulsInstruction phshInstruction = ((PulsInstruction) _instruction_1);
      Assert.assertEquals("Must be an PULS instruction", phshInstruction.getInstruction(), "PULS");
    } catch (Throwable _e) {
      throw Exceptions.sneakyThrow(_e);
    }
  }
  ...
  public void testPULSImemdiatAddressingMode3() {
    try {
      ...
      _builder.newLine();
      _builder.append("PushPull        PULS\t\t#RegDir       ; push register");
      _builder.newLine();
      final Model result = this.parseHelper.parse(_builder);
      Assert.assertNotNull(result);
      this._validationTestHelper.assertNoErrors(result);
      ...
      final AssembledPULSInstruction line = ((AssembledPULSInstruction) _assembledLine);
  ...
  public void testPULSMissingReg() {
    try {
      ...
      _builder.append("ORG    \t\t$8000");
      _builder.newLine();
      _builder.append("Pshs       PULS\t\t  \t#RegDir       ; push register");
      _builder.newLine();
      final Model result = this.parseHelper.parse(_builder);
      Assert.assertNotNull(result);
  ...
  public void testInstructionWithAAndDRegister() {
    try {
      StringConcatenation _builder = new StringConcatenation();
      _builder.append("; test PULS without label");
      _builder.newLine();
      _builder.append("\t \t    ");
      _builder.append("PULS    A,D \t\t ; Oups");
      _builder.newLine();
      final Model result = this.parseHelper.parse(_builder);
      Assert.assertNotNull(result);
      this._validationTestHelper.assertError(result, AssemblerPackage.eINSTANCE.getPulsInstruction(), InstructionValidator.DUPLICATE_OPTION, "D register overwrite the A register in the REG Directive");
    } catch (Throwable _e) {
      throw Exceptions.sneakyThrow(_e);
    }
  }
  ...
  public void testInstructionWithBAndDRegister() {
    try {
      ...
      _builder.newLine();
      _builder.append("\t \t    ");
      _builder.append("PULS    B,D \t\t ; Oups");
      _builder.newLine();
      final Model result = this.parseHelper.parse(_builder);
      Assert.assertNotNull(result);
      this._validationTestHelper.assertError(result, AssemblerPackage.eINSTANCE.getPulsInstruction(), InstructionValidator.DUPLICATE_OPTION, "D register overwrite the B register in the REG Directive");
    } catch (Throwable _e) {
      throw Exceptions.sneakyThrow(_e);
    }
  }
  ...
  public void testInstructionWithDuplicateLabel() {
    try {
      ...
      _builder.newLine();
      _builder.append("Lab1\t \tPULS    \tB,A \t\t ; Oups");
      _builder.newLine();
      final Model result = this.parseHelper.parse(_builder);
      Assert.assertNotNull(result);
  ...
  public void testInstructionOperandRegS() {
    try {
      ...
      _builder.newLine();
      _builder.append("\t \t    ");
      _builder.append("PULS   \t#REG_S \t\t ; Oups");
      _builder.newLine();
      final Model result = this.parseHelper.parse(_builder);
      Assert.assertNotNull(result);
      this._validationTestHelper.assertError(result, 
