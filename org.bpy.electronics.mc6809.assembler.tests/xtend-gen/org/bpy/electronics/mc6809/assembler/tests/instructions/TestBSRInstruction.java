...
public class TestBSRInstruction {
  ...
  public void testSimpleBSRWithExtraSpace() {
    try {
      ...
      Assert.assertTrue("Must be an BSR directive line", (_instruction instanceof BsrInstruction));
    } catch (Throwable _e) {
  ...
  public void testSimpleBSRWithWithLabel() {
    try {
      ...
      _builder.append("ASLB");
      _builder.newLine();
      _builder.append("MyBanch\t\tBSR\t\tJump");
      _builder.newLine();
      final Model result = this.parseHelper.parse(_builder);
      Assert.assertNotNull(result);
      this._validationTestHelper.assertNoErrors(result);
  ...
  public void testSimpleBSRWithDuplicateLabel() {
    try {
      ...
      _builder.append("NOP");
      _builder.newLine();
      _builder.append("Jump\t\tBSR\t\tJump\t\t; Jump=3FFF");
      _builder.newLine();
      final Model result = this.parseHelper.parse(_builder);
      Assert.assertNotNull(result);
  ...
  public void testSimpleBSRWithBadLabel() {
    try {
      ...
      _builder.append("NOP");
      _builder.newLine();
      _builder.append("Jump\t\tBSR\t\tJump2\t\t; Jump=3FFF");
      _builder.newLine();
      final Model result = this.parseHelper.parse(_builder);
      Assert.assertNotNull(result);
  ...
  public void testSimpleBSRWithNegativeJump() {
    try {
      ...
      final AssembledBSRInstruction line = ((AssembledBSRInstruction) _assembledLine);
