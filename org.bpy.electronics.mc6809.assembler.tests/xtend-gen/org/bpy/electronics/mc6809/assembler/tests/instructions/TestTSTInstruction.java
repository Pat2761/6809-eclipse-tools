...
public class TestTSTInstruction {
   ...
   */
  @Test
  public void testSimpleTSTAWithExtraSpace() {
    try {
      ...
      Assert.assertTrue("Must be an Tst Accumulateur line", (_instruction instanceof TstInstruction));
      EObject _instruction_1 = instructionLine.getInstruction();
      final TstInstruction tstInstruction = ((TstInstruction) _instruction_1);
      Assert.assertEquals("Must be an TSTA instruction", "TSTA", tstInstruction.getInstruction());
    } catch (Throwable _e) {
   ...
   */
  @Test
  public void testSimpleTSTAWithoutExtraSpace() {
    try {
      StringConcatenation _builder = new StringConcatenation();
      _builder.append("; -----------------------------------------");
      _builder.newLine();
   ...
   */
  @Test
  public void testSimpleTSTAWithExtraSpaceWithComment() {
    try {
      StringConcatenation _builder = new StringConcatenation();
      _builder.append("; -----------------------------------------");
      _builder.newLine();
      ...
      _builder.newLine();
      _builder.append("\t       ");
      _builder.append("TSTA  \t\t\t; It is a comment ");
      _builder.newLine();
      final Model result = this.parseHelper.parse(_builder);
      Assert.assertNotNull(result);
      this._validationTestHelper.assertNoErrors(result);
   ...
   */
  @Test
  public void testSimpleTSTAWithoutExtraSpaceWithComment() {
    try {
      StringConcatenation _builder = new StringConcatenation();
      _builder.append("; -----------------------------------------");
      _builder.newLine();
   ...
   */
  @Test
  public void testSimpleTSTBWithExtraSpace() {
    try {
      StringConcatenation _builder = new StringConcatenation();
      _builder.append("; -----------------------------------------");
      _builder.newLine();
      ...
      EObject _instruction_1 = instructionLine.getInstruction();
      final TstInstruction tstInstruction = ((TstInstruction) _instruction_1);
      Assert.assertEquals("Must be an TSTB instruction", "TSTB", tstInstruction.getInstruction());
    } catch (Throwable _e) {
      throw Exceptions.sneakyThrow(_e);
    }
  }
   ...
   */
  @Test
  public void testSimpleTSTBWithoutExtraSpace() {
    try {
      StringConcatenation _builder = new StringConcatenation();
      _builder.append("; -----------------------------------------");
      _builder.newLine();
   ...
   */
  @Test
  public void testSimpleTSTBWithExtraSpaceWithComment() {
    try {
      StringConcatenation _builder = new StringConcatenation();
      _builder.append("; -----------------------------------------");
      _builder.newLine();
      ...
      _builder.newLine();
      _builder.append("\t       ");
      _builder.append("TSTB  \t\t\t; It is a comment ");
      _builder.newLine();
      final Model result = this.parseHelper.parse(_builder);
      Assert.assertNotNull(result);
      this._validationTestHelper.assertNoErrors(result);
   ...
   */
  @Test
  public void testSimpleTSTBWithoutExtraSpaceWithComment() {
    try {
      StringConcatenation _builder = new StringConcatenation();
      _builder.append("; -----------------------------------------");
      _builder.newLine();
  ...
  public void testTSTDirectAddressingMode() {
    try {
      ...
      final InstructionLine instructionLine = ((InstructionLine) _lineContent_1);
      EObject _instruction = instructionLine.getInstruction();
      Assert.assertTrue("Must be an ADD directive line", (_instruction instanceof TstInstruction));
      EObject _instruction_1 = instructionLine.getInstruction();
      final TstInstruction TstInstruction = ((org.bpy.electronics.mc6809.assembler.assembler.TstInstruction) _instruction_1);
  ...
  public void testTSTAutoIncrementIndexed() {
    try {
      ...
      _builder.newLine();
      _builder.append("\t       \t");
      _builder.append("TST\t\t  \t0,--S");
      _builder.newLine();
      _builder.append("\t       \t");
      _builder.append("TST\t\t  \t0,-S");
      _builder.newLine();
      _builder.append("\t       \t");
      _builder.append("TST\t\t  \tConst,U+");
      _builder.newLine();
      _builder.append("\t       \t");
      _builder.append("TST\t\t  \tConst,U++");
      _builder.newLine();
  ...
  public void testTSTRelativePCIndexed() {
    try {
      ...
      _builder.newLine();
      _builder.append("\t       \t");
      _builder.append("TST\t\t  \t0,PCR");
      _builder.newLine();
      _builder.append("\t       \t");
      _builder.append("TST\t\t  \t,PCR");
      _builder.newLine();
      _builder.append("\t       \t");
      _builder.append("TST\t\t  \tConst,PCR");
      _builder.newLine();
      final Model result = this.parseHelper.parse(_builder);
      Assert.assertNotNull(result);
      this._validationTestHelper.assertNoErrors(result);
