...
public class TestCWAIInstruction {
  ...
  public void testCWAIImemdiatAddressingMode() {
    try {
      ...
      Assert.assertTrue("Must be an CWAI directive line", (_instruction instanceof CwaiInstruction));
      EObject _instruction_1 = instructionLine.getInstruction();
      final CwaiInstruction cwaiInstruction = ((CwaiInstruction) _instruction_1);
      ImmediatOperand _operand = cwaiInstruction.getOperand();
