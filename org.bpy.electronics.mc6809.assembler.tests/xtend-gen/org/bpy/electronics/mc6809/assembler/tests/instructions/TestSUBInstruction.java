...
public class TestSUBInstruction {
  ...
  public void testSUBAImemdiatAddressingMode() {
    try {
      ...
      Assert.assertTrue("Must be an SUB directive line", (_instruction instanceof SubInstruction));
  ...
  public void testSUBAAutoIncrementIndexed() {
    try {
      ...
      _builder.newLine();
      _builder.append("\t       \t");
      _builder.append("SUBA\t\t  \t0,--S");
      _builder.newLine();
      _builder.append("\t       \t");
      _builder.append("SUBA\t\t  \t0,-S");
      _builder.newLine();
      _builder.append("\t       \t");
      _builder.append("SUBA\t\t  \tConst,U+");
      _builder.newLine();
      _builder.append("\t       \t");
      _builder.append("SUBA\t\t  \tConst,U++");
      _builder.newLine();
  ...
  public void testSUBARelativePCIndexed() {
    try {
      ...
      _builder.newLine();
      _builder.append("\t       \t");
      _builder.append("SUBA\t\t  \t0,PCR");
      _builder.newLine();
      _builder.append("\t       \t");
      _builder.append("SUBA\t\t  \t,PCR");
      _builder.newLine();
      _builder.append("\t       \t");
      _builder.append("SUBA\t\t  \tConst,PCR");
      _builder.newLine();
      final Model result = this.parseHelper.parse(_builder);
      Assert.assertNotNull(result);
      this._validationTestHelper.assertNoErrors(result);
  ...
  public void testSUBBAutoIncrementIndexed() {
    try {
      ...
      _builder.newLine();
      _builder.append("\t       \t");
      _builder.append("SUBB\t\t  \t0,--S");
      _builder.newLine();
      _builder.append("\t       \t");
      _builder.append("SUBB\t\t  \t0,-S");
      _builder.newLine();
      _builder.append("\t       \t");
      _builder.append("SUBB\t\t  \tConst,U+");
      _builder.newLine();
      _builder.append("\t       \t");
      _builder.append("SUBB\t\t  \tConst,U++");
      _builder.newLine();
  ...
  public void testSUBBRelativePCIndexed() {
    try {
      ...
      _builder.newLine();
      _builder.append("\t       \t");
      _builder.append("SUBB\t\t  \t0,PCR");
      _builder.newLine();
      _builder.append("\t       \t");
      _builder.append("SUBB\t\t  \t,PCR");
      _builder.newLine();
      _builder.append("\t       \t");
      _builder.append("SUBB\t\t  \tConst,PCR");
      _builder.newLine();
      final Model result = this.parseHelper.parse(_builder);
      Assert.assertNotNull(result);
      this._validationTestHelper.assertNoErrors(result);
