...
public class TestORCCInstruction {
   ...
   */
  @Test
  public void testOCCImemdiatAddressingMode() {
    try {
      ...
      Assert.assertTrue("Must be an ORCC directive line", (_instruction instanceof OrccInstruction));
      ...
      Assert.assertEquals("Must be an ORA instruction", orccInstruction.getInstruction(), "ORCC");
      ImmediatOperand _operand = orccInstruction.getOperand();
