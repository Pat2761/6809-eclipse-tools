...
public class TestFcbDirective {
   ...
   */
  @Test
  public void testRmbWithTwoValues() {
    try {
      StringConcatenation _builder = new StringConcatenation();
      _builder.append("; -----------------------------------------");
      _builder.newLine();
   ...
   */
  @Test
  public void testRmbWithThreeValues() {
    try {
      StringConcatenation _builder = new StringConcatenation();
      _builder.append("; -----------------------------------------");
      _builder.newLine();
   ...
   */
  @Test
  public void testRmbWithThreeValuesWithComment() {
    try {
      StringConcatenation _builder = new StringConcatenation();
      _builder.append("; -----------------------------------------");
      _builder.newLine();
      ...
      _builder.newLine();
      _builder.append("\t       ");
      _builder.append("FCB    1,,3      ; Set 1,0,3");
      _builder.newLine();
      final Model result = this.parseHelper.parse(_builder);
      Assert.assertNotNull(result);
      this._validationTestHelper.assertNoErrors(result);
  ...
  public void testRmbWithThreeValuesWithCommentAndLabel() {
    try {
      ...
      _builder.append("ORG    $8000");
      _builder.newLine();
      _builder.append("FcbL       FCB    1,,3      ; Set 1,0,3");
      _builder.newLine();
      final Model result = this.parseHelper.parse(_builder);
      Assert.assertNotNull(result);
      this._validationTestHelper.assertNoErrors(result);
   ...
   */
  @Test
  public void testRmbWithThreeValuesWithLabel() {
    try {
      StringConcatenation _builder = new StringConcatenation();
      _builder.append("; -----------------------------------------");
      _builder.newLine();
  ...
  public void testFCBWithBadNegativeValue() {
    try {
      ...
      final Model result = this.parseHelper.parse(_builder);
      Assert.assertNotNull(result);
      this._validationTestHelper.assertError(result, AssemblerPackage.eINSTANCE.getFcbDirective(), DirectiveValidator.INVALID_RANGE, "RMB value can\'t lower than -127 at location 3");
    } catch (Throwable _e) {
      throw Exceptions.sneakyThrow(_e);
    }
  }
