...
public class TestSUBDInstruction {
  ...
  public void testSUBDImemdiatAddressingMode() {
    try {
      ...
      Assert.assertTrue("Must be an ADD directive line", (_instruction instanceof SubdInstruction));
      EObject _instruction_1 = instructionLine.getInstruction();
      final SubdInstruction SubdInstruction = ((org.bpy.electronics.mc6809.assembler.assembler.SubdInstruction) _instruction_1);
      Assert.assertEquals("Must be an SUBD instruction", SubdInstruction.getInstruction(), "SUBD");
      EObject _operand = SubdInstruction.getOperand();
  ...
  public void testSUBDConstantOffsetIndexed() {
    try {
      ...
      EObject _operand_1 = SubdInstruction.getOperand();
  ...
  public void testSUBDAutoIncrementIndexed() {
    try {
      ...
      _builder.newLine();
      _builder.append("\t       \t");
      _builder.append("SUBD\t\t  \t0,--S");
      _builder.newLine();
      _builder.append("\t       \t");
      _builder.append("SUBD\t\t  \t0,-S");
      _builder.newLine();
      _builder.append("\t       \t");
      _builder.append("SUBD\t\t  \tConst,U+");
      _builder.newLine();
      _builder.append("\t       \t");
      _builder.append("SUBD\t\t  \tConst,U++");
      _builder.newLine();
  ...
  public void testSUBDRelativePCIndexed() {
    try {
      ...
      _builder.newLine();
      _builder.append("\t       \t");
      _builder.append("SUBD\t\t  \t0,PCR");
      _builder.newLine();
      _builder.append("\t       \t");
      _builder.append("SUBD\t\t  \t,PCR");
      _builder.newLine();
      _builder.append("\t       \t");
      _builder.append("SUBD\t\t  \tConst,PCR");
      _builder.newLine();
      final Model result = this.parseHelper.parse(_builder);
      Assert.assertNotNull(result);
      this._validationTestHelper.assertNoErrors(result);
