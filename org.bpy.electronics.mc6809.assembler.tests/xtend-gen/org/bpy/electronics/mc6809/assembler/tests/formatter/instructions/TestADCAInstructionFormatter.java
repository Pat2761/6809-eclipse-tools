...
public class TestADCAInstructionFormatter extends AbstractTestFormatter {
  ...
  public void testFormatterTabOnly() {
    try {
      ...
      StringConcatenation _builder = new StringConcatenation();
      _builder.append(" ");
      _builder.append("ADCA #$25 ; Instruction without operand");
      _builder.newLine();
      final String test1 = _builder.toString();
      StringConcatenation _builder_1 = new StringConcatenation();
      _builder_1.append("Z ADCA #$25 ; Instruction without operand");
      _builder_1.newLine();
      final String test2 = _builder_1.toString();
      StringConcatenation _builder_2 = new StringConcatenation();
      _builder_2.append("X2: ADCA #$25 ; Instruction without operand");
      _builder_2.newLine();
      final String test3 = _builder_2.toString();
      StringConcatenation _builder_3 = new StringConcatenation();
      _builder_3.append("X2c:\tADCA #$25\t; Instruction without operand");
      _builder_3.newLine();
      final String test4 = _builder_3.toString();
      StringConcatenation _builder_4 = new StringConcatenation();
      _builder_4.append("X23 ADCA #$25 ; Instruction without operand");
      _builder_4.newLine();
      final String test5 = _builder_4.toString();
      StringConcatenation _builder_5 = new StringConcatenation();
      _builder_5.append("Xai1 ADCA #$25\t; Instruction without operand");
      _builder_5.newLine();
      final String test6 = _builder_5.toString();
      StringConcatenation _builder_6 = new StringConcatenation();
      _builder_6.append("Xai2: ADCA #$25 ; Instruction without operand");
      _builder_6.newLine();
      final String test7 = _builder_6.toString();
      StringConcatenation _builder_7 = new StringConcatenation();
      _builder_7.append("Xait3: ADCA #$25 ; Instruction without operand");
      _builder_7.newLine();
      final String test8 = _builder_7.toString();
      StringConcatenation _builder_8 = new StringConcatenation();
      _builder_8.append("Xait31: ADCA #$25 ; Instruction without operand");
      _builder_8.newLine();
      final String test9 = _builder_8.toString();
      StringConcatenation _builder_9 = new StringConcatenation();
      _builder_9.append("XXait312: ADCA #$25 ; Instruction without operand");
      _builder_9.newLine();
      final String test10 = _builder_9.toString();
      final String result1 = this._iSerializer.serialize(this.parseHelper.parse(test1), SaveOptions.newBuilder().format().getOptions());
      Assert.assertEquals("Check spaces before instruction", "\t\t\tA", result1.substring(0, 4));
      Assert.assertEquals("Check spaces after instruction", "ADCA #$25\t\t\t\t\t\t\t\t\t;", result1.substring(3, 16));
      ...
      Assert.assertEquals("Check spaces after instruction", "ADCA #$25\t\t\t\t\t\t\t\t\t;", result2.substring(4, 17));
      ...
      Assert.assertEquals("Check spaces after instruction", "ADCA #$25\t\t\t\t\t\t\t\t\t;", result3.substring(5, 18));
      ...
      Assert.assertEquals("Check spaces after instruction", "ADCA #$25\t\t\t\t\t\t\t\t\t;", result4.substring(6, 19));
      ...
      Assert.assertEquals("Check spaces after instruction", "ADCA #$25\t\t\t\t\t\t\t\t\t;", result5.substring(5, 18));
      ...
      Assert.assertEquals("Check spaces after instruction", "ADCA #$25\t\t\t\t\t\t\t\t\t;", result6.substring(6, 19));
      ...
      Assert.assertEquals("Check spaces after instruction", "ADCA #$25\t\t\t\t\t\t\t\t\t;", result7.substring(7, 20));
      ...
      Assert.assertEquals("Check spaces after instruction", "ADCA #$25\t\t\t\t\t\t\t\t\t;", result8.substring(7, 20));
      ...
      Assert.assertEquals("Check spaces after instruction", "ADCA #$25\t\t\t\t\t\t\t\t\t;", result9.substring(8, 21));
      ...
      Assert.assertEquals("Check spaces after instruction", "ADCA #$25\t\t\t\t\t\t\t\t\t;", result10.substring(10, 23));
