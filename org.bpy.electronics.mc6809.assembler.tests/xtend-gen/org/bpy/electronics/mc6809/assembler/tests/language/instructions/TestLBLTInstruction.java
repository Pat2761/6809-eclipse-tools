...
public class TestLBLTInstruction {
  ...
  public void testSimpleLBLTWithExtraSpace() {
    try {
      ...
      Assert.assertTrue("Must be an LBLT directive line", (_instruction instanceof BltInstruction));
    } catch (Throwable _e) {
  ...
  public void testSimpleLBLTWithDuplicateLabel() {
    try {
      ...
      _builder.append("NOP");
      _builder.newLine();
      _builder.append("Jump\t\tLBLT\t\tJump\t\t; Jump=3FFF");
      _builder.newLine();
      final Model result = this.parseHelper.parse(_builder);
      Assert.assertNotNull(result);
  ...
  public void testSimpleLBLTWithBadLabel() {
    try {
      ...
      _builder.append("NOP");
      _builder.newLine();
      _builder.append("Jump\t\tLBLT\t\tJump2\t\t; Jump=3FFF");
      _builder.newLine();
      final Model result = this.parseHelper.parse(_builder);
      Assert.assertNotNull(result);
      this._validationTestHelper.assertError(result, AssemblerPackage.eINSTANCE.getBltInstruction(), 
  ...
  public void testSimpleLBLTWithWithLabel() {
    try {
      ...
      _builder.append("ASLB");
      _builder.newLine();
      _builder.append("MyBanch\t\tLBLT\t\tJump");
      _builder.newLine();
      final Model result = this.parseHelper.parse(_builder);
      Assert.assertNotNull(result);
      this._validationTestHelper.assertNoErrors(result);
  ...
  public void testSimpleLBLTWithNegativeJump1() {
    try {
      ...
      _builder.newLine();
      _builder.append("MyBanch\t\tLBLT\tJump\t\t; Jump=1024FF80");
      _builder.newLine();
      final Model result = this.parseHelper.parse(_builder);
      Assert.assertNotNull(result);
      ...
      final AssembledLBLTInstruction line = ((AssembledLBLTInstruction) _assembledLine);
  ...
  public void testSimpleLBLTWithNegativeJump2() {
    try {
      ...
      _builder.append("ORG     $8080");
      _builder.newLine();
      _builder.append("MyBanch\t\tLBLT\tJump\t\t; Jump=1024FF7F");
      _builder.newLine();
      final Model result = this.parseHelper.parse(_builder);
      Assert.assertNotNull(result);
  ...
  public void testSimpleLBLTWithPositiveJump1() {
    try {
      ...
      _builder.append("ORG     $8000");
      _builder.newLine();
      _builder.append("MyBanch\t\tLBLT\t\tJump\t\t; Jump=1024007F");
      _builder.newLine();
      _builder.append("\t\t\t");
  ...
  public void testSimpleLBLTWithPositiveJump2() {
    try {
      ...
      _builder.append("ORG     $8000");
      _builder.newLine();
      _builder.append("MyBanch\t\tLBLT\t\tJump\t\t; Jump=10240080");
      _builder.newLine();
      _builder.append("\t\t\t");
  ...
  public void testSimpleLBLTWithPositiveLimitJump1() {
    try {
      ...
      _builder.newLine();
      _builder.append("MyBranch\tLBLT\t\tJump\t\t; Jump=10257FFF");
      _builder.newLine();
      _builder.append("\t\t\t");
      _builder.append("ORG     $8003");
      _builder.newLine();
  ...
  public void testSimpleLBLTWithPositiveLimitJump2() {
    try {
      ...
      _builder.append("ORG     $0000");
      _builder.newLine();
      _builder.append("MyBanch\t\tLBLT\tJump\t\t; Jump=10248000");
      _builder.newLine();
      _builder.append("\t\t\t");
      _builder.append("ORG     $8004");
      _builder.newLine();
