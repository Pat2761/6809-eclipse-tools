...
public class TestBCCInstruction {
  ...
  public void testSimpleBCCWithExtraSpace() {
    try {
      ...
      Assert.assertTrue("Must be an BCC directive line", (_instruction instanceof BccInstruction));
    } catch (Throwable _e) {
  ...
  public void testSimpleBCCWithWithLabel() {
    try {
      ...
      _builder.append("ASLB");
      _builder.newLine();
      _builder.append("MyBanch\t\tBCC\t\tJump");
      _builder.newLine();
      final Model result = this.parseHelper.parse(_builder);
      Assert.assertNotNull(result);
      this._validationTestHelper.assertNoErrors(result);
  ...
  public void testSimpleBCCWithDuplicateLabel() {
    try {
      ...
      _builder.append("NOP");
      _builder.newLine();
      _builder.append("Jump\t\tBCC\t\tJump\t\t; Jump=3FFF");
      _builder.newLine();
      final Model result = this.parseHelper.parse(_builder);
      Assert.assertNotNull(result);
  ...
  public void testSimpleBCCWithBadLabel() {
    try {
      ...
      _builder.append("NOP");
      _builder.newLine();
      _builder.append("Jump\t\tBCC\t\tJump2\t\t; Jump=3FFF");
      _builder.newLine();
      final Model result = this.parseHelper.parse(_builder);
      Assert.assertNotNull(result);
  ...
  public void testSimpleBCCWithNegativeJump() {
    try {
      ...
      _builder.append("NOP");
      _builder.newLine();
      _builder.append("MyBanch\t\tBCC\t\tJump\t\t; Jump=24FB");
      _builder.newLine();
      final Model result = this.parseHelper.parse(_builder);
      Assert.assertNotNull(result);
      this._validationTestHelper.assertNoErrors(result);
      ...
      final AssembledBCCInstruction line = ((AssembledBCCInstruction) _assembledLine);
  ...
  public void testSimpleBCCWithPositiveJump() {
    try {
      ...
      _builder.append("ORG     $8000");
      _builder.newLine();
      _builder.append("MyBanch\t\tBCC\t\tJump\t\t; Jump=2401");
      _builder.newLine();
      _builder.append("\t\t\t");
      _builder.append("NOP");
      _builder.newLine();
  ...
  public void testSimpleBCCWithPositiveLimitJump1() {
    try {
      ...
      _builder.append("ORG     $8000");
      _builder.newLine();
      _builder.append("MyBanch\t\tBCC\t\tJump\t\t; Jump=247F");
      _builder.newLine();
      _builder.append("\t\t\t");
