...
public class TestLBHSInstruction {
  ...
  public void testSimpleLBHSWithExtraSpace() {
    try {
      ...
      Assert.assertTrue("Must be an LBHS directive line", (_instruction instanceof BhsInstruction));
    } catch (Throwable _e) {
  ...
  public void testSimpleLBHSWithDuplicateLabel() {
    try {
      ...
      _builder.append("NOP");
      _builder.newLine();
      _builder.append("Jump\t\tLBHS\t\tJump\t\t; Jump=3FFF");
      _builder.newLine();
      final Model result = this.parseHelper.parse(_builder);
      Assert.assertNotNull(result);
  ...
  public void testSimpleLBHSWithBadLabel() {
    try {
      ...
      _builder.append("NOP");
      _builder.newLine();
      _builder.append("Jump\t\tLBHS\t\tJump2\t\t; Jump=3FFF");
      _builder.newLine();
      final Model result = this.parseHelper.parse(_builder);
      Assert.assertNotNull(result);
      this._validationTestHelper.assertError(result, AssemblerPackage.eINSTANCE.getBhsInstruction(), 
  ...
  public void testSimpleLBHSWithWithLabel() {
    try {
      ...
      _builder.append("ASLB");
      _builder.newLine();
      _builder.append("MyBanch\t\tLBHS\t\tJump");
      _builder.newLine();
      final Model result = this.parseHelper.parse(_builder);
      Assert.assertNotNull(result);
      this._validationTestHelper.assertNoErrors(result);
  ...
  public void testSimpleLBHSWithNegativeJump1() {
    try {
      ...
      _builder.newLine();
      _builder.append("MyBanch\t\tLBHS\tJump\t\t; Jump=1024FF80");
      _builder.newLine();
      final Model result = this.parseHelper.parse(_builder);
      Assert.assertNotNull(result);
      ...
      final AssembledLBHSInstruction line = ((AssembledLBHSInstruction) _assembledLine);
  ...
  public void testSimpleLBHSWithNegativeJump2() {
    try {
      ...
      _builder.append("ORG     $8080");
      _builder.newLine();
      _builder.append("MyBanch\t\tLBHS\tJump\t\t; Jump=1024FF7F");
      _builder.newLine();
      final Model result = this.parseHelper.parse(_builder);
      Assert.assertNotNull(result);
  ...
  public void testSimpleLBHSWithPositiveJump1() {
    try {
      ...
      _builder.append("ORG     $8000");
      _builder.newLine();
      _builder.append("MyBanch\t\tLBHS\t\tJump\t\t; Jump=1024007F");
      _builder.newLine();
      _builder.append("\t\t\t");
  ...
  public void testSimpleLBHSWithPositiveJump2() {
    try {
      ...
      _builder.append("ORG     $8000");
      _builder.newLine();
      _builder.append("MyBanch\t\tLBHS\t\tJump\t\t; Jump=10240080");
      _builder.newLine();
      _builder.append("\t\t\t");
  ...
  public void testSimpleLBHSWithPositiveLimitJump1() {
    try {
      ...
      _builder.newLine();
      _builder.append("MyBranch\tLBHS\t\tJump\t\t; Jump=10257FFF");
      _builder.newLine();
      _builder.append("\t\t\t");
      _builder.append("ORG     $8003");
      _builder.newLine();
  ...
  public void testSimpleLBHSWithPositiveLimitJump2() {
    try {
      ...
      _builder.append("ORG     $0000");
      _builder.newLine();
      _builder.append("MyBanch\t\tLBHS\tJump\t\t; Jump=10248000");
      _builder.newLine();
      _builder.append("\t\t\t");
      _builder.append("ORG     $8004");
      _builder.newLine();
