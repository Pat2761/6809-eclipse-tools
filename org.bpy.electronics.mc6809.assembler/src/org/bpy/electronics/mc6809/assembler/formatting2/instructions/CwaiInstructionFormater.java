...
/**
 * Format Cwai instruction.
 * 
 * @author Patrick BRIAND
 *
 */
public class CwaiInstructionFormater extends AbstractInstructionWithOperand {

	/** reference on the instruction */
	private CwaiInstruction cwaiInstruction;
	 ...
	 */
	public CwaiInstructionFormater(IFormattableDocument doc, String tabPolicy, int tabSize) {
	...
	public void format(AssemblerFormatter assemblerFormatter, EObject instruction, int instructionPosition, int operandPosition) {
		...
		this.cwaiInstruction = (CwaiInstruction)instruction;
	...
	public String getInstructioName() {
		return cwaiInstruction.getInstruction();
	}

	@Override
	public EAttribute getSeparatorAttribute() {
		return AssemblerPackage.eINSTANCE.getCwaiInstruction_WsOperand();
	}
	...
	public EObject getOperand() {
		return cwaiInstruction.getOperand();
	}
}
