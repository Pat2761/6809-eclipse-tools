...
/**
 * Format St instruction.
 * 
 * @author Patrick BRIAND
 *
 */
public class StInstructionFormater extends AbstractInstructionWithOperand {
	 ...
	 */
	public StInstructionFormater(IFormattableDocument doc, String tabPolicy, int tabSize) {
	...
	public void format(AssemblerFormatter assemblerFormatter, EObject instruction, int instructionPosition, int operandPosition) {
		...
		this.stInstruction = (StInstruction)instruction;
	...
	public String getInstructioName() {
		return stInstruction.getInstruction();
	}
	...
	public EObject getOperand() {
		return stInstruction.getOperand();
	}
}
