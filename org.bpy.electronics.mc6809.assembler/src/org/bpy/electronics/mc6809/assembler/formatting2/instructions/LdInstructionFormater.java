...
/**
 * Format Ld instruction.
 * 
 * @author Patrick BRIAND
 *
 */
public class LdInstructionFormater extends AbstractInstructionWithOperand {
	 ...
	 */
	public LdInstructionFormater(IFormattableDocument doc, String tabPolicy, int tabSize) {
	...
	public void format(AssemblerFormatter assemblerFormatter, EObject instruction, int instructionPosition, int operandPosition) {
		...
		this.ldInstruction = (LdInstruction)instruction;
	...
	public String getInstructioName() {
		return ldInstruction.getInstruction();
	}
	...
	public EObject getOperand() {
		return ldInstruction.getOperand();
	}
}
