...
/**
 * Format Cmp instruction.
 * 
 * @author Patrick BRIAND
 *
 */
public class CmpInstructionFormater extends AbstractInstructionWithOperand {
	 ...
	 */
	public CmpInstructionFormater(IFormattableDocument doc, String tabPolicy, int tabSize) {
	...
	public void format(AssemblerFormatter assemblerFormatter, EObject instruction, int instructionPosition, int operandPosition) {
		...
		this.cmpInstruction = (CmpInstruction)instruction;
	...
	public String getInstructioName() {
		return cmpInstruction.getInstruction();
	}
	...
	public EObject getOperand() {
		return cmpInstruction.getOperand();
	}
}
