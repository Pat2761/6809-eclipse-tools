...
/**
 * Format Fail instruction.
 * 
 * @author Patrick BRIAND
 *
 */
public class FailFormatter extends AbstractObjectFormatter {

	/** reference on the instruction */
	private FailDirective instruction;
	 ...
	 */
	public FailFormatter(IFormattableDocument doc, String tabPolicy, int tabSize) {
	...
	public void format(AssemblerFormatter assemblerFormatter, EObject object, int instructionPosition, int operandPosition) {
		...
		this.instruction = (FailDirective)object;
