...
/**
 * Format Inc instruction.
 * 
 * @author Patrick BRIAND
 *
 */
public class IncInstructionFormater extends AbstractInstructionWithOperand {

	/** reference on the instruction */
	private IncInstruction incInstruction;
	 ...
	 */
	public IncInstructionFormater(IFormattableDocument doc, String tabPolicy, int tabSize) {
	...
	public void format(AssemblerFormatter assemblerFormatter, EObject instruction, int instructionPosition, int operandPosition) {
		...
		this.incInstruction = (IncInstruction)instruction;
	...
	public String getInstructioName() {
		return incInstruction.getInstruction();
	}
	...
	public EObject getOperand() {
		return incInstruction.getOperand();
	}
}
