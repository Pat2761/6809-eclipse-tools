...
/**
 * Format Add instruction.
 * 
 * @author Patrick BRIAND
 *
 */
public class AddInstructionFormater extends AbstractInstructionWithOperand {
	 ...
	 */
	public AddInstructionFormater(IFormattableDocument doc, String tabPolicy, int tabSize) {
	...
	public void format(AssemblerFormatter assemblerFormatter, EObject instruction, int instructionPosition, int operandPosition) {
		...
		this.addInstruction = (AddInstruction)instruction;
	...
	public String getInstructioName() {
		return addInstruction.getInstruction();
	}
	...
	public EObject getOperand() {
		return addInstruction.getOperand();
	}
}
