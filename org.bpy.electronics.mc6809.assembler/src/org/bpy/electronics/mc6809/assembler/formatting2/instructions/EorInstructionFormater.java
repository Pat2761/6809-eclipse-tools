...
/**
 * Format Eor instruction.
 * 
 * @author Patrick BRIAND
 *
 */
public class EorInstructionFormater extends AbstractInstructionWithOperand {

	/** reference on the instruction */
	private EorInstruction eorInstruction;
	 ...
	 */
	public EorInstructionFormater(IFormattableDocument doc, String tabPolicy, int tabSize) {
	...
	public void format(AssemblerFormatter assemblerFormatter, EObject instruction, int instructionPosition, int operandPosition) {
		...
		this.eorInstruction = (EorInstruction)instruction;
	...
	public String getInstructioName() {
		return eorInstruction.getInstruction();
	}

	@Override
	public EAttribute getSeparatorAttribute() {
		return AssemblerPackage.eINSTANCE.getEorInstruction_WsOperand();
	}
	...
	public EObject getOperand() {
		return eorInstruction.getOperand();
	}
}
