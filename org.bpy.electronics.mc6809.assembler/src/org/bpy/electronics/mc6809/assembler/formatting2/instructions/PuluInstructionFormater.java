...
/**
 * Format Pulu instruction.
 * 
 * @author Patrick BRIAND
 *
 */
public class PuluInstructionFormater extends AbstractInstructionWithOperand {

	/** reference on the instruction */
	private PuluInstruction puluInstruction;
	 ...
	 */
	public PuluInstructionFormater(IFormattableDocument doc, String tabPolicy, int tabSize) {
	...
	public void format(AssemblerFormatter assemblerFormatter, EObject instruction, int instructionPosition, int operandPosition) {
		...
		this.puluInstruction = (PuluInstruction)instruction;
	...
	public String getInstructioName() {
		return puluInstruction.getInstruction();
	}
	...
	public EObject getOperand() {
		return puluInstruction.getOperand();
	}
}
