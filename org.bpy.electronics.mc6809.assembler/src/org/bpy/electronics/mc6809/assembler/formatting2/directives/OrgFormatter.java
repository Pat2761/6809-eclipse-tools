...
/**
 * Format Org instruction.
 * 
 * @author Patrick BRIAND
 *
 */
public class OrgFormatter extends AbstractObjectFormatter {

	/** reference on the instruction */
	private OrgDirective instruction;
	 ...
	 */
	public OrgFormatter(IFormattableDocument doc, String tabPolicy, int tabSize) {
	...
	public void format(AssemblerFormatter assemblerFormatter, EObject object, int instructionPosition, int operandPosition) {
		...
		this.instruction = (OrgDirective)object;
