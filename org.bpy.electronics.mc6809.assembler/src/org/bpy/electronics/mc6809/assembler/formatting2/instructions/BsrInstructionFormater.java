...
/**
 * Format Bsr instruction.
 * 
 * @author Patrick BRIAND
 *
 */
public class BsrInstructionFormater extends AbstractInstructionWithOperand {

	/** reference on the instruction */
	private BsrInstruction bsrInstruction;
	 ...
	 */
	public BsrInstructionFormater(IFormattableDocument doc, String tabPolicy, int tabSize) {
	...
	public void format(AssemblerFormatter assemblerFormatter, EObject instruction, int instructionPosition, int operandPosition) {
		...
		this.bsrInstruction = (BsrInstruction)instruction;
	...
	public String getInstructioName() {
		return bsrInstruction.getInstruction();
	}

	@Override
	public EAttribute getSeparatorAttribute() {
		return AssemblerPackage.eINSTANCE.getBsrInstruction_WsOperand();
	}
	...
	public EObject getOperand() {
		return bsrInstruction.getOperand();
	}
}
