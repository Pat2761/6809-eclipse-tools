...
/**
 * Format Daa instruction.
 * 
 * @author Patrick BRIAND
 *
 */
public class DaaInstructionFormater extends AbstractInstructionWithOperand {

	/** reference on the instruction */
	private DaaInstruction daaInstruction;
	 ...
	 */
	public DaaInstructionFormater(IFormattableDocument doc, String tabPolicy, int tabSize) {
	...
	public void format(AssemblerFormatter assemblerFormatter, EObject instruction, int instructionPosition, int operandPosition) {
		...
		this.daaInstruction = (DaaInstruction)instruction;
	...
	public String getInstructioName() {
		return daaInstruction.getInstruction();
	}
