...
/**
 * Format Mul instruction.
 * 
 * @author Patrick BRIAND
 *
 */
public class MulInstructionFormater extends AbstractInstructionWithOperand {

	/** reference on the instruction */
	private MulInstruction mulInstruction;
	 ...
	 */
	public MulInstructionFormater(IFormattableDocument doc, String tabPolicy, int tabSize) {
	...
	public void format(AssemblerFormatter assemblerFormatter, EObject instruction, int instructionPosition, int operandPosition) {
		...
		this.mulInstruction = (MulInstruction)instruction;
	...
	public String getInstructioName() {
		return mulInstruction.getInstruction();
	}
