...
/**
 * Format Sex instruction.
 * 
 * @author Patrick BRIAND
 *
 */
public class SexInstructionFormater extends AbstractInstructionWithOperand {

	/** reference on the instruction */
	private SexInstruction sexInstruction;
	 ...
	 */
	public SexInstructionFormater(IFormattableDocument doc, String tabPolicy, int tabSize) {
	...
	public void format(AssemblerFormatter assemblerFormatter, EObject instruction, int instructionPosition, int operandPosition) {
		...
		this.sexInstruction = (SexInstruction)instruction;
	...
	public String getInstructioName() {
		return sexInstruction.getInstruction();
	}
