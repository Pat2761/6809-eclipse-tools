...
/**
 * Format Sbc instruction.
 * 
 * @author Patrick BRIAND
 *
 */
public class SbcInstructionFormater extends AbstractInstructionWithOperand {

	/** reference on the instruction */
	private SbcInstruction SbcInstruction;
	 ...
	 */
	public SbcInstructionFormater(IFormattableDocument doc, String tabPolicy, int tabSize) {
	...
	public void format(AssemblerFormatter assemblerFormatter, EObject instruction, int instructionPosition, int operandPosition) {
		...
		this.SbcInstruction = (SbcInstruction)instruction;
	...
	public String getInstructioName() {
		return SbcInstruction.getInstruction();
	}

	@Override
	public EAttribute getSeparatorAttribute() {
		return AssemblerPackage.eINSTANCE.getSbcInstruction_WsOperand();
	}
	...
	public EObject getOperand() {
		return SbcInstruction.getOperand();
	}
}
