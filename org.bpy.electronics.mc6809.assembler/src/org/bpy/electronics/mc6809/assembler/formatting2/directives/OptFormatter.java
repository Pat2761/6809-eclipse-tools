...
/**
 * Format Opt instruction.
 * 
 * @author Patrick BRIAND
 *
 */
public class OptFormatter extends AbstractObjectFormatter {

	/** reference on the instruction */
	private OptDirective instruction;
	 ...
	 */
	public OptFormatter(IFormattableDocument doc, String tabPolicy, int tabSize) {
	...
	public void format(AssemblerFormatter assemblerFormatter, EObject object, int instructionPosition, int operandPosition) {
		...
		this.instruction = (OptDirective)object;
