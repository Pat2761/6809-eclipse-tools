...
/**
 * Format Sub instruction.
 * 
 * @author Patrick BRIAND
 *
 */
public class SubInstructionFormater extends AbstractInstructionWithOperand {

	/** reference on the instruction */
	private SubInstruction SubInstruction;
	 ...
	 */
	public SubInstructionFormater(IFormattableDocument doc, String tabPolicy, int tabSize) {
	...
	public void format(AssemblerFormatter assemblerFormatter, EObject instruction, int instructionPosition, int operandPosition) {
		...
		this.SubInstruction = (SubInstruction)instruction;
	...
	public String getInstructioName() {
		return SubInstruction.getInstruction();
	}

	@Override
	public EAttribute getSeparatorAttribute() {
		return AssemblerPackage.eINSTANCE.getSubInstruction_WsOperand();
	}
	...
	public EObject getOperand() {
		return SubInstruction.getOperand();
	}
}
