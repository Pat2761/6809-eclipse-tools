...
/**
 * Format Pag instruction.
 * 
 * @author Patrick BRIAND
 *
 */
public class PagFormatter extends AbstractObjectFormatter {

	/** reference on the instruction */
	private PagDirective instruction;
	 ...
	 */
	public PagFormatter(IFormattableDocument doc, String tabPolicy, int tabSize) {
	...
	public void format(AssemblerFormatter assemblerFormatter, EObject object, int instructionPosition, int operandPosition) {
		...
		this.instruction = (PagDirective)object;
