...
/**
 * Format Swi instruction.
 * 
 * @author Patrick BRIAND
 *
 */
public class SwiInstructionFormater extends AbstractInstructionWithOperand {

	/** reference on the instruction */
	private SwiInstruction swiInstruction;
	 ...
	 */
	public SwiInstructionFormater(IFormattableDocument doc, String tabPolicy, int tabSize) {
	...
	public void format(AssemblerFormatter assemblerFormatter, EObject instruction, int instructionPosition, int operandPosition) {
		...
		this.swiInstruction = (SwiInstruction)instruction;
	...
	public String getInstructioName() {
		return swiInstruction.getInstruction();
	}
