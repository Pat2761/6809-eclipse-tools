...
/**
 * Format Brn instruction.
 * 
 * @author Patrick BRIAND
 *
 */
public class BrnInstructionFormater extends AbstractInstructionWithOperand {

	/** reference on the instruction */
	private BrnInstruction brnInstruction;
	 ...
	 */
	public BrnInstructionFormater(IFormattableDocument doc, String tabPolicy, int tabSize) {
	...
	public void format(AssemblerFormatter assemblerFormatter, EObject instruction, int instructionPosition, int operandPosition) {
		...
		this.brnInstruction = (BrnInstruction)instruction;
	...
	public String getInstructioName() {
		return brnInstruction.getInstruction();
	}
	...
	public EObject getOperand() {
		return brnInstruction.getOperand();
	}
}
