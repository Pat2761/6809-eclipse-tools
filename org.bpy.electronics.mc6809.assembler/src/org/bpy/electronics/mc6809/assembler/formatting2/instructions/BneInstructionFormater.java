...
/**
 * Format Bne instruction.
 * 
 * @author Patrick BRIAND
 *
 */
public class BneInstructionFormater extends AbstractInstructionWithOperand {

	/** reference on the instruction */
	private BneInstruction bneInstruction;
	 ...
	 */
	public BneInstructionFormater(IFormattableDocument doc, String tabPolicy, int tabSize) {
	...
	public void format(AssemblerFormatter assemblerFormatter, EObject instruction, int instructionPosition, int operandPosition) {
		...
		this.bneInstruction = (BneInstruction)instruction;
	...
	public String getInstructioName() {
		return bneInstruction.getInstruction();
	}
	...
	public EObject getOperand() {
		return bneInstruction.getOperand();
	}
}
