...
/**
 * Format Or instruction.
 * 
 * @author Patrick BRIAND
 *
 */
public class OrInstructionFormater extends AbstractInstructionWithOperand {

	/** reference on the instruction */
	private OrInstruction orInstruction;
	 ...
	 */
	public OrInstructionFormater(IFormattableDocument doc, String tabPolicy, int tabSize) {
	...
	public void format(AssemblerFormatter assemblerFormatter, EObject instruction, int instructionPosition, int operandPosition) {
		...
		this.orInstruction = (OrInstruction)instruction;
	...
	public String getInstructioName() {
		return orInstruction.getInstruction();
	}
	...
	public EObject getOperand() {
		return orInstruction.getOperand();
	}
}
