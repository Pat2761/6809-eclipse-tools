...
/**
 * Format Bcs instruction.
 * 
 * @author Patrick BRIAND
 *
 */
public class BcsInstructionFormater extends AbstractInstructionWithOperand {

	/** reference on the instruction */
	private BcsInstruction bcsInstruction;
	 ...
	 */
	public BcsInstructionFormater(IFormattableDocument doc, String tabPolicy, int tabSize) {
	...
	public void format(AssemblerFormatter assemblerFormatter, EObject instruction, int instructionPosition, int operandPosition) {
		...
		this.bcsInstruction = (BcsInstruction)instruction;
	...
	public String getInstructioName() {
		return bcsInstruction.getInstruction();
	}
	...
	public EObject getOperand() {
		return bcsInstruction.getOperand();
	}
}
