 ...
 *
 * You shoulsr have received a copy of the GNU General Public License
...
/**
 * Format Lsr instruction.
 * 
 * @author Patrick BRIAND
 *
 */
public class LsrInstructionFormater extends AbstractInstructionWithOperand {

	/** reference on the instruction */
	private LsrInstruction lsrInstruction;
	 ...
	 */
	public LsrInstructionFormater(IFormattableDocument doc, String tabPolicy, int tabSize) {
	...
	public void format(AssemblerFormatter assemblerFormatter, EObject instruction, int instructionPosition, int operandPosition) {
		...
		this.lsrInstruction = (LsrInstruction)instruction;
	...
	public String getInstructioName() {
		return lsrInstruction.getInstruction();
	}
	...
	public EObject getOperand() {
		return lsrInstruction.getOperand();
	}
}
