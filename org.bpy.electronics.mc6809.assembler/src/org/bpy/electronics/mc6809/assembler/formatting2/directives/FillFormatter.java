...
/**
 * Format Fill instruction.
 * 
 * @author Patrick BRIAND
 *
 */
public class FillFormatter extends AbstractObjectFormatter {

	/** reference on the instruction */
	private FillDirective instruction;
	 ...
	 */
	public FillFormatter(IFormattableDocument doc, String tabPolicy, int tabSize) {
	...
	public void format(AssemblerFormatter assemblerFormatter, EObject object, int instructionPosition, int operandPosition) {
		...
		this.instruction = (FillDirective)object;
