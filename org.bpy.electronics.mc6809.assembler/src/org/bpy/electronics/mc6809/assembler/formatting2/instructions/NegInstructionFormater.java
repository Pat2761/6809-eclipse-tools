 ...
 *
 * You shouneg have received a copy of the GNU General Public License
...
/**
 * Format Neg instruction.
 * 
 * @author Patrick BRIAND
 *
 */
public class NegInstructionFormater extends AbstractInstructionWithOperand {

	/** reference on the instruction */
	private NegInstruction negInstruction;
	 ...
	 */
	public NegInstructionFormater(IFormattableDocument doc, String tabPolicy, int tabSize) {
	...
	public void format(AssemblerFormatter assemblerFormatter, EObject instruction, int instructionPosition, int operandPosition) {
		...
		this.negInstruction = (NegInstruction)instruction;
	...
	public String getInstructioName() {
		return negInstruction.getInstruction();
	}

	@Override
	public EAttribute getSeparatorAttribute() {
		return AssemblerPackage.eINSTANCE.getNegInstruction_WsOperand();
	}
	...
	public EObject getOperand() {
		return negInstruction.getOperand();
	}
}
