...
/**
 * Format Com instruction.
 * 
 * @author Patrick BRIAND
 *
 */
public class ComInstructionFormater extends AbstractInstructionWithOperand {

	/** reference on the instruction */
	private ComInstruction comInstruction;
	 ...
	 */
	public ComInstructionFormater(IFormattableDocument doc, String tabPolicy, int tabSize) {
	...
	public void format(AssemblerFormatter assemblerFormatter, EObject instruction, int instructionPosition, int operandPosition) {
		...
		this.comInstruction = (ComInstruction)instruction;
	...
	public String getInstructioName() {
		return comInstruction.getInstruction();
	}

	@Override
	public EAttribute getSeparatorAttribute() {
		return AssemblerPackage.eINSTANCE.getComInstruction_WsOperand();
	}
	...
	public EObject getOperand() {
		return comInstruction.getOperand();
	}
}
