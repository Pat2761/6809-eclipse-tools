...
/**
 * Format Dec instruction.
 * 
 * @author Patrick BRIAND
 *
 */
public class DecInstructionFormater extends AbstractInstructionWithOperand {

	/** reference on the instruction */
	private DecInstruction decInstruction;
	 ...
	 */
	public DecInstructionFormater(IFormattableDocument doc, String tabPolicy, int tabSize) {
	...
	public void format(AssemblerFormatter assemblerFormatter, EObject instruction, int instructionPosition, int operandPosition) {
		...
		this.decInstruction = (DecInstruction)instruction;
	...
	public String getInstructioName() {
		return decInstruction.getInstruction();
	}
	...
	public EObject getOperand() {
		return decInstruction.getOperand();
	}
}
