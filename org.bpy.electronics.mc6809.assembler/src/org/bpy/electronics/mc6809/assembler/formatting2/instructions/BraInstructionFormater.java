...
/**
 * Format Bra instruction.
 * 
 * @author Patrick BRIAND
 *
 */
public class BraInstructionFormater extends AbstractInstructionWithOperand {

	/** reference on the instruction */
	private BraInstruction braInstruction;
	 ...
	 */
	public BraInstructionFormater(IFormattableDocument doc, String tabPolicy, int tabSize) {
	...
	public void format(AssemblerFormatter assemblerFormatter, EObject instruction, int instructionPosition, int operandPosition) {
		...
		this.braInstruction = (BraInstruction)instruction;
	...
	public String getInstructioName() {
		return braInstruction.getInstruction();
	}
	...
	public EObject getOperand() {
		return braInstruction.getOperand();
	}
}
