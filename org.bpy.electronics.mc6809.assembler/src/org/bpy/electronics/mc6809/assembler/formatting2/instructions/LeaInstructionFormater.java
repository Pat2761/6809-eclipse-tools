 ...
 *
 * You shoulea have received a copy of the GNU General Public License
...
/**
 * Format Lea instruction.
 * 
 * @author Patrick BRIAND
 *
 */
public class LeaInstructionFormater extends AbstractInstructionWithOperand {

	/** reference on the instruction */
	private LeaInstruction leaInstruction;
	 ...
	 */
	public LeaInstructionFormater(IFormattableDocument doc, String tabPolicy, int tabSize) {
	...
	public void format(AssemblerFormatter assemblerFormatter, EObject instruction, int instructionPosition, int operandPosition) {
		...
		this.leaInstruction = (LeaInstruction)instruction;
	...
	public String getInstructioName() {
		return leaInstruction.getInstruction();
	}

	@Override
	public EAttribute getSeparatorAttribute() {
		return AssemblerPackage.eINSTANCE.getLeaInstruction_WsOperand();
	}
	...
	public EObject getOperand() {
		return leaInstruction.getOperand();
	}
}
