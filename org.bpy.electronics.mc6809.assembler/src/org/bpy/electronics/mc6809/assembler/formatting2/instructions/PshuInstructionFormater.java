...
/**
 * Format Pshu instruction.
 * 
 * @author Patrick BRIAND
 *
 */
public class PshuInstructionFormater extends AbstractInstructionWithOperand {

	/** reference on the instruction */
	private PshuInstruction pshuInstruction;
	 ...
	 */
	public PshuInstructionFormater(IFormattableDocument doc, String tabPolicy, int tabSize) {
	...
	public void format(AssemblerFormatter assemblerFormatter, EObject instruction, int instructionPosition, int operandPosition) {
		...
		this.pshuInstruction = (PshuInstruction)instruction;
	...
	public String getInstructioName() {
		return pshuInstruction.getInstruction();
	}
	...
	public EObject getOperand() {
		return pshuInstruction.getOperand();
	}
}
