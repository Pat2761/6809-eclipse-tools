...
/**
 * Format End instruction.
 * 
 * @author Patrick BRIAND
 *
 */
public class EndFormatter extends AbstractObjectFormatter {

	/** reference on the instruction */
	private EndDirective instruction;
	 ...
	 */
	public EndFormatter(IFormattableDocument doc, String tabPolicy, int tabSize) {
	...
	public void format(AssemblerFormatter assemblerFormatter, EObject object, int instructionPosition, int operandPosition) {
		...
		this.instruction = (EndDirective)object;
