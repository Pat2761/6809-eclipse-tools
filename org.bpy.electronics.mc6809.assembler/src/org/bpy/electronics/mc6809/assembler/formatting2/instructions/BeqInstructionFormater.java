 ...
 *
 */
public class BeqInstructionFormater extends AbstractInstructionWithOperand {

	/** reference on the instruction */
	private BeqInstruction beqInstruction;
	 ...
	 */
	public BeqInstructionFormater(IFormattableDocument doc, String tabPolicy, int tabSize) {
	...
	public void format(AssemblerFormatter assemblerFormatter, EObject instruction, int instructionPosition, int operandPosition) {
		...
		this.beqInstruction = (BeqInstruction)instruction;
	...
	public String getInstructioName() {
		return beqInstruction.getInstruction();
	}
	...
	public EObject getOperand() {
		return beqInstruction.getOperand();
	}
}
