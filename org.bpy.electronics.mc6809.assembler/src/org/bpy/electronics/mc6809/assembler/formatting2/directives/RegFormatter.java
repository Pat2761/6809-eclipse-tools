 ...
 *
 */
public class RegFormatter extends AbstractObjectFormatter {

	/** reference on the instruction */
	private RegDirective instruction;
	 ...
	 */
	public RegFormatter(IFormattableDocument doc, String tabPolicy, int tabSize) {
	...
	public void format(AssemblerFormatter assemblerFormatter, EObject object, int instructionPosition, int operandPosition) {
		...
		this.instruction = (RegDirective)object;
