...
/**
 * Format Puls instruction.
 * 
 * @author Patrick BRIAND
 *
 */
public class PulsInstructionFormater extends AbstractInstructionWithOperand {

	/** reference on the instruction */
	private PulsInstruction pulsInstruction;
	 ...
	 */
	public PulsInstructionFormater(IFormattableDocument doc, String tabPolicy, int tabSize) {
	...
	public void format(AssemblerFormatter assemblerFormatter, EObject instruction, int instructionPosition, int operandPosition) {
		...
		this.pulsInstruction = (PulsInstruction)instruction;
	...
	public String getInstructioName() {
		return pulsInstruction.getInstruction();
	}

	@Override
	public EAttribute getSeparatorAttribute() {
		return AssemblerPackage.eINSTANCE.getPulsInstruction_WsOperand();
	}
	...
	public EObject getOperand() {
		return pulsInstruction.getOperand();
	}
}
