...
/**
 * Format Bvs instruction.
 * 
 * @author Patrick BRIAND
 *
 */
public class BvsInstructionFormater extends AbstractInstructionWithOperand {

	/** reference on the instruction */
	private BvsInstruction bvsInstruction;
	 ...
	 */
	public BvsInstructionFormater(IFormattableDocument doc, String tabPolicy, int tabSize) {
	...
	public void format(AssemblerFormatter assemblerFormatter, EObject instruction, int instructionPosition, int operandPosition) {
		...
		this.bvsInstruction = (BvsInstruction)instruction;
	...
	public String getInstructioName() {
		return bvsInstruction.getInstruction();
	}

	@Override
	public EAttribute getSeparatorAttribute() {
		return AssemblerPackage.eINSTANCE.getBvsInstruction_WsOperand();
	}
	...
	public EObject getOperand() {
		return bvsInstruction.getOperand();
	}
}
