...
/**
 * Format Pshs instruction.
 * 
 * @author Patrick BRIAND
 *
 */
public class PshsInstructionFormater extends AbstractInstructionWithOperand {

	/** reference on the instruction */
	private PshsInstruction pshsInstruction;
	 ...
	 */
	public PshsInstructionFormater(IFormattableDocument doc, String tabPolicy, int tabSize) {
	...
	public void format(AssemblerFormatter assemblerFormatter, EObject instruction, int instructionPosition, int operandPosition) {
		...
		this.pshsInstruction = (PshsInstruction)instruction;
	...
	public String getInstructioName() {
		return pshsInstruction.getInstruction();
	}

	@Override
	public EAttribute getSeparatorAttribute() {
		return AssemblerPackage.eINSTANCE.getPshsInstruction_WsOperand();
	}
	...
	public EObject getOperand() {
		return pshsInstruction.getOperand();
	}
}
