...
/**
 * Format Rti instruction.
 * 
 * @author Patrick BRIAND
 *
 */
public class RtiInstructionFormater extends AbstractInstructionWithOperand {

	/** reference on the instruction */
	private RtiInstruction rtiInstruction;
	 ...
	 */
	public RtiInstructionFormater(IFormattableDocument doc, String tabPolicy, int tabSize) {
	...
	public void format(AssemblerFormatter assemblerFormatter, EObject instruction, int instructionPosition, int operandPosition) {
		...
		this.rtiInstruction = (RtiInstruction)instruction;
	...
	public String getInstructioName() {
		return rtiInstruction.getInstruction();
	}
