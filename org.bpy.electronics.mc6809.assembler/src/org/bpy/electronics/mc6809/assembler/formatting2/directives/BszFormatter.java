...
/**
 * Format Bsz instruction.
 * 
 * @author Patrick BRIAND
 *
 */
public class BszFormatter extends AbstractObjectFormatter {

	/** reference on the instruction */
	private BszDirective instruction;
	 ...
	 */
	public BszFormatter(IFormattableDocument doc, String tabPolicy, int tabSize) {
	...
	public void format(AssemblerFormatter assemblerFormatter, EObject object, int instructionPosition, int operandPosition) {
		...
		this.instruction = (BszDirective)object;
