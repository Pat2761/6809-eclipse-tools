 ...
 *
 */
package org.bpy.electronics.mc6809.assembler.formatting2.others;
 ...
 *
 */
public class MacroDefinitionStart extends AbstractInstructionWithOperand {
	 ...
	 */
	public MacroDefinitionStart(IFormattableDocument doc, String tabPolicy, int tabSize) {
	...
	public void format(AssemblerFormatter assemblerFormatter, EObject instruction, int instructionPosition, int operandPosition) {
		...
		this.macroDefinition = (MacroDefinition)instruction;
	...
	public EAttribute getSeparatorAttribute() {
		return AssemblerPackage.eINSTANCE.getMacroDefinition_Ws2();
	}
