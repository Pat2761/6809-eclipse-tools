...
/**
 * Format Nop instruction.
 * 
 * @author Patrick BRIAND
 *
 */
public class NopInstructionFormater extends AbstractInstructionWithOperand {

	/** reference on the instruction */
	private NopInstruction nopInstruction;
	 ...
	 */
	public NopInstructionFormater(IFormattableDocument doc, String tabPolicy, int tabSize) {
	...
	public void format(AssemblerFormatter assemblerFormatter, EObject instruction, int instructionPosition, int operandPosition) {
		...
		this.nopInstruction = (NopInstruction)instruction;
	...
	public String getInstructioName() {
		return nopInstruction.getInstruction();
	}
