...
/**
 * Format Jmp instruction.
 * 
 * @author Patrick BRIAND
 *
 */
public class JmpInstructionFormater extends AbstractInstructionWithOperand {
	 ...
	 */
	public JmpInstructionFormater(IFormattableDocument doc, String tabPolicy, int tabSize) {
	...
	public void format(AssemblerFormatter assemblerFormatter, EObject instruction, int instructionPosition, int operandPosition) {
		...
		this.jmpInstruction = (JmpInstruction)instruction;
	...
	public String getInstructioName() {
		return jmpInstruction.getInstruction();
	}
	...
	public EObject getOperand() {
		return jmpInstruction.getOperand();
	}
}
