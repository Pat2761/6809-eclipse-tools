...
/**
 * Format Spc instruction.
 * 
 * @author Patrick BRIAND
 *
 */
public class SpcFormatter extends AbstractObjectFormatter {

	/** reference on the instruction */
	private SpcDirective instruction;
	 ...
	 */
	public SpcFormatter(IFormattableDocument doc, String tabPolicy, int tabSize) {
	...
	public void format(AssemblerFormatter assemblerFormatter, EObject object, int instructionPosition, int operandPosition) {
		...
		this.instruction = (SpcDirective)object;
