...
/**
 * Format Beq instruction.
 * 
 * @author Patrick BRIAND
 *
 */
public class BgeInstructionFormater extends AbstractInstructionWithOperand {

	/** reference on the instruction */
	private BeqInstruction bgeInstruction;
	 ...
	 */
	public BgeInstructionFormater(IFormattableDocument doc, String tabPolicy, int tabSize) {
	...
	public void format(AssemblerFormatter assemblerFormatter, EObject instruction, int instructionPosition, int operandPosition) {
		...
		this.bgeInstruction = (BeqInstruction)instruction;
	...
	public String getInstructioName() {
		return bgeInstruction.getInstruction();
	}

	@Override
	public EAttribute getSeparatorAttribute() {
		return AssemblerPackage.eINSTANCE.getBgeInstruction_WsOperand();
	}
	...
	public EObject getOperand() {
		return bgeInstruction.getOperand();
	}
}
