...
/**
 * Format Bvc instruction.
 * 
 * @author Patrick BRIAND
 *
 */
public class BvcInstructionFormater extends AbstractInstructionWithOperand {

	/** reference on the instruction */
	private BvcInstruction bvcInstruction;
	 ...
	 */
	public BvcInstructionFormater(IFormattableDocument doc, String tabPolicy, int tabSize) {
	...
	public void format(AssemblerFormatter assemblerFormatter, EObject instruction, int instructionPosition, int operandPosition) {
		...
		this.bvcInstruction = (BvcInstruction)instruction;
	...
	public String getInstructioName() {
		return bvcInstruction.getInstruction();
	}

	@Override
	public EAttribute getSeparatorAttribute() {
		return AssemblerPackage.eINSTANCE.getBvcInstruction_WsOperand();
	}
	...
	public EObject getOperand() {
		return bvcInstruction.getOperand();
	}
}
