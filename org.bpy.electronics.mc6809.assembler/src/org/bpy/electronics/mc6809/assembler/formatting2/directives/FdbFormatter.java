...
/**
 * Format Fdb instruction.
 * 
 * @author Patrick BRIAND
 *
 */
public class FdbFormatter extends AbstractObjectFormatter {

	/** reference on the instruction */
	private FdbDirective instruction;
	 ...
	 */
	public FdbFormatter(IFormattableDocument doc, String tabPolicy, int tabSize) {
	...
	public void format(AssemblerFormatter assemblerFormatter, EObject object, int instructionPosition, int operandPosition) {
		...
		this.instruction = (FdbDirective)object;
