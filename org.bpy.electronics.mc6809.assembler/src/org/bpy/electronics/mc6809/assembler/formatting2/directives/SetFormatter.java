...
/**
 * Format Set instruction.
 * 
 * @author Patrick BRIAND
 *
 */
public class SetFormatter extends AbstractObjectFormatter {

	/** reference on the instruction */
	private SetDirective instruction;
	 ...
	 */
	public SetFormatter(IFormattableDocument doc, String tabPolicy, int tabSize) {
	...
	public void format(AssemblerFormatter assemblerFormatter, EObject object, int instructionPosition, int operandPosition) {
		...
		this.instruction = (SetDirective)object;
