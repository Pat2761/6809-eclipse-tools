...
/**
 * Format Ror instruction.
 * 
 * @author Patrick BRIAND
 *
 */
public class RorInstructionFormater extends AbstractInstructionWithOperand {

	/** reference on the instruction */
	private RorInstruction rorInstruction;
	 ...
	 */
	public RorInstructionFormater(IFormattableDocument doc, String tabPolicy, int tabSize) {
	...
	public void format(AssemblerFormatter assemblerFormatter, EObject instruction, int instructionPosition, int operandPosition) {
		...
		this.rorInstruction = (RorInstruction)instruction;
	...
	public String getInstructioName() {
		return rorInstruction.getInstruction();
	}

	@Override
	public EAttribute getSeparatorAttribute() {
		return AssemblerPackage.eINSTANCE.getRorInstruction_WsOperand();
	}
	...
	public EObject getOperand() {
		return rorInstruction.getOperand();
	}
}
