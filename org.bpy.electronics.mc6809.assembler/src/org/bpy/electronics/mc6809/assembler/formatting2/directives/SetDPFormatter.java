...
/**
 * Format SetDP instruction.
 * 
 * @author Patrick BRIAND
 *
 */
public class SetDPFormatter extends AbstractObjectFormatter {

	/** reference on the instruction */
	private SetDPDirective instruction;
	 ...
	 */
	public SetDPFormatter(IFormattableDocument doc, String tabPolicy, int tabSize) {
	...
	public void format(AssemblerFormatter assemblerFormatter, EObject object, int instructionPosition, int operandPosition) {
		...
		this.instruction = (SetDPDirective)object;
	...
	public EAttribute getSeparatorAttribute() {
		return AssemblerPackage.eINSTANCE.getSetDPDirective_Ws();
	}
