...
/**
 * Format Rmb instruction.
 * 
 * @author Patrick BRIAND
 *
 */
public class RmbFormatter extends AbstractObjectFormatter {

	/** reference on the instruction */
	private RmbDirective instruction;
	 ...
	 */
	public RmbFormatter(IFormattableDocument doc, String tabPolicy, int tabSize) {
	...
	public void format(AssemblerFormatter assemblerFormatter, EObject object, int instructionPosition, int operandPosition) {
		...
		this.instruction = (RmbDirective)object;
