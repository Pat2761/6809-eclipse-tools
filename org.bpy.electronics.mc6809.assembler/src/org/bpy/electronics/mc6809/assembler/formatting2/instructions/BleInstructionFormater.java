...
/**
 * Format Ble instruction.
 * 
 * @author Patrick BRIAND
 *
 */
public class BleInstructionFormater extends AbstractInstructionWithOperand {
	 ...
	 */
	public BleInstructionFormater(IFormattableDocument doc, String tabPolicy, int tabSize) {
	...
	public void format(AssemblerFormatter assemblerFormatter, EObject instruction, int instructionPosition, int operandPosition) {
		...
		this.bleInstruction = (BleInstruction)instruction;
	...
	public String getInstructioName() {
		return bleInstruction.getInstruction();
	}

	@Override
	public EAttribute getSeparatorAttribute() {
		return AssemblerPackage.eINSTANCE.getBleInstruction_WsOperand();
	}
	...
	public EObject getOperand() {
		return bleInstruction.getOperand();
	}
}
