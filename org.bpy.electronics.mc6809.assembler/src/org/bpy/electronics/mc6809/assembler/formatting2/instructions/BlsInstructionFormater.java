...
/**
 * Format Bls instruction.
 * 
 * @author Patrick BRIAND
 *
 */
public class BlsInstructionFormater extends AbstractInstructionWithOperand {

	/** reference on the instruction */
	private BlsInstruction blsInstruction;
	 ...
	 */
	public BlsInstructionFormater(IFormattableDocument doc, String tabPolicy, int tabSize) {
	...
	public void format(AssemblerFormatter assemblerFormatter, EObject instruction, int instructionPosition, int operandPosition) {
		...
		this.blsInstruction = (BlsInstruction)instruction;
	...
	public String getInstructioName() {
		return blsInstruction.getInstruction();
	}

	@Override
	public EAttribute getSeparatorAttribute() {
		return AssemblerPackage.eINSTANCE.getBlsInstruction_WsOperand();
	}
	...
	public EObject getOperand() {
		return blsInstruction.getOperand();
	}
}
