...
/**
 * Format Bpl instruction.
 * 
 * @author Patrick BRIAND
 *
 */
public class BplInstructionFormater extends AbstractInstructionWithOperand {

	/** reference on the instruction */
	private BplInstruction bplInstruction;
	 ...
	 */
	public BplInstructionFormater(IFormattableDocument doc, String tabPolicy, int tabSize) {
	...
	public void format(AssemblerFormatter assemblerFormatter, EObject instruction, int instructionPosition, int operandPosition) {
		...
		this.bplInstruction = (BplInstruction)instruction;
	...
	public String getInstructioName() {
		return bplInstruction.getInstruction();
	}
	...
	public EObject getOperand() {
		return bplInstruction.getOperand();
	}
}
