...
/**
 * Format Tst instruction.
 * 
 * @author Patrick BRIAND
 *
 */
public class TstInstructionFormater extends AbstractInstructionWithOperand {

	/** reference on the instruction */
	private TstInstruction tstInstruction;
	 ...
	 */
	public TstInstructionFormater(IFormattableDocument doc, String tabPolicy, int tabSize) {
	...
	public void format(AssemblerFormatter assemblerFormatter, EObject instruction, int instructionPosition, int operandPosition) {
		...
		this.tstInstruction = (TstInstruction)instruction;
	...
	public String getInstructioName() {
		return tstInstruction.getInstruction();
	}

	@Override
	public EAttribute getSeparatorAttribute() {
		return AssemblerPackage.eINSTANCE.getTstInstruction_WsOperand();
	}
	...
	public EObject getOperand() {
		return tstInstruction.getOperand();
	}
}
