...
/**
 * Format Bgt instruction.
 * 
 * @author Patrick BRIAND
 *
 */
public class BgtInstructionFormater extends AbstractInstructionWithOperand {

	/** reference on the instruction */
	private BgtInstruction bgtInstruction;
	 ...
	 */
	public BgtInstructionFormater(IFormattableDocument doc, String tabPolicy, int tabSize) {
	...
	public void format(AssemblerFormatter assemblerFormatter, EObject instruction, int instructionPosition, int operandPosition) {
		...
		this.bgtInstruction = (BgtInstruction)instruction;
	...
	public String getInstructioName() {
		return bgtInstruction.getInstruction();
	}
	...
	public EObject getOperand() {
		return bgtInstruction.getOperand();
	}
}
