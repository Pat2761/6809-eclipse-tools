...
/**
 * Format Bhs instruction.
 * 
 * @author Patrick BRIAND
 *
 */
public class BhsInstructionFormater extends AbstractInstructionWithOperand {

	/** reference on the instruction */
	private BhsInstruction bhsInstruction;
	 ...
	 */
	public BhsInstructionFormater(IFormattableDocument doc, String tabPolicy, int tabSize) {
	...
	public void format(AssemblerFormatter assemblerFormatter, EObject instruction, int instructionPosition, int operandPosition) {
		...
		this.bhsInstruction = (BhsInstruction)instruction;
	...
	public String getInstructioName() {
		return bhsInstruction.getInstruction();
	}

	@Override
	public EAttribute getSeparatorAttribute() {
		return AssemblerPackage.eINSTANCE.getBhsInstruction_WsOperand();
	}
	...
	public EObject getOperand() {
		return bhsInstruction.getOperand();
	}
}
