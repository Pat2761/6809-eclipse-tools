...
/**
 * Format Bmi instruction.
 * 
 * @author Patrick BRIAND
 *
 */
public class BmiInstructionFormater extends AbstractInstructionWithOperand {

	/** reference on the instruction */
	private BmiInstruction bmiInstruction;
	 ...
	 */
	public BmiInstructionFormater(IFormattableDocument doc, String tabPolicy, int tabSize) {
	...
	public void format(AssemblerFormatter assemblerFormatter, EObject instruction, int instructionPosition, int operandPosition) {
		...
		this.bmiInstruction = (BmiInstruction)instruction;
	...
	public String getInstructioName() {
		return bmiInstruction.getInstruction();
	}
	...
	public EObject getOperand() {
		return bmiInstruction.getOperand();
	}
}
