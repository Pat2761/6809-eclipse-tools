...
/**
 * Allow to parse an ASRA Instruction
 * 
 * @author Patrick BRIAND
 *
 */
public class AssembledASRAInstruction extends AbstractInstructionAssemblyLine {
    ...
    *
	 ...
	 */
	public AssembledASRAInstruction(AssemblerEngine engine) {
		super(engine);
	}
