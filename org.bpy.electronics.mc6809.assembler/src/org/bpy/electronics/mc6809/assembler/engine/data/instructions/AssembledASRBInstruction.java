 ...
 *
 */
public class AssembledASRBInstruction extends AbstractInstructionAssemblyLine {
    ...
    *
	 ...
	 */
	public AssembledASRBInstruction(AssemblerEngine engine) {
		super(engine);
	}
