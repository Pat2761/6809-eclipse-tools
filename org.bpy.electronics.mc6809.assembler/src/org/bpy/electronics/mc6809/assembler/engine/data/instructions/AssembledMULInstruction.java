...
/**
 * Allow to pars an MUL Instruction
 * 
 * @author briand
 *
 */
public class AssembledMULInstruction extends AbstractInstructionAssemblyLine {
	 ...
	 */
	public void parse(MulInstruction instruction, int currentPcValue, int lineNumber) {
	 ...
	 */
	public MulInstruction getInstruction() {
		return instruction;
	}

	@Override
	public void setOpcode(AddressingMode mode) {
		opcodeBytes =  new int[] {0x3D};
	}
