...
/**
 * Allow to parse an DECB Instruction
 * 
 * @author Patrick BRIAND
 *
 */
public class AssembledDECBInstruction extends AbstractInstructionAssemblyLine {
    ...
    *
	 ...
	 */
	public AssembledDECBInstruction(AssemblerEngine engine) {
		super(engine);
	}
