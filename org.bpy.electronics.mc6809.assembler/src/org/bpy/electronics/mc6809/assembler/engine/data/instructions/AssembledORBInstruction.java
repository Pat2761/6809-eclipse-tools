...
/**
 * Allow to parse an ORB instruction
 * 
 * 
 * @author briand
 *
 */
public class AssembledORBInstruction extends AbstractInstructionAssemblyLine {
	...
	static {
		...
		OP_CODE.put(AddressingMode.IMMEDIATE, new int[] { 0xCA});
		OP_CODE.put(AddressingMode.DIRECT, new int[] { 0xDA});
		OP_CODE.put(AddressingMode.INDEXED_ACCUMULATOR_MOVING_INDIRECT_MODE, new int[] { 0xEA});
		OP_CODE.put(AddressingMode.INDEXED_ACCUMULATOR_MOVING_MODE, new int[] { 0xEA});
		OP_CODE.put(AddressingMode.INDEXED_AUTO_DEC_INC_INDIRECT_MODE, new int[] { 0xEA});
		OP_CODE.put(AddressingMode.INDEXED_AUTO_DEC_INC_MODE, new int[] { 0xEA});
		OP_CODE.put(AddressingMode.INDEXED_CONSTANT_MODE, new int[] { 0xEA});
		OP_CODE.put(AddressingMode.INDEXED_CONSTANT_INDIRECT_MODE, new int[] { 0xEA});
		OP_CODE.put(AddressingMode.INDEXED_RELATIF_TO_PC, new int[] { 0xEA});
		OP_CODE.put(AddressingMode.INDEXED_RELATIF_TO_PC_INDIRECT_MODE, new int[] { 0xEA});
		OP_CODE.put(AddressingMode.EXTENDED_INDIRECT, new int[] { 0xEA, 0x9F});
		OP_CODE.put(AddressingMode.EXTENDED, new int[] { 0xFA});
    ...
    *
	 ...
	 */
	public AssembledORBInstruction(AssemblerEngine engine) {
		super(engine);
	}
