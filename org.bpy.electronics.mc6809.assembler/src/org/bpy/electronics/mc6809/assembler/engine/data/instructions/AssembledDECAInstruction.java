...
/**
 * Allow to parse an DECA Instruction
 * 
 * @author Patrick BRIAND
 *
 */
public class AssembledDECAInstruction extends AbstractInstructionAssemblyLine {
    ...
    *
	 ...
	 */
	public AssembledDECAInstruction(AssemblerEngine engine) {
		super(engine);
	}
