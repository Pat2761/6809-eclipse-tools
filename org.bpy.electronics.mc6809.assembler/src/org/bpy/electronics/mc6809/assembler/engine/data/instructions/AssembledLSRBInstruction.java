...
/**
 * Allow to pars an LSRB Instruction
 * 
 * @author Patrick BRIAND
 *
 */
public class AssembledLSRBInstruction extends AbstractInstructionAssemblyLine {
    ...
    *
	 ...
	 */
	public AssembledLSRBInstruction(AssemblerEngine engine) {
		super(engine);
	}
