		...
		switch (mode) {
			case IMMEDIATE:
				AssemblerErrorDescription errorDescription = new AssemblerErrorDescription(
						...
						AssemblerPackage.Literals.NEG_INSTRUCTION__OPERAND, 
						InstructionValidator.ILLEGAL_MODE);
				AssemblerErrorManager.getInstance().addProblem(instruction, errorDescription);
				break;
				
			case DIRECT:
				setDirectOperand(instruction, (DirectOperand)instruction.getOperand(), AssemblerPackage.Literals.NEG_INSTRUCTION__OPERAND);
				break;
			
			case EXTENDED:
				setExtendedOperand(instruction, (ExtendedOperand)instruction.getOperand(), AssemblerPackage.Literals.NEG_INSTRUCTION__OPERAND);
				break;
				
			case EXTENDED_INDIRECT:
				setExtendedIndirectOperand(instruction, (ExtendedIndirectOperand)instruction.getOperand(), AssemblerPackage.Literals.NEG_INSTRUCTION__OPERAND);
				break;
			...
			case INDEXED_AUTO_DEC_INC_INDIRECT_MODE:
				setIndexedAccumulatorMovingMode(instruction, (AutoIncDecIndirectMode)((IndexedOperand)instruction.getOperand()).getMode(),AssemblerPackage.Literals.NEG_INSTRUCTION__OPERAND);
				break;
			...
			case INDEXED_CONSTANT_MODE:
				setIndexedConstantMode(instruction, (ConstantIndexedMode)((IndexedOperand)instruction.getOperand()).getMode(), AssemblerPackage.Literals.NEG_INSTRUCTION__OPERAND);
				break;
				
			case INDEXED_CONSTANT_INDIRECT_MODE:
				setIndexedConstantIndirectMode(instruction, (ConstantIndexedMovingIndirectMode)((IndexedOperand)instruction.getOperand()).getMode(), AssemblerPackage.Literals.NEG_INSTRUCTION__OPERAND);
				break;
				
			case INDEXED_RELATIF_TO_PC:
				setRelatifToPCMode(instruction, (RelatifToPCMode)((IndexedOperand)instruction.getOperand()).getMode(),AssemblerPackage.Literals.NEG_INSTRUCTION__OPERAND);
				break;
				
			case INDEXED_RELATIF_TO_PC_INDIRECT_MODE:
				setRelatifToPCIndirectMode(instruction, (RelatifToPCIndirectMode)((IndexedOperand)instruction.getOperand()).getMode(),AssemblerPackage.Literals.NEG_INSTRUCTION__OPERAND);
				break;
