...
/**
 * Allow to parse an LEAU instruction
 * 
 * 
 * @author briand
 *
 */
public class AssembledLEAUInstruction extends AbstractInstructionAssemblyLine {
	...
	static {
		...
		OP_CODE.put(AddressingMode.INDEXED_ACCUMULATOR_MOVING_INDIRECT_MODE, new int[] {0x33});
		OP_CODE.put(AddressingMode.INDEXED_ACCUMULATOR_MOVING_MODE, new int[] {0x33});
		OP_CODE.put(AddressingMode.INDEXED_AUTO_DEC_INC_INDIRECT_MODE, new int[] {0x33});
		OP_CODE.put(AddressingMode.INDEXED_AUTO_DEC_INC_MODE, new int[] {0x33});
		OP_CODE.put(AddressingMode.INDEXED_CONSTANT_MODE, new int[] {0x33});
		OP_CODE.put(AddressingMode.INDEXED_CONSTANT_INDIRECT_MODE, new int[] {0x33});
		OP_CODE.put(AddressingMode.INDEXED_RELATIF_TO_PC, new int[] {0x33});
		OP_CODE.put(AddressingMode.INDEXED_RELATIF_TO_PC_INDIRECT_MODE, new int[] {0x33});
		OP_CODE.put(AddressingMode.EXTENDED_INDIRECT, new int[] {0x33, 0x9F});
    ...
    *
	 ...
	 */
	public AssembledLEAUInstruction(AssemblerEngine engine) {
		super(engine);
	}
