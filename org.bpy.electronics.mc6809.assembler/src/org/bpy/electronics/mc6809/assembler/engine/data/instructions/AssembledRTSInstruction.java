...
/**
 * Allow to pars an RTS Instruction
 * 
 * @author Patrick BRIAND
 *
 */
public class AssembledRTSInstruction extends AbstractInstructionAssemblyLine {
    ...
    *
	 ...
	 */
	public AssembledRTSInstruction(AssemblerEngine engine) {
		super(engine);
	}
	...
	public void parsePass1(EObject instruction, int currentPcValue, int lineNumber) {
		this.instruction = (RtsInstruction) instruction;
	 ...
	 */
	public RtsInstruction getInstruction() {
		return instruction;
	}

	@Override
	public void setOpcode(AddressingMode mode) {
		opcodeBytes =  new int[] {0x39};
	}
