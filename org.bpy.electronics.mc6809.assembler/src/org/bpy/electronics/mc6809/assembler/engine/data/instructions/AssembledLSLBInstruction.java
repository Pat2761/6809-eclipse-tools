...
/**
 * Allow to pars an LSLB Instruction
 * 
 * @author Patrick BRIAND
 *
 */
public class AssembledLSLBInstruction extends AbstractInstructionAssemblyLine {
    ...
    *
	 ...
	 */
	public AssembledLSLBInstruction(AssemblerEngine engine) {
		super(engine);
	}
