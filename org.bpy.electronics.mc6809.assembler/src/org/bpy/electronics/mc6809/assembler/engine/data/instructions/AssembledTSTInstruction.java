...
/**
 * Allow to parse an TST instruction
 * 
 * 
 * @author briand
 *
 */
public class AssembledTSTInstruction extends AbstractInstructionAssemblyLine {
	...
	static {
		...
		OP_CODE.put(AddressingMode.DIRECT, new int[] { 0x0D});
		OP_CODE.put(AddressingMode.INDEXED_ACCUMULATOR_MOVING_INDIRECT_MODE, new int[] { 0x6D});
		OP_CODE.put(AddressingMode.INDEXED_ACCUMULATOR_MOVING_MODE, new int[] { 0x6D});
		OP_CODE.put(AddressingMode.INDEXED_AUTO_DEC_INC_INDIRECT_MODE, new int[] { 0x6D});
		OP_CODE.put(AddressingMode.INDEXED_AUTO_DEC_INC_MODE, new int[] { 0x6D});
		OP_CODE.put(AddressingMode.INDEXED_CONSTANT_MODE, new int[] { 0x6D});
		OP_CODE.put(AddressingMode.INDEXED_CONSTANT_INDIRECT_MODE, new int[] { 0x6D});
		OP_CODE.put(AddressingMode.INDEXED_RELATIF_TO_PC, new int[] { 0x6D});
		OP_CODE.put(AddressingMode.INDEXED_RELATIF_TO_PC_INDIRECT_MODE, new int[] { 0x6D});
		OP_CODE.put(AddressingMode.EXTENDED_INDIRECT, new int[] { 0x6D, 0x9F});
		OP_CODE.put(AddressingMode.EXTENDED, new int[] { 0x7D});
    ...
    *
	 ...
	 */
	public AssembledTSTInstruction(AssemblerEngine engine) {
		super(engine);
	}
	...
	public void parsePass1(EObject instruction, int currentPcValue, int lineNumber) {
		this.instruction = (TstInstruction) instruction;
	 ...
	 */
	public TstInstruction getInstruction() {
		return instruction;
	}
		...
		switch (mode) {
			case IMMEDIATE:
				AssemblerErrorDescription errorDescription = new AssemblerErrorDescription(
						...
						AssemblerPackage.eINSTANCE.getTstInstruction_Operand(), 
						InstructionValidator.ILLEGAL_MODE);
				AssemblerErrorManager.getInstance().addProblem(instruction, errorDescription);
				break;
				
			case DIRECT:
				setDirectOperand(instruction, (DirectOperand)instruction.getOperand(), AssemblerPackage.eINSTANCE.getTstInstruction_Operand());	
				break;
			
			case EXTENDED:
				setExtendedOperand(instruction, (ExtendedOperand)instruction.getOperand(), AssemblerPackage.eINSTANCE.getTstInstruction_Operand());
				break;
				
			case EXTENDED_INDIRECT:
				setExtendedIndirectOperand(instruction, (ExtendedIndirectOperand)instruction.getOperand(), AssemblerPackage.eINSTANCE.getTstInstruction_Operand());
				break;
			...
			case INDEXED_AUTO_DEC_INC_INDIRECT_MODE:
				setIndexedAccumulatorMovingMode(instruction, (AutoIncDecIndirectMode)((IndexedOperand)instruction.getOperand()).getMode(),AssemblerPackage.eINSTANCE.getTstInstruction_Operand());
				break;
			...
			case INDEXED_CONSTANT_MODE:
				setIndexedConstantMode(instruction, (ConstantIndexedMode)((IndexedOperand)instruction.getOperand()).getMode(), AssemblerPackage.eINSTANCE.getTstInstruction_Operand());
				break;
				
			case INDEXED_CONSTANT_INDIRECT_MODE:
				setIndexedConstantIndirectMode(instruction, (ConstantIndexedMovingIndirectMode)((IndexedOperand)instruction.getOperand()).getMode(), AssemblerPackage.eINSTANCE.getTstInstruction_Operand());
				break;
				
			case INDEXED_RELATIF_TO_PC:
				setRelatifToPCMode(instruction, (RelatifToPCMode)((IndexedOperand)instruction.getOperand()).getMode(),AssemblerPackage.eINSTANCE.getTstInstruction_Operand());
				break;
				
			case INDEXED_RELATIF_TO_PC_INDIRECT_MODE:
				setRelatifToPCIndirectMode(instruction, (RelatifToPCIndirectMode)((IndexedOperand)instruction.getOperand()).getMode(),AssemblerPackage.eINSTANCE.getTstInstruction_Operand());
				break;
