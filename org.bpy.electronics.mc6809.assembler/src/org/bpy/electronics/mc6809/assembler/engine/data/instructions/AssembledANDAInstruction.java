 ...
 *
 */
public class AssembledANDAInstruction extends AbstractInstructionAssemblyLine {
	...
	static {
		...
		OP_CODE.put(AddressingMode.IMMEDIATE, new int[] { 0x84});
		OP_CODE.put(AddressingMode.DIRECT, new int[] { 0x94});
		OP_CODE.put(AddressingMode.INDEXED_ACCUMULATOR_MOVING_INDIRECT_MODE, new int[] { 0xA4});
		OP_CODE.put(AddressingMode.INDEXED_ACCUMULATOR_MOVING_MODE, new int[] { 0xA4});
		OP_CODE.put(AddressingMode.INDEXED_AUTO_DEC_INC_INDIRECT_MODE, new int[] { 0xA4});
		OP_CODE.put(AddressingMode.INDEXED_AUTO_DEC_INC_MODE, new int[] { 0xA4});
		OP_CODE.put(AddressingMode.INDEXED_CONSTANT_MODE, new int[] { 0xA4});
		OP_CODE.put(AddressingMode.INDEXED_CONSTANT_INDIRECT_MODE, new int[] { 0xA4});
		OP_CODE.put(AddressingMode.INDEXED_RELATIF_TO_PC, new int[] { 0xA4});
		OP_CODE.put(AddressingMode.INDEXED_RELATIF_TO_PC_INDIRECT_MODE, new int[] { 0xA4});
		OP_CODE.put(AddressingMode.EXTENDED_INDIRECT, new int[] { 0xA4, 0x9F});
		OP_CODE.put(AddressingMode.EXTENDED, new int[] { 0xB4});
    ...
    *
	 ...
	 */
	public AssembledANDAInstruction(AssemblerEngine engine) {
		super(engine);
	}
