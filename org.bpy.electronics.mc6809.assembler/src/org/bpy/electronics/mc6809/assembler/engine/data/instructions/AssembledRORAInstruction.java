...
/**
 * Allow to pars an RORA Instruction
 * 
 * @author Patrick BRIAND
 *
 */
public class AssembledRORAInstruction extends AbstractInstructionAssemblyLine {
    ...
    *
	 ...
	 */
	public AssembledRORAInstruction(AssemblerEngine engine) {
		super(engine);
	}
