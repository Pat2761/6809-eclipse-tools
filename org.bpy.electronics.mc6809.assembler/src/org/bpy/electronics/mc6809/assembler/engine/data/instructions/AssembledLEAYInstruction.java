...
/**
 * Allow to parse an LEAY instruction
 * 
 * 
 * @author briand
 *
 */
public class AssembledLEAYInstruction extends AbstractInstructionAssemblyLine {
	...
	static {
		...
		OP_CODE.put(AddressingMode.INDEXED_ACCUMULATOR_MOVING_INDIRECT_MODE, new int[] {0x31});
		OP_CODE.put(AddressingMode.INDEXED_ACCUMULATOR_MOVING_MODE, new int[] {0x31});
		OP_CODE.put(AddressingMode.INDEXED_AUTO_DEC_INC_INDIRECT_MODE, new int[] {0x31});
		OP_CODE.put(AddressingMode.INDEXED_AUTO_DEC_INC_MODE, new int[] {0x31});
		OP_CODE.put(AddressingMode.INDEXED_CONSTANT_MODE, new int[] {0x31});
		OP_CODE.put(AddressingMode.INDEXED_CONSTANT_INDIRECT_MODE, new int[] {0x31});
		OP_CODE.put(AddressingMode.INDEXED_RELATIF_TO_PC, new int[] {0x31});
		OP_CODE.put(AddressingMode.INDEXED_RELATIF_TO_PC_INDIRECT_MODE, new int[] {0x31});
		OP_CODE.put(AddressingMode.EXTENDED_INDIRECT, new int[] {0x31, 0x9F});
	...
	private LeaInstruction instruction;
    ...
    *
	 ...
	 */
	public AssembledLEAYInstruction(AssemblerEngine engine) {
		super(engine);
	}
	...
	public void parsePass1(EObject instruction, int currentPcValue, int lineNumber) {
		this.instruction = (LeaInstruction) instruction;
	 ...
	 */
	public LeaInstruction getInstruction() {
		return instruction;
	}
