...
public class AssembledLBGTInstruction extends AbstractRelativeBranchInstruction {
	 ...
	 */
	public AssembledLBGTInstruction(AssemblerEngine engine) {
		super(engine);
	}
	...
	public void parsePass2() {
		...
		if (instruction.getOperand().getOffset() != null) {
			...
			if (label != null) {
				...
				if (targetLine != null) {
					computeOperand(targetLine.getPcAddress(), WORD_MODE, AssemblerPackage.eINSTANCE.getBgtInstruction_Operand());
				} else {
