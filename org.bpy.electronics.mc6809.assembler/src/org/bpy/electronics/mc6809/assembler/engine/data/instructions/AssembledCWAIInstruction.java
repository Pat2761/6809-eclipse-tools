...
public class AssembledCWAIInstruction extends AbstractInstructionAssemblyLine {
	...
	static {
		OP_CODE.put(AddressingMode.IMMEDIATE, new int[] {0x3C});
	 ...
	 */
	public CwaiInstruction getInstruction() {
		return instruction;
	}
	...
	public void setOperand(AddressingMode mode) {
		switch (mode) {
			case IMMEDIATE:
				setImmediateOperand(instruction, (ImmediatOperand)instruction.getOperand(), AssemblerPackage.Literals.CWAI_INSTRUCTION__OPERAND, -128, 127);
				break;
