...
/**
 * Allow to parse an LBLT Instruction
 * 
 * @author briand
 *
 */
public class AssembledLBLTInstruction extends AbstractRelativeBranchInstruction {
	 ...
	 */
	public void parse(BltInstruction instruction, int currentPcValue, int lineNumber) {
