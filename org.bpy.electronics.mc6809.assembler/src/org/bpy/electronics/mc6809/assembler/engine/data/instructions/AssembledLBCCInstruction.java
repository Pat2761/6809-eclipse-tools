...
/**
 * Allow to parse an LBCC Instruction
 * 
 * @author briand
 *
 */
public class AssembledLBCCInstruction extends AbstractRelativeBranchInstruction {
	 ...
	 */
	public void parse(BccInstruction instruction, int currentPcValue, int lineNumber) {
