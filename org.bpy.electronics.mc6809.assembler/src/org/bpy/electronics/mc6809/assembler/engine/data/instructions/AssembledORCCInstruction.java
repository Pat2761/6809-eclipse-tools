...
/**
 * Allow to parse an ORCC instruction
 * 
 * 
 * @author briand
 *
 */
public class AssembledORCCInstruction extends AbstractInstructionAssemblyLine {
	...
	static {
		OP_CODE.put(AddressingMode.IMMEDIATE, new int[] {0x1A});
	 ...
	 */
	public void parse(OrCCInstruction instruction, int currentPcValue, int lineNumber) {
	 ...
	 */
	public OrCCInstruction getInstruction() {
		return instruction;
	}
	...
	public void setOperand(AddressingMode mode) {
		switch (mode) {
			case IMMEDIATE:
				setImmediateOperand(instruction, (ImmediatOperand)instruction.getOperand(), AssemblerPackage.eINSTANCE.getOrCCInstruction_Operand(), -128, 255);
				break;
			...
			case DIRECT:
				{
					AssemblerErrorDescription errorDescription = new AssemblerErrorDescription(
							...
							AssemblerPackage.eINSTANCE.getOrCCInstruction_Operand(), 
