...
/**
 * Allow to pars an LSRA Instruction
 * 
 * @author Patrick BRIAND
 *
 */
public class AssembledLSRAInstruction extends AbstractInstructionAssemblyLine {
    ...
    *
	 ...
	 */
	public AssembledLSRAInstruction(AssemblerEngine engine) {
		super(engine);
	}
