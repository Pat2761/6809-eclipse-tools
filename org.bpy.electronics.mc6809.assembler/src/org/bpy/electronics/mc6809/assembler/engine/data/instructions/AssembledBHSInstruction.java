...
public class AssembledBHSInstruction extends AbstractRelativeBranchInstruction {
	 ...
	 */
	public AssembledBHSInstruction(AssemblerEngine engine) {
		super(engine);
	}
	...
	public void parsePass2() {
		...
		if (instruction.getOperand().getOffset() != null) {
			...
			if (label != null) {
				...
				if (targetLine != null) {
					computeOperand(targetLine.getPcAddress(), BYTE_MODE, AssemblerPackage.eINSTANCE.getBhsInstruction_Operand());
				} else {
