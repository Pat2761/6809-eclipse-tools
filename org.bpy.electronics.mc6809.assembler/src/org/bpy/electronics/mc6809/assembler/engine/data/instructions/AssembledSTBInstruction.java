...
/**
 * Allow to parse an STB instruction
 * 
 * 
 * @author briand
 *
 */
public class AssembledSTBInstruction extends AbstractInstructionAssemblyLine {
	...
	static {
		...
		OP_CODE.put(AddressingMode.INDEXED_ACCUMULATOR_MOVING_MODE, new int[] { 0xE7});
		OP_CODE.put(AddressingMode.INDEXED_AUTO_DEC_INC_INDIRECT_MODE, new int[] { 0xE7});
		OP_CODE.put(AddressingMode.INDEXED_AUTO_DEC_INC_MODE, new int[] { 0xE7});
		OP_CODE.put(AddressingMode.INDEXED_CONSTANT_MODE, new int[] { 0xE7});
		OP_CODE.put(AddressingMode.INDEXED_CONSTANT_INDIRECT_MODE, new int[] { 0xE7});
		OP_CODE.put(AddressingMode.INDEXED_RELATIF_TO_PC, new int[] { 0xE7});
		OP_CODE.put(AddressingMode.INDEXED_RELATIF_TO_PC_INDIRECT_MODE, new int[] { 0xE7});
		OP_CODE.put(AddressingMode.EXTENDED_INDIRECT, new int[] { 0xE7, 0x9F});
		OP_CODE.put(AddressingMode.EXTENDED, new int[] { 0xF7});
    ...
    *
	 ...
	 */
	public AssembledSTBInstruction(AssemblerEngine engine) {
		super(engine);
	}
