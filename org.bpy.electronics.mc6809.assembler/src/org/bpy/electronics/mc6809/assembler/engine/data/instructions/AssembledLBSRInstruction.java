...
/**
 * Allow to parse an LBSR Instruction
 * 
 * @author briand
 *
 */
public class AssembledLBSRInstruction extends AbstractRelativeBranchInstruction {
    ...
    *
	 ...
	 */
	public AssembledLBSRInstruction(AssemblerEngine engine) {
		super(engine);
	}
	...
	public void parsePass2() {
		...
		if (label != null) {
			...
			if (targetLine != null) {
				computeOperand(targetLine.getPcAddress(), WORD_MODE, AssemblerPackage.eINSTANCE.getBsrInstruction_Operand());
			} else {
