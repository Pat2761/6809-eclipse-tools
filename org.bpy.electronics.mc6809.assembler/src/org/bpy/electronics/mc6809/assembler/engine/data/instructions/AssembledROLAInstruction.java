...
/**
 * Allow to pars an ROLA Instruction
 * 
 * @author Patrick BRIAND
 *
 */
public class AssembledROLAInstruction extends AbstractInstructionAssemblyLine {
    ...
    *
	 ...
	 */
	public AssembledROLAInstruction(AssemblerEngine engine) {
		super(engine);
	}
