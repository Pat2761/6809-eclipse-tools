...
public class AssembledDAAInstruction extends AbstractInstructionAssemblyLine {
	...
	private DaaInstruction instruction;
    ...
    *
	 ...
	 */
	public AssembledDAAInstruction(AssemblerEngine engine) {
		super(engine);
	}
	...
	public void parsePass1(EObject instruction, int currentPcValue, int lineNumber) {
		this.instruction = (DaaInstruction) instruction;
	 ...
	 */
	public DaaInstruction getInstruction() {
		return instruction;
	}

	@Override
	public void setOpcode(AddressingMode mode) {
		opcodeBytes =  new int[] {0x19};
	}
