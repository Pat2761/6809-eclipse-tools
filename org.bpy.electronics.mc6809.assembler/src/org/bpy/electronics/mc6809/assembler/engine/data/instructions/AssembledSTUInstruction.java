...
/**
 * Allow to parse an STU instruction
 * 
 * 
 * @author briand
 *
 */
public class AssembledSTUInstruction extends AbstractInstructionAssemblyLine {
	...
	static {
		...
		OP_CODE.put(AddressingMode.DIRECT, new int[] { 0xDF});
		OP_CODE.put(AddressingMode.INDEXED_ACCUMULATOR_MOVING_INDIRECT_MODE, new int[] { 0xEF});
		OP_CODE.put(AddressingMode.INDEXED_ACCUMULATOR_MOVING_MODE, new int[] { 0xEF});
		OP_CODE.put(AddressingMode.INDEXED_AUTO_DEC_INC_INDIRECT_MODE, new int[] { 0xEF});
		OP_CODE.put(AddressingMode.INDEXED_AUTO_DEC_INC_MODE, new int[] { 0xEF});
		OP_CODE.put(AddressingMode.INDEXED_CONSTANT_MODE, new int[] { 0xEF});
		OP_CODE.put(AddressingMode.INDEXED_CONSTANT_INDIRECT_MODE, new int[] { 0xEF});
		OP_CODE.put(AddressingMode.INDEXED_RELATIF_TO_PC, new int[] { 0xEF});
		OP_CODE.put(AddressingMode.INDEXED_RELATIF_TO_PC_INDIRECT_MODE, new int[] { 0xEF});
		OP_CODE.put(AddressingMode.EXTENDED_INDIRECT, new int[] { 0xEF, 0x9F});
		OP_CODE.put(AddressingMode.EXTENDED, new int[] { 0xFF});
    ...
    *
	 ...
	 */
	public AssembledSTUInstruction(AssemblerEngine engine) {
		super(engine);
	}
