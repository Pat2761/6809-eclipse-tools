...
/**
 * Allow to parse an BPL Instruction
 * 
 * @author briand
 *
 */
public class AssembledBPLInstruction extends AbstractRelativeBranchInstruction {
    ...
    *
	 ...
	 */
	public AssembledBPLInstruction(AssemblerEngine engine) {
		super(engine);
	}
	...
	public void parsePass2() {
		...
		if (label != null) {
			...
			if (targetLine != null) {
				computeOperand(targetLine.getPcAddress(), BYTE_MODE, AssemblerPackage.eINSTANCE.getBplInstruction_Operand());
			} else {
