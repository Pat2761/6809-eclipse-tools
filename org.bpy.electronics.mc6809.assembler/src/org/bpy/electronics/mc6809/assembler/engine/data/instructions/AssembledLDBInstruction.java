...
/**
 * Allow to parse an LDB instruction
 * 
 * 
 * @author briand
 *
 */
public class AssembledLDBInstruction extends AbstractInstructionAssemblyLine {
	...
	static {
		OP_CODE.put(AddressingMode.IMMEDIATE, new int[] { 0xC6});
		OP_CODE.put(AddressingMode.DIRECT, new int[] { 0xD6});
		OP_CODE.put(AddressingMode.INDEXED_ACCUMULATOR_MOVING_INDIRECT_MODE, new int[] { 0xE6});
		OP_CODE.put(AddressingMode.INDEXED_ACCUMULATOR_MOVING_MODE, new int[] { 0xE6});
		OP_CODE.put(AddressingMode.INDEXED_AUTO_DEC_INC_INDIRECT_MODE, new int[] { 0xE6});
		OP_CODE.put(AddressingMode.INDEXED_AUTO_DEC_INC_MODE, new int[] { 0xE6});
		OP_CODE.put(AddressingMode.INDEXED_CONSTANT_MODE, new int[] { 0xE6});
		OP_CODE.put(AddressingMode.INDEXED_CONSTANT_INDIRECT_MODE, new int[] { 0xE6});
		OP_CODE.put(AddressingMode.INDEXED_RELATIF_TO_PC, new int[] { 0xE6});
		OP_CODE.put(AddressingMode.INDEXED_RELATIF_TO_PC_INDIRECT_MODE, new int[] { 0xE6});
		OP_CODE.put(AddressingMode.EXTENDED_INDIRECT, new int[] { 0xE6, 0x9F});
		OP_CODE.put(AddressingMode.EXTENDED, new int[] { 0xF6});
	...
	public void setOperand(AddressingMode mode) {
		switch (mode) {
			case IMMEDIATE:
				setImmediateOperand(instruction, (ImmediatOperand)instruction.getOperand(), AssemblerPackage.eINSTANCE.getLdInstruction_Operand(), -128, 255);
				break;
