 ...
 *
 */
public class AssembledSWIInstruction extends AbstractInstructionAssemblyLine {
    ...
    *
	 ...
	 */
	public AssembledSWIInstruction(AssemblerEngine engine) {
		super(engine);
	}
	...
	public void parsePass1(EObject instruction, int currentPcValue, int lineNumber) {
		this.instruction = (SwiInstruction) instruction;
	 ...
	 */
	public SwiInstruction getInstruction() {
		return instruction;
	}
