...
/**
 * Allow to pars an RORB Instruction
 * 
 * @author Patrick BRIAND
 *
 */
public class AssembledRORBInstruction extends AbstractInstructionAssemblyLine {
    ...
    *
	 ...
	 */
	public AssembledRORBInstruction(AssemblerEngine engine) {
		super(engine);
	}
