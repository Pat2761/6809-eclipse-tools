...
/**
 * Allow to parse an BNE Instruction
 * 
 * @author briand
 *
 */
public class AssembledBNEInstruction extends AbstractRelativeBranchInstruction {
    ...
    *
	 ...
	 */
	public AssembledBNEInstruction(AssemblerEngine engine) {
		super(engine);
	}
	...
	public void parsePass2() {
		...
		if (label != null) {
			...
			if (targetLine != null) {
				computeOperand(targetLine.getPcAddress(), BYTE_MODE, AssemblerPackage.eINSTANCE.getBneInstruction_Operand());
			} else {
