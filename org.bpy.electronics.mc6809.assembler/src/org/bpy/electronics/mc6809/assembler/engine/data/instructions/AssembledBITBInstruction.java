...
/**
 * Allow to parse an BITA instruction
 * 
 * 
 * @author briand
 *
 */
public class AssembledBITBInstruction extends AbstractInstructionAssemblyLine {
	...
	static {
		...
		OP_CODE.put(AddressingMode.IMMEDIATE, new int[] {0xC5});
		OP_CODE.put(AddressingMode.DIRECT, new int[] {0xD5});
		OP_CODE.put(AddressingMode.INDEXED_ACCUMULATOR_MOVING_INDIRECT_MODE, new int[] {0xE5});
		OP_CODE.put(AddressingMode.INDEXED_ACCUMULATOR_MOVING_MODE, new int[] {0xE5});
		OP_CODE.put(AddressingMode.INDEXED_AUTO_DEC_INC_INDIRECT_MODE, new int[] {0xE5});
		OP_CODE.put(AddressingMode.INDEXED_AUTO_DEC_INC_MODE, new int[] {0xE5});
		OP_CODE.put(AddressingMode.INDEXED_CONSTANT_MODE, new int[] {0xE5});
		OP_CODE.put(AddressingMode.INDEXED_CONSTANT_INDIRECT_MODE, new int[] {0xE5});
		OP_CODE.put(AddressingMode.INDEXED_RELATIF_TO_PC, new int[] {0xE5});
		OP_CODE.put(AddressingMode.INDEXED_RELATIF_TO_PC_INDIRECT_MODE, new int[] {0xE5});
		OP_CODE.put(AddressingMode.EXTENDED_INDIRECT, new int[] {0xE5, 0x9F});
		OP_CODE.put(AddressingMode.EXTENDED, new int[] {0xF5});
    ...
    *
	 ...
	 */
	public AssembledBITBInstruction(AssemblerEngine engine) {
		super(engine);
	}
	...
	public void parsePass1(EObject instruction, int currentPcValue, int lineNumber) {
		this.instruction = (BitInstruction) instruction;
	 ...
	 */
	public BitInstruction getInstruction() {
		return instruction;
	}
	...
	public void setOperand(AddressingMode mode) {
		switch (mode) {
			case IMMEDIATE:
				setImmediateOperand(instruction, (ImmediatOperand)instruction.getOperand(), AssemblerPackage.eINSTANCE.getBitInstruction_Operand(), -128, 255);
				break;
				
			case DIRECT:
				setDirectOperand(instruction, (DirectOperand)instruction.getOperand(), AssemblerPackage.eINSTANCE.getBitInstruction_Operand());
				break;
			
			case EXTENDED:
				setExtendedOperand(instruction, (ExtendedOperand)instruction.getOperand(), AssemblerPackage.eINSTANCE.getBitInstruction_Operand());
				break;
				
			case EXTENDED_INDIRECT:
				setExtendedIndirectOperand(instruction, (ExtendedIndirectOperand)instruction.getOperand(), AssemblerPackage.eINSTANCE.getBitInstruction_Operand());
				break;
			...
			case INDEXED_AUTO_DEC_INC_INDIRECT_MODE:
				setIndexedAccumulatorMovingMode(instruction, (AutoIncDecIndirectMode)((IndexedOperand)instruction.getOperand()).getMode(),AssemblerPackage.eINSTANCE.getBitInstruction_Operand());
				break;
			...
			case INDEXED_CONSTANT_MODE:
				setIndexedConstantMode(instruction, (ConstantIndexedMode)((IndexedOperand)instruction.getOperand()).getMode(), AssemblerPackage.eINSTANCE.getBitInstruction_Operand());
				break;
				
			case INDEXED_CONSTANT_INDIRECT_MODE:
				setIndexedConstantIndirectMode(instruction, (ConstantIndexedMovingIndirectMode)((IndexedOperand)instruction.getOperand()).getMode(), AssemblerPackage.eINSTANCE.getBitInstruction_Operand());
				break;
				
			case INDEXED_RELATIF_TO_PC:
				setRelatifToPCMode(instruction, (RelatifToPCMode)((IndexedOperand)instruction.getOperand()).getMode(),AssemblerPackage.eINSTANCE.getBitInstruction_Operand());
				break;
				
			case INDEXED_RELATIF_TO_PC_INDIRECT_MODE:
				setRelatifToPCIndirectMode(instruction, (RelatifToPCIndirectMode)((IndexedOperand)instruction.getOperand()).getMode(),AssemblerPackage.eINSTANCE.getBitInstruction_Operand());
				break;
