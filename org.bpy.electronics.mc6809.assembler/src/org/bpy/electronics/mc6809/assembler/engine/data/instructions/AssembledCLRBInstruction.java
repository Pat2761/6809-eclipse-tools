 ...
 *
 */
public class AssembledCLRBInstruction extends AbstractInstructionAssemblyLine {
    ...
    *
	 ...
	 */
	public AssembledCLRBInstruction(AssemblerEngine engine) {
		super(engine);
	}
