...
/**
 * Allow to pars an RTI Instruction
 * 
 * @author Patrick BRIAND
 *
 */
public class AssembledRTIInstruction extends AbstractInstructionAssemblyLine {
    ...
    *
	 ...
	 */
	public AssembledRTIInstruction(AssemblerEngine engine) {
		super(engine);
	}
	...
	public void parsePass1(EObject instruction, int currentPcValue, int lineNumber) {
		this.instruction = (RtiInstruction) instruction;
	 ...
	 */
	public RtiInstruction getInstruction() {
		return instruction;
	}

	@Override
	public void setOpcode(AddressingMode mode) {
		opcodeBytes =  new int[] {0x3B};
	}
