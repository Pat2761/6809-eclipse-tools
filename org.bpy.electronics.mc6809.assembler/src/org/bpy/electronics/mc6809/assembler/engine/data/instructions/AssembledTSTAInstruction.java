...
/**
 * Allow to pars an TSTA Instruction
 * 
 * @author Patrick BRIAND
 *
 */
public class AssembledTSTAInstruction extends AbstractInstructionAssemblyLine {
    ...
    *
	 ...
	 */
	public AssembledTSTAInstruction(AssemblerEngine engine) {
		super(engine);
	}
