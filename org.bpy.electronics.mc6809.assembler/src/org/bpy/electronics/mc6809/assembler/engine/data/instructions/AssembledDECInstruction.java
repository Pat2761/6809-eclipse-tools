...
public class AssembledDECInstruction extends AbstractInstructionAssemblyLine {
    ...
    *
	 ...
	 */
	public AssembledDECInstruction(AssemblerEngine engine) {
		super(engine);
	}
	...
	public void parsePass1(EObject instruction, int currentPcValue, int lineNumber) {
		this.instruction = (DecInstruction) instruction;
		...
		switch (mode) {
			case IMMEDIATE:
				AssemblerErrorDescription errorDescription = new AssemblerErrorDescription(
						...
						AssemblerPackage.eINSTANCE.getDecInstruction_Operand(), 
						InstructionValidator.ILLEGAL_MODE);
				AssemblerErrorManager.getInstance().addProblem(instruction, errorDescription);
				break;
				
			case DIRECT:
				setDirectOperand(instruction, (DirectOperand)instruction.getOperand(), AssemblerPackage.eINSTANCE.getDecInstruction_Operand());
				break;
			
			case EXTENDED:
				setExtendedOperand(instruction, (ExtendedOperand)instruction.getOperand(), AssemblerPackage.eINSTANCE.getDecInstruction_Operand());
				break;
				
			case EXTENDED_INDIRECT:
				setExtendedIndirectOperand(instruction, (ExtendedIndirectOperand)instruction.getOperand(), AssemblerPackage.eINSTANCE.getDecInstruction_Operand());
				break;
			...
			case INDEXED_AUTO_DEC_INC_INDIRECT_MODE:
				setIndexedAccumulatorMovingMode(instruction, (AutoIncDecIndirectMode)((IndexedOperand)instruction.getOperand()).getMode(),AssemblerPackage.eINSTANCE.getDecInstruction_Operand());
				break;
			...
			case INDEXED_CONSTANT_MODE:
				setIndexedConstantMode(instruction, (ConstantIndexedMode)((IndexedOperand)instruction.getOperand()).getMode(), AssemblerPackage.eINSTANCE.getDecInstruction_Operand());
				break;
				
			case INDEXED_CONSTANT_INDIRECT_MODE:
				setIndexedConstantIndirectMode(instruction, (ConstantIndexedMovingIndirectMode)((IndexedOperand)instruction.getOperand()).getMode(), AssemblerPackage.eINSTANCE.getDecInstruction_Operand());
				break;
				
			case INDEXED_RELATIF_TO_PC:
				setRelatifToPCMode(instruction, (RelatifToPCMode)((IndexedOperand)instruction.getOperand()).getMode(),AssemblerPackage.eINSTANCE.getDecInstruction_Operand());
				break;
				
			case INDEXED_RELATIF_TO_PC_INDIRECT_MODE:
				setRelatifToPCIndirectMode(instruction, (RelatifToPCIndirectMode)((IndexedOperand)instruction.getOperand()).getMode(),AssemblerPackage.eINSTANCE.getDecInstruction_Operand());
				break;
