...
/**
 * Allow to pars an ROLB Instruction
 * 
 * @author Patrick BRIAND
 *
 */
public class AssembledROLBInstruction extends AbstractInstructionAssemblyLine {
    ...
    *
	 ...
	 */
	public AssembledROLBInstruction(AssemblerEngine engine) {
		super(engine);
	}
