...
/**
 * Allow to parse an COMA Instruction
 * 
 * @author Patrick BRIAND
 *
 */
public class AssembledCOMAInstruction extends AbstractInstructionAssemblyLine {
    ...
    *
	 ...
	 */
	public AssembledCOMAInstruction(AssemblerEngine engine) {
		super(engine);
	}
