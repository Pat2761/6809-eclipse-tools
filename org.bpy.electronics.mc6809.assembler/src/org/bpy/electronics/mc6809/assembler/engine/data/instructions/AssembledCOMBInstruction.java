 ...
 *
 */
public class AssembledCOMBInstruction extends AbstractInstructionAssemblyLine {
    ...
    *
	 ...
	 */
	public AssembledCOMBInstruction(AssemblerEngine engine) {
		super(engine);
	}
