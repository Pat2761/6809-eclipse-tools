...
/**
 * Allow to parse an BCC Instruction
 * 
 * @author briand
 *
 */
public class AssembledBCCInstruction extends AbstractRelativeBranchInstruction {
    ...
    *
	 ...
	 */
	public AssembledBCCInstruction(AssemblerEngine engine) {
		super(engine);
	}
	...
	public void parsePass2() {
		...
		if (label != null) {
			...
			if (targetLine != null) {
				computeOperand(targetLine.getPcAddress(), BYTE_MODE, AssemblerPackage.eINSTANCE.getBccInstruction_Operand());
			} else {
	 ...
	 */
	public BccInstruction getInstruction() {
		return instruction;
	}
