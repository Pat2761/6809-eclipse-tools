...
/**
 * Allow to pars an NEGB Instruction
 * 
 * @author Patrick BRIAND
 *
 */
public class AssembledNEGBInstruction extends AbstractInstructionAssemblyLine {
    ...
    *
	 ...
	 */
	public AssembledNEGBInstruction(AssemblerEngine engine) {
		super(engine);
	}
