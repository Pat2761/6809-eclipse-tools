 ...
 *
 */
public class AssembledASLAInstruction extends AbstractInstructionAssemblyLine {
    ...
    *
	 ...
	 */
	public AssembledASLAInstruction(AssemblerEngine engine) {
		super(engine);
	}
