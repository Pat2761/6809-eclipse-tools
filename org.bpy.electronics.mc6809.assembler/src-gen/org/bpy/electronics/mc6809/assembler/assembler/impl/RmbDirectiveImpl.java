...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Rmb Directive</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.bpy.electronics.mc6809.assembler.assembler.impl.RmbDirectiveImpl#getName <em>Name</em>}</li>
 ...
 *   <li>{@link org.bpy.electronics.mc6809.assembler.assembler.impl.RmbDirectiveImpl#getComment <em>Comment</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RmbDirectiveImpl extends MinimalEObjectImpl.Container implements RmbDirective
{
  /**
  ...
  public NotificationChain basicSetName(IdentifierValue newName, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AssemblerPackage.RMB_DIRECTIVE__NAME, oldName, newName);
  ...
  public void setName(IdentifierValue newName)
  {
    if (newName != name)
    {
      ...
      if (name != null)
        msgs = ((InternalEObject)name).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AssemblerPackage.RMB_DIRECTIVE__NAME, null, msgs);
      if (newName != null)
        msgs = ((InternalEObject)newName).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AssemblerPackage.RMB_DIRECTIVE__NAME, null, msgs);
      msgs = basicSetName(newName, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AssemblerPackage.RMB_DIRECTIVE__NAME, newName, newName));
  }
  ...
  public void setIsRelativeToPC(boolean newIsRelativeToPC)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AssemblerPackage.RMB_DIRECTIVE__IS_RELATIVE_TO_PC, oldIsRelativeToPC, isRelativeToPC));
  }
  ...
  public NotificationChain basicSetOperand(Expression newOperand, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AssemblerPackage.RMB_DIRECTIVE__OPERAND, oldOperand, newOperand);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setOperand(Expression newOperand)
  {
    if (newOperand != operand)
    {
      NotificationChain msgs = null;
      if (operand != null)
        msgs = ((InternalEObject)operand).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AssemblerPackage.RMB_DIRECTIVE__OPERAND, null, msgs);
      if (newOperand != null)
        msgs = ((InternalEObject)newOperand).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AssemblerPackage.RMB_DIRECTIVE__OPERAND, null, msgs);
      msgs = basicSetOperand(newOperand, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AssemblerPackage.RMB_DIRECTIVE__OPERAND, newOperand, newOperand));
  }
  ...
  public void setComment(String newComment)
  {
    ...
    comment = newComment;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AssemblerPackage.RMB_DIRECTIVE__COMMENT, oldComment, comment));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case AssemblerPackage.RMB_DIRECTIVE__NAME:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      ...
      case AssemblerPackage.RMB_DIRECTIVE__OPERAND:
        return getOperand();
      case AssemblerPackage.RMB_DIRECTIVE__COMMENT:
        return getComment();
    }
