...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Org Directive</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 ...
 *   <li>{@link org.bpy.electronics.mc6809.assembler.assembler.impl.OrgDirectiveImpl#getWs <em>Ws</em>}</li>
...
public class OrgDirectiveImpl extends MinimalEObjectImpl.Container implements OrgDirective
{
  ...
  {
    return AssemblerPackage.eINSTANCE.getOrgDirective();
  }
  ...
  public void setDirective(String newDirective)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AssemblerPackage.ORG_DIRECTIVE__DIRECTIVE, oldDirective, directive));
  }
  ...
  public void setWs(String newWs)
  {
    ...
    ws = newWs;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AssemblerPackage.ORG_DIRECTIVE__WS, oldWs, ws));
  }
  ...
  public void setIsRelativeToPC(boolean newIsRelativeToPC)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AssemblerPackage.ORG_DIRECTIVE__IS_RELATIVE_TO_PC, oldIsRelativeToPC, isRelativeToPC));
  }
  ...
  public NotificationChain basicSetOperand(Expression newOperand, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AssemblerPackage.ORG_DIRECTIVE__OPERAND, oldOperand, newOperand);
  ...
  public void setOperand(Expression newOperand)
  {
    if (newOperand != operand)
    {
      ...
      if (operand != null)
        msgs = ((InternalEObject)operand).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AssemblerPackage.ORG_DIRECTIVE__OPERAND, null, msgs);
      if (newOperand != null)
        msgs = ((InternalEObject)newOperand).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AssemblerPackage.ORG_DIRECTIVE__OPERAND, null, msgs);
      msgs = basicSetOperand(newOperand, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AssemblerPackage.ORG_DIRECTIVE__OPERAND, newOperand, newOperand));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case AssemblerPackage.ORG_DIRECTIVE__DIRECTIVE:
        return getDirective();
      case AssemblerPackage.ORG_DIRECTIVE__WS:
        return getWs();
