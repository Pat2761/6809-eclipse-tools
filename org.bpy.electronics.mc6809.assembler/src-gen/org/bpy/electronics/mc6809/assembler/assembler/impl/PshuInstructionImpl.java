...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Pshu Instruction</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.bpy.electronics.mc6809.assembler.assembler.impl.PshuInstructionImpl#getInstruction <em>Instruction</em>}</li>
 *   <li>{@link org.bpy.electronics.mc6809.assembler.assembler.impl.PshuInstructionImpl#getWsOperand <em>Ws Operand</em>}</li>
 *   <li>{@link org.bpy.electronics.mc6809.assembler.assembler.impl.PshuInstructionImpl#getOperand <em>Operand</em>}</li>
 *   <li>{@link org.bpy.electronics.mc6809.assembler.assembler.impl.PshuInstructionImpl#getRegisters <em>Registers</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PshuInstructionImpl extends MinimalEObjectImpl.Container implements PshuInstruction
{
  /**
  ...
  public void setInstruction(String newInstruction)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AssemblerPackage.PSHU_INSTRUCTION__INSTRUCTION, oldInstruction, instruction));
  }
  ...
  public void setWsOperand(String newWsOperand)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AssemblerPackage.PSHU_INSTRUCTION__WS_OPERAND, oldWsOperand, wsOperand));
  }
  ...
  public NotificationChain basicSetOperand(IdentifierValue newOperand, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AssemblerPackage.PSHU_INSTRUCTION__OPERAND, oldOperand, newOperand);
  ...
  public void setOperand(IdentifierValue newOperand)
  {
    if (newOperand != operand)
    {
      ...
      if (operand != null)
        msgs = ((InternalEObject)operand).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AssemblerPackage.PSHU_INSTRUCTION__OPERAND, null, msgs);
      if (newOperand != null)
        msgs = ((InternalEObject)newOperand).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AssemblerPackage.PSHU_INSTRUCTION__OPERAND, null, msgs);
      msgs = basicSetOperand(newOperand, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AssemblerPackage.PSHU_INSTRUCTION__OPERAND, newOperand, newOperand));
  }
  ...
  public EList<Register> getRegisters()
  {
    if (registers == null)
    {
      registers = new EDataTypeEList<Register>(Register.class, this, AssemblerPackage.PSHU_INSTRUCTION__REGISTERS);
    }
    return registers;
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case AssemblerPackage.PSHU_INSTRUCTION__INSTRUCTION:
        return getInstruction();
      case AssemblerPackage.PSHU_INSTRUCTION__WS_OPERAND:
        return getWsOperand();
      case AssemblerPackage.PSHU_INSTRUCTION__OPERAND:
        return getOperand();
