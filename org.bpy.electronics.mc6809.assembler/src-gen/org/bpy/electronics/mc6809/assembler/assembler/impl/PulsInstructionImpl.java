 ...
 *   <li>{@link org.bpy.electronics.mc6809.assembler.assembler.impl.PulsInstructionImpl#getWsOperand <em>Ws Operand</em>}</li>
...
public class PulsInstructionImpl extends MinimalEObjectImpl.Container implements PulsInstruction
{
  ...
  public void setWsOperand(String newWsOperand)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AssemblerPackage.PULS_INSTRUCTION__WS_OPERAND, oldWsOperand, wsOperand));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      ...
      case AssemblerPackage.PULS_INSTRUCTION__WS_OPERAND:
        return getWsOperand();
      case AssemblerPackage.PULS_INSTRUCTION__OPERAND:
        return getOperand();
