 ...
 * </p>
 * <ul>
 *   <li>{@link org.bpy.electronics.mc6809.assembler.assembler.impl.FccDirectiveImpl#getName <em>Name</em>}</li>
 ...
 *   <li>{@link org.bpy.electronics.mc6809.assembler.assembler.impl.FccDirectiveImpl#getComment <em>Comment</em>}</li>
 * </ul>
 *
 * @generated
 */
public class FccDirectiveImpl extends MinimalEObjectImpl.Container implements FccDirective
{
  ...
  public NotificationChain basicSetName(IdentifierValue newName, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AssemblerPackage.FCC_DIRECTIVE__NAME, oldName, newName);
  ...
  public void setName(IdentifierValue newName)
  {
    if (newName != name)
    {
      ...
      if (name != null)
        msgs = ((InternalEObject)name).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AssemblerPackage.FCC_DIRECTIVE__NAME, null, msgs);
      if (newName != null)
        msgs = ((InternalEObject)newName).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AssemblerPackage.FCC_DIRECTIVE__NAME, null, msgs);
      msgs = basicSetName(newName, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AssemblerPackage.FCC_DIRECTIVE__NAME, newName, newName));
  }
  ...
  public void setComment(String newComment)
  {
    ...
    comment = newComment;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AssemblerPackage.FCC_DIRECTIVE__COMMENT, oldComment, comment));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case AssemblerPackage.FCC_DIRECTIVE__NAME:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      ...
      case AssemblerPackage.FCC_DIRECTIVE__STRING:
        return getString();
      case AssemblerPackage.FCC_DIRECTIVE__COMMENT:
        return getComment();
    }
