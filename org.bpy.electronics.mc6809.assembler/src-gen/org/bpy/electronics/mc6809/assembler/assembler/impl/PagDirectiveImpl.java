 ...
 *   <li>{@link org.bpy.electronics.mc6809.assembler.assembler.impl.PagDirectiveImpl#getWs <em>Ws</em>}</li>
...
public class PagDirectiveImpl extends MinimalEObjectImpl.Container implements PagDirective
{
  ...
  {
    return AssemblerPackage.eINSTANCE.getPagDirective();
  }
  ...
  public void setWs(String newWs)
  {
    ...
    ws = newWs;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AssemblerPackage.PAG_DIRECTIVE__WS, oldWs, ws));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case AssemblerPackage.PAG_DIRECTIVE__DIRECTIVE:
        return getDirective();
      case AssemblerPackage.PAG_DIRECTIVE__WS:
        return getWs();
      case AssemblerPackage.PAG_DIRECTIVE__OPERAND:
        return getOperand();
    }
