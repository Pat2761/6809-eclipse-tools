...
public class AssemblerAdapterFactory extends AdapterFactoryImpl
{
  ...
  protected AssemblerSwitch<Adapter> modelSwitch =
    new AssemblerSwitch<Adapter>()
    {
      ...
      @Override
      public Adapter caseTfrExgRegisters(TfrExgRegisters object)
      {
        return createTfrExgRegistersAdapter();
      }
      @Override
  ...
  /**
   * Creates a new adapter for an object of class '{@link org.bpy.electronics.mc6809.assembler.assembler.TfrExgRegisters <em>Tfr Exg Registers</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
   ...
   * @generated
   */
  public Adapter createTfrExgRegistersAdapter()
  {
    return null;
  }
