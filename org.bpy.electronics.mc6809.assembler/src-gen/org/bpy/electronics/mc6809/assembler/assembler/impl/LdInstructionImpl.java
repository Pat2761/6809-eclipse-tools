 ...
 *   <li>{@link org.bpy.electronics.mc6809.assembler.assembler.impl.LdInstructionImpl#getWsOperand <em>Ws Operand</em>}</li>
...
public class LdInstructionImpl extends MinimalEObjectImpl.Container implements LdInstruction
{
  ...
  public void setWsOperand(String newWsOperand)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AssemblerPackage.LD_INSTRUCTION__WS_OPERAND, oldWsOperand, wsOperand));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      ...
      case AssemblerPackage.LD_INSTRUCTION__WS_OPERAND:
        return getWsOperand();
      case AssemblerPackage.LD_INSTRUCTION__OPERAND:
        return getOperand();
    }
