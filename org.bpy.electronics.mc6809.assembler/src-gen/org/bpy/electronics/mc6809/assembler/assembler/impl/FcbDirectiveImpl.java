...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Fcb Directive</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.bpy.electronics.mc6809.assembler.assembler.impl.FcbDirectiveImpl#getName <em>Name</em>}</li>
 ...
 *   <li>{@link org.bpy.electronics.mc6809.assembler.assembler.impl.FcbDirectiveImpl#getComment <em>Comment</em>}</li>
 * </ul>
 *
 * @generated
 */
public class FcbDirectiveImpl extends MinimalEObjectImpl.Container implements FcbDirective
{
  /**
  ...
  public NotificationChain basicSetName(IdentifierValue newName, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AssemblerPackage.FCB_DIRECTIVE__NAME, oldName, newName);
  ...
  public void setName(IdentifierValue newName)
  {
    if (newName != name)
    {
      ...
      if (name != null)
        msgs = ((InternalEObject)name).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AssemblerPackage.FCB_DIRECTIVE__NAME, null, msgs);
      if (newName != null)
        msgs = ((InternalEObject)newName).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AssemblerPackage.FCB_DIRECTIVE__NAME, null, msgs);
      msgs = basicSetName(newName, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AssemblerPackage.FCB_DIRECTIVE__NAME, newName, newName));
  }
  ...
  public NotificationChain basicSetOperand(ListOfExpression newOperand, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AssemblerPackage.FCB_DIRECTIVE__OPERAND, oldOperand, newOperand);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setOperand(ListOfExpression newOperand)
  {
    if (newOperand != operand)
    {
      NotificationChain msgs = null;
      if (operand != null)
        msgs = ((InternalEObject)operand).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AssemblerPackage.FCB_DIRECTIVE__OPERAND, null, msgs);
      if (newOperand != null)
        msgs = ((InternalEObject)newOperand).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AssemblerPackage.FCB_DIRECTIVE__OPERAND, null, msgs);
      msgs = basicSetOperand(newOperand, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AssemblerPackage.FCB_DIRECTIVE__OPERAND, newOperand, newOperand));
  }
  ...
  public void setComment(String newComment)
  {
    ...
    comment = newComment;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AssemblerPackage.FCB_DIRECTIVE__COMMENT, oldComment, comment));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case AssemblerPackage.FCB_DIRECTIVE__NAME:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      ...
      case AssemblerPackage.FCB_DIRECTIVE__OPERAND:
        return getOperand();
      case AssemblerPackage.FCB_DIRECTIVE__COMMENT:
        return getComment();
    }
