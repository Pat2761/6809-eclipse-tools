 ...
 *   <li>{@link org.bpy.electronics.mc6809.assembler.assembler.impl.FdbDirectiveImpl#getWs <em>Ws</em>}</li>
...
public class FdbDirectiveImpl extends MinimalEObjectImpl.Container implements FdbDirective
{
  ...
  {
    return AssemblerPackage.eINSTANCE.getFdbDirective();
  }
  ...
  public void setWs(String newWs)
  {
    ...
    ws = newWs;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AssemblerPackage.FDB_DIRECTIVE__WS, oldWs, ws));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case AssemblerPackage.FDB_DIRECTIVE__DIRECTIVE:
        return getDirective();
      case AssemblerPackage.FDB_DIRECTIVE__WS:
        return getWs();
      case AssemblerPackage.FDB_DIRECTIVE__OPERAND:
        return getOperand();
    }
