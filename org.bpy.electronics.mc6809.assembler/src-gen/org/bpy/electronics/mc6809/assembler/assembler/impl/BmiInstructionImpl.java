 ...
 *   <li>{@link org.bpy.electronics.mc6809.assembler.assembler.impl.BmiInstructionImpl#getWsOperand <em>Ws Operand</em>}</li>
...
public class BmiInstructionImpl extends MinimalEObjectImpl.Container implements BmiInstruction
{
  ...
  public void setWsOperand(String newWsOperand)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AssemblerPackage.BMI_INSTRUCTION__WS_OPERAND, oldWsOperand, wsOperand));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      ...
      case AssemblerPackage.BMI_INSTRUCTION__WS_OPERAND:
        return getWsOperand();
      case AssemblerPackage.BMI_INSTRUCTION__OPERAND:
        return getOperand();
    }
