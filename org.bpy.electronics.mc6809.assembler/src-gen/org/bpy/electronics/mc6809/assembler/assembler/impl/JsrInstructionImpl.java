...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Jsr Instruction</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 ...
 * @generated
 */
public class JsrInstructionImpl extends MinimalEObjectImpl.Container implements JsrInstruction
{
  /**
  ...
  public NotificationChain basicSetOperand(EObject newOperand, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AssemblerPackage.JSR_INSTRUCTION__OPERAND, oldOperand, newOperand);
  ...
  public void setOperand(EObject newOperand)
  {
    if (newOperand != operand)
    {
      ...
      if (operand != null)
        msgs = ((InternalEObject)operand).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AssemblerPackage.JSR_INSTRUCTION__OPERAND, null, msgs);
      if (newOperand != null)
        msgs = ((InternalEObject)newOperand).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AssemblerPackage.JSR_INSTRUCTION__OPERAND, null, msgs);
      msgs = basicSetOperand(newOperand, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AssemblerPackage.JSR_INSTRUCTION__OPERAND, newOperand, newOperand));
  }
