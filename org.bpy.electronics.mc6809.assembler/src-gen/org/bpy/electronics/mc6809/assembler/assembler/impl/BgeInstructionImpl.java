...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Bge Instruction</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.bpy.electronics.mc6809.assembler.assembler.impl.BgeInstructionImpl#getInstruction <em>Instruction</em>}</li>
 *   <li>{@link org.bpy.electronics.mc6809.assembler.assembler.impl.BgeInstructionImpl#getWsOperand <em>Ws Operand</em>}</li>
 *   <li>{@link org.bpy.electronics.mc6809.assembler.assembler.impl.BgeInstructionImpl#getOperand <em>Operand</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BgeInstructionImpl extends MinimalEObjectImpl.Container implements BgeInstruction
{
  /**
  ...
  public void setInstruction(String newInstruction)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AssemblerPackage.BGE_INSTRUCTION__INSTRUCTION, oldInstruction, instruction));
  }
  ...
  public void setWsOperand(String newWsOperand)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AssemblerPackage.BGE_INSTRUCTION__WS_OPERAND, oldWsOperand, wsOperand));
  }
  ...
  public NotificationChain basicSetOperand(RelativeMode newOperand, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AssemblerPackage.BGE_INSTRUCTION__OPERAND, oldOperand, newOperand);
  ...
  public void setOperand(RelativeMode newOperand)
  {
    if (newOperand != operand)
    {
      ...
      if (operand != null)
        msgs = ((InternalEObject)operand).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AssemblerPackage.BGE_INSTRUCTION__OPERAND, null, msgs);
      if (newOperand != null)
        msgs = ((InternalEObject)newOperand).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AssemblerPackage.BGE_INSTRUCTION__OPERAND, null, msgs);
      msgs = basicSetOperand(newOperand, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AssemblerPackage.BGE_INSTRUCTION__OPERAND, newOperand, newOperand));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case AssemblerPackage.BGE_INSTRUCTION__OPERAND:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case AssemblerPackage.BGE_INSTRUCTION__INSTRUCTION:
        return getInstruction();
      case AssemblerPackage.BGE_INSTRUCTION__WS_OPERAND:
        return getWsOperand();
      case AssemblerPackage.BGE_INSTRUCTION__OPERAND:
        return getOperand();
    }
