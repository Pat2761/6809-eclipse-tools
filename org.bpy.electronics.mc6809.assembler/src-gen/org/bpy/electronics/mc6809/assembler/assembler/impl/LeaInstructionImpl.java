...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Lea Instruction</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.bpy.electronics.mc6809.assembler.assembler.impl.LeaInstructionImpl#getInstruction <em>Instruction</em>}</li>
 *   <li>{@link org.bpy.electronics.mc6809.assembler.assembler.impl.LeaInstructionImpl#getWsOperand <em>Ws Operand</em>}</li>
 *   <li>{@link org.bpy.electronics.mc6809.assembler.assembler.impl.LeaInstructionImpl#getOperand <em>Operand</em>}</li>
 * </ul>
 *
 * @generated
 */
public class LeaInstructionImpl extends MinimalEObjectImpl.Container implements LeaInstruction
{
  /**
  ...
  public void setInstruction(String newInstruction)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AssemblerPackage.LEA_INSTRUCTION__INSTRUCTION, oldInstruction, instruction));
  }
  ...
  public void setWsOperand(String newWsOperand)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AssemblerPackage.LEA_INSTRUCTION__WS_OPERAND, oldWsOperand, wsOperand));
  }
  ...
  public NotificationChain basicSetOperand(EObject newOperand, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AssemblerPackage.LEA_INSTRUCTION__OPERAND, oldOperand, newOperand);
  ...
  public void setOperand(EObject newOperand)
  {
    if (newOperand != operand)
    {
      ...
      if (operand != null)
        msgs = ((InternalEObject)operand).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AssemblerPackage.LEA_INSTRUCTION__OPERAND, null, msgs);
      if (newOperand != null)
        msgs = ((InternalEObject)newOperand).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AssemblerPackage.LEA_INSTRUCTION__OPERAND, null, msgs);
      msgs = basicSetOperand(newOperand, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AssemblerPackage.LEA_INSTRUCTION__OPERAND, newOperand, newOperand));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case AssemblerPackage.LEA_INSTRUCTION__INSTRUCTION:
        return getInstruction();
      case AssemblerPackage.LEA_INSTRUCTION__WS_OPERAND:
        return getWsOperand();
      case AssemblerPackage.LEA_INSTRUCTION__OPERAND:
        return getOperand();
    }
