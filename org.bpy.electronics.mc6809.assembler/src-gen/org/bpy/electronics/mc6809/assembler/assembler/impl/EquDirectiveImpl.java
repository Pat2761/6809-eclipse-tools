 ...
 *   <li>{@link org.bpy.electronics.mc6809.assembler.assembler.impl.EquDirectiveImpl#getWs <em>Ws</em>}</li>
...
public class EquDirectiveImpl extends MinimalEObjectImpl.Container implements EquDirective
{
  ...
  public void setWs(String newWs)
  {
    ...
    ws = newWs;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AssemblerPackage.EQU_DIRECTIVE__WS, oldWs, ws));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case AssemblerPackage.EQU_DIRECTIVE__DIRECTIVE:
        return getDirective();
      case AssemblerPackage.EQU_DIRECTIVE__WS:
        return getWs();
