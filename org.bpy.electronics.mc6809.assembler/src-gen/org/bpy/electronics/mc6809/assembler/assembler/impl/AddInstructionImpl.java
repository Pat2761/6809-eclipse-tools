 ...
 * </p>
 * <ul>
 *   <li>{@link org.bpy.electronics.mc6809.assembler.assembler.impl.AddInstructionImpl#getName <em>Name</em>}</li>
 ...
 *   <li>{@link org.bpy.electronics.mc6809.assembler.assembler.impl.AddInstructionImpl#getComment <em>Comment</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AddInstructionImpl extends MinimalEObjectImpl.Container implements AddInstruction
{
  ...
  public NotificationChain basicSetName(IdentifierValue newName, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AssemblerPackage.ADD_INSTRUCTION__NAME, oldName, newName);
  ...
  public void setName(IdentifierValue newName)
  {
    if (newName != name)
    {
      ...
      if (name != null)
        msgs = ((InternalEObject)name).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AssemblerPackage.ADD_INSTRUCTION__NAME, null, msgs);
      if (newName != null)
        msgs = ((InternalEObject)newName).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AssemblerPackage.ADD_INSTRUCTION__NAME, null, msgs);
      msgs = basicSetName(newName, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AssemblerPackage.ADD_INSTRUCTION__NAME, newName, newName));
  }
  ...
  public void setComment(String newComment)
  {
    ...
    comment = newComment;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AssemblerPackage.ADD_INSTRUCTION__COMMENT, oldComment, comment));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case AssemblerPackage.ADD_INSTRUCTION__NAME:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      ...
      case AssemblerPackage.ADD_INSTRUCTION__OPERAND:
        return getOperand();
      case AssemblerPackage.ADD_INSTRUCTION__COMMENT:
        return getComment();
    }
