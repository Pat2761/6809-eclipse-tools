...
public class InternalAssemblerParser extends AbstractInternalAntlrParser {
        ...
        try {
            ...
            do {
            	...
            	case 1 :
            	    ...
            	    {
            	    lv_operation_2_0=(Token)match(input,16,FOLLOW_10); if (state.failed) return current;
            	    if ( state.backtracking==0 ) {
        ...
        try {
            ...
            do {
            	...
            	case 1 :
            	    ...
            	    {
            	    lv_opretation_2_0=(Token)match(input,17,FOLLOW_10); if (state.failed) return current;
            	    if ( state.backtracking==0 ) {
        ...
        try {
            ...
            do {
            	...
            	case 1 :
            	    ...
            	    {
            	    lv_opretation_2_0=(Token)match(input,18,FOLLOW_10); if (state.failed) return current;
            	    if ( state.backtracking==0 ) {
        ...
        try {
            ...
            do {
            	...
            	case 1 :
            	    ...
            	    // InternalAssembler.g:774:4: ( ( '-' )=>otherlv_2= '-' )
            	    // InternalAssembler.g:775:5: ( '-' )=>otherlv_2= '-'
            	    {
            	    ...
            	    // InternalAssembler.g:781:4: ( (lv_right_3_0= ruleLeftShift ) )
            	    // InternalAssembler.g:782:5: (lv_right_3_0= ruleLeftShift )
            	    {
            	    // InternalAssembler.g:782:5: (lv_right_3_0= ruleLeftShift )
            	    // InternalAssembler.g:783:6: lv_right_3_0= ruleLeftShift
            	    {
            	    if ( state.backtracking==0 ) {
    ...
    // InternalAssembler.g:805:1: entryRuleLeftShift returns [EObject current=null] : iv_ruleLeftShift= ruleLeftShift EOF ;
    public final EObject entryRuleLeftShift() throws RecognitionException {
        ...
        try {
            // InternalAssembler.g:805:50: (iv_ruleLeftShift= ruleLeftShift EOF )
            // InternalAssembler.g:806:2: iv_ruleLeftShift= ruleLeftShift EOF
            {
            if ( state.backtracking==0 ) {
