...
|                         |                                                        |
|-------------------------|--------------------------------------------------------|
|Source Form | CWAI #$XX &nbsp; <img src="StatusRegister.jpg" alt="drawing" width="200"/> |
|Operation| CCR'^CCR A Ml (Possibly clear masks) <br> Set E (entire state saved) <br> SP'= SP-1, (SP) <- PCL <br> SP' = SP-1, (SP) = PCH <br> SP' = SP-1, (SP) <- USL <br> SP' =  SP-1, (SP) <- USH <br> SP' = SP-1, (SP) <- IYL <br> SP' = SP-1, (SP) <- lYH <br> SP' = SP-1, (SP) <- IXL <br> SP' = SP-1, (SP) <-  IXH <br> SP' = SP-1, (SP) <- DPR <br> SP' = SP-1, (SP) <- ACCB <br> SP' = SP-1, (SP) <- ACCA <br> SP' = SP-1, (SP) <- CCR |
