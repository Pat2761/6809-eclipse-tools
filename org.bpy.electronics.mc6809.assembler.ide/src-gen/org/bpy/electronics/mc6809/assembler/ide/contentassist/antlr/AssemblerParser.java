...
public class AssemblerParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, AssemblerGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getOrgDirectiveAccess().getOperandAssignment_4(), "rule__OrgDirective__OperandAssignment_4");
			builder.put(grammarAccess.getOrgDirectiveAccess().getCommentAssignment_6(), "rule__OrgDirective__CommentAssignment_6");
