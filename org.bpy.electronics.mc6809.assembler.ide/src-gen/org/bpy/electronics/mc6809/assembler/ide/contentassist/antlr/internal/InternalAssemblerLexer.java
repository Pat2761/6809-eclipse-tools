...
public class InternalAssemblerLexer extends Lexer {
    ...
    public final void mRULE_SL_COMMENT() throws RecognitionException {
        try {
            ...
            // InternalAssembler.g:341:17: ( ';' ( . )* RULE_CR )
            // InternalAssembler.g:341:19: ';' ( . )* RULE_CR
            {
            match(';'); 
            // InternalAssembler.g:341:23: ( . )*
            loop1:
            do {
                int alt1=2;
    ...
    public final void mRULE_CR() throws RecognitionException {
        try {
            int _type = RULE_CR;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalAssembler.g:343:9: ( ( '\\r' )? '\\n' )
            // InternalAssembler.g:343:11: ( '\\r' )? '\\n'
            {
            // InternalAssembler.g:343:11: ( '\\r' )?
            int alt2=2;
    ...
    public final void mRULE_WS() throws RecognitionException {
        try {
            int _type = RULE_WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalAssembler.g:345:9: ( ( ' ' | '\\t' )+ )
            // InternalAssembler.g:345:11: ( ' ' | '\\t' )+
            {
            // InternalAssembler.g:345:11: ( ' ' | '\\t' )+
            int cnt3=0;
            loop3:
